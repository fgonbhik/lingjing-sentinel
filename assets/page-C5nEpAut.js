...
`)}var _u=new Pt;function vu(e){zt._getMatrix(_u,zt.workingColorSpace,e);let t=`mat3( ${_u.elements.map(e=>e.toFixed(4))} )`;switch(zt.getTransfer(e)){case Ve:return[t,`LinearTransferOETF`];case He:return[t,`sRGBTransferOETF`];default:return U(`WebGLProgram: Unsupported color space: `,e),[t,`LinearTransferOETF`]}}function yu(e,t,n){let r=e.getShaderParameter(t,e.COMPILE_STATUS),i=(e.getShaderInfoLog(t)||``).trim();if(r&&i===``)return``;let a=/ERROR: 0:(\d+)/.exec(i);if(a){let r=parseInt(a[1]);return n.toUpperCase()+`
...
`)}var xu={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Su(e,t){let n=xu[t];return n===void 0?(U(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Cu=new q;function wu(){return zt.getLuminanceCoefficients(Cu),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Cu.x.toFixed(4)}, ${Cu.y.toFixed(4)}, ${Cu.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=pu(i,i.VERTEX_SHADER,y),S=pu(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=yu(i,x,`vertex`),n=yu(i,S,`fragment`);W(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
          ...
          totalEmissiveRadiance += windowColor * windowShape * windowOn * windowStrength;`)};let pe=new X(1,1,1),me=new li({color:3729407,wireframe:!0,transparent:!0,opacity:.16,blending:2,depthWrite:!1}),he=new X(1,.12,1),ge=new li({color:8189439,transparent:!0,opacity:.72}),_e=null,ve=[],R=[];(async()=>{try{let e=await fetch(`./beijing-buildings.json`);if(!e.ok)throw Error(`building dataset unavailable`);let r=await e.json();if(t)return;let i=r.buildings.filter(e=>e.points.length>=3).slice(0,5200),a=new Mi(pe,de,i.length);_e=a,ve=i;let o=new Mi(pe,me,i.length),s=i.filter(e=>(e.heightMeters||16)>40).slice(0,700),c=new Mi(he,ge,s.length),u=new tn,d=new tn,f=new J,p=e=>{let t=e.points.map(e=>e[0]),n=e.points.map(e=>e[1]);return{x:(Math.min(...t)+Math.max(...t))/3.35,z:(Math.min(...n)+Math.max(...n))/3.35,width:Math.max(.45,Math.min(6,(Math.max(...t)-Math.min(...t))/3.35)),depth:Math.max(.45,Math.min(6,(Math.max(...n)-Math.min(...n))/3.35)),height:Math.max(1.2,Math.min(58,(e.heightMeters||16)/5.2))}};i.forEach((e,t)=>{let{x:n,z:r,width:i,depth:s,height:c}=p(e);u.compose(new q(n,1.72+c/2,r),new jt,new q(i,c,s)),a.setMatrixAt(t,u),d.compose(new q(n,1.72+c/2,r),new jt,new q(i*1.018,c*1.006,s*1.018)),o.setMatrixAt(t,d);let l=Math.min(1,Math.sqrt(n*n+r*r)/110);f.setHSL(.51+l*.055+Math.random()*.018,.52,.31+(1-l)*.18+Math.random()*.08),a.setColorAt(t,f),R.push(f.clone())}),s.forEach((e,t)=>{let{x:n,z:r,width:i,depth:a,height:o}=p(e);u.compose(new q(n,1.76+o,r),new jt,new q(i*.82,1,a*.82)),c.setMatrixAt(t,u)}),a.instanceMatrix.needsUpdate=!0,a.instanceColor.needsUpdate=!0,o.instanceMatrix.needsUpdate=!0,c.instanceMatrix.needsUpdate=!0,a.castShadow=!0,a.receiveShadow=!0,a.userData.asset={id:`beijing-building-network`,label:`北京城市建筑群`,category:`三维城市底座`,details:`${i.length.toLocaleString()} 栋建筑已接入城市数字孪生，支持空间定位、态势叠加与运行监测。`,meta:`建筑高度 · 区位编码 · 能耗状态 · 实时同步`},n.add(a,o,c),te.push(a),l(`ready`)}catch{t||l(`degraded`)}})();let ye=new Mi(new X(1.15,.48,.62),new Z({color:14220031,emissive:3595759,emissiveIntensity:1.05,metalness:.55,roughness:.26}),54);ye.instanceMatrix.setUsage(Ge),n.add(ye);let be=new tn,xe=Array.from({length:54},(e,t)=>({axis:t%2,lane:[-72,-46,-22,0,24,49,74][t%7]+(t%3-1)*1.15,offset:t*17%224,speed:.15+t%7*.017}));_.current=(e,t)=>{n.background=new J(e?66570:466741),n.fog=new Rn(e?133138:666174,e?.0075:.0056),v.intensity=e?.42:1.15,y.intensity=e?.16:2.4,b.intensity=e?34:22,x.forEach((t,n)=>{t.intensity=e?13+n%2*2:7}),C.color.setHex(e?133906:466219),T.emissiveIntensity=e?1.1:.65,O.emissive.setHex(e?536640:332829),de.emissive.setHex(t?e?555932:676459:266780),de.emissiveIntensity=t?e?.95:.48:.1,fe.value=t?e?2.2:1.15:.03,me.opacity=t?e?.3:.16:.045,ge.opacity=t?e?.92:.72:.16,k.opacity=e?.82:.52,M.emissiveIntensity=e?.9:.55},_.current(p.current,m.current);let Se=new cc,Ce=new K,we=new J(10420223),Te=-1,Ee=null,De=0,Oe={x:0,y:0},ke=e=>{let t=o.domElement.getBoundingClientRect();Ce.set((e.clientX-t.left)/t.width*2-1,-((e.clientY-t.top)/t.height)*2+1)},z=()=>{_e&&Te>=0&&R[Te]&&(_e.setColorAt(Te,R[Te]),_e.instanceColor&&(_e.instanceColor.needsUpdate=!0)),Te=-1},Ae=()=>{Ee&&Ee.scale.setScalar(1),Ee=null},je=()=>{z(),Ae(),o.domElement.style.cursor=`grab`},Me=e=>{let t=e.clientX,n=e.clientY;cancelAnimationFrame(De),De=requestAnimationFrame(()=>{let e=o.domElement.getBoundingClientRect();Ce.set((t-e.left)/e.width*2-1,-((n-e.top)/e.height)*2+1),Se.setFromCamera(Ce,r);let i=Se.intersectObjects(te,!1)[0],a=i?.object===_e&&i.instanceId!==void 0?i.instanceId:-1,s=i?.object.userData.asset&&i?.object!==_e?i.object:null;a!==Te&&(z(),_e&&a>=0&&(_e.setColorAt(a,we),_e.instanceColor&&(_e.instanceColor.needsUpdate=!0),Te=a)),s!==Ee&&(Ae(),Ee=s,Ee?.scale.setScalar(1.35)),o.domElement.style.cursor=i?`pointer`:`grab`})},B=e=>{if(Math.hypot(e.clientX-Oe.x,e.clientY-Oe.y)>5)return;ke(e),Se.setFromCamera(Ce,r);let t=Se.intersectObjects(te,!1)[0];if(t?.object===_e&&t.instanceId!==void 0){let e=ve[t.instanceId],n=e?.id??t.instanceId+1,r=Math.round(e?.heightMeters||16);c({id:`building-${n}`,label:e?.name||`北京城市建筑 ${String(n).padStart(5,`0`)}`,category:`北京三维建筑资产`,details:`建筑高度约 ${r} 米，已接入北京城市数字孪生底座，可叠加能耗、安防、交通及应急态势数据。`,meta:`资产编号 BJ-${String(n).padStart(6,`0`)} · 实时在线 · 单击定位`});return}let n=t?.object.userData.asset;c(n||null)},Ne=e=>{Oe={x:e.clientX,y:e.clientY}};o.domElement.addEventListener(`pointermove`,Me),o.domElement.addEventListener(`pointerleave`,je),o.domElement.addEventListener(`pointerdown`,Ne),o.domElement.addEventListener(`pointerup`,B);let V=()=>{let t=Math.max(1,e.clientWidth),n=Math.max(1,e.clientHeight);r.aspect=t/n,r.updateProjectionMatrix(),o.setSize(t,n,!1)},H=new ResizeObserver(V);H.observe(e),V();let Pe=null,Fe=(e,t,n=1250)=>{Pe={from:r.position.clone(),to:new q(...e),targetFrom:s.target.clone(),targetTo:new q(...t),start:performance.now(),duration:n},s.enabled=!1},Ie=e=>{let t=e.detail;if(t===`zoomIn`||t===`zoomOut`){let e=t===`zoomIn`?.82:1.18,n=r.position.clone().sub(s.target).multiplyScalar(e);r.position.copy(s.target).add(n),s.update();return}if(t===`reset`){Fe(bf.panorama.position,bf.panorama.target);return}if(typeof t==`object`&&t.action===`view`&&t.view&&bf[t.view]){let e=bf[t.view];Fe(e.position,e.target);return}typeof t==`object`&&t.action===`focus`&&t.position&&t.target&&Fe(t.position,t.target,1050)};window.addEventListener(`smart-city-camera`,Ie);let Le=performance.now(),Re=0,Be=e=>{Re=requestAnimationFrame(Be);let t=(e-Le)/1e3,i=Math.min(54,g.current);if(ye.count=i,xe.forEach((e,n)=>{if(n>=i)return;let r=(e.offset+t*e.speed*30)%224-112,a=e.axis?r:e.lane,o=e.axis?e.lane:r,s=new jt().setFromEuler(new fn(0,e.axis?Math.PI/2:0,0));be.compose(new q(a,2.12,o),s,new q(1,1,1)),ye.setMatrixAt(n,be)}),ye.instanceMatrix.needsUpdate=!0,ue.scale.setScalar(1+t*.2%1*43),le.opacity=.24*(1-t*.2%1),se.opacity=.5+Math.sin(t*2.2)*.22,ee.forEach((e,n)=>{e.rotation.z=t*(n%2?-.025:.02),e.material.opacity=.23+Math.sin(t*1.4+n)*.12}),j.forEach((e,n)=>{e.rotation.z=t*(n===0?.08:-.055),e.material.opacity=(n===0?.62:.4)+Math.sin(t*1.7+n)*.12}),S.forEach((e,n)=>{let r=.88+Math.sin(t*2.4+n*.7)*.22;e.scale.setScalar(r)}),ne.forEach((e,n)=>{let r=1+Math.sin(t*2+n)*.12;e.scale.setScalar(r)}),ie.forEach((e,n)=>{e.material.dashOffset=-t*(.8+n*.14)}),oe.forEach((e,n)=>{let r=ie[n].userData.curve;e.position.copy(r.getPoint((t*.13+n*.22)%1))}),Pe){let t=Math.min(1,(e-Pe.start)/Pe.duration),n=1-(1-t)**3;r.position.lerpVectors(Pe.from,Pe.to,n),s.target.lerpVectors(Pe.targetFrom,Pe.targetTo,n),t>=1&&(Pe=null,s.enabled=!0)}else h.current&&(r.position.x=Math.cos(t*.075)*150,r.position.z=Math.sin(t*.075)*150,r.position.y=79+Math.sin(t*.11)*14,s.target.set(0,12,0));s.update(),o.render(n,r)};return Re=requestAnimationFrame(Be),()=>{t=!0,cancelAnimationFrame(Re),cancelAnimationFrame(De),H.disconnect(),o.domElement.removeEventListener(`pointermove`,Me),o.domElement.removeEventListener(`pointerleave`,je),o.domElement.removeEventListener(`pointerdown`,Ne),o.domElement.removeEventListener(`pointerup`,B),window.removeEventListener(`smart-city-camera`,Ie),s.dispose(),o.dispose(),n.traverse(e=>{let t=e;t.geometry?.dispose?.(),Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material?.dispose?.()}),o.domElement.remove()}},[l,c]),(0,$.jsx)(`div`,{ref:u,className:`smart-city-scene`,"aria-label":`北京科幻智慧城市三维数字孪生场景`})}var Tf=[`全域态势`,`城市治理`,`交通脉搏`,`生态能源`,`公共安全`],Ef=[{name:`朝阳`,score:97.2,tone:`cyan`,value:`商务活跃`},{name:`海淀`,score:95.8,tone:`blue`,value:`科技创新`},{name:`东城`,score:94.6,tone:`green`,value:`治理高效`},{name:`丰台`,score:91.9,tone:`orange`,value:`枢纽畅通`}],Df=[{time:`21:26:48`,level:`AI`,text:`朝阳区交通流量预测完成`,state:`已闭环`},{time:`21:25:32`,level:`感`,text:`海淀区感知节点状态巡检`,state:`正常`},{time:`21:24:16`,level:`能`,text:`全市电网负荷进入平稳区间`,state:`稳定`},{time:`21:22:09`,level:`环`,text:`城市空气质量模型已更新`,state:`优良`}],Of=[`全市感知设备在线率 99.97%`,`重点道路平均车速 41.8 km/h`,`轨道交通在途列车 1,284 列`,`空气质量优良率 94.6%`,`城市事件智能闭环率 96.8%`,`新能源消纳比例 38.7%`],kf=[{id:`panorama`,code:`01`,label:`全景`},{id:`cbd`,code:`02`,label:`CBD`},{id:`axis`,code:`03`,label:`中轴`},{id:`top`,code:`04`,label:`俯瞰`},{id:`horizon`,code:`05`,label:`天际`}],Af={朝阳:{position:[83,45,72],target:[38,9,18]},海淀:{position:[-88,48,82],target:[-48,9,40]},东城:{position:[-58,42,-58],target:[-22,9,-15]},丰台:{position:[52,43,-91],target:[12,8,-48]}};function jf({displayName:e,onOpenDemo:t,onLogout:n}){let[i,a]=(0,r.useState)(`全域态势`),[o,s]=(0,r.useState)(!0),[c,l]=(0,r.useState)(!0),[u,d]=(0,r.useState)(!0),[f,p]=(0,r.useState)(!1),[m,h]=(0,r.useState)(54),[g,_]=(0,r.useState)(null),[v,y]=(0,r.useState)(`loading`),[b,x]=(0,r.useState)(()=>new Date),[S,C]=(0,r.useState)(0),[w,T]=(0,r.useState)(!1),[E,D]=(0,r.useState)(`panorama`),[O,k]=(0,r.useState)(`左键拖拽旋转 · 滚轮缩放 · 右键平移 · 点击建筑查看详情`),[A,ee]=(0,r.useState)(0);(0,r.useEffect)(()=>{let e=window.setInterval(()=>x(new Date),1e3),t=window.setInterval(()=>C(e=>(e+1)%8),2400),n=window.requestAnimationFrame(()=>T(!0));return()=>{window.clearInterval(e),window.clearInterval(t),window.cancelAnimationFrame(n)}},[]);let j=(0,r.useCallback)(e=>{k(e),ee(e=>e+1)},[]),M=(0,r.useCallback)((e,t,n,r,i)=>{_({id:`insight-${e}`,label:t,category:n,details:r,meta:i}),j(`已打开：${t} · 右侧详情卡片已更新`)},[j]),N=(0,r.useCallback)(e=>{_(e),e&&j(`已选中：${e.label} · 详情卡片已展开`)},[j]),P=b.toLocaleTimeString(`zh-CN`,{hour12:!1}),F=b.toLocaleDateString(`zh-CN`,{year:`numeric`,month:`2-digit`,day:`2-digit`}),te=[`星期日`,`星期一`,`星期二`,`星期三`,`星期四`,`星期五`,`星期六`][b.getDay()],ne=(0,r.useMemo)(()=>v===`loading`?`正在构建北京三维建筑群`:v===`degraded`?`城市基础模型已启用`:`5,200 栋建筑在线 · 城市光网运行中`,[v]),re=e=>{d(!1),p(!1),D(`panorama`),_({id:`district-${e.name}`,label:`${e.name}区`,category:`城区运行态势`,details:`${e.value}，当前城区综合运行指数 ${e.score}，城市感知、交通与公共服务状态正常。`,meta:`AI 评分 ${e.score} · 数据刷新 128ms`});let t=Af[e.name];window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:{action:`focus`,position:t.position,target:t.target}})),j(`正在聚焦${e.name}区 · 镜头已进入城区态势视角`)},ie=e=>{d(!1),p(!1),D(e.id),window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:{action:`view`,view:e.id}})),j(`视角切换：${e.label} · 镜头缓动飞行中`)};return(0,$.jsxs)(`main`,{className:`future-city ${o?`night`:`day`}`,children:[(0,$.jsx)(`div`,{className:`future-grid`,"aria-hidden":`true`}),(0,$.jsx)(`div`,{className:`future-aurora future-aurora-a`,"aria-hidden":`true`}),(0,$.jsx)(`div`,{className:`future-aurora future-aurora-b`,"aria-hidden":`true`}),(0,$.jsxs)(`header`,{className:`future-header`,children:[(0,$.jsxs)(`div`,{className:`future-brand`,children:[(0,$.jsxs)(`div`,{className:`future-brand-symbol`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`b`,{})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:`京域智城`}),(0,$.jsx)(`span`,{children:`BEIJING URBAN INTELLIGENCE CENTER`})]})]}),(0,$.jsxs)(`div`,{className:`future-heading`,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`i`,{}),` BEIJING DIGITAL TWIN · 2026`]}),(0,$.jsx)(`h1`,{children:`北京市智慧城市运行指挥中心`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`b`,{children:`全域感知`}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]})]}),(0,$.jsxs)(`div`,{className:`future-account`,children:[(0,$.jsxs)(`div`,{className:`future-time`,children:[(0,$.jsx)(`strong`,{children:P}),(0,$.jsxs)(`span`,{children:[F,` · `,te]})]}),(0,$.jsxs)(`div`,{className:`future-user`,children:[(0,$.jsx)(`i`,{}),e,(0,$.jsx)(`button`,{onClick:n,children:`退出`})]})]})]}),(0,$.jsxs)(`nav`,{className:`future-nav`,"aria-label":`智慧城市功能导航`,children:[Tf.map((e,t)=>(0,$.jsxs)(`button`,{className:i===e?`active`:``,onClick:()=>a(e),children:[(0,$.jsxs)(`i`,{children:[`0`,t+1]}),(0,$.jsx)(`span`,{children:e})]},e)),(0,$.jsxs)(`button`,{className:`future-demo-nav`,onClick:t,children:[(0,$.jsx)(`i`,{children:`AI`}),(0,$.jsx)(`span`,{children:`演示项目`}),(0,$.jsx)(`em`,{children:`ENTER`})]})]}),(0,$.jsxs)(`section`,{className:`future-stage`,children:[(0,$.jsxs)(`aside`,{className:`future-column left`,children:[(0,$.jsxs)(`section`,{className:`future-panel city-vitals`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`01`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`城市生命体征`}),(0,$.jsx)(`em`,{children:`URBAN VITAL SIGNS`})]}),(0,$.jsx)(`i`,{children:`LIVE`})]}),(0,$.jsxs)(`div`,{className:`vital-primary`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`常住人口`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:2183.2,decimals:1})}),(0,$.jsx)(`em`,{children:`万人`})]}),(0,$.jsx)(`div`,{className:`vital-wave`,"aria-hidden":`true`,children:[34,52,41,68,48,76,57,82,61,72,55,88].map((e,t)=>(0,$.jsx)(`i`,{style:{height:`${e}%`}},t))})]}),(0,$.jsxs)(`div`,{className:`vital-grid`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`area`,`北京市域面积`,`城市生命体征`,`全市域面积 16,410 平方公里，数字孪生已覆盖核心城区、重点交通走廊和公共服务节点。`,`全域覆盖 · 数据更新 128ms`),children:[(0,$.jsx)(`span`,{children:`城市面积`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(_f,{to:16410}),(0,$.jsx)(`small`,{children:` km²`})]}),(0,$.jsx)(`em`,{children:`全域覆盖`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`gdp`,`地区生产总值`,`城市生命体征`,`城市经济运行保持稳健，数字经济、科技服务和现代服务业构成主要增长动能。`,`4.98 万亿元 · 同比 +5.2%`),children:[(0,$.jsx)(`span`,{children:`地区生产总值`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(_f,{to:4.98,decimals:2}),(0,$.jsx)(`small`,{children:` 万亿元`})]}),(0,$.jsx)(`em`,{children:`同比 +5.2%`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`rail`,`轨道交通网络`,`城市生命体征`,`轨道交通运营里程 879 公里，1,284 列列车在途，关键换乘枢纽运行正常。`,`线网联动 · 平均准点率 99.6%`),children:[(0,$.jsx)(`span`,{children:`轨道交通`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(_f,{to:879}),(0,$.jsx)(`small`,{children:` km`})]}),(0,$.jsx)(`em`,{children:`在途 1,284 列`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`parks`,`公园绿地体系`,`城市生命体征`,`全市 1,064 处公园绿地接入生态监测，绿色空间覆盖率达到 49.8%。`,`生态感知 · 1,064 处在线`),children:[(0,$.jsx)(`span`,{children:`公园绿地`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(_f,{to:1064}),(0,$.jsx)(`small`,{children:` 处`})]}),(0,$.jsx)(`em`,{children:`绿色空间 49.8%`})]})]})]}),(0,$.jsxs)(`section`,{className:`future-panel event-center`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`02`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`城市事件中枢`}),(0,$.jsx)(`em`,{children:`AI EVENT STREAM`})]}),(0,$.jsx)(`i`,{children:`04`})]}),(0,$.jsx)(`div`,{className:`event-list`,children:Df.map((e,t)=>(0,$.jsxs)(`button`,{type:`button`,className:`event-row ${S===t?`pulse`:``}`,onClick:()=>M(`event-${t}`,e.text,`城市事件中枢`,`${e.time} 由${e.level}类城市感知模型完成研判，当前处置状态为“${e.state}”。`,`事件编号 BJ-${e.time.replaceAll(`:`,``)} · ${e.state}`),children:[(0,$.jsx)(`time`,{children:e.time}),(0,$.jsx)(`i`,{children:e.level}),(0,$.jsxs)(`p`,{children:[e.text,(0,$.jsx)(`span`,{children:e.state})]})]},e.time))}),(0,$.jsxs)(`button`,{className:`event-action`,onClick:t,children:[(0,$.jsx)(`span`,{children:`突发事件智能处置演示`}),(0,$.jsx)(`b`,{children:`启动灵境哨兵`}),(0,$.jsx)(`i`,{children:`→`})]})]}),(0,$.jsxs)(`section`,{className:`future-panel eco-panel`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`03`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`生态环境监测`}),(0,$.jsx)(`em`,{children:`ECOLOGICAL MONITORING`})]}),(0,$.jsx)(`i`,{children:`优`})]}),(0,$.jsxs)(`div`,{className:`eco-content`,children:[(0,$.jsxs)(`button`,{type:`button`,className:`air-orbit`,onClick:()=>M(`pm25`,`PM2.5 实时监测`,`生态环境监测`,`北京市核心区 PM2.5 当前浓度为 28 μg/m³，空气质量等级为优。`,`气象与环境感知网 · 分钟级刷新`),children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`b`,{children:`28`}),(0,$.jsx)(`span`,{children:`PM2.5`})]}),(0,$.jsxs)(`div`,{className:`eco-stats`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`air`,`空气优良率`,`生态环境监测`,`全市空气质量优良率达到 94.6%，重点站点均处于正常监测状态。`,`94.6% · 较昨日 +1.2%`),children:[(0,$.jsx)(`span`,{children:`空气优良率`}),(0,$.jsx)(`b`,{children:`94.6%`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`temperature`,`城市平均温度`,`生态环境监测`,`当前城市平均温度 26.3°C，热岛强度处于可控区间。`,`26.3°C · 东南风 3.4m/s`),children:[(0,$.jsx)(`span`,{children:`平均温度`}),(0,$.jsx)(`b`,{children:`26.3°C`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`carbon`,`碳排强度`,`生态环境监测`,`城市单位产出碳排强度同比下降 4.8%，新能源消纳比例持续提升。`,`-4.8% · 绿色转型稳定`),children:[(0,$.jsx)(`span`,{children:`碳排强度`}),(0,$.jsx)(`b`,{children:`-4.8%`})]})]})]})]})]}),(0,$.jsxs)(`section`,{className:`future-center`,children:[(0,$.jsxs)(`div`,{className:`scene-head`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{children:i}),(0,$.jsx)(`b`,{children:`北京核心区三维数字孪生`})]}),(0,$.jsx)(`em`,{className:v,children:ne})]}),(0,$.jsxs)(`div`,{className:`future-scene`,children:[(0,$.jsx)(wf,{topView:f,nightMode:o,buildingLights:c,autoTour:u,trafficDensity:m,onSelect:N,onSceneStatus:y}),(0,$.jsx)(`div`,{className:`scene-scanline`,"aria-hidden":`true`}),(0,$.jsxs)(`div`,{className:`scene-corners`,"aria-hidden":`true`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]}),(0,$.jsxs)(`div`,{className:`scene-coordinate`,children:[(0,$.jsx)(`span`,{children:`39°54′27″N`}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{children:`116°27′07″E`}),(0,$.jsx)(`b`,{children:`BEIJING`})]}),(0,$.jsxs)(`div`,{className:`scene-layer`,children:[(0,$.jsx)(`span`,{children:`DATA LAYERS`}),(0,$.jsx)(`i`,{className:`cyan`}),(0,$.jsx)(`em`,{children:`建筑`}),(0,$.jsx)(`i`,{className:`blue`}),(0,$.jsx)(`em`,{children:`交通`}),(0,$.jsx)(`i`,{className:`green`}),(0,$.jsx)(`em`,{children:`感知`})]}),(0,$.jsxs)(`div`,{className:`scene-orientation`,children:[(0,$.jsx)(`b`,{children:`N`}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{children:`024°`})]}),(0,$.jsx)(`div`,{className:`scene-districts`,children:Ef.map(e=>(0,$.jsxs)(`button`,{onClick:()=>re(e),children:[(0,$.jsx)(`i`,{className:e.tone}),(0,$.jsx)(`span`,{children:e.name}),(0,$.jsx)(`b`,{children:e.score})]},e.name))}),(0,$.jsxs)(`div`,{className:`scene-view-presets`,"aria-label":`预设三维视角`,children:[(0,$.jsx)(`span`,{children:`VIEW`}),kf.map(e=>(0,$.jsxs)(`button`,{className:E===e.id?`active`:``,onClick:()=>ie(e),"aria-label":`切换至${e.label}视角`,children:[(0,$.jsx)(`i`,{children:e.code}),(0,$.jsx)(`b`,{children:e.label})]},e.id))]}),(0,$.jsxs)(`div`,{className:`scene-operation-tip`,role:`status`,"aria-live":`polite`,children:[(0,$.jsx)(`i`,{children:`⌁`}),(0,$.jsx)(`span`,{children:O})]},A),(0,$.jsxs)(`div`,{className:`scene-controls`,children:[(0,$.jsxs)(`button`,{className:f?`on`:``,onClick:()=>{let e=!f;d(!1),p(e),D(e?`top`:`panorama`),j(e?`垂直俯视已开启 · 可滚轮缩放查看建筑分布`:`已恢复自由视角`)},children:[(0,$.jsx)(`i`,{children:`◇`}),f?`自由视角`:`垂直俯视`]}),(0,$.jsxs)(`button`,{className:u?`on`:``,onClick:()=>{let e=!u;d(e),p(!1),j(e?`自动巡航已启动 · 手动选视角可随时接管`:`自动巡航已暂停`)},children:[(0,$.jsx)(`i`,{children:u?`■`:`▶`}),u?`停止巡航`:`自动巡航`]}),(0,$.jsxs)(`button`,{className:c?`on`:``,onClick:()=>{let e=!c;l(e),j(e?`建筑光网已点亮`:`建筑光网已隐藏`)},children:[(0,$.jsx)(`i`,{children:`✦`}),`建筑光网`]}),(0,$.jsxs)(`button`,{onClick:()=>{let e=!o;s(e),j(e?`已切换至夜间城市模式`:`已切换至日间城市模式`)},children:[(0,$.jsx)(`i`,{children:o?`☀`:`☾`}),o?`日间模式`:`夜间模式`]}),(0,$.jsxs)(`button`,{onClick:()=>{let e=m===18?36:m===36?54:18;h(e),j(`动态车流密度已调整为 ${e} 辆`)},children:[(0,$.jsx)(`i`,{children:`⇄`}),`车流 `,m]}),(0,$.jsxs)(`button`,{"aria-label":`复位三维视角`,onClick:()=>{d(!1),p(!1),D(`panorama`),window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:`reset`})),j(`三维视角已复位至北京城市全景`)},children:[(0,$.jsx)(`i`,{children:`⌖`}),`视角复位`]})]}),(0,$.jsxs)(`div`,{className:`scene-zoom`,children:[(0,$.jsx)(`button`,{"aria-label":`放大城市模型`,onClick:()=>window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:`zoomIn`})),children:`＋`}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`button`,{"aria-label":`缩小城市模型`,onClick:()=>window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:`zoomOut`})),children:`−`})]}),g&&(0,$.jsxs)(`article`,{className:`future-asset-card`,children:[(0,$.jsx)(`button`,{"aria-label":`关闭详情`,onClick:()=>_(null),children:`×`}),(0,$.jsx)(`span`,{children:g.category}),(0,$.jsx)(`strong`,{children:g.label}),(0,$.jsx)(`p`,{children:g.details}),(0,$.jsx)(`em`,{children:g.meta})]})]})]}),(0,$.jsxs)(`aside`,{className:`future-column right`,children:[(0,$.jsxs)(`section`,{className:`future-panel ai-index`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`04`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`城市智能指数`}),(0,$.jsx)(`em`,{children:`CITY AI INDEX`})]}),(0,$.jsx)(`i`,{children:`TOP 1`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`ai-score`,onClick:()=>M(`ai-score`,`城市智能指数 96.4`,`城市 AI 大脑`,`综合感知覆盖、协同效率、预测准确和处置闭环四项能力，当前城市智能指数为 96.4。`,`全国领先 · 较昨日 +1.8%`),children:[(0,$.jsxs)(`div`,{className:`score-rings`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:96.4,decimals:1})}),(0,$.jsx)(`span`,{children:`综合评分`})]}),(0,$.jsxs)(`div`,{className:`score-copy`,children:[(0,$.jsx)(`span`,{children:`AI 城市大脑`}),(0,$.jsx)(`b`,{children:`运行卓越`}),(0,$.jsx)(`em`,{children:`较昨日 +1.8%`}),(0,$.jsx)(`p`,{children:`城市治理模型实时计算中`})]})]}),(0,$.jsx)(`div`,{className:`ai-dimensions`,children:[[`感知覆盖`,98],[`协同效率`,94],[`预测准确`,96],[`处置闭环`,97]].map(([e,t],n)=>(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`ai-${n}`,`${e} ${t}%`,`城市 AI 能力维度`,`${e}能力已接入城市级模型评估，当前得分 ${t}%，运行状态稳定。`,`AI ENGINE · 第 ${n+1} 维度`),children:[(0,$.jsx)(`span`,{children:e}),(0,$.jsx)(`i`,{children:(0,$.jsx)(`b`,{style:{width:w?`${t}%`:`0%`,transitionDelay:`${n*120}ms`}})}),(0,$.jsxs)(`em`,{children:[t,`%`]})]},e))})]}),(0,$.jsxs)(`section`,{className:`future-panel traffic-panel`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`05`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`交通运行脉搏`}),(0,$.jsx)(`em`,{children:`TRAFFIC MOBILITY`})]}),(0,$.jsx)(`i`,{children:`畅通`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`traffic-number`,onClick:()=>M(`traffic-index`,`全路网交通指数`,`交通运行脉搏`,`全路网交通指数 1.42，整体处于畅通等级，重点道路信号协调运行正常。`,`指数 1.42 · 畅通`),children:[(0,$.jsx)(`span`,{children:`全路网交通指数`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:1.42,decimals:2})}),(0,$.jsx)(`em`,{children:`畅通`})]}),(0,$.jsx)(`button`,{type:`button`,className:`traffic-flow`,"aria-label":`调整并查看交通流量趋势`,onClick:()=>{let e=m===18?36:m===36?54:18;h(e),M(`traffic-flow`,`近八小时交通流量`,`交通运行脉搏`,`已将三维城市动态车流调整为 ${e} 辆，可在中央地图观察道路车流变化。`,`点击循环调节 · 当前密度 ${e}`)},children:[31,43,52,47,68,76,64,83,71,62,54,59,46,39].map((e,t)=>(0,$.jsx)(`i`,{style:{height:w?`${e}%`:`0%`,transitionDelay:`${t*55}ms`}},t))}),(0,$.jsxs)(`div`,{className:`traffic-meta`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`speed`,`道路平均车速`,`交通运行脉搏`,`全市重点道路平均车速 41.8 km/h，当前车速变化处于模型预测范围内。`,`41.8 km/h · 实时计算`),children:[(0,$.jsx)(`span`,{children:`平均车速`}),(0,$.jsx)(`b`,{children:`41.8 km/h`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`congestion`,`拥堵道路里程`,`交通运行脉搏`,`当前拥堵道路总里程 28.6 km，拥堵主要集中于晚高峰重点走廊。`,`28.6 km · 动态监测`),children:[(0,$.jsx)(`span`,{children:`拥堵里程`}),(0,$.jsx)(`b`,{children:`28.6 km`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`signals`,`信号协调率`,`交通运行脉搏`,`城市信号控制协调率达到 92.7%，重点路口绿波方案处于自动优化状态。`,`92.7% · AI 信号控制`),children:[(0,$.jsx)(`span`,{children:`信号协调率`}),(0,$.jsx)(`b`,{children:`92.7%`})]})]})]}),(0,$.jsxs)(`section`,{className:`future-panel district-rank`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`06`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`城区运行排行`}),(0,$.jsx)(`em`,{children:`DISTRICT RANKING`})]}),(0,$.jsx)(`i`,{children:`16 区`})]}),(0,$.jsx)(`div`,{children:Ef.map((e,t)=>(0,$.jsxs)(`button`,{onClick:()=>re(e),children:[(0,$.jsx)(`i`,{children:String(t+1).padStart(2,`0`)}),(0,$.jsxs)(`span`,{children:[e.name,`区`,(0,$.jsx)(`em`,{children:(0,$.jsx)(`b`,{style:{width:w?`${e.score}%`:`0%`,transitionDelay:`${t*120}ms`}})})]}),(0,$.jsx)(`strong`,{children:e.score}),(0,$.jsx)(`small`,{children:e.value})]},e.name))})]}),(0,$.jsxs)(`button`,{className:`future-demo-card`,onClick:t,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`FEATURED AI DEMO`}),(0,$.jsx)(`em`,{children:`01`})]}),(0,$.jsx)(`strong`,{children:`灵境哨兵`}),(0,$.jsx)(`p`,{children:`危化品运输事故全链路智能处置`}),(0,$.jsx)(`b`,{children:`事故识别 · 扩散计算 · 路径重规划`}),(0,$.jsxs)(`i`,{children:[`立即进入演示项目 `,(0,$.jsx)(`span`,{children:`→`})]})]})]})]}),(0,$.jsxs)(`footer`,{className:`future-footer`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{}),`CITY DATA STREAM`]}),(0,$.jsx)(`section`,{children:(0,$.jsx)(`span`,{children:Of.join(`　　◇　　`)})}),(0,$.jsxs)(`em`,{children:[`DATA LATENCY `,(0,$.jsx)(`b`,{children:`128 ms`})]}),(0,$.jsxs)(`strong`,{children:[(0,$.jsx)(`i`,{}),`AI ENGINE ONLINE`]})]})]})}var Mf=(e,t,n)=>Math.max(t,Math.min(n,e));async function Nf(e){let t=await createImageBitmap(e),n=Math.max(120,Math.round(240*t.height/t.width)),r=document.createElement(`canvas`);r.width=240,r.height=n;let i=r.getContext(`2d`,{willReadFrequently:!0});i.drawImage(t,0,0,240,n),t.close();let a=i.getImageData(0,0,240,n).data,o=0,s=0,c=0,l=0,u=new Uint8Array(240*n);for(let e=0;e<240*n;e++){let t=a[e*4],n=a[e*4+1],r=a[e*4+2],i=Math.max(t,n,r),c=Math.min(t,n,r),l=i===0?0:(i-c)/i,d=(i+c)/510,f=l<.22&&d>.27&&d<.88,p=t>n*1.02&&n>r*1.12&&d>.32;(f||p)&&o++,t>165&&t>n*1.35&&n>r*1.15&&s++,u[e]=Math.round(t*.299+n*.587+r*.114)}for(let e=1;e<n;e+=2)for(let t=1;t<240;t+=2){let n=e*240+t;Math.abs(u[n]-u[n-1])+Math.abs(u[n]-u[n-240])>52&&c++,l++}let d=240*n,f=o/d,p=s/d,m=c/l;return{type:p>.045?`火灾伴随危险品泄漏`:f>.16?`疑似有毒气体泄漏`:`道路危化品事故`,confidence:Mf(.68+f*.72+m*.16+p*.8,.71,.982),smokeRatio:f,flameRatio:p,edgeDensity:m,persons:Math.max(3,Math.round(8+m*46+p*30)),summary:`检测到烟羽特征 ${(f*100).toFixed(1)}%，边缘复杂度 ${(m*100).toFixed(1)}%。建议启动危化品二级响应。`}}function Pf(e,t,n=8e4,r=2.5){let i=.08*e/Math.sqrt(1+1e-4*e),a=.06*e/Math.sqrt(1+.0015*e);return n/(2*Math.PI*t*i*a)*Math.exp(-(r*r)/(2*a*a))}function Ff(e,t,n){let r=Math.max(20,n*t*60),i=20;for(let t=20;t<=Math.min(r,3200);t+=10)Pf(t,n)>=e&&(i=t);let a=.08*i/Math.sqrt(1+1e-4*i);return{distance:i,width:a*4.3}}function If(e,t=3.4){let n=Ff(145,e,t),r=Ff(29,e,t),i=Ff(2.9,e,t),a=Math.PI*(i.distance/2)*(i.width/2),o=Math.round(a*.0078);return{lethal:n.distance,high:r.distance,warning:i.distance,lethalWidth:n.width,highWidth:r.width,warningWidth:i.width,affectedPeople:o,model:`Gaussian Plume · Pasquill-D`}}var Lf=[{id:`S`,x:-35,z:-30},{id:`A`,x:-22,z:-17},{id:`B`,x:-13,z:-10},{id:`I`,x:-3,z:-3},{id:`C`,x:-42,z:-4},{id:`D`,x:-25,z:7},{id:`E`,x:-11,z:5},{id:`F`,x:-31,z:20}],Rf=[`S-A`,`A-B`,`B-I`,`S-C`,`C-D`,`D-E`,`E-I`,`C-F`,`F-E`],zf=(e,t)=>Math.hypot(e.x-t.x,e.z-t.z);function Bf(e=!1){let t=e?new Set([`B-I`,`I-B`]):new Set,n=new Set([`S`]),r=new Map,i=new Map(Lf.map(e=>[e.id,1/0])),a=new Map(Lf.map(e=>[e.id,1/0]));i.set(`S`,0),a.set(`S`,zf(Lf[0],Lf[3]));let o=0;for(;n.size;){let e=[...n].sort((e,t)=>(a.get(e)??1/0)-(a.get(t)??1/0))[0];if(o++,e===`I`){let t=[e];for(;r.has(e);)e=r.get(e),t.unshift(e);let n=t.map(e=>Lf.find(t=>t.id===e)),a=Math.round((i.get(`I`)??0)*78);return{path:n,distance:a,eta:Math.ceil(a/520),visited:o,algorithm:`A* · Euclidean heuristic`}}n.delete(e);for(let o of Rf){let[s,c]=o.split(`-`),l;if(s===e&&(l=c),c===e&&(l=s),!l||t.has(`${e}-${l}`))continue;let u=Lf.find(t=>t.id===e),d=Lf.find(e=>e.id===l),f=(i.get(e)??1/0)+zf(u,d);f<(i.get(l)??1/0)&&(r.set(l,e),i.set(l,f),a.set(l,f+zf(d,Lf[3])),n.add(l))}}return{path:[],distance:0,eta:0,visited:o,algorithm:`A* · no path`}}var Vf=[{icon:`焰`,name:`消防智能体`,text:`2 辆泡沫消防车已从青岚站出发`,tone:`orange`},{icon:`十`,name:`医疗智能体`,text:`三级医院开放绿色救援通道`,tone:`cyan`},{icon:`路`,name:`交通智能体`,text:`已建立 3.2 km 应急绿波带`,tone:`blue`},{icon:`盾`,name:`指挥智能体`,text:`建议启动学校二级疏散预案`,tone:`purple`}],Hf=[{id:`overview`,label:`态势总览`},{id:`events`,label:`事件中心`},{id:`resources`,label:`资源调度`},{id:`archives`,label:`推演档案`}],Uf=[{id:0,start:0,end:0,clock:`14:32:00`,icon:`待`,title:`全流程演示就绪`,subtitle:`化学废料车辆事故联合处置`,detail:`一键播放车辆行驶、突发故障、AI 告警、消防出警、医疗救援与警力疏散完整链路。`,metric:`72 秒 · 9 阶段`},{id:1,start:0,end:7,clock:`14:32:00`,icon:`运`,title:`正常运输`,subtitle:`化学废料运输车沿北京真实道路行驶`,detail:`京A·WH2576 · 车速 32 km/h · 罐体压力与尾阀状态正常`,metric:`OSM 实时轨迹`},{id:2,start:7,end:13,clock:`14:32:07`,icon:`故`,title:`突发故障`,subtitle:`车辆动力系统失效并紧急制动`,detail:`罐体尾阀受冲击松动 · 双闪开启 · 检测到黄绿色挥发气体`,metric:`自动停车 · 遥测异常`},{id:3,start:13,end:20,clock:`14:32:13`,icon:`AI`,title:`AI 告警`,subtitle:`识别为含氯化学废料泄漏`,detail:`事故图片识别置信度 96.8% · 高斯烟羽模型开始风险扩散计算`,metric:`Ⅰ级联合响应`},{id:4,start:20,end:27,clock:`14:32:20`,icon:`调`,title:`联合调度`,subtitle:`消防、医疗和交警同步接收指令`,detail:`基于 OSM 真实路网生成三条应急路线 · 自动建立救援优先通行权`,metric:`A* 路径已生成`},{id:5,start:27,end:40,clock:`14:32:27`,icon:`驰`,title:`力量赶赴`,subtitle:`三支队伍沿真实道路接近现场`,detail:`警车先期抵达 · 消防车携带泡沫与洗消设备 · 医疗组开放绿色通道`,metric:`动态 ETA 更新`},{id:6,start:40,end:49,clock:`14:32:40`,icon:`警`,title:`交通疏散`,subtitle:`警车到场并建立 500 米封控区`,detail:`3 个路口完成管制 · 社会车流主动避让 · 186 人向侧上风向疏散`,metric:`应急通道畅通`},{id:7,start:49,end:59,clock:`14:32:49`,icon:`消`,title:`消防处置`,subtitle:`泡沫消防车到场建立水幕并堵漏`,detail:`消防员从上风向压制挥发气体 · 泄漏速率下降 68% · 核心区浓度回落`,metric:`风险持续下降`},{id:8,start:59,end:67,clock:`14:32:59`,icon:`医`,title:`医疗救援`,subtitle:`救护车抵达并完成现场检伤分类`,detail:`2 名轻度吸入人员接受吸氧 · 三级医院绿色通道保持开启`,metric:`检伤与转运完成`},{id:9,start:67,end:72,clock:`14:33:07`,icon:`联`,title:`响应完成`,subtitle:`风险受控，联合处置闭环形成`,detail:`重点区域疏散 186 人 · 2 人完成转运 · 事故处置报告可立即生成`,metric:`全链路可追溯`}],Wf=72,Gf=async e=>{let t=new TextEncoder().encode(e),n=await crypto.subtle.digest(`SHA-256`,t);return Array.from(new Uint8Array(n)).map(e=>e.toString(16).padStart(2,`0`)).join(``)};function Kf({onAuthenticated:e}){let[t,n]=(0,r.useState)(`login`),[i,a]=(0,r.useState)(!1),[o,s]=(0,r.useState)(!0),[c,l]=(0,r.useState)(!1),[u,d]=(0,r.useState)(``),[f,p]=(0,r.useState)({username:``,password:``}),[m,h]=(0,r.useState)({displayName:``,department:`北京市智慧城市运行中心`,username:``,password:``,confirm:``,agreement:!0}),g=e=>{n(e),d(``),a(!1)},_=()=>{try{return JSON.parse(localStorage.getItem(`lingjing-users`)||`[]`)}catch{return[]}};return(0,$.jsxs)(`main`,{className:`auth-shell`,children:[(0,$.jsx)(`div`,{className:`auth-grid`}),(0,$.jsx)(`div`,{className:`auth-glow auth-glow-a`}),(0,$.jsx)(`div`,{className:`auth-glow auth-glow-b`}),(0,$.jsxs)(`header`,{className:`auth-topbar`,children:[(0,$.jsxs)(`div`,{className:`auth-brand-mark`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`京域智城`}),(0,$.jsx)(`span`,{children:`BEIJING SMART CITY DIGITAL TWIN`})]}),(0,$.jsxs)(`em`,{children:[(0,$.jsx)(`i`,{}),`北京市城市运行管理中心`]})]}),(0,$.jsxs)(`section`,{className:`auth-layout`,children:[(0,$.jsxs)(`div`,{className:`auth-hero`,children:[(0,$.jsxs)(`div`,{className:`auth-kicker`,children:[(0,$.jsx)(`i`,{}),`北京城市数字孪生统一入口`]}),(0,$.jsxs)(`h1`,{children:[`一屏感知北京`,(0,$.jsx)(`br`,{}),(0,$.jsx)(`span`,{children:`让城市实时可见`})]}),(0,$.jsx)(`p`,{children:`汇聚城市治理、交通运行、能源环保与公共安全数据，构建可旋转、可交互、可推演的北京智慧城市三维运行中心。`}),(0,$.jsxs)(`div`,{className:`auth-metrics`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:6016})}),(0,$.jsx)(`span`,{children:`三维建筑模型`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:86.4,decimals:1,suffix:`万`})}),(0,$.jsx)(`span`,{children:`城市感知节点`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:99.97,decimals:2,suffix:`%`})}),(0,$.jsx)(`span`,{children:`设备在线率`})]})]}),(0,$.jsxs)(`div`,{className:`auth-radar`,"aria-hidden":`true`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`b`,{children:`AI`}),(0,$.jsxs)(`em`,{children:[`REAL-TIME`,(0,$.jsx)(`br`,{}),`SITUATION`]})]})]}),(0,$.jsxs)(`section`,{className:`auth-card`,"aria-label":t===`login`?`登录`:`注册`,children:[(0,$.jsx)(`div`,{className:`auth-card-line`}),(0,$.jsxs)(`div`,{className:`auth-tabs`,children:[(0,$.jsx)(`button`,{className:t===`login`?`active`:``,onClick:()=>g(`login`),children:`账号登录`}),(0,$.jsx)(`button`,{className:t===`register`?`active`:``,onClick:()=>g(`register`),children:`用户注册`})]}),(0,$.jsxs)(`div`,{className:`auth-heading`,children:[(0,$.jsx)(`span`,{children:t===`login`?`CITY OPERATION ACCESS`:`CREATE CITY ACCOUNT`}),(0,$.jsx)(`h2`,{children:t===`login`?`进入智慧城市运行中心`:`注册城市运行账号`}),(0,$.jsx)(`p`,{children:t===`login`?`登录后首先进入北京智慧城市 3D 大屏`:`注册信息仅保存在当前设备，用于比赛演示`})]}),t===`login`?(0,$.jsxs)(`form`,{onSubmit:async t=>{if(t.preventDefault(),d(``),!f.username.trim()||!f.password){d(`请输入账号和密码`);return}l(!0);try{let t=f.username.trim().toLowerCase();if(t===`admin`&&f.password===`123456`){e({username:`admin`,displayName:`城市运行管理员`},o);return}let n=await Gf(f.password),r=_().find(e=>e.username.toLowerCase()===t&&e.passwordHash===n);if(!r){d(`账号或密码不正确，可使用演示账号登录`);return}e({username:r.username,displayName:r.displayName},o)}finally{l(!1)}},children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`城市运行账号`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`城`}),(0,$.jsx)(`input`,{autoFocus:!0,autoComplete:`username`,value:f.username,onChange:e=>p({...f,username:e.target.value}),placeholder:`请输入城市运行账号`})]})]}),(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`登录密码`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`密`}),(0,$.jsx)(`input`,{type:i?`text`:`password`,autoComplete:`current-password`,value:f.password,onChange:e=>p({...f,password:e.target.value}),placeholder:`请输入密码`}),(0,$.jsx)(`button`,{type:`button`,onClick:()=>a(e=>!e),children:i?`隐藏`:`显示`})]})]}),(0,$.jsxs)(`div`,{className:`auth-options`,children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:o,onChange:e=>s(e.target.checked)}),(0,$.jsx)(`i`,{}),`保持登录`]}),(0,$.jsx)(`button`,{type:`button`,onClick:()=>d(`演示账号：admin　密码：123456`),children:`忘记密码？`})]}),u&&(0,$.jsx)(`div`,{className:`auth-message ${u.includes(`成功`)?`success`:``}`,children:u}),(0,$.jsxs)(`button`,{className:`auth-submit`,disabled:c,children:[c?`身份校验中…`:`进入智慧城市大屏`,(0,$.jsx)(`span`,{children:`→`})]}),(0,$.jsxs)(`button`,{className:`auth-demo`,type:`button`,onClick:()=>{p({username:`admin`,password:`123456`}),d(`已填入演示账号，点击上方按钮进入系统`)},children:[`一键填入演示账号 `,(0,$.jsx)(`b`,{children:`admin / 123456`})]})]}):(0,$.jsxs)(`form`,{onSubmit:async e=>{e.preventDefault(),d(``);let t=m.displayName.trim(),n=m.username.trim();if(!t||!n||!m.password||!m.confirm){d(`请完整填写注册信息`);return}if(!/^[a-zA-Z0-9_-]{3,20}$/.test(n)){d(`账号需为 3–20 位字母、数字、下划线或短横线`);return}if(m.password.length<6){d(`密码至少需要 6 位`);return}if(m.password!==m.confirm){d(`两次输入的密码不一致`);return}if(!m.agreement){d(`请先同意演示环境使用说明`);return}let r=_();if(n.toLowerCase()===`admin`||r.some(e=>e.username.toLowerCase()===n.toLowerCase())){d(`该账号已存在，请更换账号`);return}l(!0);try{r.push({username:n,displayName:t,department:m.department,passwordHash:await Gf(m.password)}),localStorage.setItem(`lingjing-users`,JSON.stringify(r)),p({username:n,password:``}),g(`login`),d(`注册成功，请使用新账号登录`)}finally{l(!1)}},children:[(0,$.jsxs)(`div`,{className:`auth-form-grid`,children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`姓名`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`名`}),(0,$.jsx)(`input`,{autoFocus:!0,value:m.displayName,onChange:e=>h({...m,displayName:e.target.value}),placeholder:`请输入真实姓名`})]})]}),(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`所属单位`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`部`}),(0,$.jsxs)(`select`,{value:m.department,onChange:e=>h({...m,department:e.target.value}),children:[(0,$.jsx)(`option`,{children:`北京市智慧城市运行中心`}),(0,$.jsx)(`option`,{children:`城市管理部门`}),(0,$.jsx)(`option`,{children:`交通运行部门`}),(0,$.jsx)(`option`,{children:`生态环境部门`}),(0,$.jsx)(`option`,{children:`公共安全与应急部门`})]})]})]})]}),(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`登录账号`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`指`}),(0,$.jsx)(`input`,{autoComplete:`username`,value:m.username,onChange:e=>h({...m,username:e.target.value}),placeholder:`3–20 位字母或数字`})]})]}),(0,$.jsxs)(`div`,{className:`auth-form-grid`,children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`设置密码`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`密`}),(0,$.jsx)(`input`,{type:i?`text`:`password`,autoComplete:`new-password`,value:m.password,onChange:e=>h({...m,password:e.target.value}),placeholder:`至少 6 位`})]})]}),(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`确认密码`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`验`}),(0,$.jsx)(`input`,{type:i?`text`:`password`,autoComplete:`new-password`,value:m.confirm,onChange:e=>h({...m,confirm:e.target.value}),placeholder:`再次输入`})]})]})]}),(0,$.jsxs)(`div`,{className:`auth-options register`,children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:m.agreement,onChange:e=>h({...m,agreement:e.target.checked})}),(0,$.jsx)(`i`,{}),`同意本地演示环境使用说明`]}),(0,$.jsx)(`button`,{type:`button`,onClick:()=>a(e=>!e),children:i?`隐藏密码`:`显示密码`})]}),u&&(0,$.jsx)(`div`,{className:`auth-message ${u.includes(`成功`)?`success`:``}`,children:u}),(0,$.jsxs)(`button`,{className:`auth-submit`,disabled:c,children:[c?`正在创建账号…`:`完成注册`,(0,$.jsx)(`span`,{children:`→`})]})]}),(0,$.jsxs)(`footer`,{className:`auth-card-footer`,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`i`,{}),`SHA-256 LOCAL HASH`]}),(0,$.jsx)(`em`,{children:`演示环境 · 数据仅存本机`})]})]})]}),(0,$.jsxs)(`footer`,{className:`auth-footer`,children:[(0,$.jsx)(`span`,{children:`© 2026 京域智城 · 北京智慧城市创新实验室`}),(0,$.jsxs)(`span`,{children:[`城市数据链路 `,(0,$.jsx)(`i`,{}),` 正常　|　比赛演示版 v4.1.0`]})]})]})}function qf(){let[e,t]=(0,r.useState)(!1),[n,i]=(0,r.useState)(null),[a,o]=(0,r.useState)(`city`),[s,c]=(0,r.useState)(!1),[l,u]=(0,r.useState)(`overview`),[d,f]=(0,r.useState)(!1),[p,m]=(0,r.useState)(``),[h,g]=(0,r.useState)(`loading`),[_,v]=(0,r.useState)(!1),[y,b]=(0,r.useState)(!1),[x,S]=(0,r.useState)(null),[C,w]=(0,r.useState)(null),[T,E]=(0,r.useState)(15),[D,O]=(0,r.useState)(!1),[k,A]=(0,r.useState)(0),[ee,j]=(0,r.useState)(!0),[M,N]=(0,r.useState)(!1),[P,F]=(0,r.useState)(!1),[te,ne]=(0,r.useState)(!0),[re,ie]=(0,r.useState)(!1),[ae,oe]=(0,r.useState)(null),[I,L]=(0,r.useState)(null),[se,ce]=(0,r.useState)(!1),[le,ue]=(0,r.useState)(!1),[de,fe]=(0,r.useState)(`2026-07-20 14:32:26`),[pe,me]=(0,r.useState)(null),[he,ge]=(0,r.useState)(!1),[_e,ve]=(0,r.useState)({type:`氯气泄漏`,confidence:.968,smokeRatio:.214,flameRatio:.008,edgeDensity:.182,persons:23,summary:`检测到淡黄色烟羽和危化品运输车辆，建议启动危化品二级响应。`}),[R,ye]=(0,r.useState)(`idle`),[be,xe]=(0,r.useState)(0),[Se,Ce]=(0,r.useState)(1),[we,Te]=(0,r.useState)(!0),[Ee,De]=(0,r.useState)(36),[Oe,ke]=(0,r.useState)(``),z=R===`idle`?0:Uf.find(e=>e.id>0&&be>=e.start&&be<e.end)?.id??9,Ae=Uf[z],je=R===`idle`?0:Math.min(100,be/Wf*100),Me=z<=2&&z>0?`chemical-truck`:z===5?be<31?`police-car`:be<36?`firetruck`:`ambulance`:z===6?`police-car`:z===7?`firetruck`:z===8?`ambulance`:null,B=(0,r.useMemo)(()=>If(T,3.4),[T]),Ne=(0,r.useMemo)(()=>Bf(y),[y]),V=(0,r.useMemo)(()=>{let e=C?.distance??Ne.distance,t=C?.eta??Ne.eta,n=C?.roads.join(` → `)||`OSM 真实道路网络加载中`;return`灵境哨兵｜危化品泄漏应急处置报告\n报告编号：LJ-BJ-20260720-001\n生成时间：${de}\n响应等级：Ⅰ级应急响应\n\n一、事件概况\n事件地点：北京市朝阳区建国门外大街国贸桥西侧（演示坐标 39°54′27″N，116°27′07″E）\n事件类型：${_e.type}\nAI 识别置信度：${(_e.confidence*100).toFixed(1)}%\n现场人员估计：约 ${_e.persons} 人\n研判摘要：${_e.summary}\n\n二、风险扩散计算\n气象条件：东南风 3.4 m/s，污染羽流吹向西北，Pasquill-D 稳定度\n致命区纵深：${B.lethal} m\n高风险区纵深：${B.high} m\n警戒区纵深：${B.warning} m\n预计风险暴露人口：${B.affectedPeople} 人\n模型：${B.model}\n\n三、消防救援路线\n算法：OSM 真实路网 A*（欧氏距离启发）\n道路序列：${n}\n路线距离：${e} m\n预计到达：${t} min\n搜索道路节点：${C?.visited??Ne.visited} 个\n封路状态：${y?`已封锁 OSM 道路 ${C?.blockedRoadId??x??`自动选择路段`}，完成动态重规划`:`当前道路正常通行`}\n\n四、联合处置指令\n1. 交通智能体：立即封锁泄漏点周边 500 m 道路，建立 3.2 km 应急绿波带。\n2. 教育智能体：城北实验学校师生经东南侧上风向安全通道分批疏散，8 分钟内完成重点人员转移。\n3. 消防智能体：2 辆泡沫消防车沿 OSM 规划路线抵达，在上风向布置水幕并实施堵漏。\n4. 医疗智能体：市第三人民医院开放绿色通道，在体育中心设置临时分诊点。\n5. 环境监测组：在下风向 200 m、500 m、1000 m 设置连续监测点，每 2 分钟回传浓度。\n\n五、处置结论\n建议立即启动危化品泄漏Ⅰ级联合响应，优先完成学校疏散、道路管制和泄漏源控制。AI 决策结果仅用于竞赛演示，正式行动应由现场指挥员复核确认。\n\n生成系统：灵境哨兵城市应急智能决策平台`},[y,x,B,C,de,Ne,_e]);(0,r.useEffect)(()=>{try{let e=localStorage.getItem(`lingjing-session`)||sessionStorage.getItem(`lingjing-session`);e&&i(JSON.parse(e))}catch{localStorage.removeItem(`lingjing-session`),sessionStorage.removeItem(`lingjing-session`)}t(!0)},[]),(0,r.useEffect)(()=>{if(!p)return;let e=window.setTimeout(()=>m(``),2800);return()=>window.clearTimeout(e)},[p]),(0,r.useEffect)(()=>{if(!Oe)return;let e=window.setTimeout(()=>ke(``),2800);return()=>window.clearTimeout(e)},[Oe]),(0,r.useEffect)(()=>{if(!D||R===`playing`||R===`paused`)return;let e=window.setInterval(()=>E(e=>e>=30?1:e+1),520);return()=>window.clearInterval(e)},[D,R]),(0,r.useEffect)(()=>{if(R!==`playing`)return;let e=performance.now(),t=window.setInterval(()=>{let t=performance.now(),n=(t-e)/1e3*Se;e=t,xe(e=>Math.min(Wf,e+n))},100);return()=>window.clearInterval(t)},[Se,R]),(0,r.useEffect)(()=>{R===`playing`&&be>=Wf&&ye(`complete`)},[R,be]),(0,r.useEffect)(()=>{z!==0&&(v(z>=4),N(z>=3),E(z<3?1:z===3?5:z<7?15:z===9?8:22))},[z]),(0,r.useEffect)(()=>{!we||z===0||(ie(!1),Me?(oe(Me),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:Me}}))):(oe(null),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:null}})),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:z===9?`reset`:`incident`}))))},[we,Me,z]),(0,r.useEffect)(()=>{let e=e=>{let t=e.target;if([`INPUT`,`TEXTAREA`,`SELECT`].includes(t.tagName))return;if(e.code===`Escape`){if(s){c(!1);return}if(se){ce(!1);return}if(d){f(!1);return}if(l!==`overview`){u(`overview`);return}if(I){L(null);return}Te(!1),oe(null),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:null}}));return}let n={Digit1:`overview`,Digit2:`events`,Digit3:`resources`,Digit4:`archives`};if(n[e.code]){e.preventDefault(),u(n[e.code]),f(!1);return}if(!(z===0||l!==`overview`||se)&&(e.code===`Space`&&(e.preventDefault(),ye(e=>e===`playing`?`paused`:e===`paused`?`playing`:e)),e.code===`ArrowRight`)){e.preventDefault();let t=Uf[Math.min(9,z+1)];xe(t.start+.01),ye(t.id===9?`paused`:`playing`)}};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[d,l,s,se,z,I]),(0,r.useEffect)(()=>{if(!d)return;let e=e=>{e.target.closest(`.status`)||f(!1)};return window.addEventListener(`pointerdown`,e,!0),()=>window.removeEventListener(`pointerdown`,e,!0)},[d]),(0,r.useEffect)(()=>{if(!_)return;let e=setInterval(()=>A(e=>(e+1)%4),900);return()=>clearInterval(e)},[_]);let H=()=>{if(h===`loading`){m(`真实北京路网仍在加载，请稍候一秒再启动`);return}h===`degraded`&&m(`真实路网数据异常，已启用内置完整路线继续演示`),xe(0),ye(`playing`),Te(!0),v(!1),b(!1),S(null),E(1),O(!1),N(!1),ie(!1),oe(null)},Pe=()=>{c(!1),u(`overview`),window.setTimeout(H,120)},Fe=()=>ye(e=>e===`playing`?`paused`:e===`paused`||e===`complete`?`playing`:e),Ie=()=>{let e=Uf[Math.min(9,z+1)];xe(e.start+.01),ye(e.id===9?`paused`:`playing`)},Le=()=>Ce(e=>e===1?1.5:e===1.5?2:1),Re=()=>De(e=>e===18?36:e===36?54:18),ze=e=>{S(typeof e==`number`?e:null),b(!0),v(!0)},Be=()=>{oe(null),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:null}}))},Ve=()=>{Be(),Te(!1),ie(!1),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`incident`}))},He=(e,t,n,r,i)=>{ke(e),L({id:`side-${e}`,label:t,category:n,details:r,meta:i}),m(`已打开：${t}`)},Ue=e=>{if(h===`loading`){m(`真实地图仍在加载，资源位置暂不可追踪`);return}let t={"FIRE-01":`firetruck`,"FIRE-02":`firetruck`,"ROBOT-01":`firetruck`,"MED-03":`ambulance`,"MED-06":`ambulance`,"POLICE-07":`police-car`,"BIKE-02":`police-car`}[e];L(null),ie(!1),Te(!1),(z<4||R===`complete`)&&(xe(20.01),ye(`playing`),v(!0),N(!0)),t?(oe(t),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:t}})),m(`已同步到所属编队的真实道路跟随视角`)):(oe(null),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`incident`})),m(`该资源已同步到事故现场任务区域`))},We=e=>{let t=ae===e.id?null:e.id;ie(!1),oe(t),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:t}}))},Ge=()=>{fe(new Date().toLocaleString(`zh-CN`,{hour12:!1}).replaceAll(`/`,`-`)),ce(!0),ue(!0),window.setTimeout(()=>ue(!1),700)},Ke=()=>{let e=URL.createObjectURL(new Blob([`﻿`,V],{type:`text/plain;charset=utf-8`})),t=document.createElement(`a`);t.href=e,t.download=`灵境哨兵-危化品泄漏应急处置报告.txt`,t.click(),window.setTimeout(()=>URL.revokeObjectURL(e),1e3)},qe=async e=>{if(!e)return;ge(!0);let t=URL.createObjectURL(e);me(e=>(e&&URL.revokeObjectURL(e),t));try{ve(await Nf(e))}finally{ge(!1)}},Je=(e,t)=>{localStorage.removeItem(`lingjing-session`),sessionStorage.removeItem(`lingjing-session`),(t?localStorage:sessionStorage).setItem(`lingjing-session`,JSON.stringify(e)),i(e)},Ye=async()=>{try{document.fullscreenElement?await document.exitFullscreen():await document.documentElement.requestFullscreen(),m(document.fullscreenElement?`已进入全屏演示`:`已退出全屏演示`)}catch{m(`当前浏览器未允许全屏，请使用 F11`)}},Xe=()=>{a===`emergency`&&(R===`playing`||R===`paused`)&&!window.confirm(`当前推演尚未结束，退出将中止本次演示。确定退出吗？`)||(localStorage.removeItem(`lingjing-session`),sessionStorage.removeItem(`lingjing-session`),f(!1),c(!1),u(`overview`),g(`loading`),o(`city`),i(null))};return e?n?a===`city`?(0,$.jsx)(jf,{displayName:n.displayName,onLogout:Xe,onOpenDemo:()=>{c(!1),u(`overview`),g(`loading`),o(`emergency`)}}):(0,$.jsxs)(`main`,{className:`shell`,children:[(0,$.jsxs)(`header`,{className:`topbar`,children:[(0,$.jsxs)(`div`,{className:`brand-mark`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]}),(0,$.jsxs)(`div`,{className:`brand`,children:[(0,$.jsx)(`b`,{children:`京域智城`}),(0,$.jsx)(`span`,{children:`北京智慧城市 3D 大屏 · SMART CITY DIGITAL TWIN`})]}),(0,$.jsxs)(`nav`,{"aria-label":`主功能导航`,children:[Hf.map(e=>(0,$.jsx)(`button`,{className:l===e.id&&!s?`active`:``,"aria-current":l===e.id&&!s?`page`:void 0,onClick:()=>{c(!1),u(e.id),f(!1)},children:e.label},e.id)),(0,$.jsx)(`button`,{className:`demo-nav`,onClick:()=>{c(!1),o(`city`),f(!1)},children:`返回智慧城市`})]}),(0,$.jsxs)(`div`,{className:`status`,children:[(0,$.jsx)(`span`,{className:`live-dot`}),`系统在线 `,(0,$.jsx)(`em`,{children:n.displayName}),(0,$.jsx)(`button`,{className:`avatar ${d?`open`:``}`,onClick:()=>f(e=>!e),title:`打开账号菜单`,"aria-label":`打开账号菜单`,"aria-expanded":d,"aria-haspopup":`menu`,"aria-controls":`account-menu`,children:n.displayName.slice(0,1)}),d&&(0,$.jsxs)(`div`,{className:`account-menu`,id:`account-menu`,role:`menu`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`i`,{children:n.displayName.slice(0,1)}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:n.displayName}),(0,$.jsxs)(`span`,{children:[n.username,` · 应急指挥中心`]})]})]}),(0,$.jsxs)(`button`,{onClick:Ye,children:[(0,$.jsx)(`span`,{children:`⛶ 全屏演示`}),(0,$.jsx)(`b`,{children:typeof document<`u`&&document.fullscreenElement?`退出`:`进入`})]}),(0,$.jsxs)(`button`,{onClick:()=>{Te(e=>!e),m(we?`导演视角已关闭`:`导演视角已开启`)},children:[(0,$.jsx)(`span`,{children:`◉ 导演视角`}),(0,$.jsx)(`b`,{children:we?`开启`:`关闭`})]}),(0,$.jsxs)(`button`,{onClick:()=>m(`快捷键：1–4 切换模块　空格暂停/继续　→ 下一阶段　Esc 返回`),children:[(0,$.jsx)(`span`,{children:`? 演示快捷键`}),(0,$.jsx)(`b`,{children:`查看`})]}),(0,$.jsxs)(`button`,{onClick:()=>m(h===`ready`?`系统自检通过：真实地图、路网、AI 模型和调度模块均已就绪`:h===`loading`?`系统自检进行中：真实路网仍在加载`:`系统自检警告：真实路网已启用内置降级路线`),children:[(0,$.jsx)(`span`,{children:`✓ 演示自检`}),(0,$.jsx)(`b`,{children:h===`ready`?`通过`:h===`loading`?`检测中`:`降级`})]}),(0,$.jsxs)(`button`,{onClick:()=>{F(e=>!e),m(P?`已切换为白天态势`:`已切换为夜间态势`)},children:[(0,$.jsx)(`span`,{children:`◐ 显示模式`}),(0,$.jsx)(`b`,{children:P?`夜间`:`白天`})]}),(0,$.jsxs)(`button`,{onClick:()=>{ne(e=>!e),m(te?`已关闭楼宇灯光`:`已开启楼宇灯光`)},children:[(0,$.jsx)(`span`,{children:`✦ 楼宇灯光`}),(0,$.jsx)(`b`,{children:te?`开启`:`关闭`})]}),(0,$.jsxs)(`button`,{onClick:()=>{u(`resources`),f(!1)},children:[(0,$.jsx)(`span`,{children:`⌘ 快速调度`}),(0,$.jsx)(`b`,{children:`进入`})]}),(0,$.jsxs)(`button`,{className:`logout`,onClick:Xe,children:[(0,$.jsx)(`span`,{children:`↪ 退出登录`}),(0,$.jsx)(`b`,{children:`EXIT`})]})]})]})]}),(0,$.jsxs)(`section`,{className:`command-strip`,children:[(0,$.jsx)(`div`,{className:`alert-tag scenario-alert phase-${z}`,children:z===0?`演示项目 01 · READY`:`${String(z).padStart(2,`0`)}/09 · ${R===`playing`?`LIVE`:R===`paused`?`PAUSED`:`COMPLETE`}`}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`strong`,{children:[Ae.title,`｜`,Ae.subtitle]}),(0,$.jsxs)(`span`,{children:[Ae.clock,` · `,Ae.detail]})]}),(0,$.jsxs)(`div`,{className:`command-actions`,children:[(0,$.jsx)(`span`,{children:h===`loading`?`正在装载 6,016 栋建筑与 674 段道路`:z===0?`智慧城市大屏已就绪 · 点击进入演示项目`:`T+${be.toFixed(1)}s · ${Ae.metric}`}),(0,$.jsx)(`button`,{disabled:h===`loading`,onClick:z===0?()=>c(!0):H,children:h===`loading`?`正在加载真实路网…`:z===0?`进入演示项目 →`:R===`complete`?`↻ 再演示一次`:`↻ 从头重播`})]})]}),(0,$.jsx)(gf,{active:l,onClose:()=>u(`overview`),onStartScenario:H,onFocusIncident:Ve,onGenerateReport:Ge,onNotice:m,onTrackResource:Ue,scenarioPhase:z,scenarioTime:be,scenarioStatus:R}),s&&(0,$.jsx)(yf,{ready:h!==`loading`,onClose:()=>c(!1),onStart:Pe}),p&&(0,$.jsxs)(`div`,{className:`system-toast ${/失败|异常|未允许/.test(p)?`error`:/召回|关闭|降级|加载/.test(p)?`warning`:`success`}`,role:`status`,"aria-live":`polite`,children:[(0,$.jsx)(`i`,{children:/失败|异常|未允许/.test(p)?`!`:/召回|关闭|降级|加载/.test(p)?`i`:`✓`}),(0,$.jsx)(`span`,{children:p})]}),(0,$.jsxs)(`section`,{className:`workspace`,children:[(0,$.jsxs)(`aside`,{className:`left-panel panel`,children:[(0,$.jsxs)(`div`,{className:`panel-title`,children:[(0,$.jsx)(`span`,{children:`01`}),`事件智能识别 `,(0,$.jsx)(`b`,{children:`AI VISION`})]}),(0,$.jsxs)(`div`,{className:`scene`,children:[pe&&(0,$.jsx)(`img`,{className:`scene-upload-preview`,src:pe,alt:`上传的事故现场`}),(0,$.jsx)(`div`,{className:`sky`}),(0,$.jsx)(`div`,{className:`road-lines`}),(0,$.jsx)(`div`,{className:`truck ${z>=2?`failed`:``}`,children:(0,$.jsx)(`span`,{children:`化学废料`})}),z>=2&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`smoke s1`}),(0,$.jsx)(`div`,{className:`smoke s2`}),(0,$.jsx)(`div`,{className:`smoke s3`})]}),z>=3&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`detect-box`,children:(0,$.jsx)(`label`,{children:`化学废料运输车 98.2%`})}),(0,$.jsx)(`div`,{className:`detect-smoke`,children:(0,$.jsx)(`label`,{children:`含氯挥发气体 96.8%`})})]}),(0,$.jsx)(`div`,{className:`camera`,children:`CAM-07 · LIVE`}),(0,$.jsxs)(`label`,{className:`upload-image`,children:[he?`分析中…`:`上传事故图`,(0,$.jsx)(`input`,{type:`file`,accept:`image/*`,onChange:e=>qe(e.target.files?.[0])})]}),(0,$.jsx)(`div`,{className:`local-cv`,children:`LOCAL CV · PIXEL FEATURE MODEL`})]}),(0,$.jsxs)(`div`,{className:`recognition`,children:[(0,$.jsxs)(`button`,{type:`button`,className:Oe===`vehicle`?`active`:``,onClick:()=>{Ve(),He(`vehicle`,`危化品车辆状态`,`事件智能识别`,z===0?`演示车辆已加载并等待启动。`:Ae.detail,`京A·WH2576 · 阶段 ${String(z).padStart(2,`0`)}`)},children:[(0,$.jsx)(`span`,{children:`车辆状态`}),(0,$.jsx)(`strong`,{children:z===0?`等待演示`:z===1?`正常运输`:z===2?`动力故障`:`已停车处置`})]}),(0,$.jsxs)(`button`,{type:`button`,className:Oe===`confidence`?`active`:``,onClick:()=>{Ve(),He(`confidence`,`AI 识别置信度`,`本地视觉模型`,_e.summary,`置信度 ${(_e.confidence*100).toFixed(1)}% · PIXEL FEATURE MODEL`)},children:[(0,$.jsx)(`span`,{children:`AI 识别置信度`}),(0,$.jsx)(`strong`,{children:z>=3?(0,$.jsx)(_f,{to:_e.confidence*100,decimals:1,suffix:`%`}):`—`})]}),(0,$.jsxs)(`button`,{type:`button`,className:Oe===`plume`?`active`:``,onClick:()=>{N(!0),Ve(),He(`plume`,`烟羽像素与风险扩散`,`风险扩散计算`,`烟羽像素占比 ${(_e.smokeRatio*100).toFixed(1)}%，当前警戒纵深 ${B.warning} 米。`,`高斯烟羽 · ${B.model}`)},children:[(0,$.jsx)(`span`,{children:`烟羽像素占比`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:z>=3?_e.smokeRatio*100:0,decimals:1,suffix:`%`})})]}),(0,$.jsxs)(`button`,{type:`button`,className:Oe===`evacuated`?`active`:``,onClick:()=>He(`evacuated`,`人员疏散进度`,`联合处置态势`,z>=6?`重点区域 186 人已完成向侧上风向疏散。`:`人员疏散队伍已待命，将在交通封控完成后执行。`,z>=6?`186 人 · 已完成`:`0 人 · 等待执行`),children:[(0,$.jsx)(`span`,{children:`已疏散人员`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:z>=6?186:0,suffix:` 人`})})]})]}),(0,$.jsxs)(`button`,{type:`button`,className:`ai-note side-wide-action ${Oe===`ai-note`?`active`:``}`,onClick:()=>{N(!0),Ve(),He(`ai-note`,z>=3?`本地视觉研判`:`运输遥测状态`,`AI 研判摘要`,z===0?`等待启动完整演示，车辆与应急力量已加载。`:Ae.detail,z>=3?`东南风 3.4m/s · 风险模型已联动`:`车辆遥测 · 正常待命`)},children:[(0,$.jsx)(`b`,{children:z>=3?`本地视觉研判`:`运输遥测状态`}),(0,$.jsxs)(`p`,{children:[z===0?`等待启动完整演示，车辆与应急力量已加载。`:Ae.detail,` `,z>=3&&(0,$.jsxs)($.Fragment,{children:[`东南风 3.4 m/s（吹向西北），预计 `,(0,$.jsxs)(`em`,{children:[3,` 分钟`]}),`进入重点警戒区域。`]})]})]}),(0,$.jsxs)(`div`,{className:`panel-title compact`,children:[(0,$.jsx)(`span`,{children:`02`}),`智能体协同 `,(0,$.jsx)(`b`,{children:`MULTI-AGENT`})]}),(0,$.jsx)(`div`,{className:`agents`,children:Vf.map((e,t)=>{let n=[4,4,4,3][t],r=[7,8,6,9][t],i=z>=n,a=z>=r,o=[`FIRE-01`,`MED-03`,`POLICE-07`,`COMMAND`][t];return(0,$.jsxs)(`button`,{type:`button`,className:`agent ${e.tone} ${i?`scenario-active`:``} ${a?`scenario-done`:``} ${Oe===`agent-${t}`?`side-selected`:``}`,onClick:()=>{ke(`agent-${t}`),o===`COMMAND`?(Ve(),He(`agent-${t}`,e.name,`多智能体协同`,e.text,`指挥中枢 · 联合处置`)):Ue(o)},children:[(0,$.jsx)(`i`,{children:a?`✓`:e.icon}),(0,$.jsxs)(`p`,{children:[(0,$.jsx)(`b`,{children:e.name}),(0,$.jsx)(`span`,{children:i?a?`阶段任务完成 · 点击查看位置`:_&&k===t?`正在执行当前处置任务…`:e.text:`系统待命 · 点击可提前追踪`})]}),(0,$.jsx)(`em`,{children:`●`})]},e.name)})})]}),(0,$.jsxs)(`section`,{className:`map-panel panel`,children:[(0,$.jsxs)(`div`,{className:`panel-title`,children:[(0,$.jsx)(`span`,{children:`03`}),`真实城市三维推演 `,(0,$.jsx)(`b`,{children:`REAL-WORLD DIGITAL TWIN`}),(0,$.jsxs)(`div`,{className:`map-tools`,children:[(0,$.jsx)(`button`,{"aria-label":`缩小`,onClick:()=>window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`zoomOut`})),children:`−`}),(0,$.jsx)(`button`,{"aria-label":`放大`,onClick:()=>window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`zoomIn`})),children:`＋`})]})]}),(0,$.jsxs)(`div`,{className:`map`,onClick:()=>L(null),children:[(0,$.jsx)(uf,{running:_,blocked:y,blockedRoadId:x,showRisk:M,topView:!ee,nightMode:P,buildingLights:te,autoTour:re,suspended:l!==`overview`||se,scenarioPhase:z,scenarioTime:be,trafficDensity:Ee,onSelect:L,onRealRoute:w,onSceneStatus:e=>{g(e),e===`degraded`&&m(`真实路网数据异常，已自动启用内置完整路线`)},plume:B}),(0,$.jsxs)(`div`,{className:`scenario-console phase-${z} ${R}`,onClick:e=>e.stopPropagation(),children:[(0,$.jsxs)(`div`,{className:`scenario-now`,children:[(0,$.jsx)(`i`,{children:Ae.icon}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`span`,{children:[`SCENARIO DIRECTOR · `,z===0?`READY`:`${String(z).padStart(2,`0`)}/09`]}),(0,$.jsx)(`strong`,{children:Ae.title}),(0,$.jsx)(`p`,{children:Ae.subtitle})]}),(0,$.jsx)(`em`,{children:z===0?`01:12`:`${Math.floor(be/60).toString().padStart(2,`0`)}:${Math.floor(be%60).toString().padStart(2,`0`)}`})]}),(0,$.jsxs)(`div`,{className:`scenario-progress`,children:[(0,$.jsx)(`span`,{style:{width:`${je}%`}}),(0,$.jsx)(`i`,{style:{left:`${je}%`}})]}),(0,$.jsx)(`div`,{className:`scenario-stage-rail`,children:Uf.slice(1).map(e=>(0,$.jsxs)(`button`,{className:z===e.id?`active`:z>e.id?`done`:``,title:`${e.clock} ${e.title}`,onClick:()=>{xe(e.start+.01),ye(`paused`)},children:[(0,$.jsx)(`i`,{children:e.id}),(0,$.jsx)(`span`,{children:e.title})]},e.id))}),(0,$.jsxs)(`div`,{className:`scenario-controls`,children:[(0,$.jsx)(`button`,{className:`primary`,disabled:h===`loading`,onClick:z===0||R===`complete`?H:Fe,children:h===`loading`?`路网加载中…`:z===0?`▶ 一键完整演示`:R===`playing`?`Ⅱ 暂停`:R===`complete`?`↻ 再演示`:`▶ 继续`}),(0,$.jsx)(`button`,{disabled:z===0||z===9,onClick:Ie,children:`下一阶段 →`}),(0,$.jsxs)(`button`,{onClick:Le,children:[Se,`× 倍速`]}),(0,$.jsxs)(`button`,{onClick:Re,children:[`车流：`,Ee===18?`畅通`:Ee===36?`繁忙`:`拥堵`,` · `,Ee]}),(0,$.jsx)(`button`,{className:we?`on`:``,"aria-pressed":we,onClick:()=>Te(e=>!e),children:`◉ 导演视角`})]})]}),(0,$.jsxs)(`div`,{className:`map-layer-tools`,children:[(0,$.jsxs)(`button`,{className:ee?`on`:``,onClick:()=>{Be(),Te(!1),j(e=>!e)},children:[`◈ `,ee?`自由三维`:`垂直俯视`]}),(0,$.jsx)(`button`,{className:M?`on`:``,onClick:()=>N(e=>!e),children:`◉ 风险热区`}),(0,$.jsx)(`button`,{className:P?`on`:``,onClick:()=>F(e=>!e),children:P?`☀ 白天`:`☾ 夜间`}),(0,$.jsx)(`button`,{className:te?`on`:``,onClick:()=>ne(e=>!e),children:`✦ 楼宇灯光`}),(0,$.jsx)(`button`,{className:re?`on`:``,onClick:()=>{Be(),Te(!1),ie(e=>!e)},children:re?`■ 停止巡航`:`▶ 自动巡航`}),ae&&(0,$.jsx)(`button`,{className:`on`,onClick:Be,children:`■ 停止跟随`}),(0,$.jsx)(`button`,{onClick:()=>{Be(),Te(!1),ie(!1),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`incident`}))},children:`◎ 聚焦事故`}),(0,$.jsx)(`button`,{onClick:()=>{Be(),Te(!1),ie(!1),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`reset`}))},children:`⌖ 复位`})]}),(0,$.jsx)(`div`,{className:`coordinates`,children:`39°54′27″N\xA0\xA0116°27′07″E　|　北京 CBD`}),(0,$.jsxs)(`div`,{className:`wind`,children:[`↖`,(0,$.jsxs)(`span`,{children:[`东南风 3.4m/s`,(0,$.jsx)(`br`,{}),`吹向西北`]})]}),(0,$.jsxs)(`div`,{className:`legend`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{className:`lg-red`}),`致命区`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{className:`lg-orange`}),`高风险`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{className:`lg-yellow`}),`警戒区`]})]}),(0,$.jsx)(`div`,{className:`map-attribution`,children:`© OpenStreetMap contributors · 北京核心区真实矢量数据`}),I&&(0,$.jsxs)(`div`,{className:`asset-card`,onClick:e=>e.stopPropagation(),children:[(0,$.jsx)(`button`,{onClick:()=>L(null),children:`×`}),(0,$.jsx)(`span`,{children:I.category}),(0,$.jsx)(`strong`,{children:I.label}),(0,$.jsx)(`p`,{children:I.details}),(0,$.jsx)(`em`,{children:I.meta}),(0,$.jsxs)(`div`,{className:`asset-actions`,children:[I.position&&(0,$.jsx)(`button`,{onClick:()=>{Be(),ie(!1),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`focus`,position:I.position}}))},children:`◎ 定位观察`}),I.action===`follow-vehicle`&&(0,$.jsx)(`button`,{className:ae===I.id?`tracking`:``,onClick:()=>We(I),children:ae===I.id?`■ 停止跟随`:`◉ 跟随车辆`}),I.action===`toggle-building-lights`&&(0,$.jsx)(`button`,{className:`lights`,onClick:()=>window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`toggle-building-lights`,assetId:I.id}})),children:`✦ 切换楼层灯光`}),I.action===`block-road`&&(0,$.jsx)(`button`,{className:`danger`,onClick:()=>ze(Number(I.id.replace(`road-`,``))),children:y?`✓ 已封锁并完成真实路网重规划`:`⊘ 封锁此路并按真实路网重规划`})]})]})]}),(0,$.jsxs)(`div`,{className:`time-control`,children:[(0,$.jsx)(`button`,{"aria-label":R===`playing`?`暂停完整推演`:R===`paused`?`继续完整推演`:D?`暂停风险扩散时间`:`播放风险扩散时间`,onClick:()=>R===`playing`||R===`paused`?Fe():O(e=>!e),children:R===`playing`||D?`Ⅱ`:`▶`}),(0,$.jsx)(`input`,{"aria-label":`风险扩散推演时间`,type:`range`,min:`1`,max:`30`,value:T,disabled:R===`playing`||R===`paused`,onChange:e=>{O(!1),E(Number(e.target.value))}}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`现在`}),(0,$.jsx)(`span`,{children:`+5min`}),(0,$.jsx)(`span`,{children:`+15min`}),(0,$.jsx)(`span`,{children:`+30min`})]}),(0,$.jsxs)(`strong`,{children:[R===`playing`||R===`paused`?`导演脚本联动 · `:``,`+`,T,`min · 警戒纵深 `,B.warning,`m`]})]})]}),(0,$.jsxs)(`aside`,{className:`right-panel panel`,children:[(0,$.jsxs)(`div`,{className:`panel-title`,children:[(0,$.jsx)(`span`,{children:`04`}),`决策方案 `,(0,$.jsx)(`b`,{children:`AI COMMAND`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`score-card ${Oe===`plan-score`?`side-selected`:``}`,onClick:()=>He(`plan-score`,y?`方案 B · A* 动态重规划`:`方案 A · 最短响应路径`,`AI 决策方案`,y?`东二环封闭后，系统已使用 OSM 真实路网完成避让重规划。`:`当前道路正常通行，系统选择消防最短响应路径。`,`综合评分 ${y?`92.4`:`95.1`} · 实时求解`),children:[(0,$.jsx)(`span`,{children:`当前最优方案 · 实时求解`}),(0,$.jsx)(`strong`,{children:y?`方案 B · A* 动态重规划`:`方案 A · 最短响应路径`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:(0,$.jsx)(_f,{to:y?92.4:95.1,decimals:1})}),(0,$.jsx)(`small`,{children:`综合评分`})]})]}),(0,$.jsxs)(`div`,{className:`metrics`,children:[(0,$.jsxs)(`button`,{type:`button`,className:Oe===`eta`?`active`:``,onClick:()=>{ke(`eta`),Ue(`FIRE-01`)},children:[(0,$.jsx)(`span`,{children:`OSM A* 预计响应`}),(0,$.jsx)(`b`,{className:`green`,children:(0,$.jsx)(_f,{to:C?.eta??Ne.eta,suffix:` min`})}),(0,$.jsxs)(`small`,{children:[`点击追踪消防车 · 搜索 `,C?.visited??Ne.visited,` 个节点`]})]}),(0,$.jsxs)(`button`,{type:`button`,className:Oe===`exposure`?`active`:``,onClick:()=>{N(!0),Ve(),He(`exposure`,`模型风险暴露`,`风险扩散计算`,`当前预计风险暴露人口 ${B.affectedPeople} 人，警戒纵深 ${B.warning} 米。`,B.model)},children:[(0,$.jsx)(`span`,{children:`模型风险暴露`}),(0,$.jsx)(`b`,{children:(0,$.jsx)(_f,{to:B.affectedPeople,suffix:` 人`})}),(0,$.jsxs)(`small`,{children:[`点击聚焦风险区 · `,B.model]})]}),(0,$.jsxs)(`button`,{type:`button`,className:Oe===`route`?`active`:``,onClick:()=>He(`route`,`消防真实救援路径`,`OSM 路径规划`,C?.roads.join(` → `)||`正在加载 OSM 真实道路名称。`,`${((C?.distance??Ne.distance)/1e3).toFixed(2)} km · ETA ${C?.eta??Ne.eta} min`),children:[(0,$.jsx)(`span`,{children:`真实救援路径`}),(0,$.jsx)(`b`,{children:(0,$.jsx)(_f,{to:(C?.distance??Ne.distance)/1e3,decimals:2,suffix:` km`})}),(0,$.jsxs)(`small`,{children:[`点击查看道路序列 · `,C?.roads.slice(0,2).join(` → `)||`正在加载`]})]})]}),(0,$.jsx)(`div`,{className:`plan-steps`,children:[`封锁泄漏点周边 500m 道路`,`学校师生向东南侧上风向分批疏散`,`消防车沿 OSM 真实道路抵达`,`救护组在体育中心建立分诊点`].map((e,t)=>{let n=[6,6,7,8][t];return(0,$.jsxs)(`button`,{type:`button`,className:Oe===`step-${t}`?`active`:``,onClick:()=>{ke(`step-${t}`),xe(Uf[n].start+.01),ye(`paused`),Te(!0),m(`已跳转到处置步骤：${e}`)},children:[(0,$.jsx)(`i`,{children:t+1}),(0,$.jsxs)(`p`,{children:[e,(0,$.jsxs)(`span`,{children:[[`交警 · 2分钟内`,`教育 · 8分钟完成`,`消防 · 预计${C?.eta??7}分钟`,`医疗 · 12分钟启用`][t],` · 点击定位`]})]}),(0,$.jsx)(`em`,{children:`→`})]},e)})}),(0,$.jsx)(`button`,{className:`block-button`,disabled:z>0&&R!==`complete`,onClick:()=>ze(),children:z>0&&R!==`complete`?`完整演示进行中 · 道路决策已锁定`:y?`✓ OSM A* 已重规划：${C?.roads.slice(0,4).join(` → `)||`已避开封闭道路`}`:`模拟突发：封闭东二环路段并按真实道路重规划`}),(0,$.jsxs)(`div`,{className:`algorithm-proof`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>{N(e=>!e),Ve(),m(M?`风险扩散图层已隐藏`:`风险扩散图层已开启`)},children:[(0,$.jsx)(`span`,{children:`扩散模型`}),(0,$.jsx)(`b`,{children:`高斯烟羽 / Pasquill-D`}),(0,$.jsx)(`em`,{children:`点击切换风险图层 · Q=80g/s`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>He(`algorithm`,`OSM 真实路网 A*`,`路径算法`,`A* 已搜索 ${C?.visited??Ne.visited} 个道路节点，使用欧氏距离作为启发函数。`,`距离 ${C?.distance??Ne.distance}m · ETA ${C?.eta??Ne.eta}min`),children:[(0,$.jsx)(`span`,{children:`路径算法`}),(0,$.jsx)(`b`,{children:`OSM 真实路网 A* · Euclidean`}),(0,$.jsx)(`em`,{children:`点击查看求解结果`})]})]}),(0,$.jsxs)(`div`,{className:`panel-title compact`,children:[(0,$.jsx)(`span`,{children:`05`}),`决策时间线 `,(0,$.jsx)(`b`,{children:`TRACE`})]}),(0,$.jsx)(`div`,{className:`timeline scenario-timeline`,children:Uf.slice(1).map(e=>(0,$.jsxs)(`button`,{type:`button`,className:`${z===e.id?`active`:z>e.id?`done`:``} ${Oe===`timeline-${e.id}`?`side-selected`:``}`,onClick:()=>{ke(`timeline-${e.id}`),xe(e.start+.01),ye(`paused`),Te(!0),m(`时间线已定位：${e.title}`)},children:[(0,$.jsx)(`time`,{children:e.clock}),(0,$.jsx)(`i`,{}),(0,$.jsxs)(`p`,{children:[(0,$.jsx)(`b`,{children:e.title}),(0,$.jsx)(`span`,{children:e.subtitle})]})]},e.id))}),(0,$.jsxs)(`button`,{className:`report`,onClick:Ge,children:[`生成应急处置报告 `,(0,$.jsx)(`span`,{children:`↗`})]})]})]}),se&&(0,$.jsx)(`div`,{className:`report-overlay`,onClick:()=>ce(!1),children:(0,$.jsxs)(`section`,{className:`report-dialog`,role:`dialog`,"aria-modal":`true`,"aria-label":`应急处置报告`,onClick:e=>e.stopPropagation(),children:[(0,$.jsx)(`button`,{className:`report-close`,"aria-label":`关闭报告`,onClick:()=>ce(!1),children:`×`}),le?(0,$.jsxs)(`div`,{className:`report-generating`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`strong`,{children:`AI 正在生成应急处置报告`}),(0,$.jsx)(`p`,{children:`汇总视觉识别、风险扩散、OSM 路网与多智能体决策结果…`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{})]})]}):(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`header`,{className:`report-head`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`LINGJING SENTINEL · AUTO REPORT`}),(0,$.jsx)(`h2`,{children:`危化品泄漏应急处置报告`}),(0,$.jsxs)(`p`,{children:[`报告编号：LJ-BJ-20260720-001　生成时间：`,de]})]}),(0,$.jsx)(`b`,{children:`Ⅰ级响应`})]}),(0,$.jsxs)(`div`,{className:`report-paper`,children:[(0,$.jsxs)(`div`,{className:`report-summary`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`AI 事故判定`}),(0,$.jsx)(`strong`,{children:_e.type}),(0,$.jsxs)(`em`,{children:[`置信度 `,(_e.confidence*100).toFixed(1),`%`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`警戒纵深`}),(0,$.jsxs)(`strong`,{children:[B.warning,` m`]}),(0,$.jsx)(`em`,{children:`高斯烟羽 · Pasquill-D`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`风险暴露`}),(0,$.jsxs)(`strong`,{children:[B.affectedPeople,` 人`]}),(0,$.jsxs)(`em`,{children:[`现场估计 `,_e.persons,` 人`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`消防 ETA`}),(0,$.jsxs)(`strong`,{children:[C?.eta??Ne.eta,` min`]}),(0,$.jsxs)(`em`,{children:[C?.distance??Ne.distance,` m`]})]})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`h3`,{children:`01　事件概况与智能研判`}),(0,$.jsxs)(`p`,{children:[`北京市朝阳区建国门外大街国贸桥西侧发生危化品运输车泄漏。视觉模型识别为`,(0,$.jsx)(`strong`,{children:_e.type}),`，烟羽像素占比 `,(_e.smokeRatio*100).toFixed(1),`%，现场人员约 `,_e.persons,` 人。`,_e.summary]}),(0,$.jsxs)(`div`,{className:`report-callout danger`,children:[(0,$.jsx)(`b`,{children:`核心风险`}),(0,$.jsx)(`span`,{children:`东南风 3.4 m/s，污染羽流向西北扩散；学校位于事故点 500 米重点保护范围内，应启动预防性疏散。`})]})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`h3`,{children:`02　风险扩散计算`}),(0,$.jsx)(`table`,{children:(0,$.jsxs)(`tbody`,{children:[(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`th`,{children:`风险等级`}),(0,$.jsx)(`th`,{children:`纵深`}),(0,$.jsx)(`th`,{children:`处置要求`})]}),(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:`致命区`}),(0,$.jsxs)(`td`,{children:[B.lethal,` m`]}),(0,$.jsx)(`td`,{children:`仅允许专业防化力量进入`})]}),(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:`高风险区`}),(0,$.jsxs)(`td`,{children:[B.high,` m`]}),(0,$.jsx)(`td`,{children:`立即疏散并设置硬隔离`})]}),(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:`警戒区`}),(0,$.jsxs)(`td`,{children:[B.warning,` m`]}),(0,$.jsx)(`td`,{children:`持续监测并准备扩大疏散`})]})]})})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`h3`,{children:`03　消防救援真实道路路线`}),(0,$.jsxs)(`p`,{children:[`系统使用 674 段北京 OSM 道路构图，并通过 A* 搜索 `,C?.visited??Ne.visited,` 个道路节点。当前路线：`]}),(0,$.jsx)(`div`,{className:`report-route`,children:C?.roads.join(`　→　`)||`正在载入真实道路名称`}),(0,$.jsx)(`p`,{children:y?`已封锁 OSM 道路 ${C?.blockedRoadId??x??`自动选择路段`}，消防车已避开该路段并完成动态重规划。`:`当前道路正常通行，消防车沿最短真实路网路线行驶。`})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`h3`,{children:`04　联合处置指令`}),(0,$.jsxs)(`ol`,{children:[(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`交通：`}),`2 分钟内封锁事故点周边 500 m 道路，建立 3.2 km 应急绿波带。`]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`教育：`}),`城北实验学校师生经东南侧上风向安全通道分批疏散，8 分钟完成重点人员转移。`]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`消防：`}),`2 辆泡沫消防车沿 OSM 路线抵达，在上风向布置水幕并实施堵漏。`]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`医疗：`}),`开放三级医院绿色通道，在体育中心设置临时分诊点。`]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`监测：`}),`下风向 200 m、500 m、1000 m 设置监测点，每 2 分钟回传浓度。`]})]})]}),(0,$.jsxs)(`div`,{className:`report-conclusion`,children:[(0,$.jsx)(`b`,{children:`AI 处置结论`}),(0,$.jsx)(`p`,{children:`立即启动危化品泄漏Ⅰ级联合响应，处置优先级为：学校疏散 → 道路封控 → 泄漏源控制 → 医疗救治 → 环境复测。`}),(0,$.jsx)(`small`,{children:`本报告由灵境哨兵自动生成，用于竞赛演示；正式行动须由现场指挥员复核。`})]})]}),(0,$.jsxs)(`footer`,{className:`report-actions`,children:[(0,$.jsx)(`button`,{onClick:Ke,children:`↓ 下载完整报告`}),(0,$.jsx)(`button`,{onClick:()=>ce(!1),children:`关闭报告`})]})]})]})}),(0,$.jsxs)(`footer`,{children:[(0,$.jsx)(`span`,{children:`数据源：城市感知网络 · 气象局 · 应急资源库`}),(0,$.jsxs)(`strong`,{children:[(0,$.jsx)(`i`,{}),` AI 决策引擎运行正常 · 处理延迟 128ms`]}),(0,$.jsx)(`span`,{children:`灵境哨兵 v3.0 FINAL · 离线演示环境`})]})]}):(0,$.jsx)(Kf,{onAuthenticated:Je}):(0,$.jsxs)(`main`,{className:`auth-boot`,children:[(0,$.jsxs)(`div`,{className:`auth-brand-mark`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]}),(0,$.jsx)(`span`,{children:`安全环境初始化中`})]})}export{qf as default};