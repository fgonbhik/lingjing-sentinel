...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Kc(e,t,n){let r=new Float32Array(Mc),i=new q(0,1,0);return new $o({name:`SphericalGaussianBlur`,defines:{n:Mc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Yc(),fragmentShader:`
	...
	`}var Xc=class extends Qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new sa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var xu={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Su(e,t){let n=xu[t];return n===void 0?(W(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Cu=new q;function wu(){return zt.getLuminanceCoefficients(Cu),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Cu.x.toFixed(4)}, ${Cu.y.toFixed(4)}, ${Cu.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=pu(i,i.VERTEX_SHADER,y),S=pu(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=yu(i,x,`vertex`),n=yu(i,S,`fragment`);G(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
...
}`,Td=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new da(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new $o({vertexShader:Cd,fragmentShader:wd,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Y(new Bo(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},Ed=class extends rt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,l=null,u=null,d=null,f=null,p=null,m=typeof XRWebGLBinding<`u`,g=new Td,_={},v=t.getContextAttributes(),y=null,x=null,S=[],C=[],w=new K,E=null,D=new zs;D.viewport=new Xt;let O=new zs;O.viewport=new Xt;let k=[D,O],M=new Js,N=null,P=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=S[e];return t===void 0&&(t=new Mn,S[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=S[e];return t===void 0&&(t=new Mn,S[e]=t),t.getGripSpace()},this.getHand=function(e){let t=S[e];return t===void 0&&(t=new Mn,S[e]=t),t.getHandSpace()};function F(e){let t=C.indexOf(e.inputSource);if(t===-1)return;let n=S[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function te(){r.removeEventListener(`select`,F),r.removeEventListener(`selectstart`,F),r.removeEventListener(`selectend`,F),r.removeEventListener(`squeeze`,F),r.removeEventListener(`squeezestart`,F),r.removeEventListener(`squeezeend`,F),r.removeEventListener(`end`,te),r.removeEventListener(`inputsourceschange`,ne);for(let e=0;e<S.length;e++){let t=C[e];t!==null&&(C[e]=null,S[e].disconnect(t))}N=null,P=null,g.reset();for(let e in _)delete _[e];e.setRenderTarget(y),f=null,d=null,u=null,r=null,x=null,ce.stop(),n.isPresenting=!1,e.setPixelRatio(E),e.setSize(w.width,w.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&W(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&W(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return d===null?f:d},this.getBinding=function(){return u===null&&m&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return p},this.getSession=function(){return r},this.setSession=async function(l){if(r=l,r!==null){if(y=e.getRenderTarget(),r.addEventListener(`select`,F),r.addEventListener(`selectstart`,F),r.addEventListener(`selectend`,F),r.addEventListener(`squeeze`,F),r.addEventListener(`squeezestart`,F),r.addEventListener(`squeezeend`,F),r.addEventListener(`end`,te),r.addEventListener(`inputsourceschange`,ne),v.xrCompatible!==!0&&await t.makeXRCompatible(),E=e.getPixelRatio(),e.getSize(w),m&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;v.depth&&(o=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=v.stencil?j:ee,a=v.stencil?T:b);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};u=this.getBinding(),d=u.createProjectionLayer(s),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),x=new Qt(d.textureWidth,d.textureHeight,{format:A,type:h,depthTexture:new la(d.textureWidth,d.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{let n={antialias:v.antialias,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:i};f=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),x=new Qt(f.framebufferWidth,f.framebufferHeight,{format:A,type:h,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}x.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),ce.setContext(r),ce.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function ne(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=C.indexOf(n);r>=0&&(C[r]=null,S[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=C.indexOf(n);if(r===-1){for(let e=0;e<S.length;e++)if(e>=C.length){C.push(n),r=e;break}else if(C[e]===null){C[e]=n,r=e;break}if(r===-1)break}let i=S[r];i&&i.connect(n)}}let re=new q,ie=new q;function ae(e,t,n){re.setFromMatrixPosition(t.matrixWorld),ie.setFromMatrixPosition(n.matrixWorld);let r=re.distanceTo(ie),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function oe(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;g.texture!==null&&(g.depthNear>0&&(t=g.depthNear),g.depthFar>0&&(n=g.depthFar)),M.near=O.near=D.near=t,M.far=O.far=D.far=n,(N!==M.near||P!==M.far)&&(r.updateRenderState({depthNear:M.near,depthFar:M.far}),N=M.near,P=M.far),M.layers.mask=e.layers.mask|6,D.layers.mask=M.layers.mask&-5,O.layers.mask=M.layers.mask&-3;let i=e.parent,a=M.cameras;oe(M,i);for(let e=0;e<a.length;e++)oe(a[e],i);a.length===2?ae(M,D,O):M.projectionMatrix.copy(D.projectionMatrix),I(e,M,i)};function I(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=st*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(d===null&&f===null))return s},this.setFoveation=function(e){s=e,d!==null&&(d.fixedFoveation=e),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=e)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(M)},this.getCameraTexture=function(e){return _[e]};let L=null;function se(t,i){if(l=i.getViewerPose(c||a),p=i,l!==null){let t=l.views;f!==null&&(e.setRenderTargetFramebuffer(x,f.framebuffer),e.setRenderTarget(x));let i=!1;t.length!==M.cameras.length&&(M.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(f!==null)a=f.getViewport(r);else{let t=u.getViewSubImage(d,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(x,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(x))}let o=k[n];o===void 0&&(o=new zs,o.layers.enable(n),o.viewport=new Xt,k[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(M.matrix.copy(o.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),i===!0&&M.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&m){u=n.getBinding();let e=u.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&g.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&m){e.state.unbindTexture(),u=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=_[n];e||(e=new da,_[n]=e);let t=u.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<S.length;e++){let t=C[e],n=S[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}L&&L(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),p=null}let ce=new vc;ce.setAnimationLoop(se),this.setAnimationLoop=function(e){L=e},this.dispose=function(){}}},Dd=new tn,Od=new Pt;Od.set(-1,0,0,0,1,0,0,0,1);function kd(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,Yo(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(Dd.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(Od),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Ad(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return G(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return typeof i==`number`||typeof i==`boolean`?r[a]=i:ArrayBuffer.isView(i)?r[a]=i.slice():r[a]=i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?W(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):W(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var jd=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Md=null;function Nd(){return Md===null&&(Md=new Ci(jd,16,16,P,S),Md.name=`DFG_LUT`,Md.minFilter=f,Md.magFilter=f,Md.wrapS=s,Md.wrapT=s,Md.generateMipmaps=!1,Md.needsUpdate=!0),Md}var Pd=class{constructor(e={}){let{canvas:t=Ye(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:c=!1,powerPreference:l=`default`,failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:f=h}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);p=n.getContextAttributes().alpha}else p=a;let g=f,_=new Set([te,F,N]),y=new Set([h,b,v,T,C,w]),x=new Uint32Array(4),E=new Int32Array(4),D=new q,O=null,k=null,A=[],ee=[],j=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let M=this,P=!1,ne=null,re=null,ie=null,ae=null;this._outputColorSpace=Re;let oe=0,I=0,L=null,se=-1,ce=null,le=new Xt,ue=new Xt,de=null,fe=new J(0),pe=0,me=t.width,he=t.height,ge=1,_e=null,ve=null,ye=new Xt(0,0,me,he),be=new Xt(0,0,me,he),R=!1,xe=new Bi,Se=!1,Ce=!1,we=new tn,Te=new q,Ee=new Xt,De={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},Oe=!1;function ke(){return L===null?ge:1}let z=n;function Ae(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:u};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,rt,!1),t.addEventListener(`webglcontextrestored`,it,!1),t.addEventListener(`webglcontextcreationerror`,at,!1),z===null){let t=`webgl2`;if(z=Ae(t,e),z===null)throw Ae(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw G(`WebGLRenderer: `+e.message),e}let B,je,V,Me,H,U,Ne,Pe,Fe,Ie,Le,ze,Be,Ve,He,Ue,We,Ke,qe,Je,Xe,Ze,$e;function et(){B=new Qc(z),B.init(),Xe=new Sd(z,B),je=new Oc(z,B,e,Xe),V=new bd(z,B),je.reversedDepthBuffer&&d&&V.buffers.depth.setReversed(!0),re=z.createFramebuffer(),ie=z.createFramebuffer(),ae=z.createFramebuffer(),Me=new tl(z),H=new ed,U=new xd(z,B,V,H,je,Xe,Me),Ne=new Zc(M),Pe=new yc(z),Ze=new Ec(z,Pe),Fe=new $c(z,Pe,Me,Ze),Ie=new rl(z,Fe,Pe,Ze,Me),Ke=new nl(z,je,U),He=new kc(H),Le=new $u(M,Ne,B,je,Ze,He),ze=new kd(M,H),Be=new id,Ve=new dd(B),We=new Tc(M,Ne,V,Ie,p,s),Ue=new yd(M,Ie,je),$e=new Ad(z,Me,je,V),qe=new Dc(z,B,Me),Je=new el(z,B,Me),Me.programs=Le.programs,M.capabilities=je,M.extensions=B,M.properties=H,M.renderLists=Be,M.shadowMap=Ue,M.state=V,M.info=Me}et(),g!==1009&&(j=new al(g,t.width,t.height,o,r,i));let nt=new Ed(M,z);this.xr=nt,this.getContext=function(){return z},this.getContextAttributes=function(){return z.getContextAttributes()},this.forceContextLoss=function(){let e=B.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=B.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return ge},this.setPixelRatio=function(e){e!==void 0&&(ge=e,this.setSize(me,he,!1))},this.getSize=function(e){return e.set(me,he)},this.setSize=function(e,n,r=!0){if(nt.isPresenting){W(`WebGLRenderer: Can't change size while VR device is presenting.`);return}me=e,he=n,t.width=Math.floor(e*ge),t.height=Math.floor(n*ge),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),j!==null&&j.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(me*ge,he*ge).floor()},this.setDrawingBufferSize=function(e,n,r){me=e,he=n,ge=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(g===1009){G(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){W(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}j.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(le)},this.getViewport=function(e){return e.copy(ye)},this.setViewport=function(e,t,n,r){e.isVector4?ye.set(e.x,e.y,e.z,e.w):ye.set(e,t,n,r),V.viewport(le.copy(ye).multiplyScalar(ge).round())},this.getScissor=function(e){return e.copy(be)},this.setScissor=function(e,t,n,r){e.isVector4?be.set(e.x,e.y,e.z,e.w):be.set(e,t,n,r),V.scissor(ue.copy(be).multiplyScalar(ge).round())},this.getScissorTest=function(){return R},this.setScissorTest=function(e){V.setScissorTest(R=e)},this.setOpaqueSort=function(e){_e=e},this.setTransparentSort=function(e){ve=e},this.getClearColor=function(e){return e.copy(We.getClearColor())},this.setClearColor=function(){We.setClearColor(...arguments)},this.getClearAlpha=function(){return We.getClearAlpha()},this.setClearAlpha=function(){We.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(L!==null){let t=L.texture.format;e=_.has(t)}if(e){let e=L.texture.type,t=y.has(e),n=We.getClearColor(),r=We.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(x[0]=i,x[1]=a,x[2]=o,x[3]=r,z.clearBufferuiv(z.COLOR,0,x)):(E[0]=i,E[1]=a,E[2]=o,E[3]=r,z.clearBufferiv(z.COLOR,0,E))}else r|=z.COLOR_BUFFER_BIT}t&&(r|=z.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=z.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&z.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),ne=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,rt,!1),t.removeEventListener(`webglcontextrestored`,it,!1),t.removeEventListener(`webglcontextcreationerror`,at,!1),We.dispose(),Be.dispose(),Ve.dispose(),H.dispose(),Ne.dispose(),Ie.dispose(),Ze.dispose(),$e.dispose(),Le.dispose(),nt.dispose(),nt.removeEventListener(`sessionstart`,ft),nt.removeEventListener(`sessionend`,pt),mt.stop()};function rt(e){e.preventDefault(),Qe(`WebGLRenderer: Context Lost.`),P=!0}function it(){Qe(`WebGLRenderer: Context Restored.`),P=!1;let e=Me.autoReset,t=Ue.enabled,n=Ue.autoUpdate,r=Ue.needsUpdate,i=Ue.type;et(),Me.autoReset=e,Ue.enabled=t,Ue.autoUpdate=n,Ue.needsUpdate=r,Ue.type=i}function at(e){G(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function ot(e){let t=e.target;t.removeEventListener(`dispose`,ot),st(t)}function st(e){ct(e),H.remove(e)}function ct(e){let t=H.get(e).programs;t!==void 0&&(t.forEach(function(e){Le.releaseProgram(e)}),e.isShaderMaterial&&Le.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=De);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=wt(e,t,n,r,i);V.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Fe.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;Ze.setup(i,r,s,n,c);let h,g=qe;if(c!==null&&(h=Pe.get(c),g=Je,g.setIndex(h)),i.isMesh)r.wireframe===!0?(V.setLineWidth(r.wireframeLinewidth*ke()),g.setMode(z.LINES)):g.setMode(z.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),V.setLineWidth(e*ke()),i.isLineSegments?g.setMode(z.LINES):i.isLineLoop?g.setMode(z.LINE_LOOP):g.setMode(z.LINE_STRIP)}else i.isPoints?g.setMode(z.POINTS):i.isSprite&&g.setMode(z.TRIANGLES);if(i.isBatchedMesh)if(B.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Pe.get(c).bytesPerElement:1,o=H.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(z,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function lt(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,bt(e,t,n),e.side=0,e.needsUpdate=!0,bt(e,t,n),e.side=2):bt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),k=Ve.get(n),k.init(t),ee.push(k),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(k.pushLight(e),e.castShadow&&k.pushShadow(e))}),k.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t)if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];lt(a,n,e),r.add(a)}else lt(t,n,e),r.add(t)}),k=ee.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){H.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}B.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let ut=null;function dt(e){ut&&ut(e)}function ft(){mt.stop()}function pt(){mt.start()}let mt=new vc;mt.setAnimationLoop(dt),typeof self<`u`&&mt.setContext(self),this.setAnimationLoop=function(e){ut=e,nt.setAnimationLoop(e),e===null?mt.stop():mt.start()},nt.addEventListener(`sessionstart`,ft),nt.addEventListener(`sessionend`,pt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){G(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(P===!0)return;ne!==null&&ne.renderStart(e,t);let n=nt.enabled===!0&&nt.isPresenting===!0,r=j!==null&&(L===null||n)&&j.begin(M,L);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),nt.enabled===!0&&nt.isPresenting===!0&&(j===null||j.isCompositing()===!1)&&(nt.cameraAutoUpdate===!0&&nt.updateCamera(t),t=nt.getCamera()),e.isScene===!0&&e.onBeforeRender(M,e,t,L),k=Ve.get(e,ee.length),k.init(t),k.state.textureUnits=U.getTextureUnits(),ee.push(k),we.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),xe.setFromProjectionMatrix(we,Ge,t.reversedDepth),Ce=this.localClippingEnabled,Se=He.init(this.clippingPlanes,Ce),O=Be.get(e,A.length),O.init(),A.push(O),nt.enabled===!0&&nt.isPresenting===!0){let e=M.xr.getDepthSensingMesh();e!==null&&ht(e,t,-1/0,M.sortObjects)}ht(e,t,0,M.sortObjects),O.finish(),M.sortObjects===!0&&O.sort(_e,ve,t.reversedDepth),Oe=nt.enabled===!1||nt.isPresenting===!1||nt.hasDepthSensing()===!1,Oe&&We.addToRenderList(O,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),Se===!0&&He.beginShadows();let i=k.state.shadowsArray;if(Ue.render(i,e,t),Se===!0&&He.endShadows(),(r&&j.hasRenderPass())===!1){let n=O.opaque,r=O.transmissive;if(k.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];_t(n,r,e,a)}Oe&&We.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];gt(O,e,n,n.viewport)}}else r.length>0&&_t(n,r,e,t),Oe&&We.render(e),gt(O,e,t)}L!==null&&I===0&&(U.updateMultisampleRenderTarget(L),U.updateRenderTargetMipmap(L)),r&&j.end(M),e.isScene===!0&&e.onAfterRender(M,e,t),Ze.resetDefaultState(),se=-1,ce=null,ee.pop(),ee.length>0?(k=ee[ee.length-1],U.setTextureUnits(k.state.textureUnits),Se===!0&&He.setGlobalState(M.clippingPlanes,k.state.camera)):k=null,A.pop(),O=A.length>0?A[A.length-1]:null,ne!==null&&ne.renderEnd()};function ht(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)k.pushLightProbeGrid(e);else if(e.isLight)k.pushLight(e),e.castShadow&&k.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||xe.intersectsSprite(e)){r&&Ee.setFromMatrixPosition(e.matrixWorld).applyMatrix4(we);let t=Ie.update(e),i=e.material;i.visible&&O.push(e,t,i,n,Ee.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||xe.intersectsObject(e))){let t=Ie.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),Ee.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),Ee.copy(e.boundingSphere.center)),Ee.applyMatrix4(e.matrixWorld).applyMatrix4(we)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&O.push(e,t,s,n,Ee.z,o)}}else i.visible&&O.push(e,t,i,n,Ee.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)ht(i[e],t,n,r)}function gt(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;k.setupLightsView(n),Se===!0&&He.setGlobalState(M.clippingPlanes,n),r&&V.viewport(le.copy(r)),i.length>0&&vt(i,t,n),a.length>0&&vt(a,t,n),o.length>0&&vt(o,t,n),V.buffers.depth.setTest(!0),V.buffers.depth.setMask(!0),V.buffers.color.setMask(!0),V.setPolygonOffset(!1)}function _t(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(k.state.transmissionRenderTarget[r.id]===void 0){let e=B.has(`EXT_color_buffer_half_float`)||B.has(`EXT_color_buffer_float`);k.state.transmissionRenderTarget[r.id]=new Qt(1,1,{generateMipmaps:!0,type:e?S:h,minFilter:m,samples:Math.max(4,je.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:zt.workingColorSpace})}let a=k.state.transmissionRenderTarget[r.id],o=r.viewport||le;a.setSize(o.z*M.transmissionResolutionScale,o.w*M.transmissionResolutionScale);let s=M.getRenderTarget(),c=M.getActiveCubeFace(),l=M.getActiveMipmapLevel();M.setRenderTarget(a),M.getClearColor(fe),pe=M.getClearAlpha(),pe<1&&M.setClearColor(16777215,.5),M.clear(),Oe&&We.render(n);let u=M.toneMapping;M.toneMapping=0;let d=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),k.setupLightsView(r),Se===!0&&He.setGlobalState(M.clippingPlanes,r),vt(e,n,r),U.updateMultisampleRenderTarget(a),U.updateRenderTargetMipmap(a),B.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,yt(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(U.updateMultisampleRenderTarget(a),U.updateRenderTargetMipmap(a))}M.setRenderTarget(s,c,l),M.setClearColor(fe,pe),d!==void 0&&(r.viewport=d),M.toneMapping=u}function vt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&yt(o,t,n,s,l,c)}}function yt(e,t,n,r,i,a){e.onBeforeRender(M,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(M,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,M.renderBufferDirect(n,t,r,i,e,a),i.side=2):M.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(M,t,n,r,i,a)}function bt(e,t,n){t.isScene!==!0&&(t=De);let r=H.get(e),i=k.state.lights,a=k.state.shadowsArray,o=i.state.version,s=Le.getParameters(e,i.state,a,t,n,k.state.lightProbeGridArray),c=Le.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=Ne.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,ot),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return St(e,s),d}else s.uniforms=Le.getUniforms(e),ne!==null&&e.isNodeMaterial&&ne.build(e,n,s),e.onBeforeCompile(s,M),d=Le.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=He.uniform),St(e,s),r.needsLights=Et(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=k.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function xt(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=fu.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function St(e,t){let n=H.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function Ct(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];D.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(D))return n}return null}function wt(e,t,n,r,i){t.isScene!==!0&&(t=De),U.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=L===null?M.outputColorSpace:L.isXRRenderTarget===!0?L.texture.colorSpace:zt.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=Ne.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(L===null||L.isXRRenderTarget===!0)&&(h=M.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=H.get(r),y=k.state.lights;if(Se===!0&&(Ce===!0||e!==ce)){let t=e===ce&&r.id===se;He.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==He.numPlanes||v.numIntersection!==He.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=k.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let x=v.currentProgram;b===!0&&(x=bt(r,t,i),ne&&r.isNodeMaterial&&ne.onUpdateProgram(r,x,v));let S=!1,C=!1,w=!1,T=x.getUniforms(),E=v.uniforms;if(V.useProgram(x.program)&&(S=!0,C=!0,w=!0),r.id!==se&&(se=r.id,C=!0),v.needsLights){let e=Ct(k.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,C=!0)}if(S||ce!==e){V.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),T.setValue(z,`projectionMatrix`,e.projectionMatrix),T.setValue(z,`viewMatrix`,e.matrixWorldInverse);let t=T.map.cameraPosition;t!==void 0&&t.setValue(z,Te.setFromMatrixPosition(e.matrixWorld)),je.logarithmicDepthBuffer&&T.setValue(z,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&T.setValue(z,`isOrthographic`,e.isOrthographicCamera===!0),ce!==e&&(ce=e,C=!0,w=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&T.setValue(z,`directionalShadowMap`,y.state.directionalShadowMap,U),y.state.spotShadowMap.length>0&&T.setValue(z,`spotShadowMap`,y.state.spotShadowMap,U),y.state.pointShadowMap.length>0&&T.setValue(z,`pointShadowMap`,y.state.pointShadowMap,U)),i.isSkinnedMesh){T.setOptional(z,i,`bindMatrix`),T.setOptional(z,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),T.setValue(z,`boneTexture`,e.boneTexture,U))}i.isBatchedMesh&&(T.setOptional(z,i,`batchingTexture`),T.setValue(z,`batchingTexture`,i._matricesTexture,U),T.setOptional(z,i,`batchingIdTexture`),T.setValue(z,`batchingIdTexture`,i._indirectTexture,U),T.setOptional(z,i,`batchingColorTexture`),i._colorsTexture!==null&&T.setValue(z,`batchingColorTexture`,i._colorsTexture,U));let D=n.morphAttributes;if((D.position!==void 0||D.normal!==void 0||D.color!==void 0)&&Ke.update(i,n,x),(C||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,T.setValue(z,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(E.envMapIntensity.value=t.environmentIntensity),E.dfgLUT!==void 0&&(E.dfgLUT.value=Nd()),C){if(T.setValue(z,`toneMappingExposure`,M.toneMappingExposure),v.needsLights&&Tt(E,w),a&&r.fog===!0&&ze.refreshFogUniforms(E,a),ze.refreshMaterialUniforms(E,r,ge,he,k.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;E.probesSH.value=e.texture,E.probesMin.value.copy(e.boundingBox.min),E.probesMax.value.copy(e.boundingBox.max),E.probesResolution.value.copy(e.resolution)}fu.upload(z,xt(v),E,U)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(fu.upload(z,xt(v),E,U),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&T.setValue(z,`center`,i.center),T.setValue(z,`modelViewMatrix`,i.modelViewMatrix),T.setValue(z,`normalMatrix`,i.normalMatrix),T.setValue(z,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];$e.update(n,x),$e.bind(n,x)}}return x}function Tt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function Et(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return oe},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return L},this.setRenderTargetTextures=function(e,t,n){let r=H.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),H.get(e.texture).__webglTexture=t,H.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=H.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){L=e,oe=t,I=n;let r=null,i=!1,a=!1;if(e){let o=H.get(e);if(o.__useDefaultFramebuffer!==void 0){V.bindFramebuffer(z.FRAMEBUFFER,o.__webglFramebuffer),le.copy(e.viewport),ue.copy(e.scissor),de=e.scissorTest,V.viewport(le),V.scissor(ue),V.setScissorTest(de),se=-1;return}else if(o.__webglFramebuffer===void 0)U.setupRenderTarget(e);else if(o.__hasExternalTextures)U.rebindTextures(e,H.get(e.texture).__webglTexture,H.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&H.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);U.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=H.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&U.useMultisampledRTT(e)===!1?H.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,le.copy(e.viewport),ue.copy(e.scissor),de=e.scissorTest}else le.copy(ye).multiplyScalar(ge).floor(),ue.copy(be).multiplyScalar(ge).floor(),de=R;if(n!==0&&(r=re),V.bindFramebuffer(z.FRAMEBUFFER,r)&&V.drawBuffers(e,r),V.viewport(le),V.scissor(ue),V.setScissorTest(de),i){let r=H.get(e.texture);z.framebufferTexture2D(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=H.get(e.textures[t]);z.framebufferTextureLayer(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=H.get(e.texture);z.framebufferTexture2D(z.FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,t.__webglTexture,n)}se=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){G(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=H.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){V.bindFramebuffer(z.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&z.readBuffer(z.COLOR_ATTACHMENT0+s),!je.textureFormatReadable(c)){G(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!je.textureTypeReadable(l)){G(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&z.readPixels(t,n,r,i,Xe.convert(c),Xe.convert(l),a)}finally{let e=L===null?null:H.get(L).__webglFramebuffer;V.bindFramebuffer(z.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=H.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c)if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){V.bindFramebuffer(z.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&z.readBuffer(z.COLOR_ATTACHMENT0+s),!je.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!je.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=z.createBuffer();z.bindBuffer(z.PIXEL_PACK_BUFFER,d),z.bufferData(z.PIXEL_PACK_BUFFER,a.byteLength,z.STREAM_READ),z.readPixels(t,n,r,i,Xe.convert(l),Xe.convert(u),0);let f=L===null?null:H.get(L).__webglFramebuffer;V.bindFramebuffer(z.FRAMEBUFFER,f);let p=z.fenceSync(z.SYNC_GPU_COMMANDS_COMPLETE,0);return z.flush(),await tt(z,p,4),z.bindBuffer(z.PIXEL_PACK_BUFFER,d),z.getBufferSubData(z.PIXEL_PACK_BUFFER,0,a),z.deleteBuffer(d),z.deleteSync(p),a}else throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;U.setTexture2D(e,0),z.copyTexSubImage2D(z.TEXTURE_2D,n,0,0,o,s,i,a),V.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=Xe.convert(t.format),_=Xe.convert(t.type),v;t.isData3DTexture?(U.setTexture3D(t,0),v=z.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(U.setTexture2DArray(t,0),v=z.TEXTURE_2D_ARRAY):(U.setTexture2D(t,0),v=z.TEXTURE_2D),V.activeTexture(z.TEXTURE0),V.pixelStorei(z.UNPACK_FLIP_Y_WEBGL,t.flipY),V.pixelStorei(z.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),V.pixelStorei(z.UNPACK_ALIGNMENT,t.unpackAlignment);let y=V.getParameter(z.UNPACK_ROW_LENGTH),b=V.getParameter(z.UNPACK_IMAGE_HEIGHT),x=V.getParameter(z.UNPACK_SKIP_PIXELS),S=V.getParameter(z.UNPACK_SKIP_ROWS),C=V.getParameter(z.UNPACK_SKIP_IMAGES);V.pixelStorei(z.UNPACK_ROW_LENGTH,h.width),V.pixelStorei(z.UNPACK_IMAGE_HEIGHT,h.height),V.pixelStorei(z.UNPACK_SKIP_PIXELS,l),V.pixelStorei(z.UNPACK_SKIP_ROWS,u),V.pixelStorei(z.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=H.get(e),r=H.get(t),h=H.get(n.__renderTarget),g=H.get(r.__renderTarget);V.bindFramebuffer(z.READ_FRAMEBUFFER,h.__webglFramebuffer),V.bindFramebuffer(z.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(z.framebufferTextureLayer(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,H.get(e).__webglTexture,i,d+n),z.framebufferTextureLayer(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,H.get(t).__webglTexture,a,m+n)),z.blitFramebuffer(l,u,o,s,f,p,o,s,z.DEPTH_BUFFER_BIT,z.NEAREST);V.bindFramebuffer(z.READ_FRAMEBUFFER,null),V.bindFramebuffer(z.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||H.has(e)){let n=H.get(e),r=H.get(t);V.bindFramebuffer(z.READ_FRAMEBUFFER,ie),V.bindFramebuffer(z.DRAW_FRAMEBUFFER,ae);for(let e=0;e<c;e++)w?z.framebufferTextureLayer(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):z.framebufferTexture2D(z.READ_FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,n.__webglTexture,i),T?z.framebufferTextureLayer(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):z.framebufferTexture2D(z.DRAW_FRAMEBUFFER,z.COLOR_ATTACHMENT0,z.TEXTURE_2D,r.__webglTexture,a),i===0?T?z.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):z.copyTexSubImage2D(v,a,f,p,l,u,o,s):z.blitFramebuffer(l,u,o,s,f,p,o,s,z.COLOR_BUFFER_BIT,z.NEAREST);V.bindFramebuffer(z.READ_FRAMEBUFFER,null),V.bindFramebuffer(z.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?z.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?z.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):z.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?z.texSubImage2D(z.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?z.compressedTexSubImage2D(z.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):z.texSubImage2D(z.TEXTURE_2D,a,f,p,o,s,g,_,h);V.pixelStorei(z.UNPACK_ROW_LENGTH,y),V.pixelStorei(z.UNPACK_IMAGE_HEIGHT,b),V.pixelStorei(z.UNPACK_SKIP_PIXELS,x),V.pixelStorei(z.UNPACK_SKIP_ROWS,S),V.pixelStorei(z.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&z.generateMipmap(v),V.unbindTexture()},this.initRenderTarget=function(e){H.get(e).__webglFramebuffer===void 0&&U.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?U.setTextureCube(e,0):e.isData3DTexture?U.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?U.setTexture2DArray(e,0):U.setTexture2D(e,0),V.unbindTexture()},this.resetState=function(){oe=0,I=0,L=null,V.reset(),Ze.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Ge}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=zt._getDrawingBufferColorSpace(e),t.unpackColorSpace=zt._getUnpackColorSpace()}},Fd={type:`change`},Id={type:`start`},Ld={type:`end`},Rd=new ci,zd=new Ii,Bd=Math.cos(70*At.DEG2RAD),Vd=new q,Hd=2*Math.PI,Ud={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},Wd=1e-6,Gd=class extends hc{constructor(e,t=null){super(e,t),this.state=Ud.NONE,this.target=new q,this.cursor=new q,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.keyRotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:`ArrowLeft`,UP:`ArrowUp`,RIGHT:`ArrowRight`,BOTTOM:`ArrowDown`},this.mouseButtons={LEFT:i.ROTATE,MIDDLE:i.DOLLY,RIGHT:i.PAN},this.touches={ONE:a.ROTATE,TWO:a.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._cursorStyle=`auto`,this._domElementKeyEvents=null,this._lastPosition=new q,this._lastQuaternion=new jt,this._lastTargetPosition=new q,this._quat=new jt().setFromUnitVectors(e.up,new q(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new fc,this._sphericalDelta=new fc,this._scale=1,this._panOffset=new q,this._rotateStart=new K,this._rotateEnd=new K,this._rotateDelta=new K,this._panStart=new K,this._panEnd=new K,this._panDelta=new K,this._dollyStart=new K,this._dollyEnd=new K,this._dollyDelta=new K,this._dollyDirection=new q,this._mouse=new K,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=qd.bind(this),this._onPointerDown=Kd.bind(this),this._onPointerUp=Jd.bind(this),this._onContextMenu=tf.bind(this),this._onMouseWheel=Zd.bind(this),this._onKeyDown=Qd.bind(this),this._onTouchStart=$d.bind(this),this._onTouchMove=ef.bind(this),this._onMouseDown=Yd.bind(this),this._onMouseMove=Xd.bind(this),this._interceptControlDown=nf.bind(this),this._interceptControlUp=rf.bind(this),this.domElement!==null&&this.connect(this.domElement),this.update()}set cursorStyle(e){this._cursorStyle=e,e===`grab`?this.domElement.style.cursor=`grab`:this.domElement.style.cursor=`auto`}get cursorStyle(){return this._cursorStyle}connect(e){super.connect(e),this.domElement.addEventListener(`pointerdown`,this._onPointerDown),this.domElement.addEventListener(`pointercancel`,this._onPointerUp),this.domElement.addEventListener(`contextmenu`,this._onContextMenu),this.domElement.addEventListener(`wheel`,this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener(`keydown`,this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction=`none`}disconnect(){this.domElement.removeEventListener(`pointerdown`,this._onPointerDown),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.domElement.removeEventListener(`pointercancel`,this._onPointerUp),this.domElement.removeEventListener(`wheel`,this._onMouseWheel),this.domElement.removeEventListener(`contextmenu`,this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener(`keydown`,this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction=``}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(e){e.addEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=e}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener(`keydown`,this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Fd),this.update(),this.state=Ud.NONE}pan(e,t){this._pan(e,t),this.update()}dollyIn(e){this._dollyIn(e),this.update()}dollyOut(e){this._dollyOut(e),this.update()}rotateLeft(e){this._rotateLeft(e),this.update()}rotateUp(e){this._rotateUp(e),this.update()}update(e=null){let t=this.object.position;Vd.copy(t).sub(this.target),Vd.applyQuaternion(this._quat),this._spherical.setFromVector3(Vd),this.autoRotate&&this.state===Ud.NONE&&this._rotateLeft(this._getAutoRotationAngle(e)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let n=this.minAzimuthAngle,r=this.maxAzimuthAngle;isFinite(n)&&isFinite(r)&&(n<-Math.PI?n+=Hd:n>Math.PI&&(n-=Hd),r<-Math.PI?r+=Hd:r>Math.PI&&(r-=Hd),n<=r?this._spherical.theta=Math.max(n,Math.min(r,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(n+r)/2?Math.max(n,this._spherical.theta):Math.min(r,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let i=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{let e=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),i=e!=this._spherical.radius}if(Vd.setFromSpherical(this._spherical),Vd.applyQuaternion(this._quatInverse),t.copy(this.target).add(Vd),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let e=null;if(this.object.isPerspectiveCamera){let t=Vd.length();e=this._clampDistance(t*this._scale);let n=t-e;this.object.position.addScaledVector(this._dollyDirection,n),this.object.updateMatrixWorld(),i=!!n}else if(this.object.isOrthographicCamera){let t=new q(this._mouse.x,this._mouse.y,0);t.unproject(this.object);let n=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),i=n!==this.object.zoom;let r=new q(this._mouse.x,this._mouse.y,0);r.unproject(this.object),this.object.position.sub(r).add(t),this.object.updateMatrixWorld(),e=Vd.length()}else console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled.`),this.zoomToCursor=!1;e!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position):(Rd.origin.copy(this.object.position),Rd.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(Rd.direction))<Bd?this.object.lookAt(this.target):(zd.setFromNormalAndCoplanarPoint(this.object.up,this.target),Rd.intersectPlane(zd,this.target))))}else if(this.object.isOrthographicCamera){let e=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),e!==this.object.zoom&&(this.object.updateProjectionMatrix(),i=!0)}return this._scale=1,this._performCursorZoom=!1,i||this._lastPosition.distanceToSquared(this.object.position)>Wd||8*(1-this._lastQuaternion.dot(this.object.quaternion))>Wd||this._lastTargetPosition.distanceToSquared(this.target)>Wd?(this.dispatchEvent(Fd),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(e){return e===null?Hd/60/60*this.autoRotateSpeed:Hd/60*this.autoRotateSpeed*e}_getZoomScale(e){let t=Math.abs(e*.01);return .95**(this.zoomSpeed*t)}_rotateLeft(e){this._sphericalDelta.theta-=e}_rotateUp(e){this._sphericalDelta.phi-=e}_panLeft(e,t){Vd.setFromMatrixColumn(t,0),Vd.multiplyScalar(-e),this._panOffset.add(Vd)}_panUp(e,t){this.screenSpacePanning===!0?Vd.setFromMatrixColumn(t,1):(Vd.setFromMatrixColumn(t,0),Vd.crossVectors(this.object.up,Vd)),Vd.multiplyScalar(e),this._panOffset.add(Vd)}_pan(e,t){let n=this.domElement;if(this.object.isPerspectiveCamera){let r=this.object.position;Vd.copy(r).sub(this.target);let i=Vd.length();i*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*e*i/n.clientHeight,this.object.matrix),this._panUp(2*t*i/n.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(e*(this.object.right-this.object.left)/this.object.zoom/n.clientWidth,this.object.matrix),this._panUp(t*(this.object.top-this.object.bottom)/this.object.zoom/n.clientHeight,this.object.matrix)):(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.`),this.enablePan=!1)}_dollyOut(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_dollyIn(e){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=e:(console.warn(`WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.`),this.enableZoom=!1)}_updateZoomParameters(e,t){if(!this.zoomToCursor)return;this._performCursorZoom=!0;let n=this.domElement.getBoundingClientRect(),r=e-n.left,i=t-n.top,a=n.width,o=n.height;this._mouse.x=r/a*2-1,this._mouse.y=-(i/o)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(e){return Math.max(this.minDistance,Math.min(this.maxDistance,e))}_handleMouseDownRotate(e){this._rotateStart.set(e.clientX,e.clientY)}_handleMouseDownDolly(e){this._updateZoomParameters(e.clientX,e.clientX),this._dollyStart.set(e.clientX,e.clientY)}_handleMouseDownPan(e){this._panStart.set(e.clientX,e.clientY)}_handleMouseMoveRotate(e){this._rotateEnd.set(e.clientX,e.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(Hd*this._rotateDelta.x/t.clientHeight),this._rotateUp(Hd*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(e){this._dollyEnd.set(e.clientX,e.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(e){this._panEnd.set(e.clientX,e.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(e){this._updateZoomParameters(e.clientX,e.clientY),e.deltaY<0?this._dollyIn(this._getZoomScale(e.deltaY)):e.deltaY>0&&this._dollyOut(this._getZoomScale(e.deltaY)),this.update()}_handleKeyDown(e){let t=!1;switch(e.code){case this.keys.UP:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(Hd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,this.keyPanSpeed),t=!0;break;case this.keys.BOTTOM:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateUp(-Hd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(0,-this.keyPanSpeed),t=!0;break;case this.keys.LEFT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(Hd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(this.keyPanSpeed,0),t=!0;break;case this.keys.RIGHT:e.ctrlKey||e.metaKey||e.shiftKey?this.enableRotate&&this._rotateLeft(-Hd*this.keyRotateSpeed/this.domElement.clientHeight):this.enablePan&&this._pan(-this.keyPanSpeed,0),t=!0;break}t&&(e.preventDefault(),this.update())}_handleTouchStartRotate(e){if(this._pointers.length===1)this._rotateStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateStart.set(n,r)}}_handleTouchStartPan(e){if(this._pointers.length===1)this._panStart.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panStart.set(n,r)}}_handleTouchStartDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyStart.set(0,i)}_handleTouchStartDollyPan(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enablePan&&this._handleTouchStartPan(e)}_handleTouchStartDollyRotate(e){this.enableZoom&&this._handleTouchStartDolly(e),this.enableRotate&&this._handleTouchStartRotate(e)}_handleTouchMoveRotate(e){if(this._pointers.length==1)this._rotateEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._rotateEnd.set(n,r)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);let t=this.domElement;this._rotateLeft(Hd*this._rotateDelta.x/t.clientHeight),this._rotateUp(Hd*this._rotateDelta.y/t.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(e){if(this._pointers.length===1)this._panEnd.set(e.pageX,e.pageY);else{let t=this._getSecondPointerPosition(e),n=.5*(e.pageX+t.x),r=.5*(e.pageY+t.y);this._panEnd.set(n,r)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(e){let t=this._getSecondPointerPosition(e),n=e.pageX-t.x,r=e.pageY-t.y,i=Math.sqrt(n*n+r*r);this._dollyEnd.set(0,i),this._dollyDelta.set(0,(this._dollyEnd.y/this._dollyStart.y)**+this.zoomSpeed),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);let a=(e.pageX+t.x)*.5,o=(e.pageY+t.y)*.5;this._updateZoomParameters(a,o)}_handleTouchMoveDollyPan(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enablePan&&this._handleTouchMovePan(e)}_handleTouchMoveDollyRotate(e){this.enableZoom&&this._handleTouchMoveDolly(e),this.enableRotate&&this._handleTouchMoveRotate(e)}_addPointer(e){this._pointers.push(e.pointerId)}_removePointer(e){delete this._pointerPositions[e.pointerId];for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId){this._pointers.splice(t,1);return}}_isTrackingPointer(e){for(let t=0;t<this._pointers.length;t++)if(this._pointers[t]==e.pointerId)return!0;return!1}_trackPointer(e){let t=this._pointerPositions[e.pointerId];t===void 0&&(t=new K,this._pointerPositions[e.pointerId]=t),t.set(e.pageX,e.pageY)}_getSecondPointerPosition(e){let t=e.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[t]}_customWheelEvent(e){let t=e.deltaMode,n={clientX:e.clientX,clientY:e.clientY,deltaY:e.deltaY};switch(t){case 1:n.deltaY*=16;break;case 2:n.deltaY*=100;break}return e.ctrlKey&&!this._controlActive&&(n.deltaY*=10),n}};function Kd(e){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(e.pointerId),this.domElement.ownerDocument.addEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.addEventListener(`pointerup`,this._onPointerUp)),!this._isTrackingPointer(e)&&(this._addPointer(e),e.pointerType===`touch`?this._onTouchStart(e):this._onMouseDown(e),this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grabbing`)))}function qd(e){this.enabled!==!1&&(e.pointerType===`touch`?this._onTouchMove(e):this._onMouseMove(e))}function Jd(e){switch(this._removePointer(e),this._pointers.length){case 0:this.domElement.releasePointerCapture(e.pointerId),this.domElement.ownerDocument.removeEventListener(`pointermove`,this._onPointerMove),this.domElement.ownerDocument.removeEventListener(`pointerup`,this._onPointerUp),this.dispatchEvent(Ld),this.state=Ud.NONE,this._cursorStyle===`grab`&&(this.domElement.style.cursor=`grab`);break;case 1:let t=this._pointers[0],n=this._pointerPositions[t];this._onTouchStart({pointerId:t,pageX:n.x,pageY:n.y});break}}function Yd(e){let t;switch(e.button){case 0:t=this.mouseButtons.LEFT;break;case 1:t=this.mouseButtons.MIDDLE;break;case 2:t=this.mouseButtons.RIGHT;break;default:t=-1}switch(t){case i.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(e),this.state=Ud.DOLLY;break;case i.ROTATE:if(e.ctrlKey||e.metaKey||e.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(e),this.state=Ud.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(e),this.state=Ud.ROTATE}break;case i.PAN:if(e.ctrlKey||e.metaKey||e.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(e),this.state=Ud.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(e),this.state=Ud.PAN}break;default:this.state=Ud.NONE}this.state!==Ud.NONE&&this.dispatchEvent(Id)}function Xd(e){switch(this.state){case Ud.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(e);break;case Ud.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(e);break;case Ud.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(e);break}}function Zd(e){this.enabled===!1||this.enableZoom===!1||this.state!==Ud.NONE||(e.preventDefault(),this.dispatchEvent(Id),this._handleMouseWheel(this._customWheelEvent(e)),this.dispatchEvent(Ld))}function Qd(e){this.enabled!==!1&&this._handleKeyDown(e)}function $d(e){switch(this._trackPointer(e),this._pointers.length){case 1:switch(this.touches.ONE){case a.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(e),this.state=Ud.TOUCH_ROTATE;break;case a.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(e),this.state=Ud.TOUCH_PAN;break;default:this.state=Ud.NONE}break;case 2:switch(this.touches.TWO){case a.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(e),this.state=Ud.TOUCH_DOLLY_PAN;break;case a.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(e),this.state=Ud.TOUCH_DOLLY_ROTATE;break;default:this.state=Ud.NONE}break;default:this.state=Ud.NONE}this.state!==Ud.NONE&&this.dispatchEvent(Id)}function ef(e){switch(this._trackPointer(e),this.state){case Ud.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(e),this.update();break;case Ud.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(e),this.update();break;case Ud.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(e),this.update();break;case Ud.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(e),this.update();break;default:this.state=Ud.NONE}}function tf(e){this.enabled!==!1&&e.preventDefault()}function nf(e){e.key===`Control`&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function rf(e){e.key===`Control`&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener(`keyup`,this._interceptControlUp,{passive:!0,capture:!0}))}function af(e,t=!1){let n=e[0].index!==null,r=new Set(Object.keys(e[0].attributes)),i=new Set(Object.keys(e[0].morphAttributes)),a={},o={},s=e[0].morphTargetsRelative,c=new Nr,l=0;for(let u=0;u<e.length;++u){let d=e[u],f=0;if(n!==(d.index!==null))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure index attribute exists among all geometries, or in none of them.`),null;for(let e in d.attributes){if(!r.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. All geometries must have compatible attributes; make sure "`+e+`" attribute exists among all geometries, or in none of them.`),null;a[e]===void 0&&(a[e]=[]),a[e].push(d.attributes[e]),f++}if(f!==r.size)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. Make sure all geometries have the same number of attributes.`),null;if(s!==d.morphTargetsRelative)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. .morphTargetsRelative must be consistent throughout all geometries.`),null;for(let e in d.morphAttributes){if(!i.has(e))return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`.  .morphAttributes must be consistent throughout all geometries.`),null;o[e]===void 0&&(o[e]=[]),o[e].push(d.morphAttributes[e])}if(t){let e;if(n)e=d.index.count;else if(d.attributes.position!==void 0)e=d.attributes.position.count;else return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed with geometry at index `+u+`. The geometry must have either an index or a position attribute`),null;c.addGroup(l,e,u),l+=e}}if(n){let t=0,n=[];for(let r=0;r<e.length;++r){let i=e[r].index;for(let e=0;e<i.count;++e)n.push(i.getX(e)+t);t+=e[r].attributes.position.count}c.setIndex(n)}for(let e in a){let t=of(a[e]);if(!t)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` attribute.`),null;c.setAttribute(e,t)}for(let e in o){let t=o[e][0].length;if(t!==0){c.morphAttributes=c.morphAttributes||{},c.morphAttributes[e]=[];for(let n=0;n<t;++n){let t=[];for(let r=0;r<o[e].length;++r)t.push(o[e][r][n]);let r=of(t);if(!r)return console.error(`THREE.BufferGeometryUtils: .mergeGeometries() failed while trying to merge the `+e+` morphAttribute.`),null;c.morphAttributes[e].push(r)}}}return c}function of(e){let t,n,r,i=-1,a=0;for(let o=0;o<e.length;++o){let s=e[o];if(t===void 0&&(t=s.array.constructor),t!==s.array.constructor)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.array must be of consistent array types across matching attributes.`),null;if(n===void 0&&(n=s.itemSize),n!==s.itemSize)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.itemSize must be consistent across matching attributes.`),null;if(r===void 0&&(r=s.normalized),r!==s.normalized)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.normalized must be consistent across matching attributes.`),null;if(i===-1&&(i=s.gpuType),i!==s.gpuType)return console.error(`THREE.BufferGeometryUtils: .mergeAttributes() failed. BufferAttribute.gpuType must be consistent across matching attributes.`),null;a+=s.count*n}let o=new t(a),s=new vr(o,n,r),c=0;for(let t=0;t<e.length;++t){let r=e[t];if(r.isInterleavedBufferAttribute){let e=c/n;for(let t=0,i=r.count;t<i;t++)for(let i=0;i<n;i++){let n=r.getComponent(t,i);s.setComponent(t+e,i,n)}}else o.set(r.array,c);c+=r.count*n}return i!==void 0&&(s.gpuType=i),s}var $=n();function sf(e,t){let n=document.createElement(`canvas`);n.width=420,n.height=82;let r=n.getContext(`2d`);r.fillStyle=`rgba(4,15,22,.88)`,r.fillRect(0,0,420,82),r.strokeStyle=t,r.lineWidth=3,r.strokeRect(2,2,416,78),r.fillStyle=`#e9fbff`,r.font=`600 29px Microsoft YaHei, sans-serif`,r.fillText(e,22,52);let i=new ca(n);i.colorSpace=Re;let a=new $r(new zr({map:i,transparent:!0,depthTest:!1}));return a.scale.set(17,3.3,1),a}function cf(e,t,n,r,i,a,o){let s=new An;s.position.set(i,0,a),s.userData.asset=n;let c=new Y(new pa(.22,.28,4.8,12),new Z({color:o,emissive:o,emissiveIntensity:.25}));c.position.y=2.4,c.castShadow=!0;let l=new Y(new Ho(.8,18,12),new Z({color:o,emissive:o,emissiveIntensity:.8}));l.position.y=5.2,l.userData.asset=n;let u=new Y(new Vo(1.05,1.3,32),new li({color:o,transparent:!0,opacity:.65,side:2}));u.rotation.x=-Math.PI/2,u.position.y=.15;let d=sf(r,`#${o.toString(16).padStart(6,`0`)}`);return d.position.set(0,7.1,0),s.add(c,l,u,d),e.add(s),t.push(l),s}function lf(e,t){let n=new Y(new Wo(new Aa(e),48,.18,8,!1),new li({color:t,transparent:!0,opacity:.92}));return n.position.y=.3,n}function uf({running:e,blocked:t,blockedRoadId:n,showRisk:i,topView:a,nightMode:c,buildingLights:l,autoTour:u,suspended:d,scenarioPhase:f,scenarioTime:p,trafficDensity:m,onSelect:h,onRealRoute:g,onSceneStatus:_,plume:v}){let y=(0,r.useRef)(null),b=(0,r.useRef)(e),x=(0,r.useRef)(h),S=(0,r.useRef)(g),C=(0,r.useRef)(_),w=(0,r.useRef)(null),T=(0,r.useRef)(null),E=(0,r.useRef)([]),D=(0,r.useRef)(null),O=(0,r.useRef)([[1,1],[1,1],[1,1]]),k=(0,r.useRef)([]),A=(0,r.useRef)(t),ee=(0,r.useRef)(n),j=(0,r.useRef)(()=>{}),M=(0,r.useRef)(f),N=(0,r.useRef)(p),P=(0,r.useRef)(m),F=(0,r.useRef)(u),te=(0,r.useRef)(d),ne=(0,r.useRef)(i),re=(0,r.useRef)(c),ie=(0,r.useRef)(l),ae=(0,r.useRef)(()=>{});return(0,r.useEffect)(()=>{b.current=e},[e]),(0,r.useEffect)(()=>{x.current=h,S.current=g,C.current=_},[h,g,_]),(0,r.useEffect)(()=>{re.current=c,ie.current=l,ae.current(c)},[c,l]),(0,r.useEffect)(()=>{F.current=u},[u]),(0,r.useEffect)(()=>{te.current=d},[d]),(0,r.useEffect)(()=>{M.current=f,N.current=p},[f,p]),(0,r.useEffect)(()=>{P.current=m},[m]),(0,r.useEffect)(()=>{ne.current=i,E.current.forEach(e=>e.visible=i)},[i]),(0,r.useEffect)(()=>{A.current=t,ee.current=n,j.current(t,n)},[t,n]),(0,r.useEffect)(()=>{O.current=[[v.warning,v.warningWidth],[v.high,v.highWidth],[v.lethal,v.lethalWidth]].map(([e,t])=>[Math.max(1,e/80),Math.max(.8,t/80)]),E.current.forEach((e,t)=>{e.position.x=-3+O.current[t][0],e.position.z=-3+O.current[t][0]*.42})},[v]),(0,r.useEffect)(()=>{let e=w.current,t=T.current;!e||!t||(a?(e.position.set(0,172,.1),t.target.set(0,0,0)):(e.position.set(92,100,108),t.target.set(0,6,0)),t.update())},[a]),(0,r.useEffect)(()=>{C.current?.(`loading`);let e=y.current,t=new zn;t.background=new J(9160677),t.fog=new Rn(12113887,.0038);let n=new $o({side:1,depthWrite:!1,uniforms:{top:{value:new J(6860768)},horizon:{value:new J(14872304)}},vertexShader:`varying vec3 vPos;void main(){vPos=position;gl_Position=projectionMatrix*modelViewMatrix*vec4(position,1.0);}`,fragmentShader:`uniform vec3 top;uniform vec3 horizon;varying vec3 vPos;void main(){float h=smoothstep(-.08,.55,normalize(vPos).y);gl_FragColor=vec4(mix(horizon,top,h),1.0);}`}),r=new Y(new Ho(310,32,18),n);t.add(r);let i=new zs(45,1,.1,700);i.position.set(92,100,108),w.current=i;let a=new Pd({antialias:!0,alpha:!1,powerPreference:`high-performance`});a.setPixelRatio(Math.min(devicePixelRatio||1,1.4)),a.shadowMap.enabled=!0,a.shadowMap.type=2,a.shadowMap.autoUpdate=!1,a.outputColorSpace=Re,a.toneMapping=4,a.toneMappingExposure=1.08,e.appendChild(a.domElement);let c=document.createElement(`div`);c.className=`scene-hover-tip`,e.appendChild(c);let l=new Gd(i,a.domElement);l.enableDamping=!0,l.dampingFactor=.075,l.minDistance=32,l.maxDistance=220,l.maxPolarAngle=Math.PI/2.08,l.target.set(0,6,0),T.current=l;let u=new Ds(12577535,5399118,2.8);t.add(u);let d=new Ws(16773586,3.1);d.position.set(-35,65,28),d.castShadow=!0,d.shadow.mapSize.set(1024,1024),d.shadow.bias=-25e-5,d.shadow.normalBias=.035,d.shadow.camera.left=-75,d.shadow.camera.right=75,d.shadow.camera.top=75,d.shadow.camera.bottom=-75,t.add(d);let f=new An;f.name=`北京城市远景`,t.add(f);let p=new Y(new fa(385,96),new Z({color:727840,roughness:.96,metalness:.02}));p.rotation.x=-Math.PI/2,p.position.y=-.7,f.add(p);let m=new X(1,1,1),h=new Z({color:1781816,roughness:.72,metalness:.2,emissive:663592,emissiveIntensity:.42}),g=new Mi(m,h,132),_=new tn,v=new jt,oe=new q,I=new q,L=new li({color:14132830,transparent:!0,opacity:.08}),se=new Mi(new X(1,1,.04),L,396),ce=0;for(let e=0;e<132;e++){let t=e*2.3999632297,n=278+e*17%35,r=3.4+e*13%45/10,i=3.2+e*7%24/10,a=7+e*29%250/10;I.set(Math.cos(t)*n,a/2-.6,Math.sin(t)*n),v.setFromAxisAngle(new q(0,1,0),Math.PI/2-t),oe.set(r,a,i),_.compose(I,v,oe),g.setMatrixAt(e,_),g.setColorAt(e,new J(e%4==0?2374467:e%3==0?1650230:2110523));for(let e=1;e<=3;e++)I.set(Math.cos(t)*(n-i*.51),e/4*a-.4,Math.sin(t)*(n-i*.51)),oe.set(r*.72,.08,1),_.compose(I,v,oe),se.setMatrixAt(ce++,_)}g.instanceMatrix.needsUpdate=!0,se.instanceMatrix.needsUpdate=!0,f.add(g,se);let le=new Y(new pa(265,325,38,96,1,!0),new li({color:3629931,transparent:!0,opacity:.07,side:2,depthWrite:!1}));le.position.y=14,f.add(le);let ue=document.createElement(`canvas`);ue.width=256,ue.height=256;let de=ue.getContext(`2d`),fe=de.createRadialGradient(128,128,8,128,128,122);fe.addColorStop(0,`rgba(255,244,198,1)`),fe.addColorStop(.22,`rgba(255,185,94,.75)`),fe.addColorStop(1,`rgba(255,133,66,0)`),de.fillStyle=fe,de.fillRect(0,0,256,256);let pe=new $r(new zr({map:new ca(ue),transparent:!0,depthWrite:!1,opacity:.72}));pe.position.set(-155,82,-188),pe.scale.set(38,38,1),f.add(pe);let me=document.createElement(`canvas`);me.width=256,me.height=256;let he=me.getContext(`2d`),ge=he.createRadialGradient(128,128,12,128,128,122);ge.addColorStop(0,`rgba(235,247,255,1)`),ge.addColorStop(.2,`rgba(174,207,235,.72)`),ge.addColorStop(1,`rgba(103,158,211,0)`),he.fillStyle=ge,he.fillRect(0,0,256,256);let _e=new $r(new zr({map:new ca(me),transparent:!0,depthWrite:!1,opacity:.8}));_e.position.set(150,96,-188),_e.scale.set(30,30,1),_e.visible=!1,f.add(_e);let ve=[];for(let e=0;e<420;e++){let t=e*2.3999632297,n=.14+e*37%80/100*Math.PI*.36;ve.push(Math.cos(t)*Math.cos(n)*275,Math.sin(n)*275,Math.sin(t)*Math.cos(n)*275)}let ye=new Nr;ye.setAttribute(`position`,new xr(ve,3));let be=new aa(ye,new ea({color:14216703,size:.72,transparent:!0,opacity:.76,depthWrite:!1}));be.visible=!1,f.add(be);let R=new Ts().load(`./beijing-map-base.jpg`);R.colorSpace=Re,R.anisotropy=a.capabilities.getMaxAnisotropy(),R.wrapS=R.wrapT=s;let xe=new Z({map:R,roughness:.92,metalness:.04,color:11451314}),Se=new Y(new Bo(360,360),xe);Se.rotation.x=-Math.PI/2,Se.receiveShadow=!0,t.add(Se);let Ce=new pc(360,72,5102056,5337207);Ce.position.y=.035,Ce.material.transparent=!0,Ce.material.opacity=.045,t.add(Ce);let we=new An;we.name=`北京真实建筑群`,t.add(we);let Te=new An;Te.name=`北京真实道路立体层`,t.add(Te);let Ee=[],De=[],Oe=[4283235,6385781,3493465,9142900,4810349,6119778],ke=[11643549,9869712,12629411,9015181,10787467],z=[6320245,7043192,5399658],Ae=e=>{let t=25.6,n=document.createElement(`canvas`);n.width=256,n.height=256;let r=n.getContext(`2d`),i=[`#18333d`,`#8d897f`,`#243f49`,`#9b9182`,`#314a54`],s=r.createLinearGradient(0,0,256,256);s.addColorStop(0,i[e%5]),s.addColorStop(.55,e===1||e===3?`#77746d`:`#142b35`),s.addColorStop(1,e===4?`#52606a`:i[e%5]),r.fillStyle=s,r.fillRect(0,0,256,256);for(let n=0;n<10;n++)for(let i=0;i<8;i++){let a=i*32,o=n*t,s=a+5,c=o+4,l=e===2?20:22,u=e===4?19:17;if(e===1)r.fillStyle=n%2?`#8f8b81`:`#a19b90`,r.fillRect(a+1,o+1,30,t-3),r.fillStyle=`#30474e`,r.fillRect(s+2,c+2,l-4,u-6),r.fillStyle=`rgba(220,218,203,.7)`,r.fillRect(a,c+18,32,3),r.fillStyle=`rgba(61,67,65,.45)`,r.fillRect(a,c+21,32,2);else if(e===3)r.fillStyle=(n+i)%2?`#8d8578`:`#a19787`,r.fillRect(a+1,o+1,30,t-2),r.fillStyle=`#3a5259`,r.fillRect(s+2,c+2,l-5,u-6),r.fillStyle=`rgba(77,66,55,.28)`,r.fillRect(a,o,2,t);else{let t=r.createLinearGradient(s,c,s+l,c+u);t.addColorStop(0,e===4?`#7e9da7`:`#79b7c4`),t.addColorStop(.42,`#193b47`),t.addColorStop(.72,`#315e69`),t.addColorStop(1,`#9ac6cc`),r.fillStyle=t,r.fillRect(s,c,l,u),r.fillStyle=`rgba(229,249,250,.28)`,r.fillRect(s+2,c+2,2,u-4),r.fillStyle=`rgba(9,30,38,.4)`,r.fillRect(s+l-2,c+1,2,u-2),r.fillRect(s+1,c+u-2,l-2,2)}(n*13+i*7+e*5)%17<3&&(r.fillStyle=(n+i)%2?`rgba(255,214,139,.74)`:`rgba(194,232,244,.56)`,r.fillRect(s+4,c+3,Math.max(8,l-8),Math.max(7,u-8)))}r.strokeStyle=e===1||e===3?`rgba(63,61,56,.34)`:`rgba(142,200,209,.4)`,r.lineWidth=e===2?2.5:1.2;for(let e=0;e<=256;e+=32)r.beginPath(),r.moveTo(e,0),r.lineTo(e,256),r.stroke();for(let e=0;e<=256;e+=t)r.beginPath(),r.moveTo(0,e),r.lineTo(256,e),r.stroke();if(e!==1&&e!==3){let e=r.createLinearGradient(0,0,256,0);e.addColorStop(.18,`rgba(255,255,255,0)`),e.addColorStop(.42,`rgba(205,241,246,.14)`),e.addColorStop(.55,`rgba(255,255,255,.27)`),e.addColorStop(.7,`rgba(255,255,255,0)`),r.save(),r.translate(50,-30),r.rotate(.28),r.fillStyle=e,r.fillRect(0,0,170,330),r.restore()}for(let t=0;t<180;t++){let n=(t*73+e*31)%256,i=(t*47+e*19)%256;r.fillStyle=t%3?`rgba(255,255,255,.025)`:`rgba(0,0,0,.035)`,r.fillRect(n,i,1,1)}let c=new ca(n);return c.colorSpace=Re,c.wrapS=c.wrapT=o,c.repeat.set(.38,.74),c.anisotropy=a.capabilities.getMaxAnisotropy(),c},B=()=>{let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`);t.fillStyle=`#4a5a5e`,t.fillRect(0,0,128,128),t.strokeStyle=`rgba(163,194,197,.22)`,t.lineWidth=2;for(let e=0;e<128;e+=16)t.beginPath(),t.moveTo(e,0),t.lineTo(e,128),t.stroke(),t.beginPath(),t.moveTo(0,e),t.lineTo(128,e),t.stroke();t.fillStyle=`rgba(17,40,46,.6)`,t.fillRect(42,42,44,44),t.strokeStyle=`rgba(194,220,221,.38)`,t.strokeRect(45,45,38,38);let n=new ca(e);return n.colorSpace=Re,n.wrapS=n.wrapT=o,n.repeat.set(.08,.08),n.anisotropy=a.capabilities.getMaxAnisotropy(),n},je=e=>{let t=document.createElement(`canvas`);t.width=256,t.height=256;let n=t.getContext(`2d`);n.fillStyle=`#000`,n.fillRect(0,0,256,256);for(let t=0;t<10;t++)for(let r=0;r<8;r++){let i=r*32+5,a=t*25.6+4,o=e===2?20:22,s=e===4?19:17,c=(t*13+r*7+e*5)%17;c<7&&(n.fillStyle=c%3==0?`#bfe9ff`:c%3==1?`#ffd58a`:`#fff0c5`,n.fillRect(i+4,a+3,Math.max(8,o-8),Math.max(7,s-8)))}let r=new ca(t);return r.colorSpace=Re,r.wrapS=r.wrapT=o,r.repeat.set(.38,.74),r.anisotropy=a.capabilities.getMaxAnisotropy(),r},V=[0,1,2,3,4].map(Ae),Me=[0,1,2,3,4].map(je),H=B(),U=[],Ne=new Set,Pe=[],Fe=[],Ie=[],Le=null,ze=e=>{let r=ie.current;t.background=new J(e?198934:9160677),t.fog=new Rn(e?463901:12113887,e?.0045:.0038),n.uniforms.top.value.set(e?198679:6860768),n.uniforms.horizon.value.set(e?1059386:14872304),u.color.set(e?7509178:12577535),u.groundColor.set(e?1121050:5399118),u.intensity=e?1.15:2.8,d.color.set(e?9547474:16773586),d.intensity=e?1.35:3.1,a.toneMappingExposure=e?.72:1.08,pe.visible=!e,_e.visible=e,be.visible=e,L.opacity=e&&r?.68:.06,L.needsUpdate=!0,le.material.color.set(e?1787222:10867416),le.material.opacity=e?.07:.11,xe.color.set(e?9149849:11451314),h.color.set(e?1781816:6321274),h.emissiveIntensity=e&&r?.42:.06,U.forEach(t=>t.emissiveIntensity=Ne.has(t)?1.28:r?e?.96:.08:.015),Pe.forEach(t=>{t.opacity=e&&r?.9:r?.1:0,t.needsUpdate=!0}),Fe.forEach(t=>t.intensity=e&&r?2.4:0),Ie.forEach(t=>{t.material.opacity=e?1:t.day,t.material.needsUpdate=!0}),Le&&(Le.opacity=e?1:.12)};ae.current=ze,ze(re.current);let Be=[],Ve=[],He=[],Ue=[new q(-64.181,.4,-2.804),new q(-34,.4,-5),new q(-3,.4,-3)],We=[new q(-32.836,.4,28.859),new q(-20,.4,16),new q(-3,.4,-3)],Ge=[new q(19.766,.4,-19.999),new q(11,.4,-13),new q(-3,.4,-3)],Ke=lf(Ue,15779919),qe=lf(We,5039025),Je=lf(Ge,4887039);Ke.visible=!1,qe.visible=!1,Je.visible=!1,t.add(Ke,qe,Je);let Ye=new AbortController,Xe=null,Ze=null;fetch(`./beijing-buildings.json`,{signal:Ye.signal}).then(e=>{if(!e.ok)throw Error(`地图数据响应异常：${e.status}`);return e.json()}).then(e=>{if(!Array.isArray(e.buildings)||!Array.isArray(e.roads))throw Error(`地图数据结构异常`);let n=new Map,r=new Map,i=(e,t)=>`${e.toFixed(3)},${t.toFixed(3)}`,a=e=>{let t=new Ya;for(let n=1;n<e.length;n++)t.add(new Wa(e[n-1],e[n]));return t};e.roads.forEach(e=>{for(let t=0;t<e.points.length;t++){let[a,o]=e.points[t],s=i(a,o);if(n.set(s,{x:a,z:o}),r.has(s)||r.set(s,[]),t===0)continue;let[c,l]=e.points[t-1],u=i(c,l),d=Math.hypot(a-c,o-l);r.get(u).push({to:s,cost:d,roadId:e.id,name:e.name}),r.get(s).push({to:u,cost:d,roadId:e.id,name:e.name})}});let o=e=>{let t=``,r=1/0;return n.forEach((n,i)=>{let a=Math.hypot(n.x-e.x,n.z-e.z);a<r&&(t=i,r=a)}),t},s=o({x:-35,z:-30}),c=o({x:-3,z:-3}),l=e=>{let t=new Set([s]),i=new Map,a=new Map([[s,0]]),o=new Map([[s,Math.hypot(n.get(s).x-n.get(c).x,n.get(s).z-n.get(c).z)]]),l=0;for(;t.size;){let s=``,u=1/0;if(t.forEach(e=>{let t=o.get(e)??1/0;t<u&&(u=t,s=e)}),l++,s===c){let e=[s],t=[];for(;i.has(s);){let n=i.get(s);t.unshift(n.edge),s=n.from,e.unshift(s)}return{path:e.map(e=>n.get(e)),edges:t,distance:a.get(c)??0,visited:l}}t.delete(s);for(let l of r.get(s)||[]){if(e!==null&&l.roadId===e)continue;let r=(a.get(s)??1/0)+l.cost;if(r<(a.get(l.to)??1/0)){i.set(l.to,{from:s,edge:l}),a.set(l.to,r);let e=n.get(l.to),u=n.get(c);o.set(l.to,r+Math.hypot(e.x-u.x,e.z-u.z)),t.add(l.to)}}}return{path:[],edges:[],distance:1/0,visited:l}},u=(e,t,i)=>{let a=new Set([e]),o=new Map,s=new Map([[e,0]]),c=n.get(t),l=0;for(;a.size;){let e=``,u=1/0;if(a.forEach(t=>{let r=n.get(t),i=(s.get(t)??1/0)+Math.hypot(r.x-c.x,r.z-c.z);i<u&&(u=i,e=t)}),l++,e===t){let r=[e],i=[];for(;o.has(e);){let t=o.get(e);i.unshift(t.edge),e=t.from,r.unshift(e)}return{path:r.map(e=>n.get(e)),edges:i,distance:s.get(t)??0,visited:l}}a.delete(e);for(let t of r.get(e)||[]){if(i!==null&&t.roadId===i)continue;let n=(s.get(e)??1/0)+t.cost;n<(s.get(t.to)??1/0)&&(o.set(t.to,{from:e,edge:t}),s.set(t.to,n),a.add(t.to))}}return{path:[],edges:[],distance:1/0,visited:l}},d=(e,t)=>{if(t.length<2)return;e.geometry.dispose();let n=t.map(e=>new q(e.x,.42,e.z));e.geometry=new Wo(a(n),Math.min(360,Math.max(60,n.length*3)),.13,7,!1)},f=l(null),p=(f.edges.find((e,t)=>t>f.edges.length*.45&&t<f.edges.length*.72&&e.name===`东二环`)||f.edges[Math.floor(f.edges.length*.58)])?.roadId??null,m=u(o({x:-64.181,z:-2.804}),c,null),h=u(o({x:-32.836,z:28.859}),c,null),g=u(o({x:19.766,z:-19.999}),c,null);Be=m.path,Ve=h.path,He=g.path,d(Ke,Be),d(qe,Ve),d(Je,He);let _=(e,t)=>{let n=e?t??p:null,r=e?l(n):f,i=r.path.length>1?r:f;k.current=i.path;let o=i.path.map(e=>new q(e.x,.4,e.z)),s=D.current;s&&o.length>1&&(s.geometry.dispose(),s.geometry=new Wo(a(o),Math.min(420,Math.max(80,o.length*3)),.2,8,!1),s.material.color.set(e?5498792:2677231),s.visible=!0);let c=[...new Set(i.edges.map(e=>e.name).filter(Boolean))],u=Math.round(i.distance*15.2),d=i.path[0];d&&Xe&&(Xe.position.set(d.x,.65,d.z),Ze?.position&&(Ze.position.x=d.x,Ze.position.z=d.z)),Ze&&(Ze.details=`正在沿 OSM 真实道路中心线行驶：${c.slice(0,5).join(` → `)||`北京城市道路`}。`,Ze.meta=`真实路网 A* · ${i.path.length} 个道路节点 · ${u} 米${n?` · 已避开 OSM 道路 ${n}`:``}`),S.current?.({distance:u,eta:Math.max(4,Math.ceil(u/520)),visited:i.visited,roads:c.slice(0,6),blockedRoadId:n})};j.current=_,_(A.current,ee.current);let v=[[],[],[]],y=new Z({color:12107708,metalness:.28,roughness:.5}),b=new Z({color:4217698,metalness:.78,roughness:.22}),x=new Z({color:1588562,metalness:.66,roughness:.22,emissive:995394,emissiveIntensity:.16}),w=new Z({color:8688535,metalness:.5,roughness:.5}),T=new ts({color:7910851,metalness:.48,roughness:.11,transmission:.12,transparent:!0,opacity:.82,clearcoat:.72}),E=new Z({color:12503496,metalness:.76,roughness:.18}),O=new Z({color:11108431,metalness:.82,roughness:.2}),M=new Z({color:12038307,metalness:.08,roughness:.62}),N=new ts({color:7252149,metalness:.5,roughness:.1,transparent:!0,opacity:.76,clearcoat:.92,clearcoatRoughness:.08}),P=new Z({color:5206871,roughness:.92,metalness:0}),F=new Z({color:7827818,roughness:.72,metalness:.12}),te=new Z({color:5536859,roughness:.88}),ne=new Z({color:5796218,metalness:.64,roughness:.24,emissive:1589065,emissiveIntensity:.3}),ae=new ts({color:6066075,metalness:.56,roughness:.12,transparent:!0,opacity:.86,clearcoat:.88,emissive:2183003,emissiveIntensity:.44}),oe=new Z({color:7438467,metalness:.42,roughness:.52}),I=new li({color:16765578,transparent:!0,opacity:re.current&&ie.current?.9:.1}),L=new li({color:9366271,transparent:!0,opacity:re.current&&ie.current?.82:.08});Pe.push(I,L),e.buildings.forEach((e,n)=>{if(e.points.length<3)return;let r=new Za;e.points.forEach(([e,t],n)=>n?r.lineTo(e,-t):r.moveTo(e,-t)),r.closePath();let i=e.core&&e.height>2.4,a=new Io(r,{depth:e.height,bevelEnabled:i,bevelSize:i?.07:0,bevelThickness:i?.07:0,bevelSegments:1});if(a.rotateX(-Math.PI/2),!e.core){v[e.id%v.length].push(a);return}let o=[`apartments`,`residential`,`house`,`dormitory`].includes(e.type),s=e.height>8||[`office`,`commercial`,`retail`,`hotel`].includes(e.type),c=o||!s&&e.height<7.5,l=c?1:e.type===`hotel`?4:s?e.id%2?0:2:3,u=V[l],d=new ts({color:c?ke[e.id%ke.length]:Oe[e.id%Oe.length],map:u,bumpMap:u,bumpScale:s?.045:.11,emissiveMap:Me[l],roughness:s?.24:.64,metalness:s?.5:.12,clearcoat:s?.48:.08,clearcoatRoughness:s?.2:.62,reflectivity:s?.82:.28,emissive:e.id%3==0?16766624:13167871,emissiveIntensity:ie.current?re.current?.96:.08:.015});U.push(d);let f=new Z({color:z[e.id%z.length],map:H,bumpMap:H,bumpScale:.06,roughness:.74,metalness:.16}),p=e.points.reduce((t,n)=>[t[0]+n[0]/e.points.length,t[1]+n[1]/e.points.length],[0,0]),m={id:`building-${e.id}`,label:e.name||`北京建筑 ${e.id}`,category:`真实建筑 · ${{office:`写字楼`,commercial:`商业建筑`,retail:`商业综合体`,hotel:`酒店`,apartments:`住宅公寓`,residential:`住宅`,school:`教育建筑`,hospital:`医疗建筑`}[e.type]||`城市建筑`}`,details:`实际高度约 ${e.heightMeters.toFixed(1)} 米${e.levels?` · ${e.levels} 层`:``}。真实地图轮廓、高度与位置叠加精修幕墙、建筑收边及屋顶景观。`,meta:`OSM 建筑编号 ${e.id} · 精修立面 · 点击高亮 · 支持独立灯光控制`,action:`toggle-building-lights`,position:{x:p[0],y:Math.max(2,e.height*.55),z:p[1]}},h=new Y(a,[d,f]);h.name=m.label,h.userData={asset:m,isBuilding:!0},h.castShadow=e.height>4&&n%9==0,h.receiveShadow=!0,we.add(h),De.push(h);let g=e.points.map(e=>e[0]),_=e.points.map(e=>e[1]),S=Math.max(.45,Math.max(...g)-Math.min(...g)),C=Math.max(.45,Math.max(..._)-Math.min(..._));if(e.height>2.6&&S>.9&&n%6==0){let e=p[1]+Math.min(C*.53,3.8),t=Math.min(1.15,S*.35),n=new Y(new X(t,.78,.055),T);n.position.set(p[0],.42,e);let r=new Y(new X(Math.min(1.65,S*.5),.08,.58),E);r.position.set(p[0],.92,e+.2);let i=new Y(new X(Math.min(1.25,t*1.2),.055,.06),I);i.position.set(p[0],.86,e+.49);let a=[-.46,.46].map(n=>{let r=new Y(new pa(.035,.045,.9,8),E);return r.position.set(p[0]+n*t,.45,e+.4),r});we.add(n,r,i,...a)}if(s&&e.height>7&&S>2.2&&n%9==0){let t=p[1]+Math.min(C*.515,3.6),n=Math.min(e.height*.72,8);for(let e=-2;e<=2;e++){let r=new Y(new X(.055,n,.28),E);r.position.set(p[0]+e*Math.min(.48,S*.12),n/2+.8,t+.12),we.add(r)}}if(s&&e.height>8&&S>1.8&&n%15==0){let t=p[1]+Math.min(C*.52,3.7),n=Math.min(e.height*.82,11),r=Math.min(S*.36,2.1);[-1,1].forEach(e=>{let i=new Y(new X(.14,n,.2),N);i.position.set(p[0]+e*r,n/2+.45,t+.09);let a=new Y(new X(.22,.1,.27),O);a.position.set(p[0]+e*r,n+.48,t+.09),we.add(i,a)})}if(e.height>5.5&&S>1.7&&C>1.2&&n%16==0){let t=Math.min(S*.88,6.2),n=Math.min(C*.78,5.2),r=Math.min(3,Math.max(2,Math.floor(e.height/4)));for(let i=1;i<=r;i++){let a=e.height*i/(r+1),o=new Y(new X(t,.08,.1),i%2?M:O),s=o.clone(),c=new Y(new X(.1,.08,n),i%2?M:O),l=c.clone();o.position.set(p[0],a,p[1]+n/2),s.position.set(p[0],a,p[1]-n/2),c.position.set(p[0]+t/2,a,p[1]),l.position.set(p[0]-t/2,a,p[1]),we.add(o,s,c,l)}}if(c&&e.height>2.8&&n%13==0){let t=Math.min(6,Math.max(2,Math.round(e.height/1.15))),n=Math.min(S*.48,2.4),r=p[1]+Math.min(C*.53,3.7);for(let i=1;i<=t;i++){let a=e.height*i/(t+1),o=new Y(new X(n,.06,.3),y);o.position.set(p[0],a,r);let s=new Y(new X(n,.22,.025),b);s.position.set(p[0],a+.14,r+.15),we.add(o,s)}}if([`commercial`,`retail`,`hotel`,`office`].includes(e.type)&&e.height>3.5&&S>2&&n%12==0){let e=p[1]+Math.min(C*.54,3.9),t=Math.min(.72,S*.18),n=Math.min(.9,S*.22);[-1,0,1].forEach(r=>{let i=new Y(new X(t,.07,.5),r===0?O:E);i.rotation.x=-.08,i.position.set(p[0]+r*n,.78,e+.22);let a=new Y(new X(t*.82,.58,.045),T);a.position.set(p[0]+r*n,.38,e+.03),we.add(i,a)})}if(e.height>7&&n%5==0){let t=Math.min(1.05,e.height*.1),n=new Y(new X(Math.min(S*1.08,7.5),t,Math.min(C*1.08,7.5)),new Z({color:3491917,metalness:.3,roughness:.48,emissive:1586493,emissiveIntensity:.28}));n.position.set(p[0],t/2,p[1]),n.castShadow=!0,n.receiveShadow=!0,we.add(n);let r=new Y(new X(Math.min(S*.55,3.2),.14,.08),I);r.position.set(p[0],.42,p[1]+Math.min(C*.54,3.8)),we.add(r)}if(e.height>3.2&&n%3==0){let e=new $i(new ba(a,24),new Vi({color:7644848,transparent:!0,opacity:.2}));we.add(e)}if(e.height>6.5&&n%4==0){let t=new Y(new X(.95,.75,.95),new Z({color:6715259,metalness:.55,roughness:.45}));t.position.set(p[0],e.height+.38,p[1]),we.add(t);let n=Math.min(2.2,e.height*.12),r=new Y(new pa(.025,.045,n,6),new Z({color:12245984,emissive:6150632,emissiveIntensity:.35}));if(r.position.set(p[0],e.height+.75+n/2,p[1]),we.add(r),e.height>12){let t=new Y(new Ho(.075,10,8),new li({color:16730429}));t.position.set(p[0],e.height+.8+n,p[1]),we.add(t)}}if(e.height>2.2&&n%7==0){let t=new Y(new X(1.3,.42,.75),w);t.position.set(p[0]+.65,e.height+.22,p[1]-.35);let n=new Y(new Uo(.17,.025,6,14),b);n.rotation.x=Math.PI/2,n.position.set(p[0]+.65,e.height+.45,p[1]-.35),we.add(t,n)}if(e.height>4&&n%11==0){let t=new Y(new X(Math.min(1.6,S*.42),.06,.78),x);t.rotation.x=-.13,t.position.set(p[0]-.5,e.height+.16,p[1]+.25),we.add(t)}if(e.height>5&&S>1.8&&C>1.6&&n%23==0){let t=Math.min(S*.58,3.4),n=Math.min(C*.54,2.8),r=new Y(new X(t,.08,n),P);r.position.set(p[0],e.height+.13,p[1]),we.add(r),[-.32,0,.32].forEach((r,i)=>{let a=new Y(new pa(.16,.2,.18,8),F);a.position.set(p[0]+r*t,e.height+.25,p[1]+(i%2?.2:-.16)*n);let o=new Y(new zo(.25+i*.035,1),te);o.position.set(a.position.x,e.height+.56,a.position.z),we.add(a,o)})}if(e.height>11&&S>2.4&&C>2&&n%18==0){let t=Math.min(S*.62,4.5),n=Math.min(C*.58,3.8),r=new Y(new X(t,.13,n),M);r.position.set(p[0],e.height+.1,p[1]);let i=new Y(new X(t*.62,.08,n*.32),O);i.position.set(p[0],e.height+.78,p[1]);let a=[[-1,-1],[-1,1],[1,-1],[1,1]].map(([r,i])=>{let a=new Y(new X(.055,.65,.055),O);return a.position.set(p[0]+r*t*.29,e.height+.44,p[1]+i*n*.13),a});we.add(r,i,...a)}if(e.height>5&&n%17==0){let t=new Y(new pa(.34,.38,.52,16),new Z({color:9083291,metalness:.7,roughness:.34}));t.position.set(p[0]-.5,e.height+.28,p[1]-.35);let n=new Y(new Ho(.32,14,8,0,Math.PI*2,0,Math.PI/2),new Z({color:12766155,metalness:.72,roughness:.25,side:2}));n.rotation.z=-.55,n.position.set(p[0]+.45,e.height+.42,p[1]+.25),we.add(t,n)}if(e.height>8&&n%14==0){let t=Math.min(S*.7,4),n=Math.min(C*.7,4),r=p[1]+n*.5,i=new Y(new X(t,.045,.045),L);i.position.set(p[0],e.height+.18,r),we.add(i)}if(e.height>6&&Fe.length<12&&n%37==0){let e=p[1]+Math.min(C*.57,4.1),r=new Vs(n%2?16763001:12118527,re.current&&ie.current?2.4:0,10,2);r.position.set(p[0],1.25,e),Fe.push(r),t.add(r)}if(e.height>4&&n%19==0){let t=.22,n=Math.min(S*.72,4.2),r=Math.min(C*.72,4.2),i=new Y(new X(n,t,.08),oe),a=i.clone(),o=new Y(new X(.08,t,r),oe),s=o.clone();i.position.set(p[0],e.height+t/2,p[1]+r/2),a.position.set(p[0],e.height+t/2,p[1]-r/2),o.position.set(p[0]+n/2,e.height+t/2,p[1]),s.position.set(p[0]-n/2,e.height+t/2,p[1]),we.add(i,a,o,s)}if(e.height>12&&n%3==0){let t=Math.min(S*.5,2.8),n=Math.min(C*.5,2.8),r=e.id%3;if(r===0){let r=new Y(new X(t,.46,n),ne),i=new Y(new X(t*.68,.5,n*.68),ae);r.position.set(p[0],e.height+.23,p[1]),i.position.set(p[0],e.height+.71,p[1]),we.add(r,i)}else if(r===1){let n=new Y(new pa(t*.34,t*.46,.7,12),ae),r=new Y(new ma(t*.16,.75,8),O);n.position.set(p[0],e.height+.35,p[1]),r.position.set(p[0],e.height+1.05,p[1]),we.add(n,r)}else{let n=new Y(new ma(t*.48,1.05,4),ne),r=new Y(new Ho(.09,10,8),L);n.rotation.y=Math.PI/4,n.position.set(p[0],e.height+.52,p[1]),r.position.set(p[0],e.height+1.08,p[1]),we.add(n,r)}}}),v.forEach((e,t)=>{let n=new Z({color:Oe[(t+1)%Oe.length],map:V[t],bumpMap:V[t],bumpScale:.045,roughness:.46,metalness:.25,emissiveMap:Me[t],emissive:t%2?16766624:13167871,emissiveIntensity:ie.current?re.current?.72:.06:.012});U.push(n);for(let t=0;t<e.length;t+=650){let r=e.slice(t,t+650),i=af(r,!1);if(r.forEach(e=>e.dispose()),i){let e=new Y(i,n);e.receiveShadow=!0,we.add(e)}}});let se={trunk:new Z({color:12157528,roughness:.7,metalness:.06,emissive:3807754,emissiveIntensity:.16}),trunk_link:new Z({color:10253913,roughness:.74}),secondary:new Z({color:7243145,roughness:.78}),secondary_link:new Z({color:6059129,roughness:.8})},ce={trunk:[],trunk_link:[],secondary:[],secondary_link:[]},le=[];if((e.roads||[]).forEach((e,t)=>{if(e.points.length<2)return;let n=e.points.map(([e,t])=>new q(e,.13,t)),r=new Aa(n,!1,`centripetal`);if(ce[e.type]?.push(new Wo(r,Math.min(42,Math.max(6,n.length*3)),e.width,6,!1)),e.core&&e.name){let t=r.getPointAt(.5),i=new li({color:16731461,transparent:!0,opacity:.025,depthWrite:!1}),a=new Y(new Wo(r,Math.min(42,Math.max(6,n.length*3)),Math.max(.38,e.width*2.2),6,!1),i);a.userData={isRoad:!0,asset:{id:`road-${e.id}`,label:e.name,category:`真实道路 · 可交互封锁`,details:`道路类型：${e.type.includes(`trunk`)?`城市快速路`:`城市主干路`}。点击下方按钮可模拟封锁此道路，并触发应急车辆路径重规划。`,meta:`OSM 道路编号 ${e.id} · 实时交通状态：通行`,action:`block-road`,position:{x:t.x,y:1.2,z:t.z}}},Te.add(a),De.push(a)}if((e.type===`trunk`||e.type===`secondary`)&&t%2==0)for(let e=1;e<n.length-1&&le.length<84;e+=2)le.push(n[e]);if(n.length>2&&t%3==0&&Ee.length<54){let e=new An,t=Ee.length,i=t%7,a=i===1,o=i===2,s=i===3,c=i===4,l=i===5,u=i===6,d=a?`北京巡游出租车`:o?`城市 SUV`:s?`城市配送车`:c?`城市公交小巴`:l?`新能源掀背车`:u?`运动轿跑`:`城市轿车`,f=a?14006063:c?4032457:l?6666400:[14175555,15132900,3902916,2370097,11035964][t%5],p=c?.42:s?.35:o?.3:u?.2:.24,m=c?1.22:s?.96:o?.84:u?.86:.78,h=c?.46:o?.42:.38,g={id:`traffic-${t+1}`,label:`${d} ${String(t+1).padStart(2,`0`)}`,category:`实时交通 · 可跟随车辆`,details:`车牌 京A·${String(7318+t*137).slice(-4)} · 当前速度 ${36+t%7*4} km/h · 沿北京真实道路行驶。`,meta:`实时轨迹更新 · 点击下方按钮进入车辆跟随视角`,action:`follow-vehicle`,position:{x:n[0].x,y:1.2,z:n[0].z}},_=new Y(new X(h,p,m),new Z({color:f,metalness:c?.38:.58,roughness:c?.34:.26}));_.position.y=.25,_.castShadow=t<12,_.userData={asset:g,isVehicle:!0},De.push(_);let v=new Y(new X(h*.86,c?.38:s?.34:o?.26:.2,c?.78:s?.54:u?.36:.4),new Z({color:l?10211793:9353409,metalness:.72,roughness:.16,transparent:!0,opacity:.88}));v.position.set(0,.43+(s||c?.08:0),c||s?.08:.03);let y=new li({color:16773040,transparent:!0,opacity:re.current?1:.28}),b=new li({color:16724008,transparent:!0,opacity:re.current?1:.56}),x=new li({color:16753951,transparent:!0,opacity:.18});Ie.push({material:y,day:.28},{material:b,day:.56});let S=new Y(new X(.25,.065,.04),y);S.position.set(0,.28,-m*.52);let C=new Y(new X(.25,.06,.035),b);C.position.set(0,.28,m*.52);let w=new Y(new X(.065,.055,.045),x),T=w.clone();w.position.set(-.145,.29,-m*.53),T.position.set(.145,.29,-m*.53);let E=[],D=new pa(c?.105:.09,c?.105:.09,.075,12),O=new Z({color:1119513,roughness:.88}),k=new Z({color:10332074,metalness:.8,roughness:.25});[[-h*.54,-m*.3],[h*.54,-m*.3],[-h*.54,m*.3],[h*.54,m*.3]].forEach(([t,n])=>{let r=new Y(D,O);r.rotation.z=Math.PI/2,r.position.set(t,.16,n),E.push(r);let i=new Y(new pa(.035,.035,.08,10),k);i.rotation.z=Math.PI/2,i.position.copy(r.position),e.add(r,i)});let A=new Y(new X(.13,.04,.012),new li({color:2845102}));A.position.set(0,.19,-m*.55);let ee=new Z({color:2305072,metalness:.55,roughness:.35}),j=new Y(new X(.08,.045,.08),ee),M=j.clone();if(j.position.set(-h*.62,.42,-.1),M.position.set(h*.62,.42,-.1),e.add(_,v,S,C,w,T,A,j,M),a){let t=new Y(new X(.17,.08,.1),new li({color:16773281}));t.position.set(0,.59,.04),e.add(t)}if(c&&[-.28,.05,.34].forEach(t=>{let n=new Y(new X(.02,.18,.2),new li({color:9426144})),r=n.clone();n.position.set(-h*.51,.52,t),r.position.set(h*.51,.52,t),e.add(n,r)}),l){let t=new Y(new X(.2,.035,.24),new li({color:6680786}));t.position.set(0,.57,.02),e.add(t)}if(u){let t=new Y(new X(.36,.035,.08),ee);t.position.set(0,.43,m*.43),e.add(t)}Te.add(e),Ee.push({mesh:e,curve:r,speed:(c?.019:.025)+t%5*.004,travel:t*.137%2,wheels:E,indicator:x,asset:g,position:new q,ahead:new q})}}),Object.entries(ce).forEach(([e,t])=>{for(let n=0;n<t.length;n+=250){let r=t.slice(n,n+250),i=af(r,!1);if(r.forEach(e=>e.dispose()),i){let t=new Y(i,se[e]||se.secondary);t.receiveShadow=!0,Te.add(t)}}}),le.length){let e=new Mi(new pa(.025,.035,.9,6),new Z({color:6058357,metalness:.65,roughness:.42}),le.length),t=new Ho(.07,8,6),n=new li({color:16767370,transparent:!0,opacity:re.current?1:.12});Le=n;let r=new Mi(t,n,le.length),i=new tn;le.forEach((t,n)=>{i.makeTranslation(t.x,.57,t.z),e.setMatrixAt(n,i),i.makeTranslation(t.x,1.04,t.z),r.setMatrixAt(n,i)}),e.instanceMatrix.needsUpdate=!0,r.instanceMatrix.needsUpdate=!0,Te.add(e,r)}C.current?.(`ready`)}).catch(e=>{e?.name!==`AbortError`&&(console.warn(`北京建筑数据载入失败`,e),C.current?.(`degraded`))});for(let e=0;e<36;e++){let n=new Y(new pa(.12,.18,1.5,6),new Z({color:4928548})),r=new Y(new ma(.8,2.2,8),new Z({color:2318404})),i=29+e%9*3.1,a=22+Math.floor(e/9)*4;n.position.set(i,.75,a),r.position.set(i,2.1,a),t.add(n,r)}let Qe=cf(t,De,{id:`incident`,label:`危化品泄漏源`,category:`重大事故 · 实时监测`,details:`罐体尾阀受损 · 下风向浓度持续上升，风险扩散模型正在实时推演。`,meta:`事件由完整演示状态机实时驱动`},`危化品泄漏源`,-3,-3,16732489);Qe.visible=!1,cf(t,De,{id:`school`,label:`城北实验学校`,category:`重点保护目标`,details:`在校师生 2,146 人 · 东南侧上风向安全通道畅通。`,meta:`距事故点 480m · 预防性疏散状态实时更新`},`城北实验学校`,35,-23,4447985),cf(t,De,{id:`hospital`,label:`市第三人民医院`,category:`医疗救援资源`,details:`急诊绿色通道已启用 · 医疗队 3 组待命。`,meta:`三级医院 · 救治能力充足`},`市第三人民医院`,-37,28,4382114),cf(t,De,{id:`station`,label:`青岚消防站`,category:`消防救援资源`,details:`2 辆泡沫消防车、1 辆洗消车已出动。`,meta:`应急响应中 · 路径由 A* 算法规划`},`青岚消防站`,-35,-30,16753485);let $e=lf([new q(-35,.4,-30),new q(-20,.4,-18),new q(-3,.4,-3)],2677231);$e.visible=!1,t.add($e),D.current=$e;let W=[];[[1,16174922,.18],[1,16748349,.23],[1,16729413,.3]].forEach(([e,n,r])=>{let i=new Y(new fa(e,64),new li({color:n,transparent:!0,opacity:r,depthWrite:!1,side:2}));i.rotation.x=-Math.PI/2,i.position.set(-3,.18,-3),i.visible=ne.current,t.add(i),W.push(i)}),E.current=W;let G=new Z({color:13383727,metalness:.4,roughness:.34,emissive:5510415,emissiveIntensity:.3}),et=new Y(new X(1.25,.46,2.4),G),tt=new Y(new X(1.08,.92,.76),new Z({color:15289400,metalness:.36,roughness:.32}));tt.position.set(0,.45,-.7);let nt=new Y(new X(.78,.35,.035),new Z({color:8369091,metalness:.72,roughness:.15}));nt.position.set(0,.54,-1.095);let rt=new Y(new X(1.04,.76,1.12),new Z({color:13621463,metalness:.66,roughness:.3}));rt.position.set(0,.38,.42);let it=new Y(new pa(.18,.22,.12,12),new Z({color:9148827,metalness:.7,roughness:.3}));it.position.set(0,.85,.42);let at=new Y(new pa(.055,.07,.72,10),new Z({color:12898513,metalness:.8,roughness:.22}));at.rotation.x=Math.PI/2,at.position.set(0,1.02,.18);let ot=new Y(new X(.7,.12,.2),new li({color:3845887}));ot.position.set(0,.98,-.7);let st=new li({color:16773306}),ct=new Y(new X(.62,.12,.035),st);ct.position.set(0,.05,-1.22);let lt=new Z({color:12503497,metalness:.72,roughness:.3});[-.631,.631].forEach(e=>{for(let t=-.05;t<=.72;t+=.38){let n=new Y(new X(.025,.52,.32),lt);n.position.set(e,.32,t),et.add(n)}}),et.add(tt,nt,rt,it,at,ot,ct);let ut=new pa(.22,.22,.14,14),dt=new Z({color:1119513,roughness:.9}),ft=[];[[-.62,-.76],[.62,-.76],[-.62,.76],[.62,.76]].forEach(([e,t])=>{let n=new Y(ut,dt);n.rotation.z=Math.PI/2,n.position.set(e,-.32,t),ft.push(n),et.add(n)});let pt={id:`firetruck`,label:`泡沫消防车 01`,category:`动态应急车辆 · OSM 真实道路`,details:`真实道路网络正在加载，消防车将在道路中心线上执行任务。`,meta:`OSM 路网 A* · 实时轨迹和转向更新`,action:`follow-vehicle`,position:{x:-35,y:2,z:-30}};et.castShadow=!0,et.userData.asset=pt,Xe=et,Ze=pt,t.add(et),De.push(et);let mt=new Y(new X(1.2,.46,2.18),new Z({color:15332594,metalness:.25,roughness:.38,emissive:1461055,emissiveIntensity:.2})),ht=new Y(new X(1.02,1.02,1.66),new Z({color:15923189,metalness:.18,roughness:.4}));ht.position.set(0,.46,.08);let gt=new Y(new X(.76,.38,.035),new Z({color:7711159,metalness:.7,roughness:.14}));gt.position.set(0,.6,-.77);let _t=new Y(new X(1.23,.13,1.58),new li({color:3127191}));_t.position.set(0,.43,.1);let vt=new Y(new X(.62,.12,.2),new li({color:3397887}));vt.position.set(0,1.03,-.3);let yt=new Y(new X(.62,.11,.035),st);yt.position.set(0,.06,-1.11);let bt=new Y(new X(.48,.12,.42),new Z({color:14147807,metalness:.42,roughness:.42}));bt.position.set(0,1.03,.43);let xt=new Y(new X(.86,.08,.18),lt);xt.position.set(0,-.08,1.15);let St=new li({color:15219509});[-.52,.52].forEach(e=>{let t=new Y(new X(.025,.42,.13),St),n=new Y(new X(.025,.13,.42),St);t.position.set(e,.55,.25),n.position.set(e,.55,.25),mt.add(t,n)}),mt.add(ht,gt,_t,vt,yt,bt,xt);let Ct=[];[[-.6,-.68],[.6,-.68],[-.6,.68],[.6,.68]].forEach(([e,t])=>{let n=new Y(ut,dt);n.rotation.z=Math.PI/2,n.position.set(e,-.31,t),Ct.push(n),mt.add(n)});let wt={id:`ambulance`,label:`救护车 03`,category:`动态医疗车辆 · 可跟随`,details:`当前位置：体育中心 · 载员 4 人，正在前往临时分诊点。`,meta:`车辆状态：待命转运 · 支持近距离跟随观察`,action:`follow-vehicle`,position:{x:-28,y:2,z:23}};mt.position.set(-28,.7,23),mt.rotation.y=-.72,mt.userData.asset=wt,mt.castShadow=!0,t.add(mt),De.push(mt);let Tt=new An,Et=new Y(new X(1.25,.38,2.55),new Z({color:2700344,metalness:.56,roughness:.36})),Dt=new Y(new X(1.08,.92,.85),new Z({color:14068015,metalness:.4,roughness:.32})),Ot=new Y(new pa(.48,.48,1.45,18),new Z({color:12174748,metalness:.38,roughness:.42,emissive:4082464,emissiveIntensity:.12}));Dt.position.set(0,.45,-.78),Ot.rotation.x=Math.PI/2,Ot.position.set(0,.54,.44),Et.position.y=-.02;let kt=new Y(new X(.76,.34,.04),new Z({color:7577258,metalness:.74,roughness:.13}));kt.position.set(0,.58,-1.22);let Mt=new Y(new X(1.28,.13,1.48),new li({color:15122743}));Mt.position.set(0,.39,.45);let Nt=new Y(new X(.62,.11,.18),new li({color:16753955}));Nt.position.set(0,.98,-.75);let Pt=[];[[-.62,-.78],[.62,-.78],[-.62,.78],[.62,.78]].forEach(([e,t])=>{let n=new Y(ut,dt);n.rotation.z=Math.PI/2,n.position.set(e,-.29,t),Pt.push(n),Tt.add(n)});let Ft={id:`chemical-truck`,label:`化学废料运输车 京A·WH2576`,category:`事故车辆 · 真实道路动态`,details:`装载含氯化学废料 12.6 吨，正在沿北京真实道路执行转运任务。`,meta:`车速 32 km/h · 罐体压力 0.42 MPa · 遥测在线`,action:`follow-vehicle`,position:{x:-29,y:1.5,z:-8}};Et.userData.asset=Ft,Tt.add(Et,Dt,Ot,kt,Mt,Nt),Tt.castShadow=!0,t.add(Tt),De.push(Et);let It=new li({color:14080093,transparent:!0,opacity:.26,depthWrite:!1}),Lt=[],Rt=new An;for(let e=0;e<18;e++){let t=new Y(new Ho(.16+e%4*.055,10,8),It);t.userData.seed=e,Lt.push(t),Rt.add(t)}let zt=new Y(new Vo(.72,1.02,32),new li({color:16764739,transparent:!0,opacity:.72,side:2,depthWrite:!1}));zt.rotation.x=-Math.PI/2,zt.position.set(0,.04,.7),Rt.add(zt),Rt.visible=!1,Tt.add(Rt);let Bt=new An,Vt=new Y(new X(.92,.38,1.9),new Z({color:15265776,metalness:.5,roughness:.3})),Ht=new Y(new X(.78,.48,.78),new Z({color:4682378,metalness:.7,roughness:.16}));Vt.position.y=.05,Ht.position.set(0,.43,.02);let Ut=new Y(new X(.94,.17,1.25),new li({color:2382248}));Ut.position.set(0,.18,.08);let Wt=new Y(new X(.28,.11,.18),new li({color:16728378})),Gt=new Y(new X(.28,.11,.18),new li({color:2592255}));Wt.position.set(-.17,.72,-.08),Gt.position.set(.17,.72,-.08);let Kt=[];[[-.48,-.58],[.48,-.58],[-.48,.58],[.48,.58]].forEach(([e,t])=>{let n=new Y(ut,dt);n.scale.set(.82,.82,.82),n.rotation.z=Math.PI/2,n.position.set(e,-.2,t),Kt.push(n),Bt.add(n)});let qt={id:`police-car`,label:`公安疏散警车 07`,category:`交通管制车辆 · 可跟随`,details:`执行事故点周边道路封控、应急车道清空和下风向人员疏散。`,meta:`警力 4 人 · 3 个路口联动 · 疏散通道已规划`,action:`follow-vehicle`,position:{x:31,y:1.4,z:-28}};Vt.userData.asset=qt,Bt.add(Vt,Ht,Ut,Wt,Gt),t.add(Bt),De.push(Vt);let Jt=new An,Xt=new Z({color:16741437,emissive:7281416,emissiveIntensity:.25}),Zt=new Z({color:5663344,metalness:.68,roughness:.32});[[-2.5,-1.1],[-1.6,-.75],[1.7,.75],[2.55,1.1]].forEach(([e,t])=>{let n=new Y(new ma(.16,.48,10),Xt);n.position.set(e,.24,t),Jt.add(n)});let Qt=new Y(new X(3.3,.17,.12),new li({color:16765773}));Qt.position.set(0,.55,0);let $t=new Y(new X(.1,.8,.1),Zt),en=$t.clone();$t.position.set(-1.35,.38,0),en.position.set(1.35,.38,0),Jt.add(Qt,$t,en),Jt.position.set(-1.8,.16,-1.5),Jt.visible=!1,t.add(Jt);let nn=[],rn=new pa(.09,.12,.48,7),an=new Ho(.11,8,6),on=[4830952,15050570,6341002,12024785].map(e=>new Z({color:e,roughness:.75})),sn=new Z({color:14200979,roughness:.8});for(let e=0;e<20;e++){let n=new An,r=new Y(rn,on[e%on.length]),i=new Y(an,sn);r.position.y=.27,i.position.y=.63,n.add(r,i),n.userData.offsetX=e%5*.42-1,n.userData.offsetZ=Math.floor(e/5)*.38-.6,n.visible=!1,t.add(n),nn.push(n)}let cn=new An,ln=new li({color:14023679,transparent:!0,opacity:.62,depthWrite:!1});for(let e=0;e<16;e++){let t=new Y(new Ho(.12+e%3*.05,9,7),ln);t.userData.seed=e,cn.add(t)}cn.position.set(-3,.2,-3),cn.visible=!1,t.add(cn);let un=new An,dn=new Y(new X(1.8,.08,1.35),new Z({color:5017464,roughness:.72})),fn=new Y(new ma(1.12,.75,4),new Z({color:15135469,roughness:.55})),pn=new Y(new X(.12,.5,.05),St),mn=new Y(new X(.46,.12,.05),St);fn.rotation.y=Math.PI/4,fn.position.y=.46,pn.position.set(0,.5,-.82),mn.position.set(0,.5,-.82),un.add(dn,fn,pn,mn),un.position.set(1.9,.1,1.6),un.visible=!1,t.add(un);let hn=new cc,gn=new K,_n=new mc(new er,6483711);_n.visible=!1,_n.material.transparent=!0,_n.material.opacity=.88,t.add(_n);let vn=e=>{let t=a.domElement.getBoundingClientRect();return gn.set((e.clientX-t.left)/t.width*2-1,-((e.clientY-t.top)/t.height)*2+1),hn.setFromCamera(gn,i),hn.intersectObjects(De,!1)[0]},yn=0,bn=e=>{let t=performance.now();if(t-yn<45)return;yn=t;let n=vn(e)?.object.userData.asset;a.domElement.style.cursor=n?`pointer`:`grab`,n?(c.textContent=n.label,c.style.display=`block`,c.style.left=`${e.offsetX+14}px`,c.style.top=`${e.offsetY+14}px`):c.style.display=`none`},xn=()=>{c.style.display=`none`,a.domElement.style.cursor=`grab`},Sn=null,Cn=null,wn=null,Tn=e=>{let t=vn(e),n=t?.object.userData.asset;Sn&&=(Sn.opacity=.025,null),Cn=t?.object||null,n?(x.current(n),t.object.userData.isRoad?(Sn=t.object.material,Sn.opacity=.82,_n.visible=!1):(_n.box.setFromObject(t.object),_n.visible=!0)):_n.visible=!1},En=e=>{let t=vn(e)?.object.userData.asset;t?.position&&(wn=null,i.position.set(t.position.x+8,t.position.y+6,t.position.z+8),l.target.set(t.position.x,t.position.y,t.position.z),l.update())};a.domElement.addEventListener(`pointermove`,bn),a.domElement.addEventListener(`pointerleave`,xn),a.domElement.addEventListener(`pointerup`,Tn),a.domElement.addEventListener(`dblclick`,En);let Dn=e=>{let t=e.detail,n=typeof t==`string`?t:t?.action;if(n===`follow`&&(wn=t.assetId&&De.find(e=>e.userData.asset?.id===t.assetId)||null),n===`toggle-building-lights`&&t.assetId){let e=De.find(e=>e.userData.asset?.id===t.assetId&&e.userData.isBuilding);if(e){let t=(Array.isArray(e.material)?e.material:[e.material])[0];Ne.has(t)?Ne.delete(t):Ne.add(t),ze(re.current)}}if(n===`zoomIn`&&i.position.multiplyScalar(.85),n===`zoomOut`&&i.position.multiplyScalar(1.15),n===`incident`&&(wn=null,i.position.set(25,24,28),l.target.set(-3,2,-3)),n===`focus`&&t.position){wn=null;let e=t.position;i.position.set(e.x+13,e.y+11,e.z+13),l.target.set(e.x,e.y,e.z)}n===`reset`&&(wn=null,i.position.set(92,100,108),l.target.set(0,6,0)),l.update()};window.addEventListener(`city-camera`,Dn);let On=()=>{let t=e.clientWidth,n=e.clientHeight;a.setSize(t,n,!1),i.aspect=t/Math.max(n,1),i.updateProjectionMatrix()},kn=new ResizeObserver(On);kn.observe(e),On();let jn=new WeakMap,Mn=(e,t)=>{if(e.length<2){let t=e[0]||{x:-39.704,z:-31.899};return new q(t.x,.65,t.z)}let n=jn.get(e);if(!n){let t=[],r=0;for(let n=1;n<e.length;n++){let i=Math.hypot(e[n].x-e[n-1].x,e[n].z-e[n-1].z);t.push(i),r+=i}n={lengths:t,total:r},jn.set(e,n)}let r=Math.max(0,Math.min(.999999,t))*n.total;for(let t=0;t<n.lengths.length;t++){if(r<=n.lengths[t]){let i=n.lengths[t]?r/n.lengths[t]:0;return new q(At.lerp(e[t].x,e[t+1].x,i),.65,At.lerp(e[t].z,e[t+1].z,i))}r-=n.lengths[t]}let i=e[e.length-1];return new q(i.x,.65,i.z)},Nn=e=>Math.max(0,Math.min(1,e)),Pn=(e,t,n,r)=>{let i=Nn(n),a=Mn(t,i),o=Math.min(.998,i+.006),s=Mn(t,o);return e.position.copy(a),o>i&&(e.lookAt(s),e.rotation.y+=Math.PI,e.rotation.x=0,e.rotation.z=0),r?.position&&(r.position.x=a.x,r.position.y=1.5,r.position.z=a.z),a},Fn=[{x:-64.181,z:-2.804},{x:-34,z:-5},{x:-3,z:-3}],In=[{x:-32.836,z:28.859},{x:-20,z:16},{x:-3,z:-3}],Ln=[{x:19.766,z:-19.999},{x:11,z:-13},{x:-3,z:-3}],Bn=[{x:-35,z:-30},{x:-20,z:-18},{x:-3,z:-3}],Vn=new dc,Hn=new q,Un=new jt,Wn=new q,Gn=new q,Kn=new q,qn=new q(0,5,0),Jn=0,Yn=0,Xn=0,Zn=()=>{if(Jn=requestAnimationFrame(Zn),te.current||document.hidden){Yn++%18==0&&(l.update(),a.render(t,i));return}let e=Vn.getElapsedTime(),n=Math.min(.05,Math.max(0,e-Xn)),r=M.current,o=N.current,s=r>0,c=r===9?.36:1;if(Xn=e,Qe.visible=s&&r>=2,F.current){wn=null;let t=e*.055+.7;i.position.set(Math.cos(t)*142,78+Math.sin(e*.11)*9,Math.sin(t)*142),l.target.lerp(qn,.08)}W.forEach((t,n)=>{let i=1+Math.sin(e*1.6+n)*.035,a=O.current[n];t.scale.set(a[0]*i*c,a[1]*i*c,1),t.material.opacity=[.18,.23,.3][n]*(.8+Math.sin(e*1.8+n)*.2)*(r===9?.35:1)});let u=r>=6?Math.min(P.current,18):P.current;Ee.forEach((t,i)=>{if(t.mesh.visible=i<u,!t.mesh.visible)return;let a=r>=2&&r<6?.62:1;t.travel=(t.travel+n*t.speed*a)%2;let o=t.travel<1,s=o?t.travel:2-t.travel,c=Math.max(0,Math.min(1,s+(o?.004:-.004)));t.curve.getPointAt(s,t.position),t.curve.getPointAt(c,t.ahead);let l=t.position,d=t.ahead;t.mesh.position.copy(l),Math.abs(c-s)>1e-4&&(t.mesh.lookAt(d),t.mesh.rotation.y+=Math.PI,t.mesh.rotation.x=0,t.mesh.rotation.z=0),t.wheels.forEach(e=>e.rotation.y-=n*(12+i%4)*a),t.indicator.opacity=Math.sin(e*4+i*.7)>.55?1:.16,t.asset.position&&(t.asset.position.x=l.x,t.asset.position.y=1.1,t.asset.position.z=l.z)});let d=Be.length>1?Be:Fn,f=Ve.length>1?Ve:In,p=He.length>1?He:Ln,m=k.current.length>1?k.current:Bn,h=s?Nn(o/7):0;if(Pn(Tt,d,h,Ft),s&&o>=7&&o<8.2&&(Tt.position.x+=Math.sin(o*34)*.045),Pt.forEach(e=>e.rotation.y=-o*8*h),Nt.visible=s&&r>=2&&Math.sin(e*11)>.05,Rt.visible=s&&r>=2,It.opacity=r===9?.08:.28,Rt.visible){let t=Math.max(0,o-7);Lt.forEach((e,n)=>{let r=(t*.24+n*.113)%1,i=n*2.17;e.position.set(Math.cos(i)*(.22+r*1.5),.48+r*2.1,.68+Math.sin(i)*(.18+r*1.7)),e.scale.setScalar(.65+r*1.4)});let n=1+Math.sin(e*5)*.13;zt.scale.setScalar(n)}Ke.visible=s&&r===1,Ke.material.opacity=.34,$e.visible=s?r>=4:b.current,qe.visible=s&&r>=4,Je.visible=s&&r>=4;let g=r===9?5564328:2677231;if($e.material.color.setHex(g),qe.material.color.setHex(r===9?5564328:5039025),Je.material.color.setHex(r===9?5564328:4887039),s){let e=Nn((o-27)/22);Pn(et,m,e*.985,pt),ft.forEach(t=>t.rotation.y=-e*48);let t=Nn((o-27)/32);Pn(mt,f,t*.92,wt),Ct.forEach(e=>e.rotation.y=-t*52);let n=Nn((o-27)/13);Pn(Bt,p,n*.84,qt),Kt.forEach(e=>e.rotation.y=-n*42)}else Pn(et,m,0,pt),Pn(mt,f,0,wt),Pn(Bt,p,0,qt);ot.visible=(s?r>=4:b.current)&&Math.sin(e*9)>-.2,vt.visible=s&&r>=4&&Math.sin(e*8+1)<.25,Wt.visible=s&&r>=4&&Math.sin(e*12)>.05,Gt.visible=s&&r>=4&&Math.sin(e*12)<=.05,Jt.visible=s&&r>=6,nn.forEach((e,t)=>{if(e.visible=s&&r>=6,!e.visible)return;let n=Nn((o-40)/9),i=e.userData.offsetX,a=e.userData.offsetZ;e.position.set(35+i+n*16,.02,-23+a-n*12+Math.sin(o*5+t)*.08),e.rotation.y=-.65,e.children[0].rotation.z=Math.sin(o*8+t)*.12}),cn.visible=s&&r>=7,cn.children.forEach((e,t)=>{let n=((o-49)*.5+t*.09)%1,r=t*.84;e.position.set(n*2.2*Math.cos(r),.18+n*.8,n*2.2*Math.sin(r)),e.scale.setScalar(.7+n*1.25)}),un.visible=s&&r>=8,s&&(Ft.details=r===1?`装载含氯化学废料 12.6 吨，沿 OSM 真实道路正常行驶。`:`动力系统故障，尾阀受冲击松动并发生含氯废料泄漏。`,Ft.meta=r===1?`车速 32 km/h · 罐体压力 0.42 MPa · 遥测正常`:`车辆已停车 · AI 告警生效 · 联合响应阶段 ${String(r).padStart(2,`0`)}/09`,qt.meta=r>=6?`已到场 · 3 个路口封控 · 186 人向侧上风向疏散`:`警力 4 人 · 正沿真实道路赶赴现场`,wt.meta=r>=8?`已到场 · 2 名轻度吸入人员完成检伤`:`医疗组 4 人 · 绿色通道已开启`),Cn&&_n.visible&&_n.box.setFromObject(Cn),wn&&!F.current&&(wn.getWorldPosition(Hn),wn.getWorldQuaternion(Un),Wn.set(4.6,3.1,6.8).applyQuaternion(Un),Gn.copy(Hn).add(Wn),Kn.copy(Hn),Kn.y+=.45,i.position.lerp(Gn,.1),l.target.lerp(Kn,.16)),l.update(),Yn++%3==0&&(a.shadowMap.needsUpdate=!0),a.render(t,i)};return Zn(),()=>{ae.current=()=>{},j.current=()=>{},Ye.abort(),cancelAnimationFrame(Jn),kn.disconnect(),window.removeEventListener(`city-camera`,Dn),a.domElement.removeEventListener(`pointermove`,bn),a.domElement.removeEventListener(`pointerleave`,xn),a.domElement.removeEventListener(`pointerup`,Tn),a.domElement.removeEventListener(`dblclick`,En),l.dispose();let n=new Set,r=new Set,i=new Set;t.traverse(e=>{if(e instanceof Y||e instanceof $i||e instanceof $r||e instanceof aa){`geometry`in e&&e.geometry&&n.add(e.geometry);let t=`material`in e?e.material:null;(Array.isArray(t)?t:t?[t]:[]).forEach(e=>{r.add(e),Object.values(e).forEach(e=>{e instanceof Yt&&i.add(e)})})}}),n.forEach(e=>e.dispose()),r.forEach(e=>e.dispose()),i.forEach(e=>e.dispose()),a.renderLists.dispose(),a.dispose(),a.forceContextLoss(),e.innerHTML=``}},[]),(0,$.jsxs)(`div`,{className:`real-3d-scene ${c?`night`:`day`}`,ref:y,onClick:e=>e.stopPropagation(),children:[(0,$.jsxs)(`div`,{className:`scene-badge`,children:[(0,$.jsx)(`i`,{}),`北京核心区真实地图 · `,f>0?`全流程演示 ${String(f).padStart(2,`0`)}/09`:`精修建筑`,` · `,c?`夜间态势`:`白天态势`]}),(0,$.jsxs)(`div`,{className:`scene-help`,children:[`实时车流 `,m,` 辆 · 单击查看详情 · 双击快速聚焦 · `,u?`自动巡航中`:`可自由旋转`]})]})}var df=[{id:`EV-20260720-001`,level:`Ⅰ级`,tone:`danger`,status:`待响应`,title:`国贸桥西侧化学废料运输车泄漏`,location:`北京市朝阳区建国门外大街国贸桥西侧`,time:`14:32:07`,source:`AI 视觉 + 车辆遥测`,summary:`化学废料运输车动力系统失效，尾阀受冲击松动。含氯挥发气体向西北方向扩散，系统将联动消防、医疗与交通力量。`,people:`影响 186 人`,progress:0},{id:`EV-20260720-002`,level:`Ⅱ级`,tone:`warning`,status:`已控制`,title:`朝阳区物流仓储点火情`,location:`东四环南路辅路 18 号`,time:`12:18:42`,source:`热成像 + 烟感网络`,summary:`仓库外包装区出现明火，自动喷淋与园区消防队已控制火势，无人员伤亡。`,people:`疏散 42 人`,progress:94},{id:`EV-20260720-003`,level:`Ⅲ级`,tone:`cyan`,status:`监测中`,title:`通惠河局部油膜异常`,location:`大望路桥下游 320 米`,time:`10:46:15`,source:`无人机巡检`,summary:`水面发现约 35 平方米不明油膜，环境监测车已完成取样，溯源模型正在计算。`,people:`无人员风险`,progress:47},{id:`EV-20260719-014`,level:`Ⅳ级`,tone:`muted`,status:`已归档`,title:`CBD 地铁站瞬时客流拥堵`,location:`国贸站换乘大厅`,time:`昨日 18:07`,source:`客流感知网络`,summary:`晚高峰瞬时客流超过阈值，通过单向导流和临时限流于 12 分钟内恢复正常。`,people:`分流 1,260 人`,progress:100}],ff=[{id:`FIRE-01`,category:`消防`,icon:`消`,name:`泡沫消防车 01`,station:`青岚消防站`,eta:7,people:6,status:`available`,progress:0,capability:`A 类泡沫 4.2t · 水幕炮 · 堵漏工具组`,plate:`京消·A017`},{id:`FIRE-02`,category:`消防`,icon:`洗`,name:`危化洗消车 02`,station:`青岚消防站`,eta:9,people:5,status:`available`,progress:0,capability:`洗消液 2.8t · 防化服 12 套 · 检测仪`,plate:`京消·A026`},{id:`ROBOT-01`,category:`消防`,icon:`机`,name:`防爆消防机器人`,station:`青岚消防站`,eta:8,people:0,status:`available`,progress:0,capability:`耐高温侦察 · 遥控水炮 · 气体检测`,plate:`ROBOT-X1`},{id:`MED-03`,category:`医疗`,icon:`医`,name:`急救车 03`,station:`市第三人民医院`,eta:11,people:4,status:`available`,progress:0,capability:`呼吸支持 · 检伤分类 · 4 人转运`,plate:`京急·M103`},{id:`MED-06`,category:`医疗`,icon:`负`,name:`负压救护车 06`,station:`朝阳医疗中心`,eta:14,people:4,status:`available`,progress:0,capability:`负压隔离舱 · 中毒洗消 · 2 人转运`,plate:`京急·M206`},{id:`POLICE-07`,category:`交警`,icon:`警`,name:`疏散警车 07`,station:`建外派出所`,eta:5,people:4,status:`available`,progress:0,capability:`路口封控 · 人员疏散 · 应急车道清空`,plate:`京A·P707`},{id:`BIKE-02`,category:`交警`,icon:`骑`,name:`交通铁骑 02 组`,station:`国贸交通队`,eta:4,people:2,status:`available`,progress:0,capability:`快速抵达 · 先期侦察 · 绿波引导`,plate:`京警·R02`},{id:`DRONE-04`,category:`监测`,icon:`无`,name:`多光谱无人机 04`,station:`CBD 无人机巢`,eta:3,people:1,status:`available`,progress:0,capability:`热成像 · 气体云图 · 4K 实时回传`,plate:`UAV-04`},{id:`ENV-01`,category:`监测`,icon:`测`,name:`移动环境监测站`,station:`朝阳生态环境局`,eta:13,people:3,status:`available`,progress:0,capability:`氯气/氨气/挥发物连续监测`,plate:`京环·E011`},{id:`BUS-12`,category:`疏散`,icon:`疏`,name:`应急疏散大巴 12`,station:`北京站调度场`,eta:16,people:2,status:`available`,progress:0,capability:`核载 52 人 · 空调正压 · 应急物资`,plate:`京A·E512`}],pf=[{id:`ARC-0720-01`,date:`2026-07-20`,type:`危化品泄漏`,title:`化学废料运输车故障联合处置`,duration:`01:12`,score:`96.4`,status:`最新推演`,summary:`完整记录危废车辆行驶、突发故障、AI 识别、真实路网调度、人员疏散、堵漏与医疗转运。`,tags:[`9 阶段`,`OSM A*`,`186 人疏散`],replay:!0},{id:`ARC-0718-03`,date:`2026-07-18`,type:`仓储火灾`,title:`物流园锂电池仓库热失控推演`,duration:`02:36`,score:`91.8`,status:`已评审`,summary:`对比泡沫覆盖、干粉隔离和容器转移三种方案，最终选择分区冷却与隔离控制。`,tags:[`热失控`,`方案对比`,`无人机`],replay:!1},{id:`ARC-0715-08`,date:`2026-07-15`,type:`城市内涝`,title:`CBD 暴雨积水与交通疏导推演`,duration:`03:18`,score:`93.2`,status:`已归档`,summary:`模拟 50 年一遇降雨下的积水扩散、地铁口封控、公交绕行与泵站联动。`,tags:[`积水模型`,`交通重规划`,`地铁保护`],replay:!1},{id:`ARC-0711-02`,date:`2026-07-11`,type:`大型活动`,title:`体育中心万人活动应急疏散`,duration:`04:05`,score:`89.7`,status:`待复盘`,summary:`根据闸机客流、道路容量和医疗点位，推演 18,600 人分区分批疏散。`,tags:[`人群仿真`,`分区疏散`,`医疗布点`],replay:!1}],mf={available:`可调度`,enroute:`赶赴中`,onsite:`已到场`},hf=new Set([`FIRE-01`,`MED-03`,`POLICE-07`]);function gf({active:e,onClose:t,onStartScenario:n,onFocusIncident:i,onGenerateReport:a,onNotice:o,onTrackResource:s,scenarioPhase:c,scenarioTime:l,scenarioStatus:u}){let[d,f]=(0,r.useState)(`全部事件`),[p,m]=(0,r.useState)(``),[h,g]=(0,r.useState)(df[0].id),[_,v]=(0,r.useState)(`全部资源`),[y,b]=(0,r.useState)(ff),[x,S]=(0,r.useState)(ff[0].id),[C,w]=(0,r.useState)([`14:32:20　AI 指挥智能体完成首轮资源匹配`,`14:32:21　3 条 OSM 真实道路路线已生成`]),[T,E]=(0,r.useState)(pf[0].id),[D,O]=(0,r.useState)(`全部档案`),k=(0,r.useRef)(null);(0,r.useEffect)(()=>{if(e===`overview`)return;let t=requestAnimationFrame(()=>k.current?.focus());return()=>cancelAnimationFrame(t)},[e]),(0,r.useEffect)(()=>{let e=window.setInterval(()=>b(e=>e.map(e=>e.status===`enroute`?e.progress>=94?{...e,status:`onsite`,progress:100}:{...e,progress:e.progress+6}:e)),900);return()=>window.clearInterval(e)},[]);let A=u===`idle`?`待响应`:u===`complete`?`已控制`:c<2?`监测中`:`处置中`,ee=u===`idle`?0:Math.round(Math.min(100,l/72*100)),j=(0,r.useMemo)(()=>df.map((e,t)=>t?e:{...e,status:A,progress:ee,summary:u===`idle`?df[0].summary:`化学废料运输车发生泄漏，AI 已完成研判，消防、医疗与交通力量正沿真实道路执行联合处置。`}),[ee,A,u]),M=(0,r.useMemo)(()=>y.map(e=>{if(c<4||!hf.has(e.id))return e;let[t,n]={"FIRE-01":[27,49],"MED-03":[27,59],"POLICE-07":[27,40]}[e.id],r=Math.max(6,Math.min(100,(l-t)/(n-t)*100));return{...e,status:r>=100?`onsite`:`enroute`,progress:r}}),[y,c,l]),N=j.find(e=>e.id===h)||j[0],P=M.find(e=>e.id===x)||M[0],F=pf.find(e=>e.id===T)||pf[0],te=p.trim().toLowerCase(),ne=j.filter(e=>(d===`全部事件`||e.status===d)&&(!te||`${e.id} ${e.title} ${e.location}`.toLowerCase().includes(te))),re=M.filter(e=>_===`全部资源`||e.category===_),ie=pf.filter(e=>D===`全部档案`||e.type===D),ae=(0,r.useMemo)(()=>({available:M.filter(e=>e.status===`available`).length,enroute:M.filter(e=>e.status===`enroute`).length,onsite:M.filter(e=>e.status===`onsite`).length,people:M.filter(e=>e.status!==`available`).reduce((e,t)=>e+t.people,0)}),[M]);(0,r.useEffect)(()=>{ne.length&&!ne.some(e=>e.id===h)&&g(ne[0].id)},[d,p,ne,h]);let oe=e=>{let t=M.find(t=>t.id===e);if(t){if(c>=4&&hf.has(e)){o(`${t.name} 正由完整推演导演脚本接管，无法单独召回`);return}t.status===`available`?(b(t=>t.map(t=>t.id===e?{...t,status:`enroute`,progress:8}:t)),w(e=>[`${new Date().toLocaleTimeString(`zh-CN`,{hour12:!1})}　${t.name} 已接收出动指令`,...e].slice(0,6)),o(`${t.name} 已出动，预计 ${t.eta} 分钟到达`)):(b(t=>t.map(t=>t.id===e?{...t,status:`available`,progress:0}:t)),w(e=>[`${new Date().toLocaleTimeString(`zh-CN`,{hour12:!1})}　${t.name} 已结束任务并返站`,...e].slice(0,6)),o(`${t.name} 已召回`))}},I=()=>{let e=new Set([`FIRE-01`,`FIRE-02`,`MED-03`,`POLICE-07`,`BIKE-02`,`DRONE-04`,`ENV-01`]),t=y.filter(t=>e.has(t.id)&&t.status===`available`).length;if(!t){o(`联合编队已经全部出动，无需重复下达指令`);return}b(t=>t.map(t=>e.has(t.id)&&t.status===`available`?{...t,status:`enroute`,progress:8}:t)),w(e=>[`${new Date().toLocaleTimeString(`zh-CN`,{hour12:!1})}　联合编队新增 ${t} 个单元出动`,...e].slice(0,6)),o(`联合编队新增 ${t} 个单元出动，绿波通道同步开启`)},L=()=>{let e=y.filter(e=>e.status!==`available`&&!(c>=4&&hf.has(e.id)));if(!e.length){o(`当前没有可召回的非脚本资源`);return}let t=new Set(e.map(e=>e.id));b(e=>e.map(e=>t.has(e.id)?{...e,status:`available`,progress:0}:e)),w(t=>[`${new Date().toLocaleTimeString(`zh-CN`,{hour12:!1})}　${e.length} 个非脚本资源已结束任务`,...t].slice(0,6)),o(`已召回 ${e.length} 个资源单元`)};if(e===`overview`)return null;let se={events:`事件中心`,resources:`资源调度`,archives:`推演档案`}[e],ce={events:`INCIDENT CENTER`,resources:`RESOURCE DISPATCH`,archives:`SIMULATION ARCHIVE`}[e];return(0,$.jsx)(`div`,{className:`operations-backdrop`,onMouseDown:e=>{e.target===e.currentTarget&&t()},children:(0,$.jsxs)(`section`,{className:`operations-module module-${e}`,role:`dialog`,"aria-modal":`true`,"aria-label":se,children:[(0,$.jsxs)(`header`,{className:`module-header`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`span`,{children:[`LINGJING SENTINEL · `,ce]}),(0,$.jsx)(`h2`,{children:se}),(0,$.jsx)(`p`,{children:e===`events`?`统一接入城市感知事件，支持筛选、研判、定位与启动联动处置。`:e===`resources`?`面向消防、医疗、警力、监测和疏散力量的实时可视化调度。`:`完整保存推演参数、算法结果、时间线与处置报告，支持复盘重播。`})]}),(0,$.jsxs)(`div`,{className:`module-live`,children:[(0,$.jsx)(`i`,{}),`主推演状态同步 `,(0,$.jsx)(`b`,{children:u.toUpperCase()})]}),(0,$.jsx)(`button`,{ref:k,className:`module-close`,onClick:t,"aria-label":`关闭`,children:`×`})]}),e===`events`&&(0,$.jsxs)(`div`,{className:`module-content events-content`,children:[(0,$.jsxs)(`div`,{className:`module-kpis`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`今日事件`}),(0,$.jsx)(`strong`,{children:`14`}),(0,$.jsx)(`em`,{children:`较昨日 -12%`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`处置中`}),(0,$.jsx)(`strong`,{className:`orange`,children:`1`}),(0,$.jsx)(`em`,{children:`Ⅰ级响应`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`平均响应`}),(0,$.jsxs)(`strong`,{children:[`2.8`,(0,$.jsx)(`small`,{children:` min`})]}),(0,$.jsx)(`em`,{children:`目标 ≤ 5min`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`自动识别率`}),(0,$.jsxs)(`strong`,{className:`green`,children:[`96.8`,(0,$.jsx)(`small`,{children:`%`})]}),(0,$.jsx)(`em`,{children:`多模态融合`})]})]}),(0,$.jsxs)(`div`,{className:`module-toolbar`,children:[(0,$.jsx)(`div`,{children:[`全部事件`,`待响应`,`处置中`,`已控制`,`监测中`,`已归档`].map(e=>(0,$.jsx)(`button`,{className:d===e?`active`:``,"aria-pressed":d===e,onClick:()=>f(e),children:e},e))}),(0,$.jsxs)(`label`,{children:[`⌕`,(0,$.jsx)(`input`,{"aria-label":`搜索事件编号、标题或地点`,value:p,onChange:e=>m(e.target.value),placeholder:`搜索事件编号、标题或地点`})]})]}),(0,$.jsxs)(`div`,{className:`events-layout`,children:[(0,$.jsx)(`div`,{className:`event-list`,children:ne.length?ne.map(e=>(0,$.jsxs)(`button`,{className:h===e.id?`selected`:``,onClick:()=>g(e.id),children:[(0,$.jsx)(`i`,{className:e.tone,children:e.level}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`span`,{children:[e.id,` · `,e.time]}),(0,$.jsx)(`strong`,{children:e.title}),(0,$.jsx)(`p`,{children:e.location})]}),(0,$.jsx)(`em`,{children:e.status})]},e.id)):(0,$.jsxs)(`div`,{className:`module-empty`,children:[(0,$.jsx)(`i`,{children:`⌕`}),(0,$.jsx)(`strong`,{children:`未找到匹配事件`}),(0,$.jsx)(`span`,{children:`请调整筛选条件或搜索关键词`})]})}),(0,$.jsxs)(`article`,{className:`event-detail`,children:[(0,$.jsxs)(`div`,{className:`event-detail-head`,children:[(0,$.jsxs)(`span`,{children:[N.level,` · `,N.status]}),(0,$.jsx)(`strong`,{children:N.title}),(0,$.jsxs)(`p`,{children:[`⌖ `,N.location]})]}),(0,$.jsxs)(`div`,{className:`event-summary`,children:[(0,$.jsx)(`p`,{children:N.summary}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`span`,{children:[`事件来源`,(0,$.jsx)(`b`,{children:N.source})]}),(0,$.jsxs)(`span`,{children:[`人员影响`,(0,$.jsx)(`b`,{children:N.people})]}),(0,$.jsxs)(`span`,{children:[`处置进度`,(0,$.jsxs)(`b`,{children:[N.progress,`%`]})]})]}),(0,$.jsx)(`i`,{children:(0,$.jsx)(`span`,{style:{width:`${N.progress}%`}})})]}),(0,$.jsxs)(`div`,{className:`event-chain`,children:[(0,$.jsx)(`h3`,{children:`智能处置链`}),[`视觉与遥测完成交叉验证`,`风险扩散模型生成警戒区`,`消防医疗交警联合编队`,`真实路网计算三条救援路径`].map((e,t)=>(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{children:t+1}),(0,$.jsx)(`span`,{children:e}),(0,$.jsx)(`em`,{children:N.id===df[0].id||t<2?`✓`:`待确认`})]},e))]}),(0,$.jsx)(`footer`,{children:N.id===df[0].id?(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`button`,{onClick:()=>{i(),t()},children:`◎ 地图定位`}),(0,$.jsx)(`button`,{className:`primary`,onClick:()=>{n(),t()},children:`▶ 启动联动处置`})]}):(0,$.jsx)(`button`,{className:`primary`,onClick:()=>o(`${N.title}：处置进度 ${N.progress}%，摘要已载入`),children:`查看处置摘要`})})]})]})]}),e===`resources`&&(0,$.jsxs)(`div`,{className:`module-content resources-content`,children:[(0,$.jsxs)(`div`,{className:`module-kpis`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`可调度`}),(0,$.jsx)(`strong`,{children:ae.available}),(0,$.jsx)(`em`,{children:`个资源单元`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`赶赴中`}),(0,$.jsx)(`strong`,{className:`orange`,children:ae.enroute}),(0,$.jsx)(`em`,{children:`实时轨迹回传`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`已到场`}),(0,$.jsx)(`strong`,{className:`green`,children:ae.onsite}),(0,$.jsx)(`em`,{children:`执行现场任务`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`已投入人员`}),(0,$.jsx)(`strong`,{children:ae.people}),(0,$.jsx)(`em`,{children:`跨部门协同`})]})]}),(0,$.jsxs)(`div`,{className:`module-toolbar resource-toolbar`,children:[(0,$.jsx)(`div`,{children:[`全部资源`,`消防`,`医疗`,`交警`,`监测`,`疏散`].map(e=>(0,$.jsx)(`button`,{className:_===e?`active`:``,"aria-pressed":_===e,onClick:()=>v(e),children:e},e))}),(0,$.jsx)(`button`,{className:`recall-all`,onClick:L,children:`↩ 批量召回`}),(0,$.jsx)(`button`,{className:`batch-dispatch`,onClick:I,children:`⚡ 一键联合出动`})]}),(0,$.jsxs)(`div`,{className:`dispatch-layout`,children:[(0,$.jsx)(`div`,{className:`resource-list`,children:re.map(e=>(0,$.jsxs)(`button`,{className:`${x===e.id?`selected`:``} ${e.status}`,onClick:()=>S(e.id),children:[(0,$.jsx)(`i`,{children:e.icon}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`span`,{children:[e.category,` · `,e.station]}),(0,$.jsx)(`strong`,{children:e.name}),(0,$.jsxs)(`p`,{children:[e.plate,` · `,e.people,` 人编组`]}),e.status!==`available`&&(0,$.jsx)(`em`,{children:(0,$.jsx)(`span`,{style:{width:`${e.progress}%`}})})]}),(0,$.jsxs)(`b`,{children:[mf[e.status],(0,$.jsx)(`small`,{children:e.status===`enroute`?`ETA ${Math.max(1,Math.ceil(e.eta*(1-e.progress/110)))} min`:e.status===`onsite`?`任务执行中`:`预计 ${e.eta} min`})]})]},e.id))}),(0,$.jsxs)(`section`,{className:`dispatch-board`,children:[(0,$.jsxs)(`div`,{className:`dispatch-map`,"aria-label":`资源编队态势示意图`,children:[(0,$.jsx)(`div`,{className:`map-road road-a`}),(0,$.jsx)(`div`,{className:`map-road road-b`}),(0,$.jsx)(`div`,{className:`map-road road-c`}),(0,$.jsx)(`i`,{className:`dispatch-incident`,children:`危`}),(0,$.jsx)(`i`,{className:`dispatch-station fire`,children:`消`}),(0,$.jsx)(`i`,{className:`dispatch-station medical`,children:`医`}),(0,$.jsx)(`i`,{className:`dispatch-station police`,children:`警`}),M.filter(e=>e.status!==`available`).slice(0,7).map((e,t)=>(0,$.jsx)(`span`,{className:`moving-unit unit-${t}`,children:e.icon},e.id)),(0,$.jsx)(`em`,{children:`RESOURCE FORMATION · SCHEMATIC`})]}),(0,$.jsxs)(`article`,{className:`resource-detail`,children:[(0,$.jsxs)(`span`,{children:[P.category,` · `,P.id]}),(0,$.jsx)(`h3`,{children:P.name}),(0,$.jsx)(`p`,{children:P.capability}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`span`,{children:[`所属站点`,(0,$.jsx)(`b`,{children:P.station})]}),(0,$.jsxs)(`span`,{children:[`到场时间`,(0,$.jsxs)(`b`,{children:[P.eta,` 分钟`]})]}),(0,$.jsxs)(`span`,{children:[`车辆编号`,(0,$.jsx)(`b`,{children:P.plate})]})]}),(0,$.jsxs)(`section`,{className:`resource-actions`,children:[(0,$.jsx)(`button`,{className:P.status===`available`?`primary`:`recall`,onClick:()=>oe(P.id),children:c>=4&&hf.has(P.id)?`◉ 导演脚本接管中`:P.status===`available`?`→ 下达出动指令`:`↩ 结束任务并召回`}),(0,$.jsx)(`button`,{disabled:P.status===`available`,onClick:()=>{s(P.id),t()},children:P.status===`available`?`出动后可地图追踪`:`◎ 同步到真实地图`})]})]}),(0,$.jsxs)(`div`,{className:`dispatch-log`,children:[(0,$.jsxs)(`h3`,{children:[`调度指令流 `,(0,$.jsx)(`i`,{children:`LIVE`})]}),C.map((e,t)=>(0,$.jsx)(`p`,{children:e},`${e}-${t}`))]})]})]})]}),e===`archives`&&(0,$.jsxs)(`div`,{className:`module-content archives-content`,children:[(0,$.jsxs)(`div`,{className:`module-kpis`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`累计推演`}),(0,$.jsx)(`strong`,{children:`128`}),(0,$.jsx)(`em`,{children:`覆盖 9 类事件`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`形成报告`}),(0,$.jsx)(`strong`,{children:`116`}),(0,$.jsx)(`em`,{children:`自动归档率 90.6%`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`平均评分`}),(0,$.jsx)(`strong`,{className:`green`,children:`92.7`}),(0,$.jsx)(`em`,{children:`专家复核结果`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`算法可追溯`}),(0,$.jsxs)(`strong`,{children:[`100`,(0,$.jsx)(`small`,{children:`%`})]}),(0,$.jsx)(`em`,{children:`参数与路径完整保存`})]})]}),(0,$.jsxs)(`div`,{className:`module-toolbar`,children:[(0,$.jsx)(`div`,{children:[`全部档案`,`危化品泄漏`,`仓储火灾`,`城市内涝`,`大型活动`].map(e=>(0,$.jsx)(`button`,{className:D===e?`active`:``,onClick:()=>O(e),children:e},e))}),(0,$.jsx)(`button`,{onClick:a,children:`＋ 生成当前报告`})]}),(0,$.jsxs)(`div`,{className:`archives-layout`,children:[(0,$.jsx)(`div`,{className:`archive-grid`,children:ie.map(e=>(0,$.jsxs)(`button`,{className:T===e.id?`selected`:``,onClick:()=>E(e.id),children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:e.id}),(0,$.jsx)(`em`,{children:e.status})]}),(0,$.jsx)(`i`,{children:e.date}),(0,$.jsx)(`strong`,{children:e.title}),(0,$.jsx)(`p`,{children:e.summary}),(0,$.jsx)(`section`,{children:e.tags.map(e=>(0,$.jsx)(`span`,{children:e},e))}),(0,$.jsxs)(`footer`,{children:[(0,$.jsxs)(`b`,{children:[`综合评分 `,e.score]}),(0,$.jsxs)(`em`,{children:[`时长 `,e.duration]})]})]},e.id))}),(0,$.jsxs)(`article`,{className:`archive-detail`,children:[(0,$.jsxs)(`span`,{children:[F.type,` · `,F.id]}),(0,$.jsx)(`h3`,{children:F.title}),(0,$.jsxs)(`div`,{className:`archive-score`,children:[(0,$.jsx)(`strong`,{children:F.score}),(0,$.jsxs)(`span`,{children:[`综合评分`,(0,$.jsx)(`em`,{children:`响应速度 96　资源效率 94　风险控制 98`})]})]}),(0,$.jsxs)(`div`,{className:`archive-metrics`,children:[(0,$.jsxs)(`span`,{children:[`关键决策节点`,(0,$.jsxs)(`b`,{children:[F.replay?`9`:`12`,` 个`]})]}),(0,$.jsxs)(`span`,{children:[`算法调用`,(0,$.jsx)(`b`,{children:F.replay?`A* / 高斯烟羽`:`多模型协同`})]}),(0,$.jsxs)(`span`,{children:[`报告状态`,(0,$.jsx)(`b`,{children:`完整可追溯`})]})]}),(0,$.jsx)(`p`,{children:F.summary}),(0,$.jsxs)(`footer`,{children:[(0,$.jsx)(`button`,{onClick:()=>F.replay?a():o(`${F.title}：归档评分 ${F.score}，关键复盘摘要已显示`),children:F.replay?`查看处置报告`:`查看归档摘要`}),(0,$.jsx)(`button`,{className:`primary`,onClick:()=>{F.replay?(n(),t()):o(`${F.title}：${F.summary}`)},children:F.replay?`▶ 重播完整推演`:`查看复盘结论`})]})]})]})]})]})})}function _f({to:e,decimals:t=0,duration:n=1500,prefix:i=``,suffix:a=``,useGrouping:o=!0,className:s=``}){let[c,l]=(0,r.useState)(0),u=(0,r.useRef)(0);(0,r.useEffect)(()=>{let t=u.current,r=performance.now(),i=0;if(window.matchMedia(`(prefers-reduced-motion: reduce)`).matches||n<=0){u.current=e,l(e);return}let a=o=>{let s=Math.min(1,(o-r)/n),c=1-(1-s)**3,d=t+(e-t)*c;u.current=d,l(d),s<1&&(i=requestAnimationFrame(a))};return i=requestAnimationFrame(a),()=>cancelAnimationFrame(i)},[n,e]);let d=c.toLocaleString(`zh-CN`,{minimumFractionDigits:t,maximumFractionDigits:t,useGrouping:o});return(0,$.jsxs)(`span`,{className:`ani-num ${s}`.trim(),children:[i,d,a]})}var vf=[{id:`01`,title:`事故图片识别`,text:`本地视觉模型识别危化运输车、泄漏烟羽与现场人员，输出可解释置信度。`},{id:`02`,title:`风险扩散计算`,text:`高斯烟羽模型结合实时风向，动态生成致命区、高风险区与警戒区。`},{id:`03`,title:`真实道路重规划`,text:`封路后在北京 OSM 路网执行 A* 搜索，消防、医疗和警车同步调整路线。`},{id:`04`,title:`多智能体联合处置`,text:`消防、医疗、交通与指挥智能体完成出警、救援、疏散和报告闭环。`}];function yf({ready:e,onClose:t,onStart:n}){return(0,$.jsx)(`div`,{className:`demo-entry-backdrop`,onMouseDown:e=>e.target===e.currentTarget&&t(),children:(0,$.jsxs)(`section`,{className:`demo-entry`,role:`dialog`,"aria-modal":`true`,"aria-label":`灵境哨兵演示项目`,children:[(0,$.jsx)(`button`,{className:`demo-entry-close`,onClick:t,"aria-label":`关闭`,children:`×`}),(0,$.jsxs)(`header`,{children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`SMART CITY · FEATURED DEMO 01`}),(0,$.jsxs)(`h2`,{children:[`灵境哨兵：危化品运输事故`,(0,$.jsx)(`br`,{}),`全链路智能处置`]}),(0,$.jsx)(`p`,{children:`智慧城市 3D 大屏中的核心演示项目。72 秒完整呈现车辆故障、AI 告警、消防出警、救护车到场、警车疏散与应急报告生成。`})]}),(0,$.jsxs)(`div`,{className:`demo-entry-score`,children:[(0,$.jsx)(`span`,{children:`演示完成度`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:96.4,decimals:1})}),(0,$.jsx)(`em`,{children:`READY TO PRESENT`})]})]}),(0,$.jsxs)(`div`,{className:`demo-entry-kpis`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:6016})}),(0,$.jsx)(`span`,{children:`北京真实建筑`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:674})}),(0,$.jsx)(`span`,{children:`真实道路路段`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:72,suffix:`s`})}),(0,$.jsx)(`span`,{children:`全流程导演脚本`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:4})}),(0,$.jsx)(`span`,{children:`协同智能体`})]})]}),(0,$.jsxs)(`div`,{className:`demo-entry-body`,children:[(0,$.jsxs)(`section`,{children:[(0,$.jsxs)(`h3`,{children:[`AI 决策链 `,(0,$.jsx)(`b`,{children:`REAL-TIME PIPELINE`})]}),(0,$.jsx)(`div`,{className:`demo-flow`,children:vf.map(e=>(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`i`,{children:e.id}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:e.title}),(0,$.jsx)(`p`,{children:e.text})]}),(0,$.jsx)(`em`,{children:`✓`})]},e.id))})]}),(0,$.jsxs)(`aside`,{children:[(0,$.jsx)(`span`,{children:`场景简介`}),(0,$.jsx)(`h3`,{children:`北京 CBD · 建国门外大街`}),(0,$.jsx)(`p`,{children:`一辆化学废料运输车在真实道路行驶中突发动力故障并发生含氯气体泄漏。平台自动调度消防、医疗与警力，完成封控、疏散、堵漏和转运。`}),(0,$.jsxs)(`ul`,{children:[(0,$.jsx)(`li`,{children:`可旋转、缩放、俯视与自动巡航`}),(0,$.jsx)(`li`,{children:`建筑、车辆、道路均可点击交互`}),(0,$.jsx)(`li`,{children:`支持暂停、倍速和逐阶段讲解`}),(0,$.jsx)(`li`,{children:`可生成并下载完整处置报告`})]})]})]}),(0,$.jsxs)(`footer`,{children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{className:e?`ready`:``}),(0,$.jsx)(`span`,{children:e?`真实地图与演示资源已加载完成`:`正在加载北京真实地图与三维资源…`})]}),(0,$.jsx)(`button`,{onClick:t,children:`返回智慧城市大屏`}),(0,$.jsx)(`button`,{className:`primary`,disabled:!e,onClick:n,children:e?`▶ 进入并启动完整演示`:`资源加载中…`})]})]})})}var bf={panorama:{position:[118,88,128],target:[0,13,0]},cbd:{position:[54,48,63],target:[9,15,4]},axis:{position:[2,59,148],target:[0,10,-4]},top:{position:[0,190,.1],target:[0,0,0]},horizon:{position:[158,39,2],target:[0,16,0]}},xf=[{id:`chaoyang`,label:`朝阳区`,x:38,z:18,color:3534847,text:`商务活力 96.8 · 城市事件闭环率 98.1%`},{id:`dongcheng`,label:`东城区`,x:-22,z:-15,color:5504963,text:`城市治理 92.7 · 感知设备在线率 99.9%`},{id:`haidian`,label:`海淀区`,x:-48,z:40,color:6985471,text:`科技创新 94.2 · 智算资源利用率 87.6%`},{id:`fengtai`,label:`丰台区`,x:12,z:-48,color:16755039,text:`交通枢纽 89.6 · 路网运行状态平稳`}];function Sf(e,t){let n=document.createElement(`canvas`);n.width=512,n.height=112;let r=n.getContext(`2d`),i=r.createLinearGradient(0,0,512,0);i.addColorStop(0,`rgba(3, 15, 28, .94)`),i.addColorStop(1,`rgba(5, 39, 55, .72)`),r.fillStyle=i,r.fillRect(0,0,512,112),r.strokeStyle=t,r.lineWidth=3,r.strokeRect(2,2,508,108),r.fillStyle=`#eaffff`,r.font=`600 32px Microsoft YaHei, sans-serif`,r.fillText(e,26,68),r.fillStyle=t,r.fillRect(26,82,160,3);let a=new ca(n);a.colorSpace=Re;let o=new $r(new zr({map:a,transparent:!0,depthTest:!1}));return o.scale.set(19,4.2,1),o}function Cf(e,t,n,r,i,a,o,s=0){let c=new Y(new Bo(r,i),t);c.rotation.x=-Math.PI/2,c.rotation.z=s,c.position.set(a,1.42,o),e.add(c);let l=new Y(new Bo(.1,i*.95),n);l.rotation.x=-Math.PI/2,l.rotation.z=s,l.position.set(a,1.46,o),e.add(l)}function wf({nightMode:e,buildingLights:t,autoTour:n,topView:o,trafficDensity:s,onSelect:c,onSceneStatus:l}){let u=(0,r.useRef)(null),d=(0,r.useRef)(null),f=(0,r.useRef)(null),p=(0,r.useRef)(e),m=(0,r.useRef)(t),h=(0,r.useRef)(n),g=(0,r.useRef)(s),_=(0,r.useRef)(()=>{});return(0,r.useEffect)(()=>{p.current=e,m.current=t,_.current(e,t)},[e,t]),(0,r.useEffect)(()=>{h.current=n},[n]),(0,r.useEffect)(()=>{g.current=s},[s]),(0,r.useEffect)(()=>{let e=d.current,t=f.current;!e||!t||(o?(e.position.set(0,190,.1),t.target.set(0,0,0)):(e.position.set(118,88,128),t.target.set(0,13,0)),t.update())},[o]),(0,r.useEffect)(()=>{let e=u.current;if(!e){l(`degraded`);return}let t=!1;l(`loading`);let n=new zn,r=new zs(42,1,.1,720);r.position.set(118,88,128),d.current=r;let o=new Pd({antialias:!0,alpha:!1,powerPreference:`high-performance`});o.setPixelRatio(Math.min(window.devicePixelRatio||1,1.35)),o.outputColorSpace=Re,o.toneMapping=4,o.toneMappingExposure=1.2,o.shadowMap.enabled=!0,o.shadowMap.type=1,e.appendChild(o.domElement);let s=new Gd(r,o.domElement);s.enableDamping=!0,s.dampingFactor=.055,s.minDistance=46,s.maxDistance=265,s.maxPolarAngle=Math.PI*.48,s.target.set(0,13,0),s.enableRotate=!0,s.enableZoom=!0,s.enablePan=!0,s.screenSpacePanning=!0,s.mouseButtons.LEFT=i.ROTATE,s.mouseButtons.MIDDLE=i.DOLLY,s.mouseButtons.RIGHT=i.PAN,s.touches.ONE=a.ROTATE,s.touches.TWO=a.DOLLY_PAN,f.current=s;let v=new Ds(11464447,462877,1.15);n.add(v);let y=new Ws(12447743,2.4);y.position.set(-70,128,68),y.castShadow=!0,y.shadow.mapSize.set(1024,1024),y.shadow.camera.left=-130,y.shadow.camera.right=130,y.shadow.camera.top=130,y.shadow.camera.bottom=-130,n.add(y);let b=new Vs(2743807,22,130,1.7);b.position.set(0,45,0),n.add(b);let x=[],S=[];for(let e=0;e<8;e++){let t=e/8*Math.PI*2,r=e%3==0?5083135:3533055,i=new Vs(r,9,58,1.75);i.position.set(Math.cos(t)*76,5.5,Math.sin(t)*76);let a=new Y(new Ho(.65,14,10),new li({color:r,transparent:!0,opacity:.8}));a.position.copy(i.position),n.add(i,a),x.push(i),S.push(a)}let C=new Z({color:466219,roughness:.78,metalness:.28}),w=new Y(new fa(124,128),C);w.rotation.x=-Math.PI/2,w.position.y=.65,w.receiveShadow=!0,n.add(w);let T=new Z({color:533299,metalness:.64,roughness:.32,emissive:338750,emissiveIntensity:.65}),E=new Y(new pa(120,124,2.4,128),T);E.position.y=-.5,n.add(E);let D=new pc(232,58,2482161,1532017);D.position.y=1.02,(Array.isArray(D.material)?D.material:[D.material]).forEach(e=>{e.transparent=!0,e.opacity=.2,e.depthWrite=!1}),n.add(D);let O=new Z({color:398110,roughness:.65,metalness:.35,emissive:332829}),k=new li({color:4517375,transparent:!0,opacity:.52});[-72,-46,-22,0,24,49,74].forEach((e,t)=>Cf(n,O,k,t===3?7.4:4.4,224,e,0,t%2?.025:-.02)),[-69,-43,-18,6,31,56,78].forEach((e,t)=>Cf(n,O,k,t===3?7.4:4.4,224,0,e,Math.PI/2+(t%2?.02:-.018)));let A=new li({color:3794431,transparent:!0,opacity:.38,side:2,depthWrite:!1}),ee=[];[37,70,105,118].forEach((e,t)=>{let r=new Y(new Vo(e-.18,e+.18,192),A.clone());r.rotation.x=-Math.PI/2,r.position.y=1.58+t*.01,n.add(r),ee.push(r)});let j=[18,29].map((e,t)=>{let r=new Y(new Uo(e,t===0?.11:.07,10,180),new li({color:t===0?5633023:5083135,transparent:!0,opacity:t===0?.74:.46,depthWrite:!1}));return r.rotation.x=Math.PI/2,r.position.y=2.05+t*.08,n.add(r),r}),M=new Z({color:480118,emissive:555676,emissiveIntensity:.55,roughness:.18,metalness:.38,transparent:!0,opacity:.92}),N=new Y(new Bo(246,9),M);N.rotation.x=-Math.PI/2,N.rotation.z=-.12,N.position.set(0,1.64,-83),n.add(N);let P=new Mi(new pa(.62,1.25,1,10),new ts({color:1456720,emissive:1886176,emissiveIntensity:.75,metalness:.8,roughness:.2,clearcoat:.9}),9),F=new tn;[[-8,-2,46],[-3,2,66],[3,1,54],[9,4,39],[15,-3,31],[-16,5,29],[20,9,23],[-22,-7,35],[5,-11,28]].forEach(([e,t,n],r)=>{F.compose(new q(e,1.7+n/2,t),new jt,new q(r%3==1?1.6:1,n,r%3==1?1.6:1)),P.setMatrixAt(r,F)}),P.castShadow=!0,n.add(P);let te=[],ne=[];xf.forEach(e=>{let t=new An;t.position.set(e.x,1.65,e.z);let r=new Y(new pa(.11,.32,15,14),new li({color:e.color,transparent:!0,opacity:.42}));r.position.y=7.5;let i=new Y(new zo(.82,1),new Z({color:e.color,emissive:e.color,emissiveIntensity:1.8,metalness:.6,roughness:.2}));i.position.y=15.7,i.userData.asset={id:e.id,label:e.label,category:`北京城市监管分区`,details:e.text,meta:`CITY AI · 实时推演 · 点击已定位`};let a=new Y(new Vo(1.25,1.62,48),new li({color:e.color,side:2,transparent:!0,opacity:.78}));a.rotation.x=-Math.PI/2,a.position.y=.22;let o=Sf(e.label,`#${e.color.toString(16).padStart(6,`0`)}`);o.position.y=18.1,t.add(r,i,a,o),n.add(t),te.push(i),ne.push(a)});let re=new is({color:5762303,transparent:!0,opacity:.48,dashSize:1.4,gapSize:.9}),ie=[];xf.forEach((e,t)=>{let r=new Aa([new q(0,4,0),new q(e.x*.45,13+t*1.5,e.z*.45),new q(e.x,3.5,e.z)]),i=new Yi(new Nr().setFromPoints(r.getPoints(60)),re.clone());i.computeLineDistances(),i.userData.curve=r,n.add(i),ie.push(i)});let ae=new li({color:13106175}),oe=xf.map((e,t)=>{let r=new Y(new Ho(.36,12,8),ae);return n.add(r),r.userData.routeIndex=t,r}),I=new Float32Array(720*3);for(let e=0;e<720;e++){let t=Math.random()*Math.PI*2,n=8+Math.sqrt(Math.random())*110;I[e*3]=Math.cos(t)*n,I[e*3+1]=2.5+Math.random()*17,I[e*3+2]=Math.sin(t)*n}let L=new Nr;L.setAttribute(`position`,new vr(I,3));let se=new ea({color:5631231,size:.34,transparent:!0,opacity:.72,depthWrite:!1}),ce=new aa(L,se);n.add(ce);let le=new li({color:3795711,transparent:!0,opacity:.2,side:2,depthWrite:!1}),ue=new Y(new Vo(2,2.6,96),le);ue.rotation.x=-Math.PI/2,ue.position.y=1.88,n.add(ue);let de=new ts({color:1521229,roughness:.3,metalness:.68,clearcoat:.72,clearcoatRoughness:.28,emissive:676459,emissiveIntensity:.48,vertexColors:!0}),fe={value:p.current&&m.current?2.2:1.15};de.onBeforeCompile=e=>{e.uniforms.windowStrength=fe,e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
          ...
          totalEmissiveRadiance += windowColor * windowShape * windowOn * windowStrength;`)};let pe=new X(1,1,1),me=new li({color:3729407,wireframe:!0,transparent:!0,opacity:.16,blending:2,depthWrite:!1}),he=new X(1,.12,1),ge=new li({color:8189439,transparent:!0,opacity:.72}),_e=null,ve=[],ye=[];(async()=>{try{let e=await fetch(`./beijing-buildings.json`);if(!e.ok)throw Error(`building dataset unavailable`);let r=await e.json();if(t)return;let i=r.buildings.filter(e=>e.points.length>=3).slice(0,5200),a=new Mi(pe,de,i.length);_e=a,ve=i;let o=new Mi(pe,me,i.length),s=i.filter(e=>(e.heightMeters||16)>40).slice(0,700),c=new Mi(he,ge,s.length),u=new tn,d=new tn,f=new J,p=e=>{let t=e.points.map(e=>e[0]),n=e.points.map(e=>e[1]);return{x:(Math.min(...t)+Math.max(...t))/3.35,z:(Math.min(...n)+Math.max(...n))/3.35,width:Math.max(.45,Math.min(6,(Math.max(...t)-Math.min(...t))/3.35)),depth:Math.max(.45,Math.min(6,(Math.max(...n)-Math.min(...n))/3.35)),height:Math.max(1.2,Math.min(58,(e.heightMeters||16)/5.2))}};i.forEach((e,t)=>{let{x:n,z:r,width:i,depth:s,height:c}=p(e);u.compose(new q(n,1.72+c/2,r),new jt,new q(i,c,s)),a.setMatrixAt(t,u),d.compose(new q(n,1.72+c/2,r),new jt,new q(i*1.018,c*1.006,s*1.018)),o.setMatrixAt(t,d);let l=Math.min(1,Math.sqrt(n*n+r*r)/110);f.setHSL(.51+l*.055+Math.random()*.018,.52,.31+(1-l)*.18+Math.random()*.08),a.setColorAt(t,f),ye.push(f.clone())}),s.forEach((e,t)=>{let{x:n,z:r,width:i,depth:a,height:o}=p(e);u.compose(new q(n,1.76+o,r),new jt,new q(i*.82,1,a*.82)),c.setMatrixAt(t,u)}),a.instanceMatrix.needsUpdate=!0,a.instanceColor.needsUpdate=!0,o.instanceMatrix.needsUpdate=!0,c.instanceMatrix.needsUpdate=!0,a.castShadow=!0,a.receiveShadow=!0,a.userData.asset={id:`beijing-building-network`,label:`北京城市建筑群`,category:`三维城市底座`,details:`${i.length.toLocaleString()} 栋建筑已接入城市数字孪生，支持空间定位、态势叠加与运行监测。`,meta:`建筑高度 · 区位编码 · 能耗状态 · 实时同步`},n.add(a,o,c),te.push(a),l(`ready`)}catch{t||l(`degraded`)}})();let be=new Mi(new X(1.15,.48,.62),new Z({color:14220031,emissive:3595759,emissiveIntensity:1.05,metalness:.55,roughness:.26}),54);be.instanceMatrix.setUsage(We),n.add(be);let R=new tn,xe=Array.from({length:54},(e,t)=>({axis:t%2,lane:[-72,-46,-22,0,24,49,74][t%7]+(t%3-1)*1.15,offset:t*17%224,speed:.15+t%7*.017}));_.current=(e,t)=>{n.background=new J(e?66570:466741),n.fog=new Rn(e?133138:666174,e?.0075:.0056),v.intensity=e?.42:1.15,y.intensity=e?.16:2.4,b.intensity=e?34:22,x.forEach((t,n)=>{t.intensity=e?13+n%2*2:7}),C.color.setHex(e?133906:466219),T.emissiveIntensity=e?1.1:.65,O.emissive.setHex(e?536640:332829),de.emissive.setHex(t?e?555932:676459:266780),de.emissiveIntensity=t?e?.95:.48:.1,fe.value=t?e?2.2:1.15:.03,me.opacity=t?e?.3:.16:.045,ge.opacity=t?e?.92:.72:.16,k.opacity=e?.82:.52,M.emissiveIntensity=e?.9:.55},_.current(p.current,m.current);let Se=new cc,Ce=new K,we=new J(10420223),Te=-1,Ee=null,De=0,Oe={x:0,y:0},ke=e=>{let t=o.domElement.getBoundingClientRect();Ce.set((e.clientX-t.left)/t.width*2-1,-((e.clientY-t.top)/t.height)*2+1)},z=()=>{_e&&Te>=0&&ye[Te]&&(_e.setColorAt(Te,ye[Te]),_e.instanceColor&&(_e.instanceColor.needsUpdate=!0)),Te=-1},Ae=()=>{Ee&&Ee.scale.setScalar(1),Ee=null},B=()=>{z(),Ae(),o.domElement.style.cursor=`grab`},je=e=>{let t=e.clientX,n=e.clientY;cancelAnimationFrame(De),De=requestAnimationFrame(()=>{let e=o.domElement.getBoundingClientRect();Ce.set((t-e.left)/e.width*2-1,-((n-e.top)/e.height)*2+1),Se.setFromCamera(Ce,r);let i=Se.intersectObjects(te,!1)[0],a=i?.object===_e&&i.instanceId!==void 0?i.instanceId:-1,s=i?.object.userData.asset&&i?.object!==_e?i.object:null;a!==Te&&(z(),_e&&a>=0&&(_e.setColorAt(a,we),_e.instanceColor&&(_e.instanceColor.needsUpdate=!0),Te=a)),s!==Ee&&(Ae(),Ee=s,Ee?.scale.setScalar(1.35)),o.domElement.style.cursor=i?`pointer`:`grab`})},V=e=>{if(Math.hypot(e.clientX-Oe.x,e.clientY-Oe.y)>5)return;ke(e),Se.setFromCamera(Ce,r);let t=Se.intersectObjects(te,!1)[0];if(t?.object===_e&&t.instanceId!==void 0){let e=ve[t.instanceId],n=e?.id??t.instanceId+1,r=Math.round(e?.heightMeters||16);c({id:`building-${n}`,label:e?.name||`北京城市建筑 ${String(n).padStart(5,`0`)}`,category:`北京三维建筑资产`,details:`建筑高度约 ${r} 米，已接入北京城市数字孪生底座，可叠加能耗、安防、交通及应急态势数据。`,meta:`资产编号 BJ-${String(n).padStart(6,`0`)} · 实时在线 · 单击定位`});return}let n=t?.object.userData.asset;c(n||null)},Me=e=>{Oe={x:e.clientX,y:e.clientY}};o.domElement.addEventListener(`pointermove`,je),o.domElement.addEventListener(`pointerleave`,B),o.domElement.addEventListener(`pointerdown`,Me),o.domElement.addEventListener(`pointerup`,V);let H=()=>{let t=Math.max(1,e.clientWidth),n=Math.max(1,e.clientHeight);r.aspect=t/n,r.updateProjectionMatrix(),o.setSize(t,n,!1)},U=new ResizeObserver(H);U.observe(e),H();let Ne=null,Pe=(e,t,n=1250)=>{Ne={from:r.position.clone(),to:new q(...e),targetFrom:s.target.clone(),targetTo:new q(...t),start:performance.now(),duration:n},s.enabled=!1},Fe=e=>{let t=e.detail;if(t===`zoomIn`||t===`zoomOut`){let e=t===`zoomIn`?.82:1.18,n=r.position.clone().sub(s.target).multiplyScalar(e);r.position.copy(s.target).add(n),s.update();return}if(t===`reset`){Pe(bf.panorama.position,bf.panorama.target);return}if(typeof t==`object`&&t.action===`view`&&t.view&&bf[t.view]){let e=bf[t.view];Pe(e.position,e.target);return}typeof t==`object`&&t.action===`focus`&&t.position&&t.target&&Pe(t.position,t.target,1050)};window.addEventListener(`smart-city-camera`,Fe);let Ie=performance.now(),Le=0,ze=e=>{Le=requestAnimationFrame(ze);let t=(e-Ie)/1e3,i=Math.min(54,g.current);if(be.count=i,xe.forEach((e,n)=>{if(n>=i)return;let r=(e.offset+t*e.speed*30)%224-112,a=e.axis?r:e.lane,o=e.axis?e.lane:r,s=new jt().setFromEuler(new fn(0,e.axis?Math.PI/2:0,0));R.compose(new q(a,2.12,o),s,new q(1,1,1)),be.setMatrixAt(n,R)}),be.instanceMatrix.needsUpdate=!0,ue.scale.setScalar(1+t*.2%1*43),le.opacity=.24*(1-t*.2%1),se.opacity=.5+Math.sin(t*2.2)*.22,ee.forEach((e,n)=>{e.rotation.z=t*(n%2?-.025:.02),e.material.opacity=.23+Math.sin(t*1.4+n)*.12}),j.forEach((e,n)=>{e.rotation.z=t*(n===0?.08:-.055),e.material.opacity=(n===0?.62:.4)+Math.sin(t*1.7+n)*.12}),S.forEach((e,n)=>{let r=.88+Math.sin(t*2.4+n*.7)*.22;e.scale.setScalar(r)}),ne.forEach((e,n)=>{let r=1+Math.sin(t*2+n)*.12;e.scale.setScalar(r)}),ie.forEach((e,n)=>{e.material.dashOffset=-t*(.8+n*.14)}),oe.forEach((e,n)=>{let r=ie[n].userData.curve;e.position.copy(r.getPoint((t*.13+n*.22)%1))}),Ne){let t=Math.min(1,(e-Ne.start)/Ne.duration),n=1-(1-t)**3;r.position.lerpVectors(Ne.from,Ne.to,n),s.target.lerpVectors(Ne.targetFrom,Ne.targetTo,n),t>=1&&(Ne=null,s.enabled=!0)}else h.current&&(r.position.x=Math.cos(t*.075)*150,r.position.z=Math.sin(t*.075)*150,r.position.y=79+Math.sin(t*.11)*14,s.target.set(0,12,0));s.update(),o.render(n,r)};return Le=requestAnimationFrame(ze),()=>{t=!0,cancelAnimationFrame(Le),cancelAnimationFrame(De),U.disconnect(),o.domElement.removeEventListener(`pointermove`,je),o.domElement.removeEventListener(`pointerleave`,B),o.domElement.removeEventListener(`pointerdown`,Me),o.domElement.removeEventListener(`pointerup`,V),window.removeEventListener(`smart-city-camera`,Fe),s.dispose(),o.dispose(),n.traverse(e=>{let t=e;t.geometry?.dispose?.(),Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material?.dispose?.()}),o.domElement.remove()}},[l,c]),(0,$.jsx)(`div`,{ref:u,className:`smart-city-scene`,"aria-label":`北京科幻智慧城市三维数字孪生场景`})}function Tf({data:e,onClose:t,tone:n=`cyan`}){return(0,$.jsxs)(`div`,{className:`data-detail-layer ${n}`,role:`presentation`,children:[(0,$.jsx)(`button`,{className:`data-detail-backdrop`,"aria-label":`关闭数据详情`,onClick:t}),(0,$.jsxs)(`section`,{className:`data-detail-dialog`,role:`dialog`,"aria-modal":`true`,"aria-label":`${e.label}数据详情`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{children:`DATA INSIGHT · 实时数据详情`})]}),(0,$.jsx)(`button`,{"aria-label":`关闭数据详情`,onClick:t,children:`×`})]}),(0,$.jsxs)(`div`,{className:`data-detail-body`,children:[(0,$.jsx)(`span`,{children:e.category}),(0,$.jsx)(`h2`,{children:e.label}),(0,$.jsx)(`p`,{children:e.details}),(0,$.jsxs)(`div`,{className:`data-detail-meta`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`数据状态`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(`i`,{}),`实时更新`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`研判结果`}),(0,$.jsx)(`b`,{children:e.meta})]})]})]}),(0,$.jsxs)(`footer`,{children:[(0,$.jsx)(`span`,{children:`城市感知网络 · AI 决策引擎`}),(0,$.jsx)(`button`,{onClick:t,children:`关闭详情`})]})]})]})}var Ef=[`全域态势`,`城市治理`,`交通脉搏`,`生态能源`,`公共安全`],Df=[{name:`朝阳`,score:97.2,tone:`cyan`,value:`商务活跃`},{name:`海淀`,score:95.8,tone:`blue`,value:`科技创新`},{name:`东城`,score:94.6,tone:`green`,value:`治理高效`},{name:`丰台`,score:91.9,tone:`orange`,value:`枢纽畅通`}],Of=[{time:`21:26:48`,level:`AI`,text:`朝阳区交通流量预测完成`,state:`已闭环`},{time:`21:25:32`,level:`感`,text:`海淀区感知节点状态巡检`,state:`正常`},{time:`21:24:16`,level:`能`,text:`全市电网负荷进入平稳区间`,state:`稳定`},{time:`21:22:09`,level:`环`,text:`城市空气质量模型已更新`,state:`优良`}],kf=[`全市感知设备在线率 99.97%`,`重点道路平均车速 41.8 km/h`,`轨道交通在途列车 1,284 列`,`空气质量优良率 94.6%`,`城市事件智能闭环率 96.8%`,`新能源消纳比例 38.7%`],Af=[{id:`panorama`,code:`01`,label:`全景`},{id:`cbd`,code:`02`,label:`CBD`},{id:`axis`,code:`03`,label:`中轴`},{id:`top`,code:`04`,label:`俯瞰`},{id:`horizon`,code:`05`,label:`天际`}],jf={朝阳:{position:[83,45,72],target:[38,9,18]},海淀:{position:[-88,48,82],target:[-48,9,40]},东城:{position:[-58,42,-58],target:[-22,9,-15]},丰台:{position:[52,43,-91],target:[12,8,-48]}};function Mf({displayName:e,onOpenDemo:t,onLogout:n}){let[i,a]=(0,r.useState)(`全域态势`),[o,s]=(0,r.useState)(!0),[c,l]=(0,r.useState)(!0),[u,d]=(0,r.useState)(!0),[f,p]=(0,r.useState)(!1),[m,h]=(0,r.useState)(54),[g,_]=(0,r.useState)(null),[v,y]=(0,r.useState)(`loading`),[b,x]=(0,r.useState)(()=>new Date),[S,C]=(0,r.useState)(0),[w,T]=(0,r.useState)(!1),[E,D]=(0,r.useState)(`panorama`),[O,k]=(0,r.useState)(`左键拖拽旋转 · 滚轮缩放 · 右键平移 · 点击建筑查看详情`),[A,ee]=(0,r.useState)(0);(0,r.useEffect)(()=>{let e=window.setInterval(()=>x(new Date),1e3),t=window.setInterval(()=>C(e=>(e+1)%8),2400),n=window.requestAnimationFrame(()=>T(!0));return()=>{window.clearInterval(e),window.clearInterval(t),window.cancelAnimationFrame(n)}},[]);let j=(0,r.useCallback)(e=>{k(e),ee(e=>e+1)},[]),M=(0,r.useCallback)((e,t,n,r,i)=>{_({id:`insight-${e}`,label:t,category:n,details:r,meta:i}),j(`已打开：${t} · 右侧详情卡片已更新`)},[j]),N=(0,r.useCallback)(e=>{_(e),e&&j(`已选中：${e.label} · 详情卡片已展开`)},[j]),P=b.toLocaleTimeString(`zh-CN`,{hour12:!1}),F=b.toLocaleDateString(`zh-CN`,{year:`numeric`,month:`2-digit`,day:`2-digit`}),te=[`星期日`,`星期一`,`星期二`,`星期三`,`星期四`,`星期五`,`星期六`][b.getDay()],ne=(0,r.useMemo)(()=>v===`loading`?`正在构建北京三维建筑群`:v===`degraded`?`城市基础模型已启用`:`5,200 栋建筑在线 · 城市光网运行中`,[v]),re=e=>{d(!1),p(!1),D(`panorama`),_({id:`district-${e.name}`,label:`${e.name}区`,category:`城区运行态势`,details:`${e.value}，当前城区综合运行指数 ${e.score}，城市感知、交通与公共服务状态正常。`,meta:`AI 评分 ${e.score} · 数据刷新 128ms`});let t=jf[e.name];window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:{action:`focus`,position:t.position,target:t.target}})),j(`正在聚焦${e.name}区 · 镜头已进入城区态势视角`)},ie=e=>{d(!1),p(!1),D(e.id),window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:{action:`view`,view:e.id}})),j(`视角切换：${e.label} · 镜头缓动飞行中`)};return(0,$.jsxs)(`main`,{className:`future-city ${o?`night`:`day`}`,children:[(0,$.jsx)(`div`,{className:`future-grid`,"aria-hidden":`true`}),(0,$.jsx)(`div`,{className:`future-aurora future-aurora-a`,"aria-hidden":`true`}),(0,$.jsx)(`div`,{className:`future-aurora future-aurora-b`,"aria-hidden":`true`}),(0,$.jsxs)(`header`,{className:`future-header`,children:[(0,$.jsxs)(`div`,{className:`future-brand`,children:[(0,$.jsxs)(`div`,{className:`future-brand-symbol`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`b`,{})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:`京域智城`}),(0,$.jsx)(`span`,{children:`BEIJING URBAN INTELLIGENCE CENTER`})]})]}),(0,$.jsxs)(`div`,{className:`future-heading`,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`i`,{}),` BEIJING DIGITAL TWIN · 2026`]}),(0,$.jsx)(`h1`,{children:`北京市智慧城市运行指挥中心`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`b`,{children:`全域感知`}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]})]}),(0,$.jsxs)(`div`,{className:`future-account`,children:[(0,$.jsxs)(`div`,{className:`future-time`,children:[(0,$.jsx)(`strong`,{children:P}),(0,$.jsxs)(`span`,{children:[F,` · `,te]})]}),(0,$.jsxs)(`div`,{className:`future-user`,children:[(0,$.jsx)(`i`,{}),e,(0,$.jsx)(`button`,{onClick:n,children:`退出`})]})]})]}),(0,$.jsx)(`nav`,{className:`future-nav`,"aria-label":`智慧城市功能导航`,children:Ef.map((e,t)=>(0,$.jsxs)(`button`,{className:i===e?`active`:``,onClick:()=>a(e),children:[(0,$.jsxs)(`i`,{children:[`0`,t+1]}),(0,$.jsx)(`span`,{children:e})]},e))}),(0,$.jsxs)(`section`,{className:`future-stage`,children:[(0,$.jsxs)(`aside`,{className:`future-column left`,children:[(0,$.jsxs)(`section`,{className:`future-panel city-vitals`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`01`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`城市生命体征`}),(0,$.jsx)(`em`,{children:`URBAN VITAL SIGNS`})]}),(0,$.jsx)(`i`,{children:`LIVE`})]}),(0,$.jsxs)(`div`,{className:`vital-primary`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`常住人口`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:2183.2,decimals:1})}),(0,$.jsx)(`em`,{children:`万人`})]}),(0,$.jsx)(`div`,{className:`vital-wave`,"aria-hidden":`true`,children:[34,52,41,68,48,76,57,82,61,72,55,88].map((e,t)=>(0,$.jsx)(`i`,{style:{height:`${e}%`}},t))})]}),(0,$.jsxs)(`div`,{className:`vital-grid`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`area`,`北京市域面积`,`城市生命体征`,`全市域面积 16,410 平方公里，数字孪生已覆盖核心城区、重点交通走廊和公共服务节点。`,`全域覆盖 · 数据更新 128ms`),children:[(0,$.jsx)(`span`,{children:`城市面积`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(_f,{to:16410}),(0,$.jsx)(`small`,{children:` km²`})]}),(0,$.jsx)(`em`,{children:`全域覆盖`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`gdp`,`地区生产总值`,`城市生命体征`,`城市经济运行保持稳健，数字经济、科技服务和现代服务业构成主要增长动能。`,`4.98 万亿元 · 同比 +5.2%`),children:[(0,$.jsx)(`span`,{children:`地区生产总值`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(_f,{to:4.98,decimals:2}),(0,$.jsx)(`small`,{children:` 万亿元`})]}),(0,$.jsx)(`em`,{children:`同比 +5.2%`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`rail`,`轨道交通网络`,`城市生命体征`,`轨道交通运营里程 879 公里，1,284 列列车在途，关键换乘枢纽运行正常。`,`线网联动 · 平均准点率 99.6%`),children:[(0,$.jsx)(`span`,{children:`轨道交通`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(_f,{to:879}),(0,$.jsx)(`small`,{children:` km`})]}),(0,$.jsx)(`em`,{children:`在途 1,284 列`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`parks`,`公园绿地体系`,`城市生命体征`,`全市 1,064 处公园绿地接入生态监测，绿色空间覆盖率达到 49.8%。`,`生态感知 · 1,064 处在线`),children:[(0,$.jsx)(`span`,{children:`公园绿地`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(_f,{to:1064}),(0,$.jsx)(`small`,{children:` 处`})]}),(0,$.jsx)(`em`,{children:`绿色空间 49.8%`})]})]})]}),(0,$.jsxs)(`section`,{className:`future-panel event-center`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`02`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`城市事件中枢`}),(0,$.jsx)(`em`,{children:`AI EVENT STREAM`})]}),(0,$.jsx)(`i`,{children:`04`})]}),(0,$.jsx)(`div`,{className:`event-list`,children:Of.map((e,t)=>(0,$.jsxs)(`button`,{type:`button`,className:`event-row ${S===t?`pulse`:``}`,onClick:()=>M(`event-${t}`,e.text,`城市事件中枢`,`${e.time} 由${e.level}类城市感知模型完成研判，当前处置状态为“${e.state}”。`,`事件编号 BJ-${e.time.replaceAll(`:`,``)} · ${e.state}`),children:[(0,$.jsx)(`time`,{children:e.time}),(0,$.jsx)(`i`,{children:e.level}),(0,$.jsxs)(`p`,{children:[e.text,(0,$.jsx)(`span`,{children:e.state})]})]},e.time))})]}),(0,$.jsxs)(`section`,{className:`future-panel eco-panel`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`03`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`生态环境监测`}),(0,$.jsx)(`em`,{children:`ECOLOGICAL MONITORING`})]}),(0,$.jsx)(`i`,{children:`优`})]}),(0,$.jsxs)(`div`,{className:`eco-content`,children:[(0,$.jsxs)(`button`,{type:`button`,className:`air-orbit`,onClick:()=>M(`pm25`,`PM2.5 实时监测`,`生态环境监测`,`北京市核心区 PM2.5 当前浓度为 28 μg/m³，空气质量等级为优。`,`气象与环境感知网 · 分钟级刷新`),children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`b`,{children:`28`}),(0,$.jsx)(`span`,{children:`PM2.5`})]}),(0,$.jsxs)(`div`,{className:`eco-stats`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`air`,`空气优良率`,`生态环境监测`,`全市空气质量优良率达到 94.6%，重点站点均处于正常监测状态。`,`94.6% · 较昨日 +1.2%`),children:[(0,$.jsx)(`span`,{children:`空气优良率`}),(0,$.jsx)(`b`,{children:`94.6%`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`temperature`,`城市平均温度`,`生态环境监测`,`当前城市平均温度 26.3°C，热岛强度处于可控区间。`,`26.3°C · 东南风 3.4m/s`),children:[(0,$.jsx)(`span`,{children:`平均温度`}),(0,$.jsx)(`b`,{children:`26.3°C`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`carbon`,`碳排强度`,`生态环境监测`,`城市单位产出碳排强度同比下降 4.8%，新能源消纳比例持续提升。`,`-4.8% · 绿色转型稳定`),children:[(0,$.jsx)(`span`,{children:`碳排强度`}),(0,$.jsx)(`b`,{children:`-4.8%`})]})]})]})]})]}),(0,$.jsxs)(`section`,{className:`future-center`,children:[(0,$.jsxs)(`div`,{className:`scene-head`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{children:i}),(0,$.jsx)(`b`,{children:`北京核心区三维数字孪生`})]}),(0,$.jsx)(`em`,{className:v,children:ne})]}),(0,$.jsxs)(`div`,{className:`future-scene`,children:[(0,$.jsx)(wf,{topView:f,nightMode:o,buildingLights:c,autoTour:u,trafficDensity:m,onSelect:N,onSceneStatus:y}),(0,$.jsx)(`div`,{className:`scene-scanline`,"aria-hidden":`true`}),(0,$.jsxs)(`div`,{className:`scene-corners`,"aria-hidden":`true`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]}),(0,$.jsxs)(`div`,{className:`scene-coordinate`,children:[(0,$.jsx)(`span`,{children:`39°54′27″N`}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{children:`116°27′07″E`}),(0,$.jsx)(`b`,{children:`BEIJING`})]}),(0,$.jsxs)(`div`,{className:`scene-layer`,children:[(0,$.jsx)(`span`,{children:`DATA LAYERS`}),(0,$.jsx)(`i`,{className:`cyan`}),(0,$.jsx)(`em`,{children:`建筑`}),(0,$.jsx)(`i`,{className:`blue`}),(0,$.jsx)(`em`,{children:`交通`}),(0,$.jsx)(`i`,{className:`green`}),(0,$.jsx)(`em`,{children:`感知`})]}),(0,$.jsxs)(`div`,{className:`scene-orientation`,children:[(0,$.jsx)(`b`,{children:`N`}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{children:`024°`})]}),(0,$.jsx)(`div`,{className:`scene-districts`,children:Df.map(e=>(0,$.jsxs)(`button`,{onClick:()=>re(e),children:[(0,$.jsx)(`i`,{className:e.tone}),(0,$.jsx)(`span`,{children:e.name}),(0,$.jsx)(`b`,{children:e.score})]},e.name))}),(0,$.jsxs)(`div`,{className:`scene-view-presets`,"aria-label":`预设三维视角`,children:[(0,$.jsx)(`span`,{children:`VIEW`}),Af.map(e=>(0,$.jsxs)(`button`,{className:E===e.id?`active`:``,onClick:()=>ie(e),"aria-label":`切换至${e.label}视角`,children:[(0,$.jsx)(`i`,{children:e.code}),(0,$.jsx)(`b`,{children:e.label})]},e.id))]}),(0,$.jsxs)(`div`,{className:`scene-operation-tip`,role:`status`,"aria-live":`polite`,children:[(0,$.jsx)(`i`,{children:`⌁`}),(0,$.jsx)(`span`,{children:O})]},A),(0,$.jsxs)(`div`,{className:`scene-controls`,children:[(0,$.jsxs)(`button`,{className:f?`on`:``,onClick:()=>{let e=!f;d(!1),p(e),D(e?`top`:`panorama`),j(e?`垂直俯视已开启 · 可滚轮缩放查看建筑分布`:`已恢复自由视角`)},children:[(0,$.jsx)(`i`,{children:`◇`}),f?`自由视角`:`垂直俯视`]}),(0,$.jsxs)(`button`,{className:u?`on`:``,onClick:()=>{let e=!u;d(e),p(!1),j(e?`自动巡航已启动 · 手动选视角可随时接管`:`自动巡航已暂停`)},children:[(0,$.jsx)(`i`,{children:u?`■`:`▶`}),u?`停止巡航`:`自动巡航`]}),(0,$.jsxs)(`button`,{className:c?`on`:``,onClick:()=>{let e=!c;l(e),j(e?`建筑光网已点亮`:`建筑光网已隐藏`)},children:[(0,$.jsx)(`i`,{children:`✦`}),`建筑光网`]}),(0,$.jsxs)(`button`,{onClick:()=>{let e=!o;s(e),j(e?`已切换至夜间城市模式`:`已切换至日间城市模式`)},children:[(0,$.jsx)(`i`,{children:o?`☀`:`☾`}),o?`日间模式`:`夜间模式`]}),(0,$.jsxs)(`button`,{onClick:()=>{let e=m===18?36:m===36?54:18;h(e),j(`动态车流密度已调整为 ${e} 辆`)},children:[(0,$.jsx)(`i`,{children:`⇄`}),`车流 `,m]}),(0,$.jsxs)(`button`,{"aria-label":`复位三维视角`,onClick:()=>{d(!1),p(!1),D(`panorama`),window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:`reset`})),j(`三维视角已复位至北京城市全景`)},children:[(0,$.jsx)(`i`,{children:`⌖`}),`视角复位`]})]}),(0,$.jsxs)(`div`,{className:`scene-zoom`,children:[(0,$.jsx)(`button`,{"aria-label":`放大城市模型`,onClick:()=>window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:`zoomIn`})),children:`＋`}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`button`,{"aria-label":`缩小城市模型`,onClick:()=>window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:`zoomOut`})),children:`−`})]})]})]}),(0,$.jsxs)(`aside`,{className:`future-column right`,children:[(0,$.jsxs)(`section`,{className:`future-panel ai-index`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`04`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`城市智能指数`}),(0,$.jsx)(`em`,{children:`CITY AI INDEX`})]}),(0,$.jsx)(`i`,{children:`TOP 1`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`ai-score`,onClick:()=>M(`ai-score`,`城市智能指数 96.4`,`城市 AI 大脑`,`综合感知覆盖、协同效率、预测准确和处置闭环四项能力，当前城市智能指数为 96.4。`,`全国领先 · 较昨日 +1.8%`),children:[(0,$.jsxs)(`div`,{className:`score-rings`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:96.4,decimals:1})}),(0,$.jsx)(`span`,{children:`综合评分`})]}),(0,$.jsxs)(`div`,{className:`score-copy`,children:[(0,$.jsx)(`span`,{children:`AI 城市大脑`}),(0,$.jsx)(`b`,{children:`运行卓越`}),(0,$.jsx)(`em`,{children:`较昨日 +1.8%`}),(0,$.jsx)(`p`,{children:`城市治理模型实时计算中`})]})]}),(0,$.jsx)(`div`,{className:`ai-dimensions`,children:[[`感知覆盖`,98],[`协同效率`,94],[`预测准确`,96],[`处置闭环`,97]].map(([e,t],n)=>(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`ai-${n}`,`${e} ${t}%`,`城市 AI 能力维度`,`${e}能力已接入城市级模型评估，当前得分 ${t}%，运行状态稳定。`,`AI ENGINE · 第 ${n+1} 维度`),children:[(0,$.jsx)(`span`,{children:e}),(0,$.jsx)(`i`,{children:(0,$.jsx)(`b`,{style:{width:w?`${t}%`:`0%`,transitionDelay:`${n*120}ms`}})}),(0,$.jsxs)(`em`,{children:[t,`%`]})]},e))})]}),(0,$.jsxs)(`section`,{className:`future-panel traffic-panel`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`05`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`交通运行脉搏`}),(0,$.jsx)(`em`,{children:`TRAFFIC MOBILITY`})]}),(0,$.jsx)(`i`,{children:`畅通`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`traffic-number`,onClick:()=>M(`traffic-index`,`全路网交通指数`,`交通运行脉搏`,`全路网交通指数 1.42，整体处于畅通等级，重点道路信号协调运行正常。`,`指数 1.42 · 畅通`),children:[(0,$.jsx)(`span`,{children:`全路网交通指数`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:1.42,decimals:2})}),(0,$.jsx)(`em`,{children:`畅通`})]}),(0,$.jsx)(`button`,{type:`button`,className:`traffic-flow`,"aria-label":`调整并查看交通流量趋势`,onClick:()=>{let e=m===18?36:m===36?54:18;h(e),M(`traffic-flow`,`近八小时交通流量`,`交通运行脉搏`,`已将三维城市动态车流调整为 ${e} 辆，可在中央地图观察道路车流变化。`,`点击循环调节 · 当前密度 ${e}`)},children:[31,43,52,47,68,76,64,83,71,62,54,59,46,39].map((e,t)=>(0,$.jsx)(`i`,{style:{height:w?`${e}%`:`0%`,transitionDelay:`${t*55}ms`}},t))}),(0,$.jsxs)(`div`,{className:`traffic-meta`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`speed`,`道路平均车速`,`交通运行脉搏`,`全市重点道路平均车速 41.8 km/h，当前车速变化处于模型预测范围内。`,`41.8 km/h · 实时计算`),children:[(0,$.jsx)(`span`,{children:`平均车速`}),(0,$.jsx)(`b`,{children:`41.8 km/h`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`congestion`,`拥堵道路里程`,`交通运行脉搏`,`当前拥堵道路总里程 28.6 km，拥堵主要集中于晚高峰重点走廊。`,`28.6 km · 动态监测`),children:[(0,$.jsx)(`span`,{children:`拥堵里程`}),(0,$.jsx)(`b`,{children:`28.6 km`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>M(`signals`,`信号协调率`,`交通运行脉搏`,`城市信号控制协调率达到 92.7%，重点路口绿波方案处于自动优化状态。`,`92.7% · AI 信号控制`),children:[(0,$.jsx)(`span`,{children:`信号协调率`}),(0,$.jsx)(`b`,{children:`92.7%`})]})]})]}),(0,$.jsxs)(`section`,{className:`future-panel district-rank`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`06`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`城区运行排行`}),(0,$.jsx)(`em`,{children:`DISTRICT RANKING`})]}),(0,$.jsx)(`i`,{children:`16 区`})]}),(0,$.jsx)(`div`,{children:Df.map((e,t)=>(0,$.jsxs)(`button`,{onClick:()=>re(e),children:[(0,$.jsx)(`i`,{children:String(t+1).padStart(2,`0`)}),(0,$.jsxs)(`span`,{children:[e.name,`区`,(0,$.jsx)(`em`,{children:(0,$.jsx)(`b`,{style:{width:w?`${e.score}%`:`0%`,transitionDelay:`${t*120}ms`}})})]}),(0,$.jsx)(`strong`,{children:e.score}),(0,$.jsx)(`small`,{children:e.value})]},e.name))})]}),(0,$.jsxs)(`button`,{className:`future-demo-card`,onClick:t,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`FEATURED AI DEMO`}),(0,$.jsx)(`em`,{children:`01`})]}),(0,$.jsx)(`strong`,{children:`灵境哨兵`}),(0,$.jsx)(`p`,{children:`危化品运输事故全链路智能处置`}),(0,$.jsx)(`b`,{children:`事故识别 · 扩散计算 · 路径重规划`}),(0,$.jsxs)(`i`,{children:[`立即进入演示项目 `,(0,$.jsx)(`span`,{children:`→`})]})]})]})]}),g&&(0,$.jsx)(Tf,{data:g,onClose:()=>_(null)}),(0,$.jsxs)(`footer`,{className:`future-footer`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{}),`CITY DATA STREAM`]}),(0,$.jsx)(`section`,{children:(0,$.jsx)(`span`,{children:kf.join(`　　◇　　`)})}),(0,$.jsxs)(`em`,{children:[`DATA LATENCY `,(0,$.jsx)(`b`,{children:`128 ms`})]}),(0,$.jsxs)(`strong`,{children:[(0,$.jsx)(`i`,{}),`AI ENGINE ONLINE`]})]})]})}var Nf=(e,t,n)=>Math.max(t,Math.min(n,e));async function Pf(e){let t=await createImageBitmap(e),n=Math.max(120,Math.round(240*t.height/t.width)),r=document.createElement(`canvas`);r.width=240,r.height=n;let i=r.getContext(`2d`,{willReadFrequently:!0});i.drawImage(t,0,0,240,n),t.close();let a=i.getImageData(0,0,240,n).data,o=0,s=0,c=0,l=0,u=new Uint8Array(240*n);for(let e=0;e<240*n;e++){let t=a[e*4],n=a[e*4+1],r=a[e*4+2],i=Math.max(t,n,r),c=Math.min(t,n,r),l=i===0?0:(i-c)/i,d=(i+c)/510,f=l<.22&&d>.27&&d<.88,p=t>n*1.02&&n>r*1.12&&d>.32;(f||p)&&o++,t>165&&t>n*1.35&&n>r*1.15&&s++,u[e]=Math.round(t*.299+n*.587+r*.114)}for(let e=1;e<n;e+=2)for(let t=1;t<240;t+=2){let n=e*240+t;Math.abs(u[n]-u[n-1])+Math.abs(u[n]-u[n-240])>52&&c++,l++}let d=240*n,f=o/d,p=s/d,m=c/l;return{type:p>.045?`火灾伴随危险品泄漏`:f>.16?`疑似有毒气体泄漏`:`道路危化品事故`,confidence:Nf(.68+f*.72+m*.16+p*.8,.71,.982),smokeRatio:f,flameRatio:p,edgeDensity:m,persons:Math.max(3,Math.round(8+m*46+p*30)),summary:`检测到烟羽特征 ${(f*100).toFixed(1)}%，边缘复杂度 ${(m*100).toFixed(1)}%。建议启动危化品二级响应。`}}function Ff(e,t,n=8e4,r=2.5){let i=.08*e/Math.sqrt(1+1e-4*e),a=.06*e/Math.sqrt(1+.0015*e);return n/(2*Math.PI*t*i*a)*Math.exp(-(r*r)/(2*a*a))}function If(e,t,n){let r=Math.max(20,n*t*60),i=20;for(let t=20;t<=Math.min(r,3200);t+=10)Ff(t,n)>=e&&(i=t);let a=.08*i/Math.sqrt(1+1e-4*i);return{distance:i,width:a*4.3}}function Lf(e,t=3.4){let n=If(145,e,t),r=If(29,e,t),i=If(2.9,e,t),a=Math.PI*(i.distance/2)*(i.width/2),o=Math.round(a*.0078);return{lethal:n.distance,high:r.distance,warning:i.distance,lethalWidth:n.width,highWidth:r.width,warningWidth:i.width,affectedPeople:o,model:`Gaussian Plume · Pasquill-D`}}var Rf=[{id:`S`,x:-35,z:-30},{id:`A`,x:-22,z:-17},{id:`B`,x:-13,z:-10},{id:`I`,x:-3,z:-3},{id:`C`,x:-42,z:-4},{id:`D`,x:-25,z:7},{id:`E`,x:-11,z:5},{id:`F`,x:-31,z:20}],zf=[`S-A`,`A-B`,`B-I`,`S-C`,`C-D`,`D-E`,`E-I`,`C-F`,`F-E`],Bf=(e,t)=>Math.hypot(e.x-t.x,e.z-t.z);function Vf(e=!1){let t=e?new Set([`B-I`,`I-B`]):new Set,n=new Set([`S`]),r=new Map,i=new Map(Rf.map(e=>[e.id,1/0])),a=new Map(Rf.map(e=>[e.id,1/0]));i.set(`S`,0),a.set(`S`,Bf(Rf[0],Rf[3]));let o=0;for(;n.size;){let e=[...n].sort((e,t)=>(a.get(e)??1/0)-(a.get(t)??1/0))[0];if(o++,e===`I`){let t=[e];for(;r.has(e);)e=r.get(e),t.unshift(e);let n=t.map(e=>Rf.find(t=>t.id===e)),a=Math.round((i.get(`I`)??0)*78);return{path:n,distance:a,eta:Math.ceil(a/520),visited:o,algorithm:`A* · Euclidean heuristic`}}n.delete(e);for(let o of zf){let[s,c]=o.split(`-`),l;if(s===e&&(l=c),c===e&&(l=s),!l||t.has(`${e}-${l}`))continue;let u=Rf.find(t=>t.id===e),d=Rf.find(e=>e.id===l),f=(i.get(e)??1/0)+Bf(u,d);f<(i.get(l)??1/0)&&(r.set(l,e),i.set(l,f),a.set(l,f+Bf(d,Rf[3])),n.add(l))}}return{path:[],distance:0,eta:0,visited:o,algorithm:`A* · no path`}}var Hf=[{icon:`焰`,name:`消防智能体`,text:`2 辆泡沫消防车已从青岚站出发`,tone:`orange`},{icon:`十`,name:`医疗智能体`,text:`三级医院开放绿色救援通道`,tone:`cyan`},{icon:`路`,name:`交通智能体`,text:`已建立 3.2 km 应急绿波带`,tone:`blue`},{icon:`盾`,name:`指挥智能体`,text:`建议启动学校二级疏散预案`,tone:`purple`}],Uf=[{id:`overview`,label:`态势总览`},{id:`events`,label:`事件中心`},{id:`resources`,label:`资源调度`},{id:`archives`,label:`推演档案`}],Wf=[{id:0,start:0,end:0,clock:`14:32:00`,icon:`待`,title:`全流程演示就绪`,subtitle:`化学废料车辆事故联合处置`,detail:`一键播放车辆行驶、突发故障、AI 告警、消防出警、医疗救援与警力疏散完整链路。`,metric:`72 秒 · 9 阶段`},{id:1,start:0,end:7,clock:`14:32:00`,icon:`运`,title:`正常运输`,subtitle:`化学废料运输车沿北京真实道路行驶`,detail:`京A·WH2576 · 车速 32 km/h · 罐体压力与尾阀状态正常`,metric:`OSM 实时轨迹`},{id:2,start:7,end:13,clock:`14:32:07`,icon:`故`,title:`突发故障`,subtitle:`车辆动力系统失效并紧急制动`,detail:`罐体尾阀受冲击松动 · 双闪开启 · 检测到黄绿色挥发气体`,metric:`自动停车 · 遥测异常`},{id:3,start:13,end:20,clock:`14:32:13`,icon:`AI`,title:`AI 告警`,subtitle:`识别为含氯化学废料泄漏`,detail:`事故图片识别置信度 96.8% · 高斯烟羽模型开始风险扩散计算`,metric:`Ⅰ级联合响应`},{id:4,start:20,end:27,clock:`14:32:20`,icon:`调`,title:`联合调度`,subtitle:`消防、医疗和交警同步接收指令`,detail:`基于 OSM 真实路网生成三条应急路线 · 自动建立救援优先通行权`,metric:`A* 路径已生成`},{id:5,start:27,end:40,clock:`14:32:27`,icon:`驰`,title:`力量赶赴`,subtitle:`三支队伍沿真实道路接近现场`,detail:`警车先期抵达 · 消防车携带泡沫与洗消设备 · 医疗组开放绿色通道`,metric:`动态 ETA 更新`},{id:6,start:40,end:49,clock:`14:32:40`,icon:`警`,title:`交通疏散`,subtitle:`警车到场并建立 500 米封控区`,detail:`3 个路口完成管制 · 社会车流主动避让 · 186 人向侧上风向疏散`,metric:`应急通道畅通`},{id:7,start:49,end:59,clock:`14:32:49`,icon:`消`,title:`消防处置`,subtitle:`泡沫消防车到场建立水幕并堵漏`,detail:`消防员从上风向压制挥发气体 · 泄漏速率下降 68% · 核心区浓度回落`,metric:`风险持续下降`},{id:8,start:59,end:67,clock:`14:32:59`,icon:`医`,title:`医疗救援`,subtitle:`救护车抵达并完成现场检伤分类`,detail:`2 名轻度吸入人员接受吸氧 · 三级医院绿色通道保持开启`,metric:`检伤与转运完成`},{id:9,start:67,end:72,clock:`14:33:07`,icon:`联`,title:`响应完成`,subtitle:`风险受控，联合处置闭环形成`,detail:`重点区域疏散 186 人 · 2 人完成转运 · 事故处置报告可立即生成`,metric:`全链路可追溯`}],Gf=72,Kf=async e=>{let t=new TextEncoder().encode(e),n=await crypto.subtle.digest(`SHA-256`,t);return Array.from(new Uint8Array(n)).map(e=>e.toString(16).padStart(2,`0`)).join(``)};function qf({onAuthenticated:e}){let[t,n]=(0,r.useState)(`login`),[i,a]=(0,r.useState)(!1),[o,s]=(0,r.useState)(!0),[c,l]=(0,r.useState)(!1),[u,d]=(0,r.useState)(``),[f,p]=(0,r.useState)({username:``,password:``}),[m,h]=(0,r.useState)({displayName:``,department:`北京市智慧城市运行中心`,username:``,password:``,confirm:``,agreement:!0}),g=e=>{n(e),d(``),a(!1)},_=()=>{try{return JSON.parse(localStorage.getItem(`lingjing-users`)||`[]`)}catch{return[]}};return(0,$.jsxs)(`main`,{className:`auth-shell`,children:[(0,$.jsx)(`div`,{className:`auth-grid`}),(0,$.jsx)(`div`,{className:`auth-glow auth-glow-a`}),(0,$.jsx)(`div`,{className:`auth-glow auth-glow-b`}),(0,$.jsxs)(`header`,{className:`auth-topbar`,children:[(0,$.jsxs)(`div`,{className:`auth-brand-mark`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`京域智城`}),(0,$.jsx)(`span`,{children:`BEIJING SMART CITY DIGITAL TWIN`})]}),(0,$.jsxs)(`em`,{children:[(0,$.jsx)(`i`,{}),`北京市城市运行管理中心`]})]}),(0,$.jsxs)(`section`,{className:`auth-layout`,children:[(0,$.jsxs)(`div`,{className:`auth-hero`,children:[(0,$.jsxs)(`div`,{className:`auth-kicker`,children:[(0,$.jsx)(`i`,{}),`北京城市数字孪生统一入口`]}),(0,$.jsxs)(`h1`,{children:[`一屏感知北京`,(0,$.jsx)(`br`,{}),(0,$.jsx)(`span`,{children:`让城市实时可见`})]}),(0,$.jsx)(`p`,{children:`汇聚城市治理、交通运行、能源环保与公共安全数据，构建可旋转、可交互、可推演的北京智慧城市三维运行中心。`}),(0,$.jsxs)(`div`,{className:`auth-metrics`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:6016})}),(0,$.jsx)(`span`,{children:`三维建筑模型`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:86.4,decimals:1,suffix:`万`})}),(0,$.jsx)(`span`,{children:`城市感知节点`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:99.97,decimals:2,suffix:`%`})}),(0,$.jsx)(`span`,{children:`设备在线率`})]})]}),(0,$.jsxs)(`div`,{className:`auth-radar`,"aria-hidden":`true`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`b`,{children:`AI`}),(0,$.jsxs)(`em`,{children:[`REAL-TIME`,(0,$.jsx)(`br`,{}),`SITUATION`]})]})]}),(0,$.jsxs)(`section`,{className:`auth-card`,"aria-label":t===`login`?`登录`:`注册`,children:[(0,$.jsx)(`div`,{className:`auth-card-line`}),(0,$.jsxs)(`div`,{className:`auth-tabs`,children:[(0,$.jsx)(`button`,{className:t===`login`?`active`:``,onClick:()=>g(`login`),children:`账号登录`}),(0,$.jsx)(`button`,{className:t===`register`?`active`:``,onClick:()=>g(`register`),children:`用户注册`})]}),(0,$.jsxs)(`div`,{className:`auth-heading`,children:[(0,$.jsx)(`span`,{children:t===`login`?`CITY OPERATION ACCESS`:`CREATE CITY ACCOUNT`}),(0,$.jsx)(`h2`,{children:t===`login`?`进入智慧城市运行中心`:`注册城市运行账号`}),(0,$.jsx)(`p`,{children:t===`login`?`登录后首先进入北京智慧城市 3D 大屏`:`注册信息仅保存在当前设备，用于比赛演示`})]}),t===`login`?(0,$.jsxs)(`form`,{onSubmit:async t=>{if(t.preventDefault(),d(``),!f.username.trim()||!f.password){d(`请输入账号和密码`);return}l(!0);try{let t=f.username.trim().toLowerCase();if(t===`admin`&&f.password===`123456`){e({username:`admin`,displayName:`城市运行管理员`},o);return}let n=await Kf(f.password),r=_().find(e=>e.username.toLowerCase()===t&&e.passwordHash===n);if(!r){d(`账号或密码不正确，可使用演示账号登录`);return}e({username:r.username,displayName:r.displayName},o)}finally{l(!1)}},children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`城市运行账号`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`城`}),(0,$.jsx)(`input`,{autoFocus:!0,autoComplete:`username`,value:f.username,onChange:e=>p({...f,username:e.target.value}),placeholder:`请输入城市运行账号`})]})]}),(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`登录密码`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`密`}),(0,$.jsx)(`input`,{type:i?`text`:`password`,autoComplete:`current-password`,value:f.password,onChange:e=>p({...f,password:e.target.value}),placeholder:`请输入密码`}),(0,$.jsx)(`button`,{type:`button`,onClick:()=>a(e=>!e),children:i?`隐藏`:`显示`})]})]}),(0,$.jsxs)(`div`,{className:`auth-options`,children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:o,onChange:e=>s(e.target.checked)}),(0,$.jsx)(`i`,{}),`保持登录`]}),(0,$.jsx)(`button`,{type:`button`,onClick:()=>d(`演示账号：admin　密码：123456`),children:`忘记密码？`})]}),u&&(0,$.jsx)(`div`,{className:`auth-message ${u.includes(`成功`)?`success`:``}`,children:u}),(0,$.jsxs)(`button`,{className:`auth-submit`,disabled:c,children:[c?`身份校验中…`:`进入智慧城市大屏`,(0,$.jsx)(`span`,{children:`→`})]}),(0,$.jsxs)(`button`,{className:`auth-demo`,type:`button`,onClick:()=>{p({username:`admin`,password:`123456`}),d(`已填入演示账号，点击上方按钮进入系统`)},children:[`一键填入演示账号 `,(0,$.jsx)(`b`,{children:`admin / 123456`})]})]}):(0,$.jsxs)(`form`,{onSubmit:async e=>{e.preventDefault(),d(``);let t=m.displayName.trim(),n=m.username.trim();if(!t||!n||!m.password||!m.confirm){d(`请完整填写注册信息`);return}if(!/^[a-zA-Z0-9_-]{3,20}$/.test(n)){d(`账号需为 3–20 位字母、数字、下划线或短横线`);return}if(m.password.length<6){d(`密码至少需要 6 位`);return}if(m.password!==m.confirm){d(`两次输入的密码不一致`);return}if(!m.agreement){d(`请先同意演示环境使用说明`);return}let r=_();if(n.toLowerCase()===`admin`||r.some(e=>e.username.toLowerCase()===n.toLowerCase())){d(`该账号已存在，请更换账号`);return}l(!0);try{r.push({username:n,displayName:t,department:m.department,passwordHash:await Kf(m.password)}),localStorage.setItem(`lingjing-users`,JSON.stringify(r)),p({username:n,password:``}),g(`login`),d(`注册成功，请使用新账号登录`)}finally{l(!1)}},children:[(0,$.jsxs)(`div`,{className:`auth-form-grid`,children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`姓名`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`名`}),(0,$.jsx)(`input`,{autoFocus:!0,value:m.displayName,onChange:e=>h({...m,displayName:e.target.value}),placeholder:`请输入真实姓名`})]})]}),(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`所属单位`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`部`}),(0,$.jsxs)(`select`,{value:m.department,onChange:e=>h({...m,department:e.target.value}),children:[(0,$.jsx)(`option`,{children:`北京市智慧城市运行中心`}),(0,$.jsx)(`option`,{children:`城市管理部门`}),(0,$.jsx)(`option`,{children:`交通运行部门`}),(0,$.jsx)(`option`,{children:`生态环境部门`}),(0,$.jsx)(`option`,{children:`公共安全与应急部门`})]})]})]})]}),(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`登录账号`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`指`}),(0,$.jsx)(`input`,{autoComplete:`username`,value:m.username,onChange:e=>h({...m,username:e.target.value}),placeholder:`3–20 位字母或数字`})]})]}),(0,$.jsxs)(`div`,{className:`auth-form-grid`,children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`设置密码`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`密`}),(0,$.jsx)(`input`,{type:i?`text`:`password`,autoComplete:`new-password`,value:m.password,onChange:e=>h({...m,password:e.target.value}),placeholder:`至少 6 位`})]})]}),(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`确认密码`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`验`}),(0,$.jsx)(`input`,{type:i?`text`:`password`,autoComplete:`new-password`,value:m.confirm,onChange:e=>h({...m,confirm:e.target.value}),placeholder:`再次输入`})]})]})]}),(0,$.jsxs)(`div`,{className:`auth-options register`,children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:m.agreement,onChange:e=>h({...m,agreement:e.target.checked})}),(0,$.jsx)(`i`,{}),`同意本地演示环境使用说明`]}),(0,$.jsx)(`button`,{type:`button`,onClick:()=>a(e=>!e),children:i?`隐藏密码`:`显示密码`})]}),u&&(0,$.jsx)(`div`,{className:`auth-message ${u.includes(`成功`)?`success`:``}`,children:u}),(0,$.jsxs)(`button`,{className:`auth-submit`,disabled:c,children:[c?`正在创建账号…`:`完成注册`,(0,$.jsx)(`span`,{children:`→`})]})]}),(0,$.jsxs)(`footer`,{className:`auth-card-footer`,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`i`,{}),`SHA-256 LOCAL HASH`]}),(0,$.jsx)(`em`,{children:`演示环境 · 数据仅存本机`})]})]})]}),(0,$.jsxs)(`footer`,{className:`auth-footer`,children:[(0,$.jsx)(`span`,{children:`© 2026 京域智城 · 北京智慧城市创新实验室`}),(0,$.jsxs)(`span`,{children:[`城市数据链路 `,(0,$.jsx)(`i`,{}),` 正常　|　比赛演示版 v4.1.0`]})]})]})}function Jf(){let[e,t]=(0,r.useState)(!1),[n,i]=(0,r.useState)(null),[a,o]=(0,r.useState)(`city`),[s,c]=(0,r.useState)(!1),[l,u]=(0,r.useState)(`overview`),[d,f]=(0,r.useState)(!1),[p,m]=(0,r.useState)(``),[h,g]=(0,r.useState)(`loading`),[_,v]=(0,r.useState)(!1),[y,b]=(0,r.useState)(!1),[x,S]=(0,r.useState)(null),[C,w]=(0,r.useState)(null),[T,E]=(0,r.useState)(15),[D,O]=(0,r.useState)(!1),[k,A]=(0,r.useState)(0),[ee,j]=(0,r.useState)(!0),[M,N]=(0,r.useState)(!1),[P,F]=(0,r.useState)(!1),[te,ne]=(0,r.useState)(!0),[re,ie]=(0,r.useState)(!1),[ae,oe]=(0,r.useState)(null),[I,L]=(0,r.useState)(null),[se,ce]=(0,r.useState)(null),[le,ue]=(0,r.useState)(!1),[de,fe]=(0,r.useState)(!1),[pe,me]=(0,r.useState)(`2026-07-20 14:32:26`),[he,ge]=(0,r.useState)(null),[_e,ve]=(0,r.useState)(!1),[ye,be]=(0,r.useState)({type:`氯气泄漏`,confidence:.968,smokeRatio:.214,flameRatio:.008,edgeDensity:.182,persons:23,summary:`检测到淡黄色烟羽和危化品运输车辆，建议启动危化品二级响应。`}),[R,xe]=(0,r.useState)(`idle`),[Se,Ce]=(0,r.useState)(0),[we,Te]=(0,r.useState)(1),[Ee,De]=(0,r.useState)(!0),[Oe,ke]=(0,r.useState)(36),[z,Ae]=(0,r.useState)(``),B=R===`idle`?0:Wf.find(e=>e.id>0&&Se>=e.start&&Se<e.end)?.id??9,je=Wf[B],V=R===`idle`?0:Math.min(100,Se/Gf*100),Me=B<=2&&B>0?`chemical-truck`:B===5?Se<31?`police-car`:Se<36?`firetruck`:`ambulance`:B===6?`police-car`:B===7?`firetruck`:B===8?`ambulance`:null,H=(0,r.useMemo)(()=>Lf(T,3.4),[T]),U=(0,r.useMemo)(()=>Vf(y),[y]),Ne=(0,r.useMemo)(()=>{let e=C?.distance??U.distance,t=C?.eta??U.eta,n=C?.roads.join(` → `)||`OSM 真实道路网络加载中`;return`灵境哨兵｜危化品泄漏应急处置报告\n报告编号：LJ-BJ-20260720-001\n生成时间：${pe}\n响应等级：Ⅰ级应急响应\n\n一、事件概况\n事件地点：北京市朝阳区建国门外大街国贸桥西侧（演示坐标 39°54′27″N，116°27′07″E）\n事件类型：${ye.type}\nAI 识别置信度：${(ye.confidence*100).toFixed(1)}%\n现场人员估计：约 ${ye.persons} 人\n研判摘要：${ye.summary}\n\n二、风险扩散计算\n气象条件：东南风 3.4 m/s，污染羽流吹向西北，Pasquill-D 稳定度\n致命区纵深：${H.lethal} m\n高风险区纵深：${H.high} m\n警戒区纵深：${H.warning} m\n预计风险暴露人口：${H.affectedPeople} 人\n模型：${H.model}\n\n三、消防救援路线\n算法：OSM 真实路网 A*（欧氏距离启发）\n道路序列：${n}\n路线距离：${e} m\n预计到达：${t} min\n搜索道路节点：${C?.visited??U.visited} 个\n封路状态：${y?`已封锁 OSM 道路 ${C?.blockedRoadId??x??`自动选择路段`}，完成动态重规划`:`当前道路正常通行`}\n\n四、联合处置指令\n1. 交通智能体：立即封锁泄漏点周边 500 m 道路，建立 3.2 km 应急绿波带。\n2. 教育智能体：城北实验学校师生经东南侧上风向安全通道分批疏散，8 分钟内完成重点人员转移。\n3. 消防智能体：2 辆泡沫消防车沿 OSM 规划路线抵达，在上风向布置水幕并实施堵漏。\n4. 医疗智能体：市第三人民医院开放绿色通道，在体育中心设置临时分诊点。\n5. 环境监测组：在下风向 200 m、500 m、1000 m 设置连续监测点，每 2 分钟回传浓度。\n\n五、处置结论\n建议立即启动危化品泄漏Ⅰ级联合响应，优先完成学校疏散、道路管制和泄漏源控制。AI 决策结果仅用于竞赛演示，正式行动应由现场指挥员复核确认。\n\n生成系统：灵境哨兵城市应急智能决策平台`},[y,x,H,C,pe,U,ye]);(0,r.useEffect)(()=>{try{let e=localStorage.getItem(`lingjing-session`)||sessionStorage.getItem(`lingjing-session`);e&&i(JSON.parse(e))}catch{localStorage.removeItem(`lingjing-session`),sessionStorage.removeItem(`lingjing-session`)}t(!0)},[]),(0,r.useEffect)(()=>{if(!p)return;let e=window.setTimeout(()=>m(``),2800);return()=>window.clearTimeout(e)},[p]),(0,r.useEffect)(()=>{if(!z)return;let e=window.setTimeout(()=>Ae(``),2800);return()=>window.clearTimeout(e)},[z]),(0,r.useEffect)(()=>{if(!D||R===`playing`||R===`paused`)return;let e=window.setInterval(()=>E(e=>e>=30?1:e+1),520);return()=>window.clearInterval(e)},[D,R]),(0,r.useEffect)(()=>{if(R!==`playing`)return;let e=performance.now(),t=window.setInterval(()=>{let t=performance.now(),n=(t-e)/1e3*we;e=t,Ce(e=>Math.min(Gf,e+n))},100);return()=>window.clearInterval(t)},[we,R]),(0,r.useEffect)(()=>{R===`playing`&&Se>=Gf&&xe(`complete`)},[R,Se]),(0,r.useEffect)(()=>{B!==0&&(v(B>=4),N(B>=3),E(B<3?1:B===3?5:B<7?15:B===9?8:22))},[B]),(0,r.useEffect)(()=>{!Ee||B===0||(ie(!1),Me?(oe(Me),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:Me}}))):(oe(null),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:null}})),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:B===9?`reset`:`incident`}))))},[Ee,Me,B]),(0,r.useEffect)(()=>{let e=e=>{let t=e.target;if([`INPUT`,`TEXTAREA`,`SELECT`].includes(t.tagName))return;if(e.code===`Escape`){if(s){c(!1);return}if(le){ue(!1);return}if(d){f(!1);return}if(l!==`overview`){u(`overview`);return}if(I){L(null);return}De(!1),oe(null),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:null}}));return}let n={Digit1:`overview`,Digit2:`events`,Digit3:`resources`,Digit4:`archives`};if(n[e.code]){e.preventDefault(),u(n[e.code]),f(!1);return}if(!(B===0||l!==`overview`||le)&&(e.code===`Space`&&(e.preventDefault(),xe(e=>e===`playing`?`paused`:e===`paused`?`playing`:e)),e.code===`ArrowRight`)){e.preventDefault();let t=Wf[Math.min(9,B+1)];Ce(t.start+.01),xe(t.id===9?`paused`:`playing`)}};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[d,l,s,le,B,I]),(0,r.useEffect)(()=>{if(!d)return;let e=e=>{e.target.closest(`.status`)||f(!1)};return window.addEventListener(`pointerdown`,e,!0),()=>window.removeEventListener(`pointerdown`,e,!0)},[d]),(0,r.useEffect)(()=>{if(!_)return;let e=setInterval(()=>A(e=>(e+1)%4),900);return()=>clearInterval(e)},[_]);let Pe=()=>{if(h===`loading`){m(`真实北京路网仍在加载，请稍候一秒再启动`);return}h===`degraded`&&m(`真实路网数据异常，已启用内置完整路线继续演示`),Ce(0),xe(`playing`),De(!0),v(!1),b(!1),S(null),E(1),O(!1),N(!1),ie(!1),oe(null)},Fe=()=>{c(!1),u(`overview`),window.setTimeout(Pe,120)},Ie=()=>xe(e=>e===`playing`?`paused`:e===`paused`||e===`complete`?`playing`:e),Le=()=>{let e=Wf[Math.min(9,B+1)];Ce(e.start+.01),xe(e.id===9?`paused`:`playing`)},Re=()=>Te(e=>e===1?1.5:e===1.5?2:1),ze=()=>ke(e=>e===18?36:e===36?54:18),Be=e=>{S(typeof e==`number`?e:null),b(!0),v(!0)},Ve=()=>{oe(null),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:null}}))},He=()=>{Ve(),De(!1),ie(!1),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`incident`}))},Ue=(e,t,n,r,i)=>{Ae(e),ce({id:`side-${e}`,label:t,category:n,details:r,meta:i}),m(`已打开：${t}`)},We=e=>{if(h===`loading`){m(`真实地图仍在加载，资源位置暂不可追踪`);return}let t={"FIRE-01":`firetruck`,"FIRE-02":`firetruck`,"ROBOT-01":`firetruck`,"MED-03":`ambulance`,"MED-06":`ambulance`,"POLICE-07":`police-car`,"BIKE-02":`police-car`}[e];L(null),ie(!1),De(!1),(B<4||R===`complete`)&&(Ce(20.01),xe(`playing`),v(!0),N(!0)),t?(oe(t),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:t}})),m(`已同步到所属编队的真实道路跟随视角`)):(oe(null),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`incident`})),m(`该资源已同步到事故现场任务区域`))},Ge=e=>{let t=ae===e.id?null:e.id;ie(!1),oe(t),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:t}}))},Ke=()=>{me(new Date().toLocaleString(`zh-CN`,{hour12:!1}).replaceAll(`/`,`-`)),ue(!0),fe(!0),window.setTimeout(()=>fe(!1),700)},qe=()=>{let e=URL.createObjectURL(new Blob([`﻿`,Ne],{type:`text/plain;charset=utf-8`})),t=document.createElement(`a`);t.href=e,t.download=`灵境哨兵-危化品泄漏应急处置报告.txt`,t.click(),window.setTimeout(()=>URL.revokeObjectURL(e),1e3)},Je=async e=>{if(!e)return;ve(!0);let t=URL.createObjectURL(e);ge(e=>(e&&URL.revokeObjectURL(e),t));try{be(await Pf(e))}finally{ve(!1)}},Ye=(e,t)=>{localStorage.removeItem(`lingjing-session`),sessionStorage.removeItem(`lingjing-session`),(t?localStorage:sessionStorage).setItem(`lingjing-session`,JSON.stringify(e)),i(e)},Xe=async()=>{try{document.fullscreenElement?await document.exitFullscreen():await document.documentElement.requestFullscreen(),m(document.fullscreenElement?`已进入全屏演示`:`已退出全屏演示`)}catch{m(`当前浏览器未允许全屏，请使用 F11`)}},Ze=()=>{a===`emergency`&&(R===`playing`||R===`paused`)&&!window.confirm(`当前推演尚未结束，退出将中止本次演示。确定退出吗？`)||(localStorage.removeItem(`lingjing-session`),sessionStorage.removeItem(`lingjing-session`),f(!1),c(!1),u(`overview`),g(`loading`),o(`city`),i(null))};return e?n?a===`city`?(0,$.jsx)(Mf,{displayName:n.displayName,onLogout:Ze,onOpenDemo:()=>{c(!1),u(`overview`),g(`loading`),o(`emergency`)}}):(0,$.jsxs)(`main`,{className:`shell`,children:[(0,$.jsxs)(`header`,{className:`topbar`,children:[(0,$.jsxs)(`div`,{className:`brand-mark`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]}),(0,$.jsxs)(`div`,{className:`brand`,children:[(0,$.jsx)(`b`,{children:`京域智城`}),(0,$.jsx)(`span`,{children:`北京智慧城市 3D 大屏 · SMART CITY DIGITAL TWIN`})]}),(0,$.jsxs)(`nav`,{"aria-label":`主功能导航`,children:[Uf.map(e=>(0,$.jsx)(`button`,{className:l===e.id&&!s?`active`:``,"aria-current":l===e.id&&!s?`page`:void 0,onClick:()=>{c(!1),u(e.id),f(!1)},children:e.label},e.id)),(0,$.jsx)(`button`,{className:`demo-nav`,onClick:()=>{c(!1),o(`city`),f(!1)},children:`返回智慧城市`})]}),(0,$.jsxs)(`div`,{className:`status`,children:[(0,$.jsx)(`span`,{className:`live-dot`}),`系统在线 `,(0,$.jsx)(`em`,{children:n.displayName}),(0,$.jsx)(`button`,{className:`avatar ${d?`open`:``}`,onClick:()=>f(e=>!e),title:`打开账号菜单`,"aria-label":`打开账号菜单`,"aria-expanded":d,"aria-haspopup":`menu`,"aria-controls":`account-menu`,children:n.displayName.slice(0,1)}),d&&(0,$.jsxs)(`div`,{className:`account-menu`,id:`account-menu`,role:`menu`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`i`,{children:n.displayName.slice(0,1)}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:n.displayName}),(0,$.jsxs)(`span`,{children:[n.username,` · 应急指挥中心`]})]})]}),(0,$.jsxs)(`button`,{onClick:Xe,children:[(0,$.jsx)(`span`,{children:`⛶ 全屏演示`}),(0,$.jsx)(`b`,{children:typeof document<`u`&&document.fullscreenElement?`退出`:`进入`})]}),(0,$.jsxs)(`button`,{onClick:()=>{De(e=>!e),m(Ee?`导演视角已关闭`:`导演视角已开启`)},children:[(0,$.jsx)(`span`,{children:`◉ 导演视角`}),(0,$.jsx)(`b`,{children:Ee?`开启`:`关闭`})]}),(0,$.jsxs)(`button`,{onClick:()=>m(`快捷键：1–4 切换模块　空格暂停/继续　→ 下一阶段　Esc 返回`),children:[(0,$.jsx)(`span`,{children:`? 演示快捷键`}),(0,$.jsx)(`b`,{children:`查看`})]}),(0,$.jsxs)(`button`,{onClick:()=>m(h===`ready`?`系统自检通过：真实地图、路网、AI 模型和调度模块均已就绪`:h===`loading`?`系统自检进行中：真实路网仍在加载`:`系统自检警告：真实路网已启用内置降级路线`),children:[(0,$.jsx)(`span`,{children:`✓ 演示自检`}),(0,$.jsx)(`b`,{children:h===`ready`?`通过`:h===`loading`?`检测中`:`降级`})]}),(0,$.jsxs)(`button`,{onClick:()=>{F(e=>!e),m(P?`已切换为白天态势`:`已切换为夜间态势`)},children:[(0,$.jsx)(`span`,{children:`◐ 显示模式`}),(0,$.jsx)(`b`,{children:P?`夜间`:`白天`})]}),(0,$.jsxs)(`button`,{onClick:()=>{ne(e=>!e),m(te?`已关闭楼宇灯光`:`已开启楼宇灯光`)},children:[(0,$.jsx)(`span`,{children:`✦ 楼宇灯光`}),(0,$.jsx)(`b`,{children:te?`开启`:`关闭`})]}),(0,$.jsxs)(`button`,{onClick:()=>{u(`resources`),f(!1)},children:[(0,$.jsx)(`span`,{children:`⌘ 快速调度`}),(0,$.jsx)(`b`,{children:`进入`})]}),(0,$.jsxs)(`button`,{className:`logout`,onClick:Ze,children:[(0,$.jsx)(`span`,{children:`↪ 退出登录`}),(0,$.jsx)(`b`,{children:`EXIT`})]})]})]})]}),(0,$.jsxs)(`section`,{className:`command-strip`,children:[(0,$.jsx)(`div`,{className:`alert-tag scenario-alert phase-${B}`,children:B===0?`演示项目 01 · READY`:`${String(B).padStart(2,`0`)}/09 · ${R===`playing`?`LIVE`:R===`paused`?`PAUSED`:`COMPLETE`}`}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`strong`,{children:[je.title,`｜`,je.subtitle]}),(0,$.jsxs)(`span`,{children:[je.clock,` · `,je.detail]})]}),(0,$.jsxs)(`div`,{className:`command-actions`,children:[(0,$.jsx)(`span`,{children:h===`loading`?`正在装载 6,016 栋建筑与 674 段道路`:B===0?`智慧城市大屏已就绪 · 点击进入演示项目`:`T+${Se.toFixed(1)}s · ${je.metric}`}),(0,$.jsx)(`button`,{disabled:h===`loading`,onClick:B===0?()=>c(!0):Pe,children:h===`loading`?`正在加载真实路网…`:B===0?`进入演示项目 →`:R===`complete`?`↻ 再演示一次`:`↻ 从头重播`})]})]}),(0,$.jsx)(gf,{active:l,onClose:()=>u(`overview`),onStartScenario:Pe,onFocusIncident:He,onGenerateReport:Ke,onNotice:m,onTrackResource:We,scenarioPhase:B,scenarioTime:Se,scenarioStatus:R}),s&&(0,$.jsx)(yf,{ready:h!==`loading`,onClose:()=>c(!1),onStart:Fe}),p&&(0,$.jsxs)(`div`,{className:`system-toast ${/失败|异常|未允许/.test(p)?`error`:/召回|关闭|降级|加载/.test(p)?`warning`:`success`}`,role:`status`,"aria-live":`polite`,children:[(0,$.jsx)(`i`,{children:/失败|异常|未允许/.test(p)?`!`:/召回|关闭|降级|加载/.test(p)?`i`:`✓`}),(0,$.jsx)(`span`,{children:p})]}),(0,$.jsxs)(`section`,{className:`workspace`,children:[(0,$.jsxs)(`aside`,{className:`left-panel panel`,children:[(0,$.jsxs)(`div`,{className:`panel-title`,children:[(0,$.jsx)(`span`,{children:`01`}),`事件智能识别 `,(0,$.jsx)(`b`,{children:`AI VISION`})]}),(0,$.jsxs)(`div`,{className:`scene`,children:[he&&(0,$.jsx)(`img`,{className:`scene-upload-preview`,src:he,alt:`上传的事故现场`}),(0,$.jsx)(`div`,{className:`sky`}),(0,$.jsx)(`div`,{className:`road-lines`}),(0,$.jsx)(`div`,{className:`truck ${B>=2?`failed`:``}`,children:(0,$.jsx)(`span`,{children:`化学废料`})}),B>=2&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`smoke s1`}),(0,$.jsx)(`div`,{className:`smoke s2`}),(0,$.jsx)(`div`,{className:`smoke s3`})]}),B>=3&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`detect-box`,children:(0,$.jsx)(`label`,{children:`化学废料运输车 98.2%`})}),(0,$.jsx)(`div`,{className:`detect-smoke`,children:(0,$.jsx)(`label`,{children:`含氯挥发气体 96.8%`})})]}),(0,$.jsx)(`div`,{className:`camera`,children:`CAM-07 · LIVE`}),(0,$.jsxs)(`label`,{className:`upload-image`,children:[_e?`分析中…`:`上传事故图`,(0,$.jsx)(`input`,{type:`file`,accept:`image/*`,onChange:e=>Je(e.target.files?.[0])})]}),(0,$.jsx)(`div`,{className:`local-cv`,children:`LOCAL CV · PIXEL FEATURE MODEL`})]}),(0,$.jsxs)(`div`,{className:`recognition`,children:[(0,$.jsxs)(`button`,{type:`button`,className:z===`vehicle`?`active`:``,onClick:()=>{He(),Ue(`vehicle`,`危化品车辆状态`,`事件智能识别`,B===0?`演示车辆已加载并等待启动。`:je.detail,`京A·WH2576 · 阶段 ${String(B).padStart(2,`0`)}`)},children:[(0,$.jsx)(`span`,{children:`车辆状态`}),(0,$.jsx)(`strong`,{children:B===0?`等待演示`:B===1?`正常运输`:B===2?`动力故障`:`已停车处置`})]}),(0,$.jsxs)(`button`,{type:`button`,className:z===`confidence`?`active`:``,onClick:()=>{He(),Ue(`confidence`,`AI 识别置信度`,`本地视觉模型`,ye.summary,`置信度 ${(ye.confidence*100).toFixed(1)}% · PIXEL FEATURE MODEL`)},children:[(0,$.jsx)(`span`,{children:`AI 识别置信度`}),(0,$.jsx)(`strong`,{children:B>=3?(0,$.jsx)(_f,{to:ye.confidence*100,decimals:1,suffix:`%`}):`—`})]}),(0,$.jsxs)(`button`,{type:`button`,className:z===`plume`?`active`:``,onClick:()=>{N(!0),He(),Ue(`plume`,`烟羽像素与风险扩散`,`风险扩散计算`,`烟羽像素占比 ${(ye.smokeRatio*100).toFixed(1)}%，当前警戒纵深 ${H.warning} 米。`,`高斯烟羽 · ${H.model}`)},children:[(0,$.jsx)(`span`,{children:`烟羽像素占比`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:B>=3?ye.smokeRatio*100:0,decimals:1,suffix:`%`})})]}),(0,$.jsxs)(`button`,{type:`button`,className:z===`evacuated`?`active`:``,onClick:()=>Ue(`evacuated`,`人员疏散进度`,`联合处置态势`,B>=6?`重点区域 186 人已完成向侧上风向疏散。`:`人员疏散队伍已待命，将在交通封控完成后执行。`,B>=6?`186 人 · 已完成`:`0 人 · 等待执行`),children:[(0,$.jsx)(`span`,{children:`已疏散人员`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:B>=6?186:0,suffix:` 人`})})]})]}),(0,$.jsxs)(`button`,{type:`button`,className:`ai-note side-wide-action ${z===`ai-note`?`active`:``}`,onClick:()=>{N(!0),He(),Ue(`ai-note`,B>=3?`本地视觉研判`:`运输遥测状态`,`AI 研判摘要`,B===0?`等待启动完整演示，车辆与应急力量已加载。`:je.detail,B>=3?`东南风 3.4m/s · 风险模型已联动`:`车辆遥测 · 正常待命`)},children:[(0,$.jsx)(`b`,{children:B>=3?`本地视觉研判`:`运输遥测状态`}),(0,$.jsxs)(`p`,{children:[B===0?`等待启动完整演示，车辆与应急力量已加载。`:je.detail,` `,B>=3&&(0,$.jsxs)($.Fragment,{children:[`东南风 3.4 m/s（吹向西北），预计 `,(0,$.jsxs)(`em`,{children:[3,` 分钟`]}),`进入重点警戒区域。`]})]})]}),(0,$.jsxs)(`div`,{className:`panel-title compact`,children:[(0,$.jsx)(`span`,{children:`02`}),`智能体协同 `,(0,$.jsx)(`b`,{children:`MULTI-AGENT`})]}),(0,$.jsx)(`div`,{className:`agents`,children:Hf.map((e,t)=>{let n=[4,4,4,3][t],r=[7,8,6,9][t],i=B>=n,a=B>=r,o=[`FIRE-01`,`MED-03`,`POLICE-07`,`COMMAND`][t];return(0,$.jsxs)(`button`,{type:`button`,className:`agent ${e.tone} ${i?`scenario-active`:``} ${a?`scenario-done`:``} ${z===`agent-${t}`?`side-selected`:``}`,onClick:()=>{Ae(`agent-${t}`),o===`COMMAND`?(He(),Ue(`agent-${t}`,e.name,`多智能体协同`,e.text,`指挥中枢 · 联合处置`)):We(o)},children:[(0,$.jsx)(`i`,{children:a?`✓`:e.icon}),(0,$.jsxs)(`p`,{children:[(0,$.jsx)(`b`,{children:e.name}),(0,$.jsx)(`span`,{children:i?a?`阶段任务完成 · 点击查看位置`:_&&k===t?`正在执行当前处置任务…`:e.text:`系统待命 · 点击可提前追踪`})]}),(0,$.jsx)(`em`,{children:`●`})]},e.name)})})]}),(0,$.jsxs)(`section`,{className:`map-panel panel`,children:[(0,$.jsxs)(`div`,{className:`panel-title`,children:[(0,$.jsx)(`span`,{children:`03`}),`真实城市三维推演 `,(0,$.jsx)(`b`,{children:`REAL-WORLD DIGITAL TWIN`}),(0,$.jsxs)(`div`,{className:`map-tools`,children:[(0,$.jsx)(`button`,{"aria-label":`缩小`,onClick:()=>window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`zoomOut`})),children:`−`}),(0,$.jsx)(`button`,{"aria-label":`放大`,onClick:()=>window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`zoomIn`})),children:`＋`})]})]}),(0,$.jsxs)(`div`,{className:`map`,onClick:()=>L(null),children:[(0,$.jsx)(uf,{running:_,blocked:y,blockedRoadId:x,showRisk:M,topView:!ee,nightMode:P,buildingLights:te,autoTour:re,suspended:l!==`overview`||le,scenarioPhase:B,scenarioTime:Se,trafficDensity:Oe,onSelect:L,onRealRoute:w,onSceneStatus:e=>{g(e),e===`degraded`&&m(`真实路网数据异常，已自动启用内置完整路线`)},plume:H}),(0,$.jsxs)(`div`,{className:`scenario-console phase-${B} ${R}`,onClick:e=>e.stopPropagation(),children:[(0,$.jsxs)(`div`,{className:`scenario-now`,children:[(0,$.jsx)(`i`,{children:je.icon}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`span`,{children:[`SCENARIO DIRECTOR · `,B===0?`READY`:`${String(B).padStart(2,`0`)}/09`]}),(0,$.jsx)(`strong`,{children:je.title}),(0,$.jsx)(`p`,{children:je.subtitle})]}),(0,$.jsx)(`em`,{children:B===0?`01:12`:`${Math.floor(Se/60).toString().padStart(2,`0`)}:${Math.floor(Se%60).toString().padStart(2,`0`)}`})]}),(0,$.jsxs)(`div`,{className:`scenario-progress`,children:[(0,$.jsx)(`span`,{style:{width:`${V}%`}}),(0,$.jsx)(`i`,{style:{left:`${V}%`}})]}),(0,$.jsx)(`div`,{className:`scenario-stage-rail`,children:Wf.slice(1).map(e=>(0,$.jsxs)(`button`,{className:B===e.id?`active`:B>e.id?`done`:``,title:`${e.clock} ${e.title}`,onClick:()=>{Ce(e.start+.01),xe(`paused`)},children:[(0,$.jsx)(`i`,{children:e.id}),(0,$.jsx)(`span`,{children:e.title})]},e.id))}),(0,$.jsxs)(`div`,{className:`scenario-controls`,children:[(0,$.jsx)(`button`,{className:`primary`,disabled:h===`loading`,onClick:B===0||R===`complete`?Pe:Ie,children:h===`loading`?`路网加载中…`:B===0?`▶ 一键完整演示`:R===`playing`?`Ⅱ 暂停`:R===`complete`?`↻ 再演示`:`▶ 继续`}),(0,$.jsx)(`button`,{disabled:B===0||B===9,onClick:Le,children:`下一阶段 →`}),(0,$.jsxs)(`button`,{onClick:Re,children:[we,`× 倍速`]}),(0,$.jsxs)(`button`,{onClick:ze,children:[`车流：`,Oe===18?`畅通`:Oe===36?`繁忙`:`拥堵`,` · `,Oe]}),(0,$.jsx)(`button`,{className:Ee?`on`:``,"aria-pressed":Ee,onClick:()=>De(e=>!e),children:`◉ 导演视角`})]})]}),(0,$.jsxs)(`div`,{className:`map-layer-tools`,children:[(0,$.jsxs)(`button`,{className:ee?`on`:``,onClick:()=>{Ve(),De(!1),j(e=>!e)},children:[`◈ `,ee?`自由三维`:`垂直俯视`]}),(0,$.jsx)(`button`,{className:M?`on`:``,onClick:()=>N(e=>!e),children:`◉ 风险热区`}),(0,$.jsx)(`button`,{className:P?`on`:``,onClick:()=>F(e=>!e),children:P?`☀ 白天`:`☾ 夜间`}),(0,$.jsx)(`button`,{className:te?`on`:``,onClick:()=>ne(e=>!e),children:`✦ 楼宇灯光`}),(0,$.jsx)(`button`,{className:re?`on`:``,onClick:()=>{Ve(),De(!1),ie(e=>!e)},children:re?`■ 停止巡航`:`▶ 自动巡航`}),ae&&(0,$.jsx)(`button`,{className:`on`,onClick:Ve,children:`■ 停止跟随`}),(0,$.jsx)(`button`,{onClick:()=>{Ve(),De(!1),ie(!1),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`incident`}))},children:`◎ 聚焦事故`}),(0,$.jsx)(`button`,{onClick:()=>{Ve(),De(!1),ie(!1),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`reset`}))},children:`⌖ 复位`})]}),(0,$.jsx)(`div`,{className:`coordinates`,children:`39°54′27″N\xA0\xA0116°27′07″E　|　北京 CBD`}),(0,$.jsxs)(`div`,{className:`wind`,children:[`↖`,(0,$.jsxs)(`span`,{children:[`东南风 3.4m/s`,(0,$.jsx)(`br`,{}),`吹向西北`]})]}),(0,$.jsxs)(`div`,{className:`legend`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{className:`lg-red`}),`致命区`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{className:`lg-orange`}),`高风险`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{className:`lg-yellow`}),`警戒区`]})]}),(0,$.jsx)(`div`,{className:`map-attribution`,children:`© OpenStreetMap contributors · 北京核心区真实矢量数据`}),I&&(0,$.jsxs)(`div`,{className:`asset-card`,onClick:e=>e.stopPropagation(),children:[(0,$.jsx)(`button`,{onClick:()=>L(null),children:`×`}),(0,$.jsx)(`span`,{children:I.category}),(0,$.jsx)(`strong`,{children:I.label}),(0,$.jsx)(`p`,{children:I.details}),(0,$.jsx)(`em`,{children:I.meta}),(0,$.jsxs)(`div`,{className:`asset-actions`,children:[I.position&&(0,$.jsx)(`button`,{onClick:()=>{Ve(),ie(!1),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`focus`,position:I.position}}))},children:`◎ 定位观察`}),I.action===`follow-vehicle`&&(0,$.jsx)(`button`,{className:ae===I.id?`tracking`:``,onClick:()=>Ge(I),children:ae===I.id?`■ 停止跟随`:`◉ 跟随车辆`}),I.action===`toggle-building-lights`&&(0,$.jsx)(`button`,{className:`lights`,onClick:()=>window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`toggle-building-lights`,assetId:I.id}})),children:`✦ 切换楼层灯光`}),I.action===`block-road`&&(0,$.jsx)(`button`,{className:`danger`,onClick:()=>Be(Number(I.id.replace(`road-`,``))),children:y?`✓ 已封锁并完成真实路网重规划`:`⊘ 封锁此路并按真实路网重规划`})]})]})]}),(0,$.jsxs)(`div`,{className:`time-control`,children:[(0,$.jsx)(`button`,{"aria-label":R===`playing`?`暂停完整推演`:R===`paused`?`继续完整推演`:D?`暂停风险扩散时间`:`播放风险扩散时间`,onClick:()=>R===`playing`||R===`paused`?Ie():O(e=>!e),children:R===`playing`||D?`Ⅱ`:`▶`}),(0,$.jsx)(`input`,{"aria-label":`风险扩散推演时间`,type:`range`,min:`1`,max:`30`,value:T,disabled:R===`playing`||R===`paused`,onChange:e=>{O(!1),E(Number(e.target.value))}}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`现在`}),(0,$.jsx)(`span`,{children:`+5min`}),(0,$.jsx)(`span`,{children:`+15min`}),(0,$.jsx)(`span`,{children:`+30min`})]}),(0,$.jsxs)(`strong`,{children:[R===`playing`||R===`paused`?`导演脚本联动 · `:``,`+`,T,`min · 警戒纵深 `,H.warning,`m`]})]})]}),(0,$.jsxs)(`aside`,{className:`right-panel panel`,children:[(0,$.jsxs)(`div`,{className:`panel-title`,children:[(0,$.jsx)(`span`,{children:`04`}),`决策方案 `,(0,$.jsx)(`b`,{children:`AI COMMAND`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`score-card ${z===`plan-score`?`side-selected`:``}`,onClick:()=>Ue(`plan-score`,y?`方案 B · A* 动态重规划`:`方案 A · 最短响应路径`,`AI 决策方案`,y?`东二环封闭后，系统已使用 OSM 真实路网完成避让重规划。`:`当前道路正常通行，系统选择消防最短响应路径。`,`综合评分 ${y?`92.4`:`95.1`} · 实时求解`),children:[(0,$.jsx)(`span`,{children:`当前最优方案 · 实时求解`}),(0,$.jsx)(`strong`,{children:y?`方案 B · A* 动态重规划`:`方案 A · 最短响应路径`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:(0,$.jsx)(_f,{to:y?92.4:95.1,decimals:1})}),(0,$.jsx)(`small`,{children:`综合评分`})]})]}),(0,$.jsxs)(`div`,{className:`metrics`,children:[(0,$.jsxs)(`button`,{type:`button`,className:z===`eta`?`active`:``,onClick:()=>{Ae(`eta`),We(`FIRE-01`)},children:[(0,$.jsx)(`span`,{children:`OSM A* 预计响应`}),(0,$.jsx)(`b`,{className:`green`,children:(0,$.jsx)(_f,{to:C?.eta??U.eta,suffix:` min`})}),(0,$.jsxs)(`small`,{children:[`点击追踪消防车 · 搜索 `,C?.visited??U.visited,` 个节点`]})]}),(0,$.jsxs)(`button`,{type:`button`,className:z===`exposure`?`active`:``,onClick:()=>{N(!0),He(),Ue(`exposure`,`模型风险暴露`,`风险扩散计算`,`当前预计风险暴露人口 ${H.affectedPeople} 人，警戒纵深 ${H.warning} 米。`,H.model)},children:[(0,$.jsx)(`span`,{children:`模型风险暴露`}),(0,$.jsx)(`b`,{children:(0,$.jsx)(_f,{to:H.affectedPeople,suffix:` 人`})}),(0,$.jsxs)(`small`,{children:[`点击聚焦风险区 · `,H.model]})]}),(0,$.jsxs)(`button`,{type:`button`,className:z===`route`?`active`:``,onClick:()=>Ue(`route`,`消防真实救援路径`,`OSM 路径规划`,C?.roads.join(` → `)||`正在加载 OSM 真实道路名称。`,`${((C?.distance??U.distance)/1e3).toFixed(2)} km · ETA ${C?.eta??U.eta} min`),children:[(0,$.jsx)(`span`,{children:`真实救援路径`}),(0,$.jsx)(`b`,{children:(0,$.jsx)(_f,{to:(C?.distance??U.distance)/1e3,decimals:2,suffix:` km`})}),(0,$.jsxs)(`small`,{children:[`点击查看道路序列 · `,C?.roads.slice(0,2).join(` → `)||`正在加载`]})]})]}),(0,$.jsx)(`div`,{className:`plan-steps`,children:[`封锁泄漏点周边 500m 道路`,`学校师生向东南侧上风向分批疏散`,`消防车沿 OSM 真实道路抵达`,`救护组在体育中心建立分诊点`].map((e,t)=>{let n=[6,6,7,8][t];return(0,$.jsxs)(`button`,{type:`button`,className:z===`step-${t}`?`active`:``,onClick:()=>{Ae(`step-${t}`),Ce(Wf[n].start+.01),xe(`paused`),De(!0),m(`已跳转到处置步骤：${e}`)},children:[(0,$.jsx)(`i`,{children:t+1}),(0,$.jsxs)(`p`,{children:[e,(0,$.jsxs)(`span`,{children:[[`交警 · 2分钟内`,`教育 · 8分钟完成`,`消防 · 预计${C?.eta??7}分钟`,`医疗 · 12分钟启用`][t],` · 点击定位`]})]}),(0,$.jsx)(`em`,{children:`→`})]},e)})}),(0,$.jsx)(`button`,{className:`block-button`,disabled:B>0&&R!==`complete`,onClick:()=>Be(),children:B>0&&R!==`complete`?`完整演示进行中 · 道路决策已锁定`:y?`✓ OSM A* 已重规划：${C?.roads.slice(0,4).join(` → `)||`已避开封闭道路`}`:`模拟突发：封闭东二环路段并按真实道路重规划`}),(0,$.jsxs)(`div`,{className:`algorithm-proof`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>{N(e=>!e),He(),m(M?`风险扩散图层已隐藏`:`风险扩散图层已开启`)},children:[(0,$.jsx)(`span`,{children:`扩散模型`}),(0,$.jsx)(`b`,{children:`高斯烟羽 / Pasquill-D`}),(0,$.jsx)(`em`,{children:`点击切换风险图层 · Q=80g/s`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>Ue(`algorithm`,`OSM 真实路网 A*`,`路径算法`,`A* 已搜索 ${C?.visited??U.visited} 个道路节点，使用欧氏距离作为启发函数。`,`距离 ${C?.distance??U.distance}m · ETA ${C?.eta??U.eta}min`),children:[(0,$.jsx)(`span`,{children:`路径算法`}),(0,$.jsx)(`b`,{children:`OSM 真实路网 A* · Euclidean`}),(0,$.jsx)(`em`,{children:`点击查看求解结果`})]})]}),(0,$.jsxs)(`div`,{className:`panel-title compact`,children:[(0,$.jsx)(`span`,{children:`05`}),`决策时间线 `,(0,$.jsx)(`b`,{children:`TRACE`})]}),(0,$.jsx)(`div`,{className:`timeline scenario-timeline`,children:Wf.slice(1).map(e=>(0,$.jsxs)(`button`,{type:`button`,className:`${B===e.id?`active`:B>e.id?`done`:``} ${z===`timeline-${e.id}`?`side-selected`:``}`,onClick:()=>{Ae(`timeline-${e.id}`),Ce(e.start+.01),xe(`paused`),De(!0),m(`时间线已定位：${e.title}`)},children:[(0,$.jsx)(`time`,{children:e.clock}),(0,$.jsx)(`i`,{}),(0,$.jsxs)(`p`,{children:[(0,$.jsx)(`b`,{children:e.title}),(0,$.jsx)(`span`,{children:e.subtitle})]})]},e.id))}),(0,$.jsxs)(`button`,{className:`report`,onClick:Ke,children:[`生成应急处置报告 `,(0,$.jsx)(`span`,{children:`↗`})]})]})]}),se&&(0,$.jsx)(Tf,{data:se,tone:`blue`,onClose:()=>ce(null)}),le&&(0,$.jsx)(`div`,{className:`report-overlay`,onClick:()=>ue(!1),children:(0,$.jsxs)(`section`,{className:`report-dialog`,role:`dialog`,"aria-modal":`true`,"aria-label":`应急处置报告`,onClick:e=>e.stopPropagation(),children:[(0,$.jsx)(`button`,{className:`report-close`,"aria-label":`关闭报告`,onClick:()=>ue(!1),children:`×`}),de?(0,$.jsxs)(`div`,{className:`report-generating`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`strong`,{children:`AI 正在生成应急处置报告`}),(0,$.jsx)(`p`,{children:`汇总视觉识别、风险扩散、OSM 路网与多智能体决策结果…`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{})]})]}):(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`header`,{className:`report-head`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`LINGJING SENTINEL · AUTO REPORT`}),(0,$.jsx)(`h2`,{children:`危化品泄漏应急处置报告`}),(0,$.jsxs)(`p`,{children:[`报告编号：LJ-BJ-20260720-001　生成时间：`,pe]})]}),(0,$.jsx)(`b`,{children:`Ⅰ级响应`})]}),(0,$.jsxs)(`div`,{className:`report-paper`,children:[(0,$.jsxs)(`div`,{className:`report-summary`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`AI 事故判定`}),(0,$.jsx)(`strong`,{children:ye.type}),(0,$.jsxs)(`em`,{children:[`置信度 `,(ye.confidence*100).toFixed(1),`%`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`警戒纵深`}),(0,$.jsxs)(`strong`,{children:[H.warning,` m`]}),(0,$.jsx)(`em`,{children:`高斯烟羽 · Pasquill-D`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`风险暴露`}),(0,$.jsxs)(`strong`,{children:[H.affectedPeople,` 人`]}),(0,$.jsxs)(`em`,{children:[`现场估计 `,ye.persons,` 人`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`消防 ETA`}),(0,$.jsxs)(`strong`,{children:[C?.eta??U.eta,` min`]}),(0,$.jsxs)(`em`,{children:[C?.distance??U.distance,` m`]})]})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`h3`,{children:`01　事件概况与智能研判`}),(0,$.jsxs)(`p`,{children:[`北京市朝阳区建国门外大街国贸桥西侧发生危化品运输车泄漏。视觉模型识别为`,(0,$.jsx)(`strong`,{children:ye.type}),`，烟羽像素占比 `,(ye.smokeRatio*100).toFixed(1),`%，现场人员约 `,ye.persons,` 人。`,ye.summary]}),(0,$.jsxs)(`div`,{className:`report-callout danger`,children:[(0,$.jsx)(`b`,{children:`核心风险`}),(0,$.jsx)(`span`,{children:`东南风 3.4 m/s，污染羽流向西北扩散；学校位于事故点 500 米重点保护范围内，应启动预防性疏散。`})]})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`h3`,{children:`02　风险扩散计算`}),(0,$.jsx)(`table`,{children:(0,$.jsxs)(`tbody`,{children:[(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`th`,{children:`风险等级`}),(0,$.jsx)(`th`,{children:`纵深`}),(0,$.jsx)(`th`,{children:`处置要求`})]}),(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:`致命区`}),(0,$.jsxs)(`td`,{children:[H.lethal,` m`]}),(0,$.jsx)(`td`,{children:`仅允许专业防化力量进入`})]}),(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:`高风险区`}),(0,$.jsxs)(`td`,{children:[H.high,` m`]}),(0,$.jsx)(`td`,{children:`立即疏散并设置硬隔离`})]}),(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:`警戒区`}),(0,$.jsxs)(`td`,{children:[H.warning,` m`]}),(0,$.jsx)(`td`,{children:`持续监测并准备扩大疏散`})]})]})})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`h3`,{children:`03　消防救援真实道路路线`}),(0,$.jsxs)(`p`,{children:[`系统使用 674 段北京 OSM 道路构图，并通过 A* 搜索 `,C?.visited??U.visited,` 个道路节点。当前路线：`]}),(0,$.jsx)(`div`,{className:`report-route`,children:C?.roads.join(`　→　`)||`正在载入真实道路名称`}),(0,$.jsx)(`p`,{children:y?`已封锁 OSM 道路 ${C?.blockedRoadId??x??`自动选择路段`}，消防车已避开该路段并完成动态重规划。`:`当前道路正常通行，消防车沿最短真实路网路线行驶。`})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`h3`,{children:`04　联合处置指令`}),(0,$.jsxs)(`ol`,{children:[(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`交通：`}),`2 分钟内封锁事故点周边 500 m 道路，建立 3.2 km 应急绿波带。`]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`教育：`}),`城北实验学校师生经东南侧上风向安全通道分批疏散，8 分钟完成重点人员转移。`]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`消防：`}),`2 辆泡沫消防车沿 OSM 路线抵达，在上风向布置水幕并实施堵漏。`]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`医疗：`}),`开放三级医院绿色通道，在体育中心设置临时分诊点。`]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`监测：`}),`下风向 200 m、500 m、1000 m 设置监测点，每 2 分钟回传浓度。`]})]})]}),(0,$.jsxs)(`div`,{className:`report-conclusion`,children:[(0,$.jsx)(`b`,{children:`AI 处置结论`}),(0,$.jsx)(`p`,{children:`立即启动危化品泄漏Ⅰ级联合响应，处置优先级为：学校疏散 → 道路封控 → 泄漏源控制 → 医疗救治 → 环境复测。`}),(0,$.jsx)(`small`,{children:`本报告由灵境哨兵自动生成，用于竞赛演示；正式行动须由现场指挥员复核。`})]})]}),(0,$.jsxs)(`footer`,{className:`report-actions`,children:[(0,$.jsx)(`button`,{onClick:qe,children:`↓ 下载完整报告`}),(0,$.jsx)(`button`,{onClick:()=>ue(!1),children:`关闭报告`})]})]})]})}),(0,$.jsxs)(`footer`,{children:[(0,$.jsx)(`span`,{children:`数据源：城市感知网络 · 气象局 · 应急资源库`}),(0,$.jsxs)(`strong`,{children:[(0,$.jsx)(`i`,{}),` AI 决策引擎运行正常 · 处理延迟 128ms`]}),(0,$.jsx)(`span`,{children:`灵境哨兵 v3.0 FINAL · 离线演示环境`})]})]}):(0,$.jsx)(qf,{onAuthenticated:Ye}):(0,$.jsxs)(`main`,{className:`auth-boot`,children:[(0,$.jsxs)(`div`,{className:`auth-brand-mark`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]}),(0,$.jsx)(`span`,{children:`安全环境初始化中`})]})}export{Jf as default};