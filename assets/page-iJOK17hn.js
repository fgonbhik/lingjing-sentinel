...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `}));x.renderOrder=-10,n.add(x);let S=new Ds(15005183,1588050,1.8);n.add(S);let C=new Ws(15200767,2.65);C.position.set(-70,128,68),C.castShadow=!0,C.shadow.mapSize.set(1024,1024),C.shadow.camera.left=-310,C.shadow.camera.right=310,C.shadow.camera.top=310,C.shadow.camera.bottom=-310,C.shadow.bias=-28e-5,C.shadow.normalBias=.035,n.add(C);let w=new Ws(5618431,1.2);w.position.set(92,52,-78),n.add(w);let T=new Vs(3714804,16,138,1.65);T.position.set(0,45,0),n.add(T);let E=[],D=[];for(let e=0;e<12;e++){let t=e/12*Math.PI*2,r=e%3==0?4685311:3524863,i=new Vs(r,6.4,62,1.7);i.position.set(Math.cos(t)*202,5.5,Math.sin(t)*202);let a=new Y(new Ho(.65,14,10),new J({color:r,transparent:!0,opacity:.42}));a.position.copy(i.position),n.add(i,a),E.push(i),D.push(a)}let O=new Ts().load(`./beijing-map-base.jpg`);O.colorSpace=ze,O.anisotropy=o.capabilities.getMaxAnisotropy(),O.generateMipmaps=!0,O.minFilter=m,O.magFilter=f;let k=new X({color:8828615,map:O,emissiveMap:O,emissive:1195346,emissiveIntensity:.22,roughness:.82,metalness:.18}),A=new Y(new fa(If,224),k);A.rotation.x=-Math.PI/2,A.position.y=.65,A.receiveShadow=!1,n.add(A);let j={uFloorPrimary:{value:new q(2874623)},uFloorSecondary:{value:new q(6978815)},uFloorOpacity:{value:.68}},ee=new Y(new fa(If-3,224),new $o({transparent:!0,depthWrite:!1,side:2,blending:2,toneMapped:!1,uniforms:j,vertexShader:`
