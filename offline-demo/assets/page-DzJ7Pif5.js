...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
          ...
          totalEmissiveRadiance += windowColor * windowShape * windowOn * windowStrength;`)};let me=new X(1,1,1),he=new li({color:3729407,wireframe:!0,transparent:!0,opacity:.16,blending:2,depthWrite:!1}),ge=new X(1,.12,1),_e=new li({color:8189439,transparent:!0,opacity:.72}),ve=null,ye=[],L=[];(async()=>{try{let e=await fetch(`./beijing-buildings.json`);if(!e.ok)throw Error(`building dataset unavailable`);let r=await e.json();if(t)return;let i=r.buildings.filter(e=>e.points.length>=3).slice(0,5200),a=new Mi(me,fe,i.length);ve=a,ye=i;let o=new Mi(me,he,i.length),s=i.filter(e=>(e.heightMeters||16)>40).slice(0,700),c=new Mi(ge,_e,s.length),u=new tn,d=new tn,f=new J,p=e=>{let t=e.points.map(e=>e[0]),n=e.points.map(e=>e[1]);return{x:(Math.min(...t)+Math.max(...t))/3.35,z:(Math.min(...n)+Math.max(...n))/3.35,width:Math.max(.45,Math.min(6,(Math.max(...t)-Math.min(...t))/3.35)),depth:Math.max(.45,Math.min(6,(Math.max(...n)-Math.min(...n))/3.35)),height:Math.max(1.2,Math.min(58,(e.heightMeters||16)/5.2))}};i.forEach((e,t)=>{let{x:n,z:r,width:i,depth:s,height:c}=p(e);u.compose(new q(n,1.72+c/2,r),new jt,new q(i,c,s)),a.setMatrixAt(t,u),d.compose(new q(n,1.72+c/2,r),new jt,new q(i*1.018,c*1.006,s*1.018)),o.setMatrixAt(t,d);let l=Math.min(1,Math.sqrt(n*n+r*r)/110);f.setHSL(.51+l*.055+Math.random()*.018,.52,.31+(1-l)*.18+Math.random()*.08),a.setColorAt(t,f),L.push(f.clone())}),s.forEach((e,t)=>{let{x:n,z:r,width:i,depth:a,height:o}=p(e);u.compose(new q(n,1.76+o,r),new jt,new q(i*.82,1,a*.82)),c.setMatrixAt(t,u)}),a.instanceMatrix.needsUpdate=!0,a.instanceColor.needsUpdate=!0,o.instanceMatrix.needsUpdate=!0,c.instanceMatrix.needsUpdate=!0,a.castShadow=!0,a.receiveShadow=!0,a.userData.asset={id:`beijing-building-network`,label:`北京城市建筑群`,category:`三维城市底座`,details:`${i.length.toLocaleString()} 栋建筑已接入城市数字孪生，支持空间定位、态势叠加与运行监测。`,meta:`建筑高度 · 区位编码 · 能耗状态 · 实时同步`},n.add(a,o,c),ne.push(a),l(`ready`)}catch{t||l(`degraded`)}})();let be=new Mi(new X(1.15,.48,.62),new Z({color:14220031,emissive:3595759,emissiveIntensity:1.05,metalness:.55,roughness:.26}),54);be.instanceMatrix.setUsage(Ge),n.add(be);let xe=new tn,Se=Array.from({length:54},(e,t)=>({axis:t%2,lane:[-72,-46,-22,0,24,49,74][t%7]+(t%3-1)*1.15,offset:t*17%224,speed:.15+t%7*.017}));_.current=(e,t)=>{n.background=new J(e?66570:466741),n.fog=new Rn(e?133138:666174,e?.0075:.0056),v.intensity=e?.42:1.15,y.intensity=e?.16:2.4,b.intensity=e?34:22,x.forEach((t,n)=>{t.intensity=e?13+n%2*2:7}),C.color.setHex(e?133906:466219),T.emissiveIntensity=e?1.1:.65,O.emissive.setHex(e?536640:332829),fe.emissive.setHex(t?e?555932:676459:266780),fe.emissiveIntensity=t?e?.95:.48:.1,pe.value=t?e?2.2:1.15:.03,he.opacity=t?e?.3:.16:.045,_e.opacity=t?e?.92:.72:.16,k.opacity=e?.82:.52,j.emissiveIntensity=e?.9:.55},_.current(p.current,m.current);let Ce=new cc,we=new K,R=new J(10420223),Te=-1,Ee=null,De=0,Oe={x:0,y:0},ke=e=>{let t=o.domElement.getBoundingClientRect();we.set((e.clientX-t.left)/t.width*2-1,-((e.clientY-t.top)/t.height)*2+1)},z=()=>{ve&&Te>=0&&L[Te]&&(ve.setColorAt(Te,L[Te]),ve.instanceColor&&(ve.instanceColor.needsUpdate=!0)),Te=-1},Ae=()=>{Ee&&Ee.scale.setScalar(1),Ee=null},je=()=>{z(),Ae(),o.domElement.style.cursor=`grab`},Me=e=>{let t=e.clientX,n=e.clientY;cancelAnimationFrame(De),De=requestAnimationFrame(()=>{let e=o.domElement.getBoundingClientRect();we.set((t-e.left)/e.width*2-1,-((n-e.top)/e.height)*2+1),Ce.setFromCamera(we,r);let i=Ce.intersectObjects(ne,!1)[0],a=i?.object===ve&&i.instanceId!==void 0?i.instanceId:-1,s=i?.object.userData.asset&&i?.object!==ve?i.object:null;a!==Te&&(z(),ve&&a>=0&&(ve.setColorAt(a,R),ve.instanceColor&&(ve.instanceColor.needsUpdate=!0),Te=a)),s!==Ee&&(Ae(),Ee=s,Ee?.scale.setScalar(1.35)),o.domElement.style.cursor=i?`pointer`:`grab`})},B=e=>{if(Math.hypot(e.clientX-Oe.x,e.clientY-Oe.y)>5)return;ke(e),Ce.setFromCamera(we,r);let t=Ce.intersectObjects(ne,!1)[0];if(t?.object===ve&&t.instanceId!==void 0){let e=ye[t.instanceId],n=e?.id??t.instanceId+1,r=Math.round(e?.heightMeters||16);c({id:`building-${n}`,label:e?.name||`北京城市建筑 ${String(n).padStart(5,`0`)}`,category:`北京三维建筑资产`,details:`建筑高度约 ${r} 米，已接入北京城市数字孪生底座，可叠加能耗、安防、交通及应急态势数据。`,meta:`资产编号 BJ-${String(n).padStart(6,`0`)} · 实时在线 · 单击定位`});return}let n=t?.object.userData.asset;c(n||null)},Ne=e=>{Oe={x:e.clientX,y:e.clientY}};o.domElement.addEventListener(`pointermove`,Me),o.domElement.addEventListener(`pointerleave`,je),o.domElement.addEventListener(`pointerdown`,Ne),o.domElement.addEventListener(`pointerup`,B);let V=()=>{let t=Math.max(1,e.clientWidth),n=Math.max(1,e.clientHeight);r.aspect=t/n,r.updateProjectionMatrix(),o.setSize(t,n,!1)},H=new ResizeObserver(V);H.observe(e),V();let Pe=null,Fe=(e,t,n=1250)=>{Pe={from:r.position.clone(),to:new q(...e),targetFrom:s.target.clone(),targetTo:new q(...t),start:performance.now(),duration:n},s.enabled=!1},Ie=e=>{let t=e.detail;if(t===`zoomIn`||t===`zoomOut`){let e=t===`zoomIn`?.82:1.18,n=r.position.clone().sub(s.target).multiplyScalar(e);r.position.copy(s.target).add(n),s.update();return}if(t===`reset`){Fe(bf.panorama.position,bf.panorama.target);return}if(typeof t==`object`&&t.action===`view`&&t.view&&bf[t.view]){let e=bf[t.view];Fe(e.position,e.target);return}typeof t==`object`&&t.action===`focus`&&t.position&&t.target&&Fe(t.position,t.target,1050)};window.addEventListener(`smart-city-camera`,Ie);let Le=performance.now(),Re=0,Be=e=>{Re=requestAnimationFrame(Be);let t=Math.max(0,(e-Le)/1e3),i=Math.min(54,g.current);if(be.count=i,Se.forEach((e,n)=>{if(n>=i)return;let r=(e.offset+t*e.speed*30)%224-112,a=e.axis?r:e.lane,o=e.axis?e.lane:r,s=new jt().setFromEuler(new fn(0,e.axis?Math.PI/2:0,0));xe.compose(new q(a,2.12,o),s,new q(1,1,1)),be.setMatrixAt(n,xe)}),be.instanceMatrix.needsUpdate=!0,de.scale.setScalar(1+t*.2%1*43),ue.opacity=.24*(1-t*.2%1),ce.opacity=.5+Math.sin(t*2.2)*.22,ee.forEach((e,n)=>{e.rotation.z=t*(n%2?-.025:.02),e.material.opacity=.23+Math.sin(t*1.4+n)*.12}),te.forEach((e,n)=>{e.rotation.z=t*(n===0?.08:-.055),e.material.opacity=(n===0?.62:.4)+Math.sin(t*1.7+n)*.12}),S.forEach((e,n)=>{let r=.88+Math.sin(t*2.4+n*.7)*.22;e.scale.setScalar(r)}),re.forEach((e,n)=>{let r=1+Math.sin(t*2+n)*.12;e.scale.setScalar(r)}),ae.forEach((e,n)=>{e.material.dashOffset=-t*(.8+n*.14)}),se.forEach((e,n)=>{let r=ae[n].userData.curve;e.position.copy(r.getPoint((t*.13+n*.22)%1))}),Pe){let t=Math.min(1,(e-Pe.start)/Pe.duration),n=1-(1-t)**3;r.position.lerpVectors(Pe.from,Pe.to,n),s.target.lerpVectors(Pe.targetFrom,Pe.targetTo,n),t>=1&&(Pe=null,s.enabled=!0)}else h.current&&(r.position.x=Math.cos(t*.075)*150,r.position.z=Math.sin(t*.075)*150,r.position.y=79+Math.sin(t*.11)*14,s.target.set(0,12,0));s.update(),o.render(n,r)};return Re=requestAnimationFrame(Be),()=>{t=!0,cancelAnimationFrame(Re),cancelAnimationFrame(De),H.disconnect(),o.domElement.removeEventListener(`pointermove`,Me),o.domElement.removeEventListener(`pointerleave`,je),o.domElement.removeEventListener(`pointerdown`,Ne),o.domElement.removeEventListener(`pointerup`,B),window.removeEventListener(`smart-city-camera`,Ie),s.dispose(),o.dispose(),n.traverse(e=>{let t=e;t.geometry?.dispose?.(),Array.isArray(t.material)?t.material.forEach(e=>e.dispose()):t.material?.dispose?.()}),o.domElement.remove()}},[l,c]),(0,$.jsx)(`div`,{ref:u,className:`smart-city-scene`,"aria-label":`北京科幻智慧城市三维数字孪生场景`})}function Tf({data:e,onClose:t,tone:n=`cyan`}){return(0,$.jsxs)(`div`,{className:`data-detail-layer ${n}`,role:`presentation`,children:[(0,$.jsx)(`button`,{className:`data-detail-backdrop`,"aria-label":`关闭数据详情`,onClick:t}),(0,$.jsxs)(`section`,{className:`data-detail-dialog`,role:`dialog`,"aria-modal":`true`,"aria-label":`${e.label}数据详情`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{children:`DATA INSIGHT · 实时数据详情`})]}),(0,$.jsx)(`button`,{"aria-label":`关闭数据详情`,onClick:t,children:`×`})]}),(0,$.jsxs)(`div`,{className:`data-detail-body`,children:[(0,$.jsx)(`span`,{children:e.category}),(0,$.jsx)(`h2`,{children:e.label}),(0,$.jsx)(`p`,{children:e.details}),(0,$.jsxs)(`div`,{className:`data-detail-meta`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`数据状态`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(`i`,{}),`实时更新`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`研判结果`}),(0,$.jsx)(`b`,{children:e.meta})]})]})]}),(0,$.jsxs)(`footer`,{children:[(0,$.jsx)(`span`,{children:`城市感知网络 · 模型与算法引擎`}),(0,$.jsx)(`button`,{onClick:t,children:`关闭详情`})]})]})]})}var Ef=[`全域态势`,`城市治理`,`交通脉搏`,`生态能源`,`公共安全`],Df=[{name:`朝阳`,score:97.2,tone:`cyan`,value:`商务活跃`},{name:`海淀`,score:95.8,tone:`blue`,value:`科技创新`},{name:`东城`,score:94.6,tone:`green`,value:`治理高效`},{name:`丰台`,score:91.9,tone:`orange`,value:`枢纽畅通`}],Of=[{time:`21:26:48`,level:`AI`,text:`朝阳区交通流量预测完成`,state:`已闭环`},{time:`21:25:32`,level:`感`,text:`海淀区感知节点状态巡检`,state:`正常`},{time:`21:24:16`,level:`能`,text:`全市电网负荷进入平稳区间`,state:`稳定`},{time:`21:22:09`,level:`环`,text:`城市空气质量模型已更新`,state:`优良`}],kf=[`全市感知设备在线率 99.97%`,`重点道路平均车速 41.8 km/h`,`轨道交通在途列车 1,284 列`,`空气质量优良率 94.6%`,`城市事件智能闭环率 96.8%`,`新能源消纳比例 38.7%`],Af=[{id:`panorama`,code:`01`,label:`全景`},{id:`cbd`,code:`02`,label:`CBD`},{id:`axis`,code:`03`,label:`中轴`},{id:`top`,code:`04`,label:`俯瞰`},{id:`horizon`,code:`05`,label:`天际`}],jf={朝阳:{position:[83,45,72],target:[38,9,18]},海淀:{position:[-88,48,82],target:[-48,9,40]},东城:{position:[-58,42,-58],target:[-22,9,-15]},丰台:{position:[52,43,-91],target:[12,8,-48]}};function Mf({displayName:e,onOpenDemo:t,onLogout:n}){let[i,a]=(0,r.useState)(`全域态势`),[o,s]=(0,r.useState)(!0),[c,l]=(0,r.useState)(!0),[u,d]=(0,r.useState)(!0),[f,p]=(0,r.useState)(!1),[m,h]=(0,r.useState)(54),[g,_]=(0,r.useState)(null),[v,y]=(0,r.useState)(`loading`),[b,x]=(0,r.useState)(()=>new Date),[S,C]=(0,r.useState)(0),[w,T]=(0,r.useState)(!1),[E,D]=(0,r.useState)(`panorama`),[O,k]=(0,r.useState)(`左键拖拽旋转 · 滚轮缩放 · 右键平移 · 点击建筑查看详情`),[A,ee]=(0,r.useState)(0);(0,r.useEffect)(()=>{let e=window.setInterval(()=>x(new Date),1e3),t=window.setInterval(()=>C(e=>(e+1)%8),2400),n=window.requestAnimationFrame(()=>T(!0));return()=>{window.clearInterval(e),window.clearInterval(t),window.cancelAnimationFrame(n)}},[]);let te=(0,r.useCallback)(e=>{k(e),ee(e=>e+1)},[]),j=(0,r.useCallback)((e,t,n,r,i)=>{_({id:`insight-${e}`,label:t,category:n,details:r,meta:i}),te(`已打开：${t} · 右侧详情卡片已更新`)},[te]),M=(0,r.useCallback)(e=>{_(e),e&&te(`已选中：${e.label} · 详情卡片已展开`)},[te]),N=b.toLocaleTimeString(`zh-CN`,{hour12:!1}),P=b.toLocaleDateString(`zh-CN`,{year:`numeric`,month:`2-digit`,day:`2-digit`}),ne=[`星期日`,`星期一`,`星期二`,`星期三`,`星期四`,`星期五`,`星期六`][b.getDay()],re=(0,r.useMemo)(()=>v===`loading`?`正在构建北京三维建筑群`:v===`degraded`?`城市基础模型已启用`:`5,200 栋建筑在线 · 城市光网运行中`,[v]),ie=e=>{d(!1),p(!1),D(`panorama`),_({id:`district-${e.name}`,label:`${e.name}区`,category:`城区运行态势`,details:`${e.value}，当前城区综合运行指数 ${e.score}，城市感知、交通与公共服务状态正常。`,meta:`AI 评分 ${e.score} · 数据刷新 128ms`});let t=jf[e.name];window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:{action:`focus`,position:t.position,target:t.target}})),te(`正在聚焦${e.name}区 · 镜头已进入城区态势视角`)},ae=e=>{d(!1),p(!1),D(e.id),window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:{action:`view`,view:e.id}})),te(`视角切换：${e.label} · 镜头缓动飞行中`)};return(0,$.jsxs)(`main`,{className:`future-city ${o?`night`:`day`}`,children:[(0,$.jsx)(`div`,{className:`future-grid`,"aria-hidden":`true`}),(0,$.jsx)(`div`,{className:`future-aurora future-aurora-a`,"aria-hidden":`true`}),(0,$.jsx)(`div`,{className:`future-aurora future-aurora-b`,"aria-hidden":`true`}),(0,$.jsxs)(`header`,{className:`future-header`,children:[(0,$.jsxs)(`div`,{className:`future-brand`,children:[(0,$.jsxs)(`div`,{className:`future-brand-symbol`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`b`,{})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:`京域智城`}),(0,$.jsx)(`span`,{children:`BEIJING URBAN INTELLIGENCE CENTER`})]})]}),(0,$.jsxs)(`div`,{className:`future-heading`,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`i`,{}),` BEIJING DIGITAL TWIN · 2026`]}),(0,$.jsx)(`h1`,{children:`北京市智慧城市运行指挥中心`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`b`,{children:`全域感知`}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]})]}),(0,$.jsxs)(`div`,{className:`future-account`,children:[(0,$.jsxs)(`div`,{className:`future-time`,children:[(0,$.jsx)(`strong`,{children:N}),(0,$.jsxs)(`span`,{children:[P,` · `,ne]})]}),(0,$.jsxs)(`div`,{className:`future-user`,children:[(0,$.jsx)(`i`,{}),e,(0,$.jsx)(`button`,{onClick:n,children:`退出`})]})]})]}),(0,$.jsx)(`nav`,{className:`future-nav`,"aria-label":`智慧城市功能导航`,children:Ef.map((e,t)=>(0,$.jsxs)(`button`,{className:i===e?`active`:``,onClick:()=>a(e),children:[(0,$.jsxs)(`i`,{children:[`0`,t+1]}),(0,$.jsx)(`span`,{children:e})]},e))}),(0,$.jsxs)(`section`,{className:`future-stage`,children:[(0,$.jsxs)(`aside`,{className:`future-column left`,children:[(0,$.jsxs)(`section`,{className:`future-panel city-vitals`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`01`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`城市生命体征`}),(0,$.jsx)(`em`,{children:`URBAN VITAL SIGNS`})]}),(0,$.jsx)(`i`,{children:`LIVE`})]}),(0,$.jsxs)(`div`,{className:`vital-primary`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`常住人口`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:2183.2,decimals:1})}),(0,$.jsx)(`em`,{children:`万人`})]}),(0,$.jsx)(`div`,{className:`vital-wave`,"aria-hidden":`true`,children:[34,52,41,68,48,76,57,82,61,72,55,88].map((e,t)=>(0,$.jsx)(`i`,{style:{height:`${e}%`}},t))})]}),(0,$.jsxs)(`div`,{className:`vital-grid`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>j(`area`,`北京市域面积`,`城市生命体征`,`全市域面积 16,410 平方公里，数字孪生已覆盖核心城区、重点交通走廊和公共服务节点。`,`全域覆盖 · 数据更新 128ms`),children:[(0,$.jsx)(`span`,{children:`城市面积`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(_f,{to:16410}),(0,$.jsx)(`small`,{children:` km²`})]}),(0,$.jsx)(`em`,{children:`全域覆盖`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>j(`gdp`,`地区生产总值`,`城市生命体征`,`城市经济运行保持稳健，数字经济、科技服务和现代服务业构成主要增长动能。`,`4.98 万亿元 · 同比 +5.2%`),children:[(0,$.jsx)(`span`,{children:`地区生产总值`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(_f,{to:4.98,decimals:2}),(0,$.jsx)(`small`,{children:` 万亿元`})]}),(0,$.jsx)(`em`,{children:`同比 +5.2%`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>j(`rail`,`轨道交通网络`,`城市生命体征`,`轨道交通运营里程 879 公里，1,284 列列车在途，关键换乘枢纽运行正常。`,`线网联动 · 平均准点率 99.6%`),children:[(0,$.jsx)(`span`,{children:`轨道交通`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(_f,{to:879}),(0,$.jsx)(`small`,{children:` km`})]}),(0,$.jsx)(`em`,{children:`在途 1,284 列`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>j(`parks`,`公园绿地体系`,`城市生命体征`,`全市 1,064 处公园绿地接入生态监测，绿色空间覆盖率达到 49.8%。`,`生态感知 · 1,064 处在线`),children:[(0,$.jsx)(`span`,{children:`公园绿地`}),(0,$.jsxs)(`b`,{children:[(0,$.jsx)(_f,{to:1064}),(0,$.jsx)(`small`,{children:` 处`})]}),(0,$.jsx)(`em`,{children:`绿色空间 49.8%`})]})]})]}),(0,$.jsxs)(`section`,{className:`future-panel event-center`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`02`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`城市事件中枢`}),(0,$.jsx)(`em`,{children:`AI EVENT STREAM`})]}),(0,$.jsx)(`i`,{children:`04`})]}),(0,$.jsx)(`div`,{className:`event-list`,children:Of.map((e,t)=>(0,$.jsxs)(`button`,{type:`button`,className:`event-row ${S===t?`pulse`:``}`,onClick:()=>j(`event-${t}`,e.text,`城市事件中枢`,`${e.time} 由${e.level}类城市感知模型完成研判，当前处置状态为“${e.state}”。`,`事件编号 BJ-${e.time.replaceAll(`:`,``)} · ${e.state}`),children:[(0,$.jsx)(`time`,{children:e.time}),(0,$.jsx)(`i`,{children:e.level}),(0,$.jsxs)(`p`,{children:[e.text,(0,$.jsx)(`span`,{children:e.state})]})]},e.time))})]}),(0,$.jsxs)(`section`,{className:`future-panel eco-panel`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`03`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`生态环境监测`}),(0,$.jsx)(`em`,{children:`ECOLOGICAL MONITORING`})]}),(0,$.jsx)(`i`,{children:`优`})]}),(0,$.jsxs)(`div`,{className:`eco-content`,children:[(0,$.jsxs)(`button`,{type:`button`,className:`air-orbit`,onClick:()=>j(`pm25`,`PM2.5 实时监测`,`生态环境监测`,`北京市核心区 PM2.5 当前浓度为 28 μg/m³，空气质量等级为优。`,`气象与环境感知网 · 分钟级刷新`),children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`b`,{children:`28`}),(0,$.jsx)(`span`,{children:`PM2.5`})]}),(0,$.jsxs)(`div`,{className:`eco-stats`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>j(`air`,`空气优良率`,`生态环境监测`,`全市空气质量优良率达到 94.6%，重点站点均处于正常监测状态。`,`94.6% · 较昨日 +1.2%`),children:[(0,$.jsx)(`span`,{children:`空气优良率`}),(0,$.jsx)(`b`,{children:`94.6%`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>j(`temperature`,`城市平均温度`,`生态环境监测`,`当前城市平均温度 26.3°C，热岛强度处于可控区间。`,`26.3°C · 东南风 3.4m/s`),children:[(0,$.jsx)(`span`,{children:`平均温度`}),(0,$.jsx)(`b`,{children:`26.3°C`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>j(`carbon`,`碳排强度`,`生态环境监测`,`城市单位产出碳排强度同比下降 4.8%，新能源消纳比例持续提升。`,`-4.8% · 绿色转型稳定`),children:[(0,$.jsx)(`span`,{children:`碳排强度`}),(0,$.jsx)(`b`,{children:`-4.8%`})]})]})]})]})]}),(0,$.jsxs)(`section`,{className:`future-center`,children:[(0,$.jsxs)(`div`,{className:`scene-head`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{children:i}),(0,$.jsx)(`b`,{children:`北京核心区三维数字孪生`})]}),(0,$.jsx)(`em`,{className:v,children:re})]}),(0,$.jsxs)(`div`,{className:`future-scene`,children:[(0,$.jsx)(wf,{topView:f,nightMode:o,buildingLights:c,autoTour:u,trafficDensity:m,onSelect:M,onSceneStatus:y}),(0,$.jsx)(`div`,{className:`scene-scanline`,"aria-hidden":`true`}),(0,$.jsxs)(`div`,{className:`scene-corners`,"aria-hidden":`true`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]}),(0,$.jsxs)(`div`,{className:`scene-coordinate`,children:[(0,$.jsx)(`span`,{children:`39°54′27″N`}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{children:`116°27′07″E`}),(0,$.jsx)(`b`,{children:`BEIJING`})]}),(0,$.jsxs)(`div`,{className:`scene-layer`,children:[(0,$.jsx)(`span`,{children:`DATA LAYERS`}),(0,$.jsx)(`i`,{className:`cyan`}),(0,$.jsx)(`em`,{children:`建筑`}),(0,$.jsx)(`i`,{className:`blue`}),(0,$.jsx)(`em`,{children:`交通`}),(0,$.jsx)(`i`,{className:`green`}),(0,$.jsx)(`em`,{children:`感知`})]}),(0,$.jsxs)(`div`,{className:`scene-orientation`,children:[(0,$.jsx)(`b`,{children:`N`}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{children:`024°`})]}),(0,$.jsx)(`div`,{className:`scene-districts`,children:Df.map(e=>(0,$.jsxs)(`button`,{onClick:()=>ie(e),children:[(0,$.jsx)(`i`,{className:e.tone}),(0,$.jsx)(`span`,{children:e.name}),(0,$.jsx)(`b`,{children:e.score})]},e.name))}),(0,$.jsxs)(`div`,{className:`scene-view-presets`,"aria-label":`预设三维视角`,children:[(0,$.jsx)(`span`,{children:`VIEW`}),Af.map(e=>(0,$.jsxs)(`button`,{className:E===e.id?`active`:``,onClick:()=>ae(e),"aria-label":`切换至${e.label}视角`,children:[(0,$.jsx)(`i`,{children:e.code}),(0,$.jsx)(`b`,{children:e.label})]},e.id))]}),(0,$.jsxs)(`div`,{className:`scene-operation-tip`,role:`status`,"aria-live":`polite`,children:[(0,$.jsx)(`i`,{children:`⌁`}),(0,$.jsx)(`span`,{children:O})]},A),(0,$.jsxs)(`div`,{className:`scene-controls`,children:[(0,$.jsxs)(`button`,{className:f?`on`:``,onClick:()=>{let e=!f;d(!1),p(e),D(e?`top`:`panorama`),te(e?`垂直俯视已开启 · 可滚轮缩放查看建筑分布`:`已恢复自由视角`)},children:[(0,$.jsx)(`i`,{children:`◇`}),f?`自由视角`:`垂直俯视`]}),(0,$.jsxs)(`button`,{className:u?`on`:``,onClick:()=>{let e=!u;d(e),p(!1),te(e?`自动巡航已启动 · 手动选视角可随时接管`:`自动巡航已暂停`)},children:[(0,$.jsx)(`i`,{children:u?`■`:`▶`}),u?`停止巡航`:`自动巡航`]}),(0,$.jsxs)(`button`,{className:c?`on`:``,onClick:()=>{let e=!c;l(e),te(e?`建筑光网已点亮`:`建筑光网已隐藏`)},children:[(0,$.jsx)(`i`,{children:`✦`}),`建筑光网`]}),(0,$.jsxs)(`button`,{onClick:()=>{let e=!o;s(e),te(e?`已切换至夜间城市模式`:`已切换至日间城市模式`)},children:[(0,$.jsx)(`i`,{children:o?`☀`:`☾`}),o?`日间模式`:`夜间模式`]}),(0,$.jsxs)(`button`,{onClick:()=>{let e=m===18?36:m===36?54:18;h(e),te(`动态车流密度已调整为 ${e} 辆`)},children:[(0,$.jsx)(`i`,{children:`⇄`}),`车流 `,m]}),(0,$.jsxs)(`button`,{"aria-label":`复位三维视角`,onClick:()=>{d(!1),p(!1),D(`panorama`),window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:`reset`})),te(`三维视角已复位至北京城市全景`)},children:[(0,$.jsx)(`i`,{children:`⌖`}),`视角复位`]})]}),(0,$.jsxs)(`div`,{className:`scene-zoom`,children:[(0,$.jsx)(`button`,{"aria-label":`放大城市模型`,onClick:()=>window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:`zoomIn`})),children:`＋`}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`button`,{"aria-label":`缩小城市模型`,onClick:()=>window.dispatchEvent(new CustomEvent(`smart-city-camera`,{detail:`zoomOut`})),children:`−`})]})]})]}),(0,$.jsxs)(`aside`,{className:`future-column right`,children:[(0,$.jsxs)(`section`,{className:`future-panel ai-index`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`04`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`城市智能指数`}),(0,$.jsx)(`em`,{children:`CITY AI INDEX`})]}),(0,$.jsx)(`i`,{children:`TOP 1`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`ai-score`,onClick:()=>j(`ai-score`,`城市智能指数 96.4`,`城市 AI 大脑`,`综合感知覆盖、协同效率、预测准确和处置闭环四项能力，当前城市智能指数为 96.4。`,`全国领先 · 较昨日 +1.8%`),children:[(0,$.jsxs)(`div`,{className:`score-rings`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:96.4,decimals:1})}),(0,$.jsx)(`span`,{children:`综合评分`})]}),(0,$.jsxs)(`div`,{className:`score-copy`,children:[(0,$.jsx)(`span`,{children:`AI 城市大脑`}),(0,$.jsx)(`b`,{children:`运行卓越`}),(0,$.jsx)(`em`,{children:`较昨日 +1.8%`}),(0,$.jsx)(`p`,{children:`城市治理模型实时计算中`})]})]}),(0,$.jsx)(`div`,{className:`ai-dimensions`,children:[[`感知覆盖`,98],[`协同效率`,94],[`预测准确`,96],[`处置闭环`,97]].map(([e,t],n)=>(0,$.jsxs)(`button`,{type:`button`,onClick:()=>j(`ai-${n}`,`${e} ${t}%`,`城市 AI 能力维度`,`${e}能力已接入城市级模型评估，当前得分 ${t}%，运行状态稳定。`,`AI ENGINE · 第 ${n+1} 维度`),children:[(0,$.jsx)(`span`,{children:e}),(0,$.jsx)(`i`,{children:(0,$.jsx)(`b`,{style:{width:w?`${t}%`:`0%`,transitionDelay:`${n*120}ms`}})}),(0,$.jsxs)(`em`,{children:[t,`%`]})]},e))})]}),(0,$.jsxs)(`section`,{className:`future-panel traffic-panel`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`05`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`交通运行脉搏`}),(0,$.jsx)(`em`,{children:`TRAFFIC MOBILITY`})]}),(0,$.jsx)(`i`,{children:`畅通`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`traffic-number`,onClick:()=>j(`traffic-index`,`全路网交通指数`,`交通运行脉搏`,`全路网交通指数 1.42，整体处于畅通等级，重点道路信号协调运行正常。`,`指数 1.42 · 畅通`),children:[(0,$.jsx)(`span`,{children:`全路网交通指数`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:1.42,decimals:2})}),(0,$.jsx)(`em`,{children:`畅通`})]}),(0,$.jsx)(`button`,{type:`button`,className:`traffic-flow`,"aria-label":`调整并查看交通流量趋势`,onClick:()=>{let e=m===18?36:m===36?54:18;h(e),j(`traffic-flow`,`近八小时交通流量`,`交通运行脉搏`,`已将三维城市动态车流调整为 ${e} 辆，可在中央地图观察道路车流变化。`,`点击循环调节 · 当前密度 ${e}`)},children:[31,43,52,47,68,76,64,83,71,62,54,59,46,39].map((e,t)=>(0,$.jsx)(`i`,{style:{height:w?`${e}%`:`0%`,transitionDelay:`${t*55}ms`}},t))}),(0,$.jsxs)(`div`,{className:`traffic-meta`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>j(`speed`,`道路平均车速`,`交通运行脉搏`,`全市重点道路平均车速 41.8 km/h，当前车速变化处于模型预测范围内。`,`41.8 km/h · 实时计算`),children:[(0,$.jsx)(`span`,{children:`平均车速`}),(0,$.jsx)(`b`,{children:`41.8 km/h`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>j(`congestion`,`拥堵道路里程`,`交通运行脉搏`,`当前拥堵道路总里程 28.6 km，拥堵主要集中于晚高峰重点走廊。`,`28.6 km · 动态监测`),children:[(0,$.jsx)(`span`,{children:`拥堵里程`}),(0,$.jsx)(`b`,{children:`28.6 km`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>j(`signals`,`信号协调率`,`交通运行脉搏`,`城市信号控制协调率达到 92.7%，重点路口绿波方案处于自动优化状态。`,`92.7% · AI 信号控制`),children:[(0,$.jsx)(`span`,{children:`信号协调率`}),(0,$.jsx)(`b`,{children:`92.7%`})]})]})]}),(0,$.jsxs)(`section`,{className:`future-panel district-rank`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`06`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`城区运行排行`}),(0,$.jsx)(`em`,{children:`DISTRICT RANKING`})]}),(0,$.jsx)(`i`,{children:`16 区`})]}),(0,$.jsx)(`div`,{children:Df.map((e,t)=>(0,$.jsxs)(`button`,{onClick:()=>ie(e),children:[(0,$.jsx)(`i`,{children:String(t+1).padStart(2,`0`)}),(0,$.jsxs)(`span`,{children:[e.name,`区`,(0,$.jsx)(`em`,{children:(0,$.jsx)(`b`,{style:{width:w?`${e.score}%`:`0%`,transitionDelay:`${t*120}ms`}})})]}),(0,$.jsx)(`strong`,{children:e.score}),(0,$.jsx)(`small`,{children:e.value})]},e.name))})]}),(0,$.jsxs)(`button`,{className:`future-demo-card`,onClick:t,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`FEATURED AI DEMO`}),(0,$.jsx)(`em`,{children:`01`})]}),(0,$.jsx)(`strong`,{children:`灵境哨兵`}),(0,$.jsx)(`p`,{children:`危化品运输事故全链路智能处置`}),(0,$.jsx)(`b`,{children:`事故识别 · 扩散计算 · 路径重规划`}),(0,$.jsxs)(`i`,{children:[`立即进入演示项目 `,(0,$.jsx)(`span`,{children:`→`})]})]})]})]}),g&&(0,$.jsx)(Tf,{data:g,onClose:()=>_(null)}),(0,$.jsxs)(`footer`,{className:`future-footer`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{}),`CITY DATA STREAM`]}),(0,$.jsx)(`section`,{children:(0,$.jsx)(`span`,{children:kf.join(`　　◇　　`)})}),(0,$.jsxs)(`em`,{children:[`DATA LATENCY `,(0,$.jsx)(`b`,{children:`128 ms`})]}),(0,$.jsxs)(`strong`,{children:[(0,$.jsx)(`i`,{}),`AI ENGINE ONLINE`]})]})]})}var Nf=(e,t,n)=>Math.max(t,Math.min(n,e)),Pf=null,Ff=null,If=()=>Pf||(Pf=new Promise((e,t)=>{let n=()=>{if(!window.ort){t(Error(`ONNX Runtime Web 未挂载`));return}window.ort.env.wasm.wasmPaths=new URL(`./models/`,document.baseURI).href,window.ort.env.wasm.numThreads=1,e(window.ort)};if(window.ort){n();return}let r=document.querySelector(`script[data-onnx-runtime="local"]`);if(r){r.addEventListener(`load`,n,{once:!0}),r.addEventListener(`error`,()=>t(Error(`ONNX Runtime Web 加载失败`)),{once:!0});return}let i=document.createElement(`script`);i.src=`./models/ort.min.js`,i.async=!0,i.dataset.onnxRuntime=`local`,i.onload=n,i.onerror=()=>t(Error(`ONNX Runtime Web 加载失败`)),document.head.appendChild(i)}).catch(e=>{throw Pf=null,e}),Pf),Lf=async()=>(Ff||=If().then(e=>e.InferenceSession.create(`./models/fire-smoke-yolo26n.onnx`,{executionProviders:[`wasm`],graphOptimizationLevel:`all`})).catch(e=>{throw Ff=null,e}),Ff),Rf=async()=>{let e=performance.now();return await Lf(),Math.round(performance.now()-e)};function zf(e){let t=Math.max(120,Math.round(240*e.height/e.width)),n=document.createElement(`canvas`);n.width=240,n.height=t;let r=n.getContext(`2d`,{willReadFrequently:!0});r.drawImage(e,0,0,240,t);let i=r.getImageData(0,0,240,t).data,a=0,o=0,s=0,c=0,l=new Uint8Array(240*t);for(let e=0;e<240*t;e++){let t=i[e*4],n=i[e*4+1],r=i[e*4+2],s=Math.max(t,n,r),c=Math.min(t,n,r),u=s===0?0:(s-c)/s,d=(s+c)/510,f=u<.22&&d>.27&&d<.88,p=t>n*1.02&&n>r*1.12&&d>.32;(f||p)&&a++,t>165&&t>n*1.35&&n>r*1.15&&o++,l[e]=Math.round(t*.299+n*.587+r*.114)}for(let e=1;e<t;e+=2)for(let t=1;t<240;t+=2){let n=e*240+t;Math.abs(l[n]-l[n-1])+Math.abs(l[n]-l[n-240])>52&&s++,c++}let u=240*t;return{smokeRatio:a/u,flameRatio:o/u,edgeDensity:s/c}}async function Bf(e,t){let n=document.createElement(`canvas`);n.width=640,n.height=640;let r=n.getContext(`2d`,{willReadFrequently:!0});r.fillStyle=`rgb(114,114,114)`,r.fillRect(0,0,640,640);let i=Math.min(640/e.width,640/e.height),a=e.width*i,o=e.height*i;r.drawImage(e,(640-a)/2,(640-o)/2,a,o);let s=r.getImageData(0,0,640,640).data,c=640*640,l=new Float32Array(c*3);for(let e=0;e<c;e+=1)l[e]=s[e*4]/255,l[c+e]=s[e*4+1]/255,l[c*2+e]=s[e*4+2]/255;return new t.Tensor(`float32`,l,[1,3,640,640])}var Vf=(e,t)=>{let n=Math.max(e.x,t.x),r=Math.max(e.y,t.y),i=Math.min(e.x+e.width,t.x+t.width),a=Math.min(e.y+e.height,t.y+t.height),o=Math.max(0,i-n)*Math.max(0,a-r),s=e.width*e.height+t.width*t.height-o;return s>0?o/s:0};function Hf(e,t,n){let r=e.data,i=[],a=Math.min(640/t,640/n),o=(640-t*a)/2,s=(640-n*a)/2;for(let e=0;e<300;e+=1){let c=e*6,l=Number(r[c+4]??0),u=Math.round(Number(r[c+5]??-1));if(l<.25||u!==0&&u!==1)continue;let d=Nf((Number(r[c]??0)-o)/a,0,t),f=Nf((Number(r[c+1]??0)-s)/a,0,n),p=Nf((Number(r[c+2]??0)-o)/a,0,t),m=Nf((Number(r[c+3]??0)-s)/a,0,n),h=u;i.push({classId:h,label:h===0?`smoke`:`fire`,labelZh:h===0?`烟雾`:`明火`,confidence:l,box:{x:d/t*100,y:f/n*100,width:Math.max(0,p-d)/t*100,height:Math.max(0,m-f)/n*100}})}i.sort((e,t)=>t.confidence-e.confidence);let c=[];for(let e of i)if(!c.some(t=>t.classId===e.classId&&Vf(t.box,e.box)>.45)&&(c.push(e),c.length>=8))break;return c}function Uf(e,t,n){let{smokeRatio:r,flameRatio:i,edgeDensity:a}=e;return{type:i>.045?`疑似明火特征`:r>.16?`疑似烟羽特征`:`未发现显著火烟特征`,confidence:Nf(.52+r*.42+a*.12+i*.5,.52,.84),smokeRatio:r,flameRatio:i,edgeDensity:a,persons:0,modelMode:`explainable-fallback`,modelName:`端侧可解释视觉研判原型`,modelVersion:`PIXEL-FEATURE v1.1`,inferenceMs:Math.round(performance.now()-t),detections:[],summary:`本地 ONNX 模型未能加载，已明确降级为像素特征研判；烟羽辅助占比 ${(r*100).toFixed(1)}%，该结果不作为深度学习识别结论。`,explanation:[`使用色彩饱和度、亮度与边缘复杂度进行可解释判别`,`降级结果不会冒充深度学习模型输出`,`降级原因：${n instanceof Error?n.message:`未知运行时错误`}`]}}async function Wf(e){let t=performance.now(),n=await createImageBitmap(e),r=zf(n);try{let e=await If(),i=await Lf(),a=await Bf(n,e),o=Hf((await i.run({images:a})).output0,n.width,n.height),s=o.filter(e=>e.label===`smoke`),c=o.filter(e=>e.label===`fire`),l=o[0]?.confidence??0,u=s.length&&c.length?`烟雾与明火复合险情`:s.length?`烟雾/泄漏羽流`:c.length?`明火险情`:`未检出火焰或烟雾`,d=Math.round(performance.now()-t);return{type:u,confidence:l,smokeRatio:r.smokeRatio,flameRatio:r.flameRatio,edgeDensity:r.edgeDensity,persons:0,modelMode:`onnx`,modelName:`YOLO-26n Fire & Smoke`,modelVersion:`ONNX FP32 · 640×640`,inferenceMs:d,detections:o,summary:o.length?`本地 ONNX 模型检出 ${s.length} 个烟雾目标、${c.length} 个明火目标，最高置信度 ${(l*100).toFixed(1)}%。图片仅在浏览器本机推理。`:`本地 ONNX 模型未检出火焰或烟雾目标；像素辅助烟羽占比 ${(r.smokeRatio*100).toFixed(1)}%，建议结合现场传感器复核。`,explanation:[`输入图片缩放并填充为 640×640 RGB 张量`,`ONNX Runtime Web 使用 WASM 在浏览器本地执行`,`输出经 0.25 置信度阈值与 0.45 IoU 去重`]}}catch(e){return Uf(r,t,e)}finally{n.close()}}async function Gf(e){let t=await fetch(e);if(!t.ok)throw Error(`验证图片加载失败：${t.status}`);let n=await t.blob();return Wf(new File([n],e.split(`/`).pop()||`benchmark.jpg`,{type:n.type||`image/jpeg`}))}function Kf(e,t,n=8e4,r=2.5){let i=.08*e/Math.sqrt(1+1e-4*e),a=.06*e/Math.sqrt(1+.0015*e);return n/(2*Math.PI*t*i*a)*Math.exp(-(r*r)/(2*a*a))}function qf(e,t,n){let r=Math.max(20,n*t*60),i=20;for(let t=20;t<=Math.min(r,3200);t+=10)Kf(t,n)>=e&&(i=t);let a=.08*i/Math.sqrt(1+1e-4*i);return{distance:i,width:a*4.3}}function Jf(e,t=3.4){let n=qf(145,e,t),r=qf(29,e,t),i=qf(2.9,e,t),a=Math.PI*(i.distance/2)*(i.width/2),o=Math.round(a*.0078);return{lethal:n.distance,high:r.distance,warning:i.distance,lethalWidth:n.width,highWidth:r.width,warningWidth:i.width,affectedPeople:o,model:`Gaussian Plume · Pasquill-D`}}var Yf=[{id:`S`,x:-35,z:-30},{id:`A`,x:-22,z:-17},{id:`B`,x:-13,z:-10},{id:`I`,x:-3,z:-3},{id:`C`,x:-42,z:-4},{id:`D`,x:-25,z:7},{id:`E`,x:-11,z:5},{id:`F`,x:-31,z:20}],Xf=[`S-A`,`A-B`,`B-I`,`S-C`,`C-D`,`D-E`,`E-I`,`C-F`,`F-E`],Zf=(e,t)=>Math.hypot(e.x-t.x,e.z-t.z);function Qf(e=!1){let t=e?new Set([`B-I`,`I-B`]):new Set,n=new Set([`S`]),r=new Map,i=new Map(Yf.map(e=>[e.id,1/0])),a=new Map(Yf.map(e=>[e.id,1/0]));i.set(`S`,0),a.set(`S`,Zf(Yf[0],Yf[3]));let o=0;for(;n.size;){let e=[...n].sort((e,t)=>(a.get(e)??1/0)-(a.get(t)??1/0))[0];if(o++,e===`I`){let t=[e];for(;r.has(e);)e=r.get(e),t.unshift(e);let n=t.map(e=>Yf.find(t=>t.id===e)),a=Math.round((i.get(`I`)??0)*78);return{path:n,distance:a,eta:Math.ceil(a/520),visited:o,algorithm:`A* · Euclidean heuristic`}}n.delete(e);for(let o of Xf){let[s,c]=o.split(`-`),l;if(s===e&&(l=c),c===e&&(l=s),!l||t.has(`${e}-${l}`))continue;let u=Yf.find(t=>t.id===e),d=Yf.find(e=>e.id===l),f=(i.get(e)??1/0)+Zf(u,d);f<(i.get(l)??1/0)&&(r.set(l,e),i.set(l,f),a.set(l,f+Zf(d,Yf[3])),n.add(l))}}return{path:[],distance:0,eta:0,visited:o,algorithm:`A* · no path`}}var $f=[{id:`fire-01`,title:`近景火焰`,image:`./ai-benchmark/fire-01-campfire-flames.jpg`,expected:`hazard`,source:`Wikimedia Commons · Public Domain`,initial:{predicted:`hazard`,label:`明火`,confidence:.6703,inferenceMs:82}},{id:`fire-02`,title:`户外明火`,image:`./ai-benchmark/fire-02-campfire.jpg`,expected:`hazard`,source:`Wikimedia Commons · Public Domain`,initial:{predicted:`hazard`,label:`明火`,confidence:.9171,inferenceMs:78}},{id:`smoke-01`,title:`建筑火灾烟雾`,image:`./ai-benchmark/fire-smoke-06-model-sample.webp`,expected:`hazard`,source:`模型仓库演示样本 · MIT`,initial:{predicted:`hazard`,label:`烟雾+明火`,confidence:.9099,inferenceMs:81}},{id:`normal-01`,title:`北京地图底图`,image:`./beijing-map-base.jpg`,expected:`normal`,source:`项目地图资产`,initial:{predicted:`normal`,label:`未检出`,confidence:0,inferenceMs:128}},{id:`normal-02`,title:`道路地图底图`,image:`./real-map-base.jpg`,expected:`normal`,source:`项目地图资产`,initial:{predicted:`normal`,label:`未检出`,confidence:0,inferenceMs:74}},{id:`normal-03`,title:`智慧城市预览`,image:`./og-future-city.png`,expected:`normal`,source:`项目视觉资产`,initial:{predicted:`normal`,label:`未检出`,confidence:0,inferenceMs:100}},{id:`false-positive-01`,title:`橙色城市灯光`,image:`./og.png`,expected:`normal`,source:`项目视觉资产 · 误判样本`,initial:{predicted:`hazard`,label:`烟雾`,confidence:.5557,inferenceMs:95}}];function ep(e){let t=0,n=0,r=0,i=0;for(let a of $f){let o=e[a.id]?.predicted??a.initial.predicted;a.expected===`hazard`&&o===`hazard`&&(t+=1),a.expected===`normal`&&o===`hazard`&&(n+=1),a.expected===`normal`&&o===`normal`&&(r+=1),a.expected===`hazard`&&o===`normal`&&(i+=1)}let a=t/Math.max(1,t+n),o=t/Math.max(1,t+i),s=2*a*o/Math.max(1e-4,a+o),c=(t+r)/Math.max(1,t+r+n+i);return{tp:t,fp:n,tn:r,fn:i,precision:a,recall:o,f1:s,accuracy:c}}function tp({vision:e,onClose:t}){let[n,i]=(0,r.useState)(Object.fromEntries($f.map(e=>[e.id,e.initial]))),[a,o]=(0,r.useState)(!1),[s,c]=(0,r.useState)(0),[l,u]=(0,r.useState)(`已载入最近一次离线实测结果`),d=(0,r.useMemo)(()=>ep(n),[n]),f=Math.round(Object.values(n).reduce((e,t)=>e+t.inferenceMs,0)/Math.max(1,Object.values(n).length));return(0,$.jsx)(`div`,{className:`evidence-layer`,role:`presentation`,onMouseDown:t,children:(0,$.jsxs)(`section`,{className:`evidence-dialog`,role:`dialog`,"aria-modal":`true`,"aria-label":`AI 可答辩证据中心`,onMouseDown:e=>e.stopPropagation(),children:[(0,$.jsxs)(`header`,{className:`evidence-head`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`AI EVIDENCE CENTER · LOCAL INFERENCE`}),(0,$.jsx)(`h2`,{children:`AI 可答辩证据中心`}),(0,$.jsx)(`p`,{children:`模型、数据、指标、误判和算法边界均可现场复核`})]}),(0,$.jsxs)(`div`,{className:`evidence-head-status`,children:[(0,$.jsx)(`b`,{className:e.modelMode===`explainable-fallback`?`warning`:``,children:e.modelMode===`onnx`?`ONNX 实时推理`:e.modelMode===`demo`?`模型待上传触发`:`已明确降级`}),(0,$.jsx)(`button`,{"aria-label":`关闭 AI 证据中心`,onClick:t,children:`×`})]})]}),(0,$.jsxs)(`div`,{className:`evidence-scroll`,children:[(0,$.jsxs)(`section`,{className:`model-proof`,children:[(0,$.jsxs)(`div`,{className:`model-identity`,children:[(0,$.jsx)(`div`,{className:`model-chip`,children:`ONNX`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`真实本地视觉模型`}),(0,$.jsx)(`h3`,{children:`YOLO-26n Fire & Smoke`}),(0,$.jsx)(`p`,{children:`FP32 · 输入 1×3×640×640 · 输出 300×6 · 模型文件 9.81 MB`})]}),(0,$.jsxs)(`dl`,{children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`运行位置`}),(0,$.jsx)(`dd`,{children:`浏览器本机 / WASM`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`网络依赖`}),(0,$.jsx)(`dd`,{children:`无 · 图片不上传`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`类别`}),(0,$.jsx)(`dd`,{children:`烟雾 / 明火`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`来源许可`}),(0,$.jsx)(`dd`,{children:`Hugging Face · MIT`})]})]})]}),(0,$.jsxs)(`div`,{className:`current-inference`,children:[(0,$.jsx)(`span`,{children:`当前上传图片`}),(0,$.jsx)(`strong`,{children:e.modelName}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:e.type}),(0,$.jsx)(`em`,{children:e.modelMode===`demo`?`等待上传`:`${(e.confidence*100).toFixed(1)}%`}),(0,$.jsxs)(`i`,{children:[e.inferenceMs||`—`,` ms`]})]}),(0,$.jsx)(`p`,{children:e.summary})]})]}),(0,$.jsxs)(`section`,{className:`metric-section`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`PROJECT SMOKE TEST`}),(0,$.jsx)(`h3`,{children:`项目内置 7 例小型验证集`})]}),(0,$.jsx)(`button`,{disabled:a,onClick:async()=>{o(!0),c(0),u(`正在初始化本地 ONNX 模型…`);try{await Rf();let e={};for(let t=0;t<$f.length;t+=1){let n=$f[t];u(`正在验证 ${t+1}/${$f.length}：${n.title}`);let r=await Gf(n.image),a=r.detections[0];e[n.id]={predicted:r.detections.length?`hazard`:`normal`,label:r.detections.map(e=>e.labelZh).filter((e,t,n)=>n.indexOf(e)===t).join(`+`)||`未检出`,confidence:a?.confidence??0,inferenceMs:r.inferenceMs},i({...e}),c((t+1)/$f.length*100)}u(`本地验证完成 · 指标由当前浏览器实时计算`)}catch(e){u(`验证中断：${e instanceof Error?e.message:`未知错误`}`)}finally{o(!1)}},children:a?`验证运行中…`:`重新运行本地验证`})]}),(0,$.jsxs)(`div`,{className:`benchmark-progress`,children:[(0,$.jsx)(`i`,{style:{width:`${s}%`}}),(0,$.jsx)(`span`,{children:l})]}),(0,$.jsxs)(`div`,{className:`metric-grid`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`Accuracy`}),(0,$.jsxs)(`b`,{children:[(d.accuracy*100).toFixed(1),`%`]}),(0,$.jsx)(`em`,{children:`准确率`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`Precision`}),(0,$.jsxs)(`b`,{children:[(d.precision*100).toFixed(1),`%`]}),(0,$.jsx)(`em`,{children:`精确率`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`Recall`}),(0,$.jsxs)(`b`,{children:[(d.recall*100).toFixed(1),`%`]}),(0,$.jsx)(`em`,{children:`召回率`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`F1 Score`}),(0,$.jsxs)(`b`,{children:[(d.f1*100).toFixed(1),`%`]}),(0,$.jsx)(`em`,{children:`平衡指标`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`Mean latency`}),(0,$.jsxs)(`b`,{children:[f,`ms`]}),(0,$.jsx)(`em`,{children:`当前设备均值`})]})]}),(0,$.jsxs)(`div`,{className:`confusion-matrix`,"aria-label":`混淆矩阵`,children:[(0,$.jsx)(`div`,{className:`matrix-axis`,children:`预测结果 →`}),(0,$.jsx)(`div`,{className:`matrix-label`,children:`实际险情`}),(0,$.jsxs)(`div`,{className:`matrix-cell good`,children:[(0,$.jsx)(`b`,{children:d.tp}),(0,$.jsx)(`span`,{children:`TP 正确告警`})]}),(0,$.jsxs)(`div`,{className:`matrix-cell bad`,children:[(0,$.jsx)(`b`,{children:d.fn}),(0,$.jsx)(`span`,{children:`FN 漏报`})]}),(0,$.jsx)(`div`,{className:`matrix-label`,children:`实际正常`}),(0,$.jsxs)(`div`,{className:`matrix-cell bad`,children:[(0,$.jsx)(`b`,{children:d.fp}),(0,$.jsx)(`span`,{children:`FP 误报`})]}),(0,$.jsxs)(`div`,{className:`matrix-cell good`,children:[(0,$.jsx)(`b`,{children:d.tn}),(0,$.jsx)(`span`,{children:`TN 正确排除`})]})]}),(0,$.jsx)(`p`,{className:`metric-disclaimer`,children:`该 7 例集合用于现场功能复核，不代表模型泛化能力。模型作者报告：Precision 73.6%、Recall 68.3%、AP50 74.3%；本系统不把作者指标冒充为自主测试结果。`})]}),(0,$.jsxs)(`section`,{className:`sample-section`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`TEST CASES & ERROR ANALYSIS`}),(0,$.jsx)(`h3`,{children:`样本结果与真实误判案例`})]}),(0,$.jsx)(`div`,{className:`sample-grid`,children:$f.map(e=>{let t=n[e.id]??e.initial,r=t.predicted===e.expected;return(0,$.jsxs)(`article`,{className:r?`pass`:`fail`,children:[(0,$.jsxs)(`div`,{className:`sample-image`,children:[(0,$.jsx)(`img`,{src:e.image,alt:e.title}),(0,$.jsx)(`i`,{children:r?`PASS`:`FALSE POSITIVE`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:e.title}),(0,$.jsxs)(`span`,{children:[`标注：`,e.expected===`hazard`?`险情`:`正常`,`　预测：`,t.label]}),(0,$.jsxs)(`em`,{children:[t.confidence?`${(t.confidence*100).toFixed(1)}%`:`无目标`,` · `,t.inferenceMs,`ms`]}),(0,$.jsx)(`small`,{children:e.source})]})]},e.id)})}),(0,$.jsxs)(`div`,{className:`error-analysis`,children:[(0,$.jsx)(`b`,{children:`误判解释`}),(0,$.jsx)(`p`,{children:`橙色城市灯光样本被模型识别为烟雾，说明颜色与局部纹理可能引发误报。因此系统将视觉模型定位为“告警触发器”，最终响应必须结合气体传感器、车辆遥测和人工复核。`})]})]}),(0,$.jsxs)(`section`,{className:`algorithm-boundary`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`TECHNOLOGY BOUNDARY`}),(0,$.jsx)(`h3`,{children:`明确区分模型、物理计算与搜索算法`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`article`,{className:`ai`,children:[(0,$.jsx)(`i`,{children:`AI`}),(0,$.jsx)(`b`,{children:`视觉目标检测`}),(0,$.jsx)(`strong`,{children:`YOLO-26n · ONNX`}),(0,$.jsx)(`p`,{children:`由训练模型识别烟雾与明火，展示置信度、目标框和推理耗时。`})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`i`,{children:`PHY`}),(0,$.jsx)(`b`,{children:`风险扩散计算`}),(0,$.jsx)(`strong`,{children:`Gaussian Plume · Pasquill-D`}),(0,$.jsx)(`p`,{children:`基于风速、源强和稳定度的物理模型，不宣称为人工智能。`})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`i`,{children:`ALG`}),(0,$.jsx)(`b`,{children:`道路路径规划`}),(0,$.jsx)(`strong`,{children:`OSM Graph · A*`}),(0,$.jsx)(`p`,{children:`使用欧氏启发函数搜索真实道路图，不宣称为机器学习。`})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`i`,{children:`AGT`}),(0,$.jsx)(`b`,{children:`协同任务编排`}),(0,$.jsx)(`strong`,{children:`Auditable deterministic agents`}),(0,$.jsx)(`p`,{children:`多角色软件智能体按任务和约束协作，保留消息与决策日志，不宣称为自由推理大模型。`})]})]})]})]})]})})}var np=e=>{let t=2166136261;for(let n=0;n<e.length;n+=1)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return Math.abs(t>>>0).toString(16).padStart(8,`0`).toUpperCase()};function rp({scenarioPhase:e,scenarioTime:t,vision:n,plume:r,route:i,blocked:a,onClose:o}){let s=[{phase:1,time:`14:32:00`,from:`VehicleAgent`,to:`EventAgent`,task:`持续读取危化运输车遥测`,message:`京A·WH2576 正沿北京 OSM 道路行驶，车速 32km/h，罐压 0.42MPa。`,basis:`车辆 CAN 遥测 + GPS 路段匹配`},{phase:2,time:`14:32:07`,from:`EventAgent`,to:`VisionAgent`,task:`验证异常并请求视觉检测`,message:`动力失效、尾阀冲击与挥发气体告警同时出现，提交现场帧进行本地推理。`,basis:`三源异常规则：动力 / 阀门 / 气体传感器`},{phase:3,time:`14:32:13`,from:`VisionAgent`,to:`PlumeAgent`,task:`输出可解释视觉证据`,message:`${n.modelName} 判定“${n.type}”，最高置信度 ${(n.confidence*100).toFixed(1)}%，目标数 ${n.detections.length}。`,basis:`${n.modelVersion} · 本机 ${n.inferenceMs||`—`}ms · ${n.modelMode}`},{phase:3,time:`14:32:15`,from:`PlumeAgent`,to:`CommandAgent`,task:`计算污染羽流边界`,message:`东南风 3.4m/s，警戒纵深 ${r.warning}m，预计风险暴露 ${r.affectedPeople} 人。`,basis:`${r.model} · Q=80g/s · 风向西北`},{phase:4,time:`14:32:20`,from:`RouteAgent`,to:`FireAgent`,task:a?`避开封闭道路重新规划`:`生成消防最短响应路径`,message:`${a?`封路后重规划`:`初始规划`}完成，距离 ${i.distance}m，ETA ${i.eta}min，搜索 ${i.visited} 个节点。`,basis:`OSM 道路图 + A* 欧氏启发函数${i.roads?.length?` · ${i.roads.slice(0,3).join(` → `)}`:``}`},{phase:4,time:`14:32:22`,from:`CommandAgent`,to:`Fire / Medical / Police`,task:`签发联合处置任务`,message:`消防执行堵漏与水幕，医疗开启绿色通道，交警建立 500m 封控并组织侧上风向疏散。`,basis:`优先级：人员安全 > 泄漏源控制 > 道路恢复`},{phase:6,time:`14:32:40`,from:`PoliceAgent`,to:`CommandAgent`,task:`执行道路封控与人群疏散`,message:`3 个路口完成管制，186 人向东南侧上风向疏散，应急绿波带已启用。`,basis:`风险区几何边界 + 路口容量 + 学校保护目标`},{phase:7,time:`14:32:49`,from:`FireAgent`,to:`CommandAgent`,task:`建立水幕并控制泄漏源`,message:`泡沫消防车到场，挥发气体受控，泄漏速率下降 68%。`,basis:`消防编组状态 + 现场处置阶段回执`},{phase:8,time:`14:32:59`,from:`MedicalAgent`,to:`CommandAgent`,task:`完成检伤与转运`,message:`2 名轻度吸入人员完成检伤，三级医院绿色通道保持开启。`,basis:`START 检伤规则 + 医疗资源容量`},{phase:9,time:`14:33:07`,from:`CommandAgent`,to:`AuditLedger`,task:`关闭事件并固化证据`,message:`联合响应闭环完成，模型输出、物理计算、路径结果和部门回执写入审计日志。`,basis:`全部强制任务完成 + 现场指挥员复核`}].map((t,n)=>({...t,id:`AUD-${String(n+1).padStart(2,`0`)}-${np(`${t.time}${t.from}${t.task}`)}`,state:e>t.phase?`done`:e===t.phase?`active`:`pending`}));return(0,$.jsx)(`div`,{className:`audit-layer`,role:`presentation`,onMouseDown:o,children:(0,$.jsxs)(`section`,{className:`audit-dialog`,role:`dialog`,"aria-modal":`true`,"aria-label":`多智能体协同审计`,onMouseDown:e=>e.stopPropagation(),children:[(0,$.jsxs)(`header`,{className:`audit-head`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`MULTI-AGENT AUDIT LEDGER`}),(0,$.jsx)(`h2`,{children:`多智能体任务与决策审计`}),(0,$.jsx)(`p`,{children:`每条任务都有输入、接收方、决策依据、执行状态和不可混淆的审计编号`})]}),(0,$.jsx)(`button`,{"aria-label":`关闭多智能体审计`,onClick:o,children:`×`})]}),(0,$.jsxs)(`div`,{className:`audit-banner`,children:[(0,$.jsx)(`b`,{children:`能力边界声明`}),(0,$.jsx)(`p`,{children:`这是确定性、可审计的软件智能体任务图，不宣称为大语言模型自由推理。任何正式处置仍由现场指挥员批准。`}),(0,$.jsxs)(`em`,{children:[`PHASE `,String(e).padStart(2,`0`),`/09 · T+`,Math.floor(t),`s`]})]}),(0,$.jsxs)(`section`,{className:`task-inputs`,children:[(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`span`,{children:`事件输入`}),(0,$.jsx)(`b`,{children:`危化车辆动力失效 + 尾阀泄漏`}),(0,$.jsx)(`small`,{children:`来源：车辆遥测 / 路侧摄像 / 气体传感器`})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`span`,{children:`视觉证据`}),(0,$.jsx)(`b`,{children:n.modelName}),(0,$.jsxs)(`small`,{children:[n.type,` · `,(n.confidence*100).toFixed(1),`% · `,n.modelMode]})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`span`,{children:`环境约束`}),(0,$.jsx)(`b`,{children:`东南风 3.4m/s · Pasquill-D`}),(0,$.jsxs)(`small`,{children:[`警戒纵深 `,r.warning,`m · 暴露 `,r.affectedPeople,` 人`]})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`span`,{children:`道路约束`}),(0,$.jsx)(`b`,{children:a?`存在封闭道路 · 已重规划`:`路网正常 · 最短响应`}),(0,$.jsxs)(`small`,{children:[`OSM A* · `,i.distance,`m · ETA `,i.eta,`min`]})]})]}),(0,$.jsxs)(`div`,{className:`audit-content`,children:[(0,$.jsxs)(`section`,{className:`agent-map`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`AGENT GRAPH`}),(0,$.jsx)(`h3`,{children:`协作角色与消息方向`})]}),(0,$.jsxs)(`div`,{className:`agent-graph-row`,children:[(0,$.jsx)(`i`,{children:`车辆`}),(0,$.jsx)(`b`,{children:`→`}),(0,$.jsx)(`i`,{children:`事件`}),(0,$.jsx)(`b`,{children:`→`}),(0,$.jsx)(`i`,{className:`ai`,children:`视觉 AI`}),(0,$.jsx)(`b`,{children:`→`}),(0,$.jsx)(`i`,{children:`扩散`})]}),(0,$.jsxs)(`div`,{className:`agent-graph-row second`,children:[(0,$.jsx)(`i`,{children:`指挥`}),(0,$.jsx)(`b`,{children:`→`}),(0,$.jsx)(`i`,{children:`消防`}),(0,$.jsx)(`b`,{children:`·`}),(0,$.jsx)(`i`,{children:`医疗`}),(0,$.jsx)(`b`,{children:`·`}),(0,$.jsx)(`i`,{children:`交警`}),(0,$.jsx)(`b`,{children:`→`}),(0,$.jsx)(`i`,{children:`审计`})]}),(0,$.jsxs)(`dl`,{children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`消息总数`}),(0,$.jsx)(`dd`,{children:s.length})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`已完成`}),(0,$.jsx)(`dd`,{children:s.filter(e=>e.state===`done`).length})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`执行中`}),(0,$.jsx)(`dd`,{children:s.filter(e=>e.state===`active`).length})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`dt`,{children:`待执行`}),(0,$.jsx)(`dd`,{children:s.filter(e=>e.state===`pending`).length})]})]}),(0,$.jsx)(`button`,{onClick:()=>{let o={incidentId:`LJ-BJ-20260720-001`,generatedAt:new Date().toISOString(),orchestrator:`Deterministic multi-agent task graph v1.0`,scenario:{phase:e,elapsedSeconds:Number(t.toFixed(2)),blocked:a},inputs:{vision:{model:n.modelName,mode:n.modelMode,result:n.type,confidence:n.confidence,detections:n.detections},plume:r,route:i},messages:s,disclaimer:`该编排为可审计确定性软件智能体，不宣称为大语言模型自主决策。`},c=document.createElement(`a`);c.href=URL.createObjectURL(new Blob([JSON.stringify(o,null,2)],{type:`application/json`})),c.download=`灵境哨兵-多智能体审计日志.json`,c.click(),window.setTimeout(()=>URL.revokeObjectURL(c.href),1e3)},children:`↓ 导出 JSON 审计日志`})]}),(0,$.jsxs)(`section`,{className:`audit-stream`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`span`,{children:`MESSAGE TRACE`}),(0,$.jsx)(`h3`,{children:`任务消息与决策依据`})]}),(0,$.jsx)(`div`,{children:s.map(e=>(0,$.jsxs)(`article`,{className:e.state,children:[(0,$.jsx)(`time`,{children:e.time}),(0,$.jsx)(`i`,{}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`b`,{children:e.from}),(0,$.jsx)(`span`,{children:`→`}),(0,$.jsx)(`strong`,{children:e.to}),(0,$.jsx)(`em`,{children:e.state===`done`?`已完成`:e.state===`active`?`执行中`:`待执行`})]}),(0,$.jsx)(`h4`,{children:e.task}),(0,$.jsx)(`p`,{children:e.message}),(0,$.jsxs)(`small`,{children:[`决策依据：`,e.basis]}),(0,$.jsx)(`code`,{children:e.id})]})]},e.id))})]})]})]})})}var ip=[{icon:`焰`,name:`消防智能体`,text:`2 辆泡沫消防车已从青岚站出发`,tone:`orange`},{icon:`十`,name:`医疗智能体`,text:`三级医院开放绿色救援通道`,tone:`cyan`},{icon:`路`,name:`交通智能体`,text:`已建立 3.2 km 应急绿波带`,tone:`blue`},{icon:`盾`,name:`指挥智能体`,text:`建议启动学校二级疏散预案`,tone:`purple`}],ap=[{id:`overview`,label:`态势总览`},{id:`events`,label:`事件中心`},{id:`resources`,label:`资源调度`},{id:`archives`,label:`推演档案`}],op=[{id:0,start:0,end:0,clock:`14:32:00`,icon:`待`,title:`全流程演示就绪`,subtitle:`化学废料车辆事故联合处置`,detail:`一键播放车辆行驶、突发故障、AI 告警、消防出警、医疗救援与警力疏散完整链路。`,metric:`72 秒 · 9 阶段`},{id:1,start:0,end:7,clock:`14:32:00`,icon:`运`,title:`正常运输`,subtitle:`化学废料运输车沿北京真实道路行驶`,detail:`京A·WH2576 · 车速 32 km/h · 罐体压力与尾阀状态正常`,metric:`OSM 实时轨迹`},{id:2,start:7,end:13,clock:`14:32:07`,icon:`故`,title:`突发故障`,subtitle:`车辆动力系统失效并紧急制动`,detail:`罐体尾阀受冲击松动 · 双闪开启 · 检测到黄绿色挥发气体`,metric:`自动停车 · 遥测异常`},{id:3,start:13,end:20,clock:`14:32:13`,icon:`AI`,title:`AI 告警`,subtitle:`识别为含氯化学废料泄漏`,detail:`事故图片识别置信度 96.8% · 高斯烟羽模型开始风险扩散计算`,metric:`Ⅰ级联合响应`},{id:4,start:20,end:27,clock:`14:32:20`,icon:`调`,title:`联合调度`,subtitle:`消防、医疗和交警同步接收指令`,detail:`基于 OSM 真实路网生成三条应急路线 · 自动建立救援优先通行权`,metric:`A* 路径已生成`},{id:5,start:27,end:40,clock:`14:32:27`,icon:`驰`,title:`力量赶赴`,subtitle:`三支队伍沿真实道路接近现场`,detail:`警车先期抵达 · 消防车携带泡沫与洗消设备 · 医疗组开放绿色通道`,metric:`动态 ETA 更新`},{id:6,start:40,end:49,clock:`14:32:40`,icon:`警`,title:`交通疏散`,subtitle:`警车到场并建立 500 米封控区`,detail:`3 个路口完成管制 · 社会车流主动避让 · 186 人向侧上风向疏散`,metric:`应急通道畅通`},{id:7,start:49,end:59,clock:`14:32:49`,icon:`消`,title:`消防处置`,subtitle:`泡沫消防车到场建立水幕并堵漏`,detail:`消防员从上风向压制挥发气体 · 泄漏速率下降 68% · 核心区浓度回落`,metric:`风险持续下降`},{id:8,start:59,end:67,clock:`14:32:59`,icon:`医`,title:`医疗救援`,subtitle:`救护车抵达并完成现场检伤分类`,detail:`2 名轻度吸入人员接受吸氧 · 三级医院绿色通道保持开启`,metric:`检伤与转运完成`},{id:9,start:67,end:72,clock:`14:33:07`,icon:`联`,title:`响应完成`,subtitle:`风险受控，联合处置闭环形成`,detail:`重点区域疏散 186 人 · 2 人完成转运 · 事故处置报告可立即生成`,metric:`全链路可追溯`}],sp=72,cp=async e=>{let t=new TextEncoder().encode(e),n=await crypto.subtle.digest(`SHA-256`,t);return Array.from(new Uint8Array(n)).map(e=>e.toString(16).padStart(2,`0`)).join(``)};function lp({onAuthenticated:e}){let[t,n]=(0,r.useState)(`login`),[i,a]=(0,r.useState)(!1),[o,s]=(0,r.useState)(!0),[c,l]=(0,r.useState)(!1),[u,d]=(0,r.useState)(``),[f,p]=(0,r.useState)({username:``,password:``}),[m,h]=(0,r.useState)({displayName:``,department:`北京市智慧城市运行中心`,username:``,password:``,confirm:``,agreement:!0}),g=e=>{n(e),d(``),a(!1)},_=()=>{try{return JSON.parse(localStorage.getItem(`lingjing-users`)||`[]`)}catch{return[]}};return(0,$.jsxs)(`main`,{className:`auth-shell`,children:[(0,$.jsx)(`div`,{className:`auth-grid`}),(0,$.jsx)(`div`,{className:`auth-glow auth-glow-a`}),(0,$.jsx)(`div`,{className:`auth-glow auth-glow-b`}),(0,$.jsxs)(`header`,{className:`auth-topbar`,children:[(0,$.jsxs)(`div`,{className:`auth-brand-mark`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:`京域智城`}),(0,$.jsx)(`span`,{children:`BEIJING SMART CITY DIGITAL TWIN`})]}),(0,$.jsxs)(`em`,{children:[(0,$.jsx)(`i`,{}),`北京市城市运行管理中心`]})]}),(0,$.jsxs)(`section`,{className:`auth-layout`,children:[(0,$.jsxs)(`div`,{className:`auth-hero`,children:[(0,$.jsxs)(`div`,{className:`auth-kicker`,children:[(0,$.jsx)(`i`,{}),`北京城市数字孪生统一入口`]}),(0,$.jsxs)(`h1`,{children:[`一屏感知北京`,(0,$.jsx)(`br`,{}),(0,$.jsx)(`span`,{children:`让城市实时可见`})]}),(0,$.jsx)(`p`,{children:`汇聚城市治理、交通运行、能源环保与公共安全数据，构建可旋转、可交互、可推演的北京智慧城市三维运行中心。`}),(0,$.jsxs)(`div`,{className:`auth-metrics`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:6016})}),(0,$.jsx)(`span`,{children:`三维建筑模型`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:86.4,decimals:1,suffix:`万`})}),(0,$.jsx)(`span`,{children:`城市感知节点`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:99.97,decimals:2,suffix:`%`})}),(0,$.jsx)(`span`,{children:`设备在线率`})]})]}),(0,$.jsxs)(`div`,{className:`auth-radar`,"aria-hidden":`true`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`b`,{children:`AI`}),(0,$.jsxs)(`em`,{children:[`REAL-TIME`,(0,$.jsx)(`br`,{}),`SITUATION`]})]})]}),(0,$.jsxs)(`section`,{className:`auth-card`,"aria-label":t===`login`?`登录`:`注册`,children:[(0,$.jsx)(`div`,{className:`auth-card-line`}),(0,$.jsxs)(`div`,{className:`auth-tabs`,children:[(0,$.jsx)(`button`,{className:t===`login`?`active`:``,onClick:()=>g(`login`),children:`账号登录`}),(0,$.jsx)(`button`,{className:t===`register`?`active`:``,onClick:()=>g(`register`),children:`用户注册`})]}),(0,$.jsxs)(`div`,{className:`auth-heading`,children:[(0,$.jsx)(`span`,{children:t===`login`?`CITY OPERATION ACCESS`:`CREATE CITY ACCOUNT`}),(0,$.jsx)(`h2`,{children:t===`login`?`进入智慧城市运行中心`:`注册城市运行账号`}),(0,$.jsx)(`p`,{children:t===`login`?`登录后首先进入北京智慧城市 3D 大屏`:`注册信息仅保存在当前设备，用于比赛演示`})]}),t===`login`?(0,$.jsxs)(`form`,{onSubmit:async t=>{if(t.preventDefault(),d(``),!f.username.trim()||!f.password){d(`请输入账号和密码`);return}l(!0);try{let t=f.username.trim().toLowerCase();if(t===`admin`&&f.password===`123456`){e({username:`admin`,displayName:`城市运行管理员`},o);return}let n=await cp(f.password),r=_().find(e=>e.username.toLowerCase()===t&&e.passwordHash===n);if(!r){d(`账号或密码不正确，可使用演示账号登录`);return}e({username:r.username,displayName:r.displayName},o)}finally{l(!1)}},children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`城市运行账号`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`城`}),(0,$.jsx)(`input`,{autoFocus:!0,autoComplete:`username`,value:f.username,onChange:e=>p({...f,username:e.target.value}),placeholder:`请输入城市运行账号`})]})]}),(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`登录密码`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`密`}),(0,$.jsx)(`input`,{type:i?`text`:`password`,autoComplete:`current-password`,value:f.password,onChange:e=>p({...f,password:e.target.value}),placeholder:`请输入密码`}),(0,$.jsx)(`button`,{type:`button`,onClick:()=>a(e=>!e),children:i?`隐藏`:`显示`})]})]}),(0,$.jsxs)(`div`,{className:`auth-options`,children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:o,onChange:e=>s(e.target.checked)}),(0,$.jsx)(`i`,{}),`保持登录`]}),(0,$.jsx)(`button`,{type:`button`,onClick:()=>d(`演示账号：admin　密码：123456`),children:`忘记密码？`})]}),u&&(0,$.jsx)(`div`,{className:`auth-message ${u.includes(`成功`)?`success`:``}`,children:u}),(0,$.jsxs)(`button`,{className:`auth-submit`,disabled:c,children:[c?`身份校验中…`:`进入智慧城市大屏`,(0,$.jsx)(`span`,{children:`→`})]}),(0,$.jsxs)(`button`,{className:`auth-demo`,type:`button`,onClick:()=>{p({username:`admin`,password:`123456`}),d(`已填入演示账号，点击上方按钮进入系统`)},children:[`一键填入演示账号 `,(0,$.jsx)(`b`,{children:`admin / 123456`})]})]}):(0,$.jsxs)(`form`,{onSubmit:async e=>{e.preventDefault(),d(``);let t=m.displayName.trim(),n=m.username.trim();if(!t||!n||!m.password||!m.confirm){d(`请完整填写注册信息`);return}if(!/^[a-zA-Z0-9_-]{3,20}$/.test(n)){d(`账号需为 3–20 位字母、数字、下划线或短横线`);return}if(m.password.length<6){d(`密码至少需要 6 位`);return}if(m.password!==m.confirm){d(`两次输入的密码不一致`);return}if(!m.agreement){d(`请先同意演示环境使用说明`);return}let r=_();if(n.toLowerCase()===`admin`||r.some(e=>e.username.toLowerCase()===n.toLowerCase())){d(`该账号已存在，请更换账号`);return}l(!0);try{r.push({username:n,displayName:t,department:m.department,passwordHash:await cp(m.password)}),localStorage.setItem(`lingjing-users`,JSON.stringify(r)),p({username:n,password:``}),g(`login`),d(`注册成功，请使用新账号登录`)}finally{l(!1)}},children:[(0,$.jsxs)(`div`,{className:`auth-form-grid`,children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`姓名`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`名`}),(0,$.jsx)(`input`,{autoFocus:!0,value:m.displayName,onChange:e=>h({...m,displayName:e.target.value}),placeholder:`请输入真实姓名`})]})]}),(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`所属单位`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`部`}),(0,$.jsxs)(`select`,{value:m.department,onChange:e=>h({...m,department:e.target.value}),children:[(0,$.jsx)(`option`,{children:`北京市智慧城市运行中心`}),(0,$.jsx)(`option`,{children:`城市管理部门`}),(0,$.jsx)(`option`,{children:`交通运行部门`}),(0,$.jsx)(`option`,{children:`生态环境部门`}),(0,$.jsx)(`option`,{children:`公共安全与应急部门`})]})]})]})]}),(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`登录账号`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`指`}),(0,$.jsx)(`input`,{autoComplete:`username`,value:m.username,onChange:e=>h({...m,username:e.target.value}),placeholder:`3–20 位字母或数字`})]})]}),(0,$.jsxs)(`div`,{className:`auth-form-grid`,children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`设置密码`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`密`}),(0,$.jsx)(`input`,{type:i?`text`:`password`,autoComplete:`new-password`,value:m.password,onChange:e=>h({...m,password:e.target.value}),placeholder:`至少 6 位`})]})]}),(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`span`,{children:`确认密码`}),(0,$.jsxs)(`div`,{className:`auth-input`,children:[(0,$.jsx)(`i`,{children:`验`}),(0,$.jsx)(`input`,{type:i?`text`:`password`,autoComplete:`new-password`,value:m.confirm,onChange:e=>h({...m,confirm:e.target.value}),placeholder:`再次输入`})]})]})]}),(0,$.jsxs)(`div`,{className:`auth-options register`,children:[(0,$.jsxs)(`label`,{children:[(0,$.jsx)(`input`,{type:`checkbox`,checked:m.agreement,onChange:e=>h({...m,agreement:e.target.checked})}),(0,$.jsx)(`i`,{}),`同意本地演示环境使用说明`]}),(0,$.jsx)(`button`,{type:`button`,onClick:()=>a(e=>!e),children:i?`隐藏密码`:`显示密码`})]}),u&&(0,$.jsx)(`div`,{className:`auth-message ${u.includes(`成功`)?`success`:``}`,children:u}),(0,$.jsxs)(`button`,{className:`auth-submit`,disabled:c,children:[c?`正在创建账号…`:`完成注册`,(0,$.jsx)(`span`,{children:`→`})]})]}),(0,$.jsxs)(`footer`,{className:`auth-card-footer`,children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(`i`,{}),`SHA-256 LOCAL HASH`]}),(0,$.jsx)(`em`,{children:`演示环境 · 数据仅存本机`})]})]})]}),(0,$.jsxs)(`footer`,{className:`auth-footer`,children:[(0,$.jsx)(`span`,{children:`© 2026 京域智城 · 北京智慧城市创新实验室`}),(0,$.jsxs)(`span`,{children:[`城市数据链路 `,(0,$.jsx)(`i`,{}),` 正常　|　比赛演示版 v4.1.0`]})]})]})}function up(){let[e,t]=(0,r.useState)(!1),[n,i]=(0,r.useState)(null),[a,o]=(0,r.useState)(`city`),[s,c]=(0,r.useState)(!1),[l,u]=(0,r.useState)(`overview`),[d,f]=(0,r.useState)(!1),[p,m]=(0,r.useState)(``),[h,g]=(0,r.useState)(`loading`),[_,v]=(0,r.useState)(!1),[y,b]=(0,r.useState)(!1),[x,S]=(0,r.useState)(null),[C,w]=(0,r.useState)(null),[T,E]=(0,r.useState)(15),[D,O]=(0,r.useState)(!1),[k,A]=(0,r.useState)(0),[ee,te]=(0,r.useState)(!0),[j,M]=(0,r.useState)(!1),[N,P]=(0,r.useState)(!1),[ne,re]=(0,r.useState)(!0),[ie,ae]=(0,r.useState)(!1),[oe,se]=(0,r.useState)(null),[F,I]=(0,r.useState)(null),[ce,le]=(0,r.useState)(null),[ue,de]=(0,r.useState)(!1),[fe,pe]=(0,r.useState)(!1),[me,he]=(0,r.useState)(`2026-07-20 14:32:26`),[ge,_e]=(0,r.useState)(null),[ve,ye]=(0,r.useState)(!1),[L,be]=(0,r.useState)({type:`演示预置：氯气泄漏`,confidence:.968,smokeRatio:.214,flameRatio:.008,edgeDensity:.182,persons:23,summary:`固定演示事件包用于保证 72 秒流程稳定；上传图片后将切换为真实本地 ONNX 推理。`,modelMode:`demo`,modelName:`演示预置事件包`,modelVersion:`SCENARIO FIXTURE v1.0`,inferenceMs:0,detections:[],explanation:[`预置结果仅用于固定比赛演示`,`上传任意图片可触发真实本地 ONNX 模型`]}),[xe,Se]=(0,r.useState)(!1),[Ce,we]=(0,r.useState)(!1),[R,Te]=(0,r.useState)(`idle`),[Ee,De]=(0,r.useState)(0),[Oe,ke]=(0,r.useState)(1),[z,Ae]=(0,r.useState)(!0),[je,Me]=(0,r.useState)(36),[B,Ne]=(0,r.useState)(``),V=R===`idle`?0:op.find(e=>e.id>0&&Ee>=e.start&&Ee<e.end)?.id??9,H=op[V],Pe=R===`idle`?0:Math.min(100,Ee/sp*100),Fe=V<=2&&V>0?`chemical-truck`:V===5?Ee<31?`police-car`:Ee<36?`firetruck`:`ambulance`:V===6?`police-car`:V===7?`firetruck`:V===8?`ambulance`:null,Ie=(0,r.useMemo)(()=>Jf(T,3.4),[T]),Le=(0,r.useMemo)(()=>Qf(y),[y]),Re=(0,r.useMemo)(()=>{let e=C?.distance??Le.distance,t=C?.eta??Le.eta,n=C?.roads.join(` → `)||`OSM 真实道路网络加载中`;return`灵境哨兵｜危化品泄漏应急处置报告\n报告编号：LJ-BJ-20260720-001\n生成时间：${me}\n响应等级：Ⅰ级应急响应\n\n一、事件概况\n事件地点：北京市朝阳区建国门外大街国贸桥西侧（演示坐标 39°54′27″N，116°27′07″E）\n事件类型：${L.type}\n视觉研判方式：${L.modelName}（${L.modelMode===`onnx`?`本地 ONNX 推理`:L.modelMode===`demo`?`演示预置事件包`:`端侧可解释特征研判`}）\n视觉置信度：${(L.confidence*100).toFixed(1)}%\n现场人员估计：约 ${L.persons} 人\n研判摘要：${L.summary}\n\n二、物理风险扩散计算\n气象条件：东南风 3.4 m/s，污染羽流吹向西北，Pasquill-D 稳定度\n致命区纵深：${Ie.lethal} m\n高风险区纵深：${Ie.high} m\n警戒区纵深：${Ie.warning} m\n预计风险暴露人口：${Ie.affectedPeople} 人\n物理模型：${Ie.model}\n\n三、消防救援路径规划\n算法：OSM 真实路网 A*（欧氏距离启发，不属于 AI 识别）\n道路序列：${n}\n路线距离：${e} m\n预计到达：${t} min\n搜索道路节点：${C?.visited??Le.visited} 个\n封路状态：${y?`已封锁 OSM 道路 ${C?.blockedRoadId??x??`自动选择路段`}，完成动态重规划`:`当前道路正常通行`}\n\n四、联合处置指令\n1. 交通智能体：立即封锁泄漏点周边 500 m 道路，建立 3.2 km 应急绿波带。\n2. 教育智能体：城北实验学校师生经东南侧上风向安全通道分批疏散，8 分钟内完成重点人员转移。\n3. 消防智能体：2 辆泡沫消防车沿 OSM 规划路线抵达，在上风向布置水幕并实施堵漏。\n4. 医疗智能体：市第三人民医院开放绿色通道，在体育中心设置临时分诊点。\n5. 环境监测组：在下风向 200 m、500 m、1000 m 设置连续监测点，每 2 分钟回传浓度。\n\n五、处置结论\n建议立即启动危化品泄漏Ⅰ级联合响应，优先完成学校疏散、道路管制和泄漏源控制。本结论由视觉模型、物理扩散计算、A* 路径规划与规则化协同流程联合生成，仅用于竞赛演示；正式行动应由现场指挥员复核确认。\n\n生成系统：灵境哨兵城市应急联合决策平台`},[y,x,Ie,C,me,Le,L]);(0,r.useEffect)(()=>{try{let e=localStorage.getItem(`lingjing-session`)||sessionStorage.getItem(`lingjing-session`);e&&i(JSON.parse(e))}catch{localStorage.removeItem(`lingjing-session`),sessionStorage.removeItem(`lingjing-session`)}t(!0)},[]),(0,r.useEffect)(()=>{if(!p)return;let e=window.setTimeout(()=>m(``),2800);return()=>window.clearTimeout(e)},[p]),(0,r.useEffect)(()=>{if(!B)return;let e=window.setTimeout(()=>Ne(``),2800);return()=>window.clearTimeout(e)},[B]),(0,r.useEffect)(()=>{if(!D||R===`playing`||R===`paused`)return;let e=window.setInterval(()=>E(e=>e>=30?1:e+1),520);return()=>window.clearInterval(e)},[D,R]),(0,r.useEffect)(()=>{if(R!==`playing`)return;let e=performance.now(),t=window.setInterval(()=>{let t=performance.now(),n=(t-e)/1e3*Oe;e=t,De(e=>Math.min(sp,e+n))},100);return()=>window.clearInterval(t)},[Oe,R]),(0,r.useEffect)(()=>{R===`playing`&&Ee>=sp&&Te(`complete`)},[R,Ee]),(0,r.useEffect)(()=>{V!==0&&(v(V>=4),M(V>=3),E(V<3?1:V===3?5:V<7?15:V===9?8:22))},[V]),(0,r.useEffect)(()=>{!z||V===0||(ae(!1),Fe?(se(Fe),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:Fe}}))):(se(null),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:null}})),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:V===9?`reset`:`incident`}))))},[z,Fe,V]),(0,r.useEffect)(()=>{let e=e=>{let t=e.target;if([`INPUT`,`TEXTAREA`,`SELECT`].includes(t.tagName))return;if(e.code===`Escape`){if(xe){Se(!1);return}if(Ce){we(!1);return}if(s){c(!1);return}if(ue){de(!1);return}if(d){f(!1);return}if(l!==`overview`){u(`overview`);return}if(F){I(null);return}Ae(!1),se(null),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:null}}));return}let n={Digit1:`overview`,Digit2:`events`,Digit3:`resources`,Digit4:`archives`};if(n[e.code]){e.preventDefault(),u(n[e.code]),f(!1);return}if(!(V===0||l!==`overview`||ue||xe||Ce)&&(e.code===`Space`&&(e.preventDefault(),Te(e=>e===`playing`?`paused`:e===`paused`?`playing`:e)),e.code===`ArrowRight`)){e.preventDefault();let t=op[Math.min(9,V+1)];De(t.start+.01),Te(t.id===9?`paused`:`playing`)}};return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[d,l,Ce,xe,s,ue,V,F]),(0,r.useEffect)(()=>{if(!d)return;let e=e=>{e.target.closest(`.status`)||f(!1)};return window.addEventListener(`pointerdown`,e,!0),()=>window.removeEventListener(`pointerdown`,e,!0)},[d]),(0,r.useEffect)(()=>{if(!_)return;let e=setInterval(()=>A(e=>(e+1)%4),900);return()=>clearInterval(e)},[_]);let ze=()=>{if(h===`loading`){m(`真实北京路网仍在加载，请稍候一秒再启动`);return}h===`degraded`&&m(`真实路网数据异常，已启用内置完整路线继续演示`),De(0),Te(`playing`),Ae(!0),v(!1),b(!1),S(null),E(1),O(!1),M(!1),ae(!1),se(null)},Be=()=>{c(!1),u(`overview`),window.setTimeout(ze,120)},Ve=()=>Te(e=>e===`playing`?`paused`:e===`paused`||e===`complete`?`playing`:e),He=()=>{let e=op[Math.min(9,V+1)];De(e.start+.01),Te(e.id===9?`paused`:`playing`)},Ue=()=>ke(e=>e===1?1.5:e===1.5?2:1),We=()=>Me(e=>e===18?36:e===36?54:18),Ge=e=>{S(typeof e==`number`?e:null),b(!0),v(!0)},Ke=()=>{se(null),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:null}}))},qe=()=>{Ke(),Ae(!1),ae(!1),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`incident`}))},Je=(e,t,n,r,i)=>{Ne(e),le({id:`side-${e}`,label:t,category:n,details:r,meta:i}),m(`已打开：${t}`)},Ye=e=>{if(h===`loading`){m(`真实地图仍在加载，资源位置暂不可追踪`);return}let t={"FIRE-01":`firetruck`,"FIRE-02":`firetruck`,"ROBOT-01":`firetruck`,"MED-03":`ambulance`,"MED-06":`ambulance`,"POLICE-07":`police-car`,"BIKE-02":`police-car`}[e];I(null),ae(!1),Ae(!1),(V<4||R===`complete`)&&(De(20.01),Te(`playing`),v(!0),M(!0)),t?(se(t),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:t}})),m(`已同步到所属编队的真实道路跟随视角`)):(se(null),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`incident`})),m(`该资源已同步到事故现场任务区域`))},Xe=e=>{let t=oe===e.id?null:e.id;ae(!1),se(t),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`follow`,assetId:t}}))},Ze=()=>{he(new Date().toLocaleString(`zh-CN`,{hour12:!1}).replaceAll(`/`,`-`)),de(!0),pe(!0),window.setTimeout(()=>pe(!1),700)},Qe=()=>{let e=URL.createObjectURL(new Blob([`﻿`,Re],{type:`text/plain;charset=utf-8`})),t=document.createElement(`a`);t.href=e,t.download=`灵境哨兵-危化品泄漏应急处置报告.txt`,t.click(),window.setTimeout(()=>URL.revokeObjectURL(e),1e3)},$e=async e=>{if(!e)return;if(!e.type.startsWith(`image/`)){m(`请选择 JPG、PNG 或 WebP 图片`);return}if(e.size>15*1024*1024){m(`图片超过 15MB，请压缩后重试`);return}ye(!0);let t=URL.createObjectURL(e);_e(e=>(e&&URL.revokeObjectURL(e),t));try{let t=await Wf(e);be(t),m(t.modelMode===`onnx`?`本地 ONNX 推理完成：${t.type} · ${(t.confidence*100).toFixed(1)}%`:`ONNX 不可用，已明确切换为可解释视觉降级模式`)}catch(e){m(`图片分析失败：${e instanceof Error?e.message:`未知错误`}`)}finally{ye(!1)}},et=(e,t)=>{localStorage.removeItem(`lingjing-session`),sessionStorage.removeItem(`lingjing-session`),(t?localStorage:sessionStorage).setItem(`lingjing-session`,JSON.stringify(e)),i(e)},U=async()=>{try{document.fullscreenElement?await document.exitFullscreen():await document.documentElement.requestFullscreen(),m(document.fullscreenElement?`已进入全屏演示`:`已退出全屏演示`)}catch{m(`当前浏览器未允许全屏，请使用 F11`)}},W=()=>{a===`emergency`&&(R===`playing`||R===`paused`)&&!window.confirm(`当前推演尚未结束，退出将中止本次演示。确定退出吗？`)||(localStorage.removeItem(`lingjing-session`),sessionStorage.removeItem(`lingjing-session`),f(!1),c(!1),u(`overview`),g(`loading`),o(`city`),i(null))};return e?n?a===`city`?(0,$.jsx)(Mf,{displayName:n.displayName,onLogout:W,onOpenDemo:()=>{c(!1),u(`overview`),g(`loading`),o(`emergency`)}}):(0,$.jsxs)(`main`,{className:`shell`,children:[(0,$.jsxs)(`header`,{className:`topbar`,children:[(0,$.jsxs)(`div`,{className:`brand-mark`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]}),(0,$.jsxs)(`div`,{className:`brand`,children:[(0,$.jsx)(`b`,{children:`京域智城`}),(0,$.jsx)(`span`,{children:`北京智慧城市 3D 大屏 · SMART CITY DIGITAL TWIN`})]}),(0,$.jsxs)(`nav`,{"aria-label":`主功能导航`,children:[ap.map(e=>(0,$.jsx)(`button`,{className:l===e.id&&!s?`active`:``,"aria-current":l===e.id&&!s?`page`:void 0,onClick:()=>{c(!1),u(e.id),f(!1)},children:e.label},e.id)),(0,$.jsx)(`button`,{className:`demo-nav`,onClick:()=>{c(!1),o(`city`),f(!1)},children:`返回智慧城市`})]}),(0,$.jsxs)(`div`,{className:`status`,children:[(0,$.jsx)(`span`,{className:`live-dot`}),`系统在线 `,(0,$.jsx)(`em`,{children:n.displayName}),(0,$.jsx)(`button`,{className:`avatar ${d?`open`:``}`,onClick:()=>f(e=>!e),title:`打开账号菜单`,"aria-label":`打开账号菜单`,"aria-expanded":d,"aria-haspopup":`menu`,"aria-controls":`account-menu`,children:n.displayName.slice(0,1)}),d&&(0,$.jsxs)(`div`,{className:`account-menu`,id:`account-menu`,role:`menu`,children:[(0,$.jsxs)(`header`,{children:[(0,$.jsx)(`i`,{children:n.displayName.slice(0,1)}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`strong`,{children:n.displayName}),(0,$.jsxs)(`span`,{children:[n.username,` · 应急指挥中心`]})]})]}),(0,$.jsxs)(`button`,{onClick:U,children:[(0,$.jsx)(`span`,{children:`⛶ 全屏演示`}),(0,$.jsx)(`b`,{children:typeof document<`u`&&document.fullscreenElement?`退出`:`进入`})]}),(0,$.jsxs)(`button`,{onClick:()=>{Ae(e=>!e),m(z?`导演视角已关闭`:`导演视角已开启`)},children:[(0,$.jsx)(`span`,{children:`◉ 导演视角`}),(0,$.jsx)(`b`,{children:z?`开启`:`关闭`})]}),(0,$.jsxs)(`button`,{onClick:()=>m(`快捷键：1–4 切换模块　空格暂停/继续　→ 下一阶段　Esc 返回`),children:[(0,$.jsx)(`span`,{children:`? 演示快捷键`}),(0,$.jsx)(`b`,{children:`查看`})]}),(0,$.jsxs)(`button`,{onClick:()=>m(h===`ready`?`系统自检通过：真实地图、路网、AI 模型和调度模块均已就绪`:h===`loading`?`系统自检进行中：真实路网仍在加载`:`系统自检警告：真实路网已启用内置降级路线`),children:[(0,$.jsx)(`span`,{children:`✓ 演示自检`}),(0,$.jsx)(`b`,{children:h===`ready`?`通过`:h===`loading`?`检测中`:`降级`})]}),(0,$.jsxs)(`button`,{onClick:()=>{P(e=>!e),m(N?`已切换为白天态势`:`已切换为夜间态势`)},children:[(0,$.jsx)(`span`,{children:`◐ 显示模式`}),(0,$.jsx)(`b`,{children:N?`夜间`:`白天`})]}),(0,$.jsxs)(`button`,{onClick:()=>{re(e=>!e),m(ne?`已关闭楼宇灯光`:`已开启楼宇灯光`)},children:[(0,$.jsx)(`span`,{children:`✦ 楼宇灯光`}),(0,$.jsx)(`b`,{children:ne?`开启`:`关闭`})]}),(0,$.jsxs)(`button`,{onClick:()=>{u(`resources`),f(!1)},children:[(0,$.jsx)(`span`,{children:`⌘ 快速调度`}),(0,$.jsx)(`b`,{children:`进入`})]}),(0,$.jsxs)(`button`,{className:`logout`,onClick:W,children:[(0,$.jsx)(`span`,{children:`↪ 退出登录`}),(0,$.jsx)(`b`,{children:`EXIT`})]})]})]})]}),(0,$.jsxs)(`section`,{className:`command-strip`,children:[(0,$.jsx)(`div`,{className:`alert-tag scenario-alert phase-${V}`,children:V===0?`演示项目 01 · READY`:`${String(V).padStart(2,`0`)}/09 · ${R===`playing`?`LIVE`:R===`paused`?`PAUSED`:`COMPLETE`}`}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`strong`,{children:[H.title,`｜`,H.subtitle]}),(0,$.jsxs)(`span`,{children:[H.clock,` · `,H.detail]})]}),(0,$.jsxs)(`div`,{className:`command-actions`,children:[(0,$.jsx)(`span`,{children:h===`loading`?`正在装载 6,016 栋建筑与 674 段道路`:V===0?`智慧城市大屏已就绪 · 点击进入演示项目`:`T+${Ee.toFixed(1)}s · ${H.metric}`}),(0,$.jsx)(`button`,{disabled:h===`loading`,onClick:V===0?()=>c(!0):ze,children:h===`loading`?`正在加载真实路网…`:V===0?`进入演示项目 →`:R===`complete`?`↻ 再演示一次`:`↻ 从头重播`})]})]}),(0,$.jsx)(gf,{active:l,onClose:()=>u(`overview`),onStartScenario:ze,onFocusIncident:qe,onGenerateReport:Ze,onNotice:m,onTrackResource:Ye,scenarioPhase:V,scenarioTime:Ee,scenarioStatus:R}),s&&(0,$.jsx)(yf,{ready:h!==`loading`,onClose:()=>c(!1),onStart:Be}),p&&(0,$.jsxs)(`div`,{className:`system-toast ${/失败|异常|未允许/.test(p)?`error`:/召回|关闭|降级|加载/.test(p)?`warning`:`success`}`,role:`status`,"aria-live":`polite`,children:[(0,$.jsx)(`i`,{children:/失败|异常|未允许/.test(p)?`!`:/召回|关闭|降级|加载/.test(p)?`i`:`✓`}),(0,$.jsx)(`span`,{children:p})]}),(0,$.jsxs)(`section`,{className:`workspace`,children:[(0,$.jsxs)(`aside`,{className:`left-panel panel`,children:[(0,$.jsxs)(`div`,{className:`panel-title`,children:[(0,$.jsx)(`span`,{children:`01`}),`事件智能识别 `,(0,$.jsx)(`b`,{children:`AI VISION`})]}),(0,$.jsxs)(`div`,{className:`scene`,children:[ge&&(0,$.jsx)(`img`,{className:`scene-upload-preview`,src:ge,alt:`上传的事故现场`}),ge&&L.detections.map((e,t)=>(0,$.jsx)(`div`,{className:`vision-detection ${e.label}`,style:{left:`${e.box.x}%`,top:`${e.box.y}%`,width:`${e.box.width}%`,height:`${e.box.height}%`},children:(0,$.jsxs)(`span`,{children:[e.labelZh,` `,(e.confidence*100).toFixed(1),`%`]})},`${e.label}-${t}`)),(0,$.jsx)(`div`,{className:`sky`}),(0,$.jsx)(`div`,{className:`road-lines`}),(0,$.jsx)(`div`,{className:`truck ${V>=2?`failed`:``}`,children:(0,$.jsx)(`span`,{children:`化学废料`})}),V>=2&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`smoke s1`}),(0,$.jsx)(`div`,{className:`smoke s2`}),(0,$.jsx)(`div`,{className:`smoke s3`})]}),!ge&&V>=3&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`detect-box`,children:(0,$.jsx)(`label`,{children:`演示预置 · 危化车辆`})}),(0,$.jsx)(`div`,{className:`detect-smoke`,children:(0,$.jsx)(`label`,{children:`演示预置 · 氯气泄漏`})})]}),(0,$.jsx)(`div`,{className:`camera`,children:`CAM-07 · LIVE`}),(0,$.jsxs)(`label`,{className:`upload-image`,children:[ve?`ONNX 推理中…`:`上传图片 · 本地识别`,(0,$.jsx)(`input`,{type:`file`,accept:`image/jpeg,image/png,image/webp`,onChange:e=>{$e(e.target.files?.[0]),e.currentTarget.value=``}})]}),(0,$.jsx)(`div`,{className:`model-status-chip ${L.modelMode===`explainable-fallback`?`fallback`:``}`,children:L.modelMode===`onnx`?`ONNX LOCAL · ${L.inferenceMs}ms`:L.modelMode===`demo`?`SCENARIO FIXTURE · 可上传实测`:`EXPLAINABLE FALLBACK`})]}),(0,$.jsxs)(`div`,{className:`recognition`,children:[(0,$.jsxs)(`button`,{type:`button`,className:B===`vehicle`?`active`:``,onClick:()=>{qe(),Je(`vehicle`,`危化品车辆状态`,`事件智能识别`,V===0?`演示车辆已加载并等待启动。`:H.detail,`京A·WH2576 · 阶段 ${String(V).padStart(2,`0`)}`)},children:[(0,$.jsx)(`span`,{children:`车辆状态`}),(0,$.jsx)(`strong`,{children:V===0?`等待演示`:V===1?`正常运输`:V===2?`动力故障`:`已停车处置`})]}),(0,$.jsxs)(`button`,{type:`button`,className:B===`confidence`?`active`:``,onClick:()=>{qe(),Je(`confidence`,`视觉模型置信度`,L.modelMode===`onnx`?`AI 视觉目标检测`:`演示/降级结果`,L.summary,`${L.modelName} · ${L.modelVersion}`)},children:[(0,$.jsx)(`span`,{children:`视觉模型置信度`}),(0,$.jsx)(`strong`,{children:ge||V>=3?(0,$.jsx)(_f,{to:L.confidence*100,decimals:1,suffix:`%`}):`—`})]}),(0,$.jsxs)(`button`,{type:`button`,className:B===`plume`?`active`:``,onClick:()=>{M(!0),qe(),Je(`plume`,`像素辅助特征与物理扩散`,`物理模型输入`,`像素辅助烟羽占比 ${(L.smokeRatio*100).toFixed(1)}%，物理模型计算警戒纵深 ${Ie.warning} 米。`,`非 AI · ${Ie.model}`)},children:[(0,$.jsx)(`span`,{children:`像素辅助占比`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:ge||V>=3?L.smokeRatio*100:0,decimals:1,suffix:`%`})})]}),(0,$.jsxs)(`button`,{type:`button`,className:B===`evacuated`?`active`:``,onClick:()=>Je(`evacuated`,`人员疏散进度`,`联合处置态势`,V>=6?`重点区域 186 人已完成向侧上风向疏散。`:`人员疏散队伍已待命，将在交通封控完成后执行。`,V>=6?`186 人 · 已完成`:`0 人 · 等待执行`),children:[(0,$.jsx)(`span`,{children:`已疏散人员`}),(0,$.jsx)(`strong`,{children:(0,$.jsx)(_f,{to:V>=6?186:0,suffix:` 人`})})]})]}),(0,$.jsxs)(`button`,{type:`button`,className:`ai-note side-wide-action ${B===`ai-note`?`active`:``}`,onClick:()=>{M(!0),qe(),Je(`ai-note`,ge?`本地 ONNX 视觉研判`:V>=3?`演示预置研判`:`运输遥测状态`,ge&&L.modelMode===`onnx`?`AI 视觉模型输出`:V>=3?`演示预置事件`:`车辆遥测`,ge?L.summary:V===0?`等待启动完整演示，车辆与应急力量已加载。`:H.detail,ge?`${L.modelName} · 图片未上传服务器`:V>=3?`固定比赛流程 · 非实时模型输出`:`车辆遥测 · 正常待命`)},children:[(0,$.jsx)(`b`,{children:ge?`本地 ONNX 视觉研判`:V>=3?`演示预置研判`:`运输遥测状态`}),(0,$.jsxs)(`p`,{children:[ge?L.summary:V===0?`等待启动完整演示，车辆与应急力量已加载。`:H.detail,` `,!ge&&V>=3&&(0,$.jsxs)($.Fragment,{children:[`东南风 3.4 m/s（吹向西北），预计 `,(0,$.jsxs)(`em`,{children:[3,` 分钟`]}),`进入重点警戒区域。`]})]})]}),(0,$.jsxs)(`div`,{className:`panel-title compact`,children:[(0,$.jsx)(`span`,{children:`02`}),`智能体协同 `,(0,$.jsx)(`b`,{children:`MULTI-AGENT`})]}),(0,$.jsx)(`div`,{className:`agents`,children:ip.map((e,t)=>{let n=[4,4,4,3][t],r=[7,8,6,9][t],i=V>=n,a=V>=r,o=[`FIRE-01`,`MED-03`,`POLICE-07`,`COMMAND`][t];return(0,$.jsxs)(`button`,{type:`button`,className:`agent ${e.tone} ${i?`scenario-active`:``} ${a?`scenario-done`:``} ${B===`agent-${t}`?`side-selected`:``}`,onClick:()=>{Ne(`agent-${t}`),o===`COMMAND`?(qe(),Je(`agent-${t}`,e.name,`多智能体协同`,e.text,`指挥中枢 · 联合处置`)):Ye(o)},children:[(0,$.jsx)(`i`,{children:a?`✓`:e.icon}),(0,$.jsxs)(`p`,{children:[(0,$.jsx)(`b`,{children:e.name}),(0,$.jsx)(`span`,{children:i?a?`阶段任务完成 · 点击查看位置`:_&&k===t?`正在执行当前处置任务…`:e.text:`系统待命 · 点击可提前追踪`})]}),(0,$.jsx)(`em`,{children:`●`})]},e.name)})}),(0,$.jsxs)(`div`,{className:`evidence-launches`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>Se(!0),children:[(0,$.jsx)(`span`,{children:`MODEL · DATA · METRICS`}),(0,$.jsx)(`b`,{children:`查看 AI 证据链`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>we(!0),children:[(0,$.jsx)(`span`,{children:`TASK · MESSAGE · BASIS`}),(0,$.jsx)(`b`,{children:`查看协同审计`})]})]})]}),(0,$.jsxs)(`section`,{className:`map-panel panel`,children:[(0,$.jsxs)(`div`,{className:`panel-title`,children:[(0,$.jsx)(`span`,{children:`03`}),`真实城市三维推演 `,(0,$.jsx)(`b`,{children:`REAL-WORLD DIGITAL TWIN`}),(0,$.jsxs)(`div`,{className:`map-tools`,children:[(0,$.jsx)(`button`,{"aria-label":`缩小`,onClick:()=>window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`zoomOut`})),children:`−`}),(0,$.jsx)(`button`,{"aria-label":`放大`,onClick:()=>window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`zoomIn`})),children:`＋`})]})]}),(0,$.jsxs)(`div`,{className:`map`,onClick:()=>I(null),children:[(0,$.jsx)(uf,{running:_,blocked:y,blockedRoadId:x,showRisk:j,topView:!ee,nightMode:N,buildingLights:ne,autoTour:ie,suspended:l!==`overview`||ue||xe||Ce,scenarioPhase:V,scenarioTime:Ee,trafficDensity:je,onSelect:I,onRealRoute:w,onSceneStatus:e=>{g(e),e===`degraded`&&m(`真实路网数据异常，已自动启用内置完整路线`)},plume:Ie}),(0,$.jsxs)(`div`,{className:`scenario-console phase-${V} ${R}`,onClick:e=>e.stopPropagation(),children:[(0,$.jsxs)(`div`,{className:`scenario-now`,children:[(0,$.jsx)(`i`,{children:H.icon}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`span`,{children:[`SCENARIO DIRECTOR · `,V===0?`READY`:`${String(V).padStart(2,`0`)}/09`]}),(0,$.jsx)(`strong`,{children:H.title}),(0,$.jsx)(`p`,{children:H.subtitle})]}),(0,$.jsx)(`em`,{children:V===0?`01:12`:`${Math.floor(Ee/60).toString().padStart(2,`0`)}:${Math.floor(Ee%60).toString().padStart(2,`0`)}`})]}),(0,$.jsxs)(`div`,{className:`scenario-progress`,children:[(0,$.jsx)(`span`,{style:{width:`${Pe}%`}}),(0,$.jsx)(`i`,{style:{left:`${Pe}%`}})]}),(0,$.jsx)(`div`,{className:`scenario-stage-rail`,children:op.slice(1).map(e=>(0,$.jsxs)(`button`,{className:V===e.id?`active`:V>e.id?`done`:``,title:`${e.clock} ${e.title}`,onClick:()=>{De(e.start+.01),Te(`paused`)},children:[(0,$.jsx)(`i`,{children:e.id}),(0,$.jsx)(`span`,{children:e.title})]},e.id))}),(0,$.jsxs)(`div`,{className:`scenario-controls`,children:[(0,$.jsx)(`button`,{className:`primary`,disabled:h===`loading`,onClick:V===0||R===`complete`?ze:Ve,children:h===`loading`?`路网加载中…`:V===0?`▶ 一键完整演示`:R===`playing`?`Ⅱ 暂停`:R===`complete`?`↻ 再演示`:`▶ 继续`}),(0,$.jsx)(`button`,{disabled:V===0||V===9,onClick:He,children:`下一阶段 →`}),(0,$.jsxs)(`button`,{onClick:Ue,children:[Oe,`× 倍速`]}),(0,$.jsxs)(`button`,{onClick:We,children:[`车流：`,je===18?`畅通`:je===36?`繁忙`:`拥堵`,` · `,je]}),(0,$.jsx)(`button`,{className:z?`on`:``,"aria-pressed":z,onClick:()=>Ae(e=>!e),children:`◉ 导演视角`})]})]}),(0,$.jsxs)(`div`,{className:`map-layer-tools`,children:[(0,$.jsxs)(`button`,{className:ee?`on`:``,onClick:()=>{Ke(),Ae(!1),te(e=>!e)},children:[`◈ `,ee?`自由三维`:`垂直俯视`]}),(0,$.jsx)(`button`,{className:j?`on`:``,onClick:()=>M(e=>!e),children:`◉ 风险热区`}),(0,$.jsx)(`button`,{className:N?`on`:``,onClick:()=>P(e=>!e),children:N?`☀ 白天`:`☾ 夜间`}),(0,$.jsx)(`button`,{className:ne?`on`:``,onClick:()=>re(e=>!e),children:`✦ 楼宇灯光`}),(0,$.jsx)(`button`,{className:ie?`on`:``,onClick:()=>{Ke(),Ae(!1),ae(e=>!e)},children:ie?`■ 停止巡航`:`▶ 自动巡航`}),oe&&(0,$.jsx)(`button`,{className:`on`,onClick:Ke,children:`■ 停止跟随`}),(0,$.jsx)(`button`,{onClick:()=>{Ke(),Ae(!1),ae(!1),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`incident`}))},children:`◎ 聚焦事故`}),(0,$.jsx)(`button`,{onClick:()=>{Ke(),Ae(!1),ae(!1),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:`reset`}))},children:`⌖ 复位`})]}),(0,$.jsx)(`div`,{className:`coordinates`,children:`39°54′27″N\xA0\xA0116°27′07″E　|　北京 CBD`}),(0,$.jsxs)(`div`,{className:`wind`,children:[`↖`,(0,$.jsxs)(`span`,{children:[`东南风 3.4m/s`,(0,$.jsx)(`br`,{}),`吹向西北`]})]}),(0,$.jsxs)(`div`,{className:`legend`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{className:`lg-red`}),`致命区`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{className:`lg-orange`}),`高风险`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`i`,{className:`lg-yellow`}),`警戒区`]})]}),(0,$.jsx)(`div`,{className:`map-attribution`,children:`© OpenStreetMap contributors · 北京核心区真实矢量数据`}),F&&(0,$.jsxs)(`div`,{className:`asset-card`,onClick:e=>e.stopPropagation(),children:[(0,$.jsx)(`button`,{onClick:()=>I(null),children:`×`}),(0,$.jsx)(`span`,{children:F.category}),(0,$.jsx)(`strong`,{children:F.label}),(0,$.jsx)(`p`,{children:F.details}),(0,$.jsx)(`em`,{children:F.meta}),(0,$.jsxs)(`div`,{className:`asset-actions`,children:[F.position&&(0,$.jsx)(`button`,{onClick:()=>{Ke(),ae(!1),window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`focus`,position:F.position}}))},children:`◎ 定位观察`}),F.action===`follow-vehicle`&&(0,$.jsx)(`button`,{className:oe===F.id?`tracking`:``,onClick:()=>Xe(F),children:oe===F.id?`■ 停止跟随`:`◉ 跟随车辆`}),F.action===`toggle-building-lights`&&(0,$.jsx)(`button`,{className:`lights`,onClick:()=>window.dispatchEvent(new CustomEvent(`city-camera`,{detail:{action:`toggle-building-lights`,assetId:F.id}})),children:`✦ 切换楼层灯光`}),F.action===`block-road`&&(0,$.jsx)(`button`,{className:`danger`,onClick:()=>Ge(Number(F.id.replace(`road-`,``))),children:y?`✓ 已封锁并完成真实路网重规划`:`⊘ 封锁此路并按真实路网重规划`})]})]})]}),(0,$.jsxs)(`div`,{className:`time-control`,children:[(0,$.jsx)(`button`,{"aria-label":R===`playing`?`暂停完整推演`:R===`paused`?`继续完整推演`:D?`暂停风险扩散时间`:`播放风险扩散时间`,onClick:()=>R===`playing`||R===`paused`?Ve():O(e=>!e),children:R===`playing`||D?`Ⅱ`:`▶`}),(0,$.jsx)(`input`,{"aria-label":`风险扩散推演时间`,type:`range`,min:`1`,max:`30`,value:T,disabled:R===`playing`||R===`paused`,onChange:e=>{O(!1),E(Number(e.target.value))}}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`现在`}),(0,$.jsx)(`span`,{children:`+5min`}),(0,$.jsx)(`span`,{children:`+15min`}),(0,$.jsx)(`span`,{children:`+30min`})]}),(0,$.jsxs)(`strong`,{children:[R===`playing`||R===`paused`?`导演脚本联动 · `:``,`+`,T,`min · 警戒纵深 `,Ie.warning,`m`]})]})]}),(0,$.jsxs)(`aside`,{className:`right-panel panel`,children:[(0,$.jsxs)(`div`,{className:`panel-title`,children:[(0,$.jsx)(`span`,{children:`04`}),`决策方案 `,(0,$.jsx)(`b`,{children:`AI COMMAND`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`score-card ${B===`plan-score`?`side-selected`:``}`,onClick:()=>Je(`plan-score`,y?`方案 B · A* 动态重规划`:`方案 A · 最短响应路径`,`AI 决策方案`,y?`东二环封闭后，系统已使用 OSM 真实路网完成避让重规划。`:`当前道路正常通行，系统选择消防最短响应路径。`,`综合评分 ${y?`92.4`:`95.1`} · 实时求解`),children:[(0,$.jsx)(`span`,{children:`当前最优方案 · 实时求解`}),(0,$.jsx)(`strong`,{children:y?`方案 B · A* 动态重规划`:`方案 A · 最短响应路径`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`b`,{children:(0,$.jsx)(_f,{to:y?92.4:95.1,decimals:1})}),(0,$.jsx)(`small`,{children:`综合评分`})]})]}),(0,$.jsxs)(`div`,{className:`metrics`,children:[(0,$.jsxs)(`button`,{type:`button`,className:B===`eta`?`active`:``,onClick:()=>{Ne(`eta`),Ye(`FIRE-01`)},children:[(0,$.jsx)(`span`,{children:`OSM A* 预计响应`}),(0,$.jsx)(`b`,{className:`green`,children:(0,$.jsx)(_f,{to:C?.eta??Le.eta,suffix:` min`})}),(0,$.jsxs)(`small`,{children:[`点击追踪消防车 · 搜索 `,C?.visited??Le.visited,` 个节点`]})]}),(0,$.jsxs)(`button`,{type:`button`,className:B===`exposure`?`active`:``,onClick:()=>{M(!0),qe(),Je(`exposure`,`模型风险暴露`,`风险扩散计算`,`当前预计风险暴露人口 ${Ie.affectedPeople} 人，警戒纵深 ${Ie.warning} 米。`,Ie.model)},children:[(0,$.jsx)(`span`,{children:`模型风险暴露`}),(0,$.jsx)(`b`,{children:(0,$.jsx)(_f,{to:Ie.affectedPeople,suffix:` 人`})}),(0,$.jsxs)(`small`,{children:[`点击聚焦风险区 · `,Ie.model]})]}),(0,$.jsxs)(`button`,{type:`button`,className:B===`route`?`active`:``,onClick:()=>Je(`route`,`消防真实救援路径`,`OSM 路径规划`,C?.roads.join(` → `)||`正在加载 OSM 真实道路名称。`,`${((C?.distance??Le.distance)/1e3).toFixed(2)} km · ETA ${C?.eta??Le.eta} min`),children:[(0,$.jsx)(`span`,{children:`真实救援路径`}),(0,$.jsx)(`b`,{children:(0,$.jsx)(_f,{to:(C?.distance??Le.distance)/1e3,decimals:2,suffix:` km`})}),(0,$.jsxs)(`small`,{children:[`点击查看道路序列 · `,C?.roads.slice(0,2).join(` → `)||`正在加载`]})]})]}),(0,$.jsx)(`div`,{className:`plan-steps`,children:[`封锁泄漏点周边 500m 道路`,`学校师生向东南侧上风向分批疏散`,`消防车沿 OSM 真实道路抵达`,`救护组在体育中心建立分诊点`].map((e,t)=>{let n=[6,6,7,8][t];return(0,$.jsxs)(`button`,{type:`button`,className:B===`step-${t}`?`active`:``,onClick:()=>{Ne(`step-${t}`),De(op[n].start+.01),Te(`paused`),Ae(!0),m(`已跳转到处置步骤：${e}`)},children:[(0,$.jsx)(`i`,{children:t+1}),(0,$.jsxs)(`p`,{children:[e,(0,$.jsxs)(`span`,{children:[[`交警 · 2分钟内`,`教育 · 8分钟完成`,`消防 · 预计${C?.eta??7}分钟`,`医疗 · 12分钟启用`][t],` · 点击定位`]})]}),(0,$.jsx)(`em`,{children:`→`})]},e)})}),(0,$.jsx)(`button`,{className:`block-button`,disabled:V>0&&R!==`complete`,onClick:()=>Ge(),children:V>0&&R!==`complete`?`完整演示进行中 · 道路决策已锁定`:y?`✓ OSM A* 已重规划：${C?.roads.slice(0,4).join(` → `)||`已避开封闭道路`}`:`模拟突发：封闭东二环路段并按真实道路重规划`}),(0,$.jsxs)(`div`,{className:`algorithm-proof`,children:[(0,$.jsxs)(`button`,{type:`button`,onClick:()=>{M(e=>!e),qe(),m(j?`风险扩散图层已隐藏`:`风险扩散图层已开启`)},children:[(0,$.jsx)(`span`,{children:`扩散模型`}),(0,$.jsx)(`b`,{children:`高斯烟羽 / Pasquill-D`}),(0,$.jsx)(`em`,{children:`点击切换风险图层 · Q=80g/s`})]}),(0,$.jsxs)(`button`,{type:`button`,onClick:()=>Je(`algorithm`,`OSM 真实路网 A*`,`路径算法`,`A* 已搜索 ${C?.visited??Le.visited} 个道路节点，使用欧氏距离作为启发函数。`,`距离 ${C?.distance??Le.distance}m · ETA ${C?.eta??Le.eta}min`),children:[(0,$.jsx)(`span`,{children:`路径算法`}),(0,$.jsx)(`b`,{children:`OSM 真实路网 A* · Euclidean`}),(0,$.jsx)(`em`,{children:`点击查看求解结果`})]})]}),(0,$.jsxs)(`div`,{className:`panel-title compact`,children:[(0,$.jsx)(`span`,{children:`05`}),`决策时间线 `,(0,$.jsx)(`b`,{children:`TRACE`})]}),(0,$.jsx)(`div`,{className:`timeline scenario-timeline`,children:op.slice(1).map(e=>(0,$.jsxs)(`button`,{type:`button`,className:`${V===e.id?`active`:V>e.id?`done`:``} ${B===`timeline-${e.id}`?`side-selected`:``}`,onClick:()=>{Ne(`timeline-${e.id}`),De(e.start+.01),Te(`paused`),Ae(!0),m(`时间线已定位：${e.title}`)},children:[(0,$.jsx)(`time`,{children:e.clock}),(0,$.jsx)(`i`,{}),(0,$.jsxs)(`p`,{children:[(0,$.jsx)(`b`,{children:e.title}),(0,$.jsx)(`span`,{children:e.subtitle})]})]},e.id))}),(0,$.jsxs)(`button`,{className:`report`,onClick:Ze,children:[`生成应急处置报告 `,(0,$.jsx)(`span`,{children:`↗`})]})]})]}),ce&&(0,$.jsx)(Tf,{data:ce,tone:`blue`,onClose:()=>le(null)}),xe&&(0,$.jsx)(tp,{vision:L,onClose:()=>Se(!1)}),Ce&&(0,$.jsx)(rp,{scenarioPhase:V,scenarioTime:Ee,vision:L,plume:Ie,route:C??{distance:Le.distance,eta:Le.eta,visited:Le.visited,roads:[]},blocked:y,onClose:()=>we(!1)}),ue&&(0,$.jsx)(`div`,{className:`report-overlay`,onClick:()=>de(!1),children:(0,$.jsxs)(`section`,{className:`report-dialog`,role:`dialog`,"aria-modal":`true`,"aria-label":`应急处置报告`,onClick:e=>e.stopPropagation(),children:[(0,$.jsx)(`button`,{className:`report-close`,"aria-label":`关闭报告`,onClick:()=>de(!1),children:`×`}),fe?(0,$.jsxs)(`div`,{className:`report-generating`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`strong`,{children:`系统正在生成应急处置报告`}),(0,$.jsx)(`p`,{children:`汇总视觉识别、物理扩散、A* 路径规划与协同决策结果…`}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{}),(0,$.jsx)(`span`,{})]})]}):(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`header`,{className:`report-head`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`LINGJING SENTINEL · AUTO REPORT`}),(0,$.jsx)(`h2`,{children:`危化品泄漏应急处置报告`}),(0,$.jsxs)(`p`,{children:[`报告编号：LJ-BJ-20260720-001　生成时间：`,me]})]}),(0,$.jsx)(`b`,{children:`Ⅰ级响应`})]}),(0,$.jsxs)(`div`,{className:`report-paper`,children:[(0,$.jsxs)(`div`,{className:`report-summary`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`视觉模型判定`}),(0,$.jsx)(`strong`,{children:L.type}),(0,$.jsxs)(`em`,{children:[`置信度 `,(L.confidence*100).toFixed(1),`%`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`警戒纵深`}),(0,$.jsxs)(`strong`,{children:[Ie.warning,` m`]}),(0,$.jsx)(`em`,{children:`物理模型 · Pasquill-D`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`风险暴露`}),(0,$.jsxs)(`strong`,{children:[Ie.affectedPeople,` 人`]}),(0,$.jsxs)(`em`,{children:[`现场估计 `,L.persons,` 人`]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{children:`消防 ETA`}),(0,$.jsxs)(`strong`,{children:[C?.eta??Le.eta,` min`]}),(0,$.jsxs)(`em`,{children:[`A* · `,C?.distance??Le.distance,` m`]})]})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`h3`,{children:`01　事件概况与视觉研判`}),(0,$.jsxs)(`p`,{children:[`北京市朝阳区建国门外大街国贸桥西侧发生危化品运输车泄漏。视觉模型识别为`,(0,$.jsx)(`strong`,{children:L.type}),`，烟羽像素占比 `,(L.smokeRatio*100).toFixed(1),`%，现场人员约 `,L.persons,` 人。`,L.summary]}),(0,$.jsxs)(`div`,{className:`report-callout danger`,children:[(0,$.jsx)(`b`,{children:`核心风险`}),(0,$.jsx)(`span`,{children:`东南风 3.4 m/s，污染羽流向西北扩散；学校位于事故点 500 米重点保护范围内，应启动预防性疏散。`})]})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`h3`,{children:`02　物理风险扩散计算`}),(0,$.jsx)(`table`,{children:(0,$.jsxs)(`tbody`,{children:[(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`th`,{children:`风险等级`}),(0,$.jsx)(`th`,{children:`纵深`}),(0,$.jsx)(`th`,{children:`处置要求`})]}),(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:`致命区`}),(0,$.jsxs)(`td`,{children:[Ie.lethal,` m`]}),(0,$.jsx)(`td`,{children:`仅允许专业防化力量进入`})]}),(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:`高风险区`}),(0,$.jsxs)(`td`,{children:[Ie.high,` m`]}),(0,$.jsx)(`td`,{children:`立即疏散并设置硬隔离`})]}),(0,$.jsxs)(`tr`,{children:[(0,$.jsx)(`td`,{children:`警戒区`}),(0,$.jsxs)(`td`,{children:[Ie.warning,` m`]}),(0,$.jsx)(`td`,{children:`持续监测并准备扩大疏散`})]})]})})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`h3`,{children:`03　A* 消防救援路径规划`}),(0,$.jsxs)(`p`,{children:[`系统使用 674 段北京 OSM 道路构图，并通过 A* 搜索 `,C?.visited??Le.visited,` 个道路节点。当前路线：`]}),(0,$.jsx)(`div`,{className:`report-route`,children:C?.roads.join(`　→　`)||`正在载入真实道路名称`}),(0,$.jsx)(`p`,{children:y?`已封锁 OSM 道路 ${C?.blockedRoadId??x??`自动选择路段`}，消防车已避开该路段并完成动态重规划。`:`当前道路正常通行，消防车沿最短真实路网路线行驶。`})]}),(0,$.jsxs)(`article`,{children:[(0,$.jsx)(`h3`,{children:`04　规则化协同处置指令`}),(0,$.jsxs)(`ol`,{children:[(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`交通：`}),`2 分钟内封锁事故点周边 500 m 道路，建立 3.2 km 应急绿波带。`]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`教育：`}),`城北实验学校师生经东南侧上风向安全通道分批疏散，8 分钟完成重点人员转移。`]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`消防：`}),`2 辆泡沫消防车沿 OSM 路线抵达，在上风向布置水幕并实施堵漏。`]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`医疗：`}),`开放三级医院绿色通道，在体育中心设置临时分诊点。`]}),(0,$.jsxs)(`li`,{children:[(0,$.jsx)(`b`,{children:`监测：`}),`下风向 200 m、500 m、1000 m 设置监测点，每 2 分钟回传浓度。`]})]})]}),(0,$.jsxs)(`div`,{className:`report-conclusion`,children:[(0,$.jsx)(`b`,{children:`联合处置结论`}),(0,$.jsx)(`p`,{children:`立即启动危化品泄漏Ⅰ级联合响应，处置优先级为：学校疏散 → 道路封控 → 泄漏源控制 → 医疗救治 → 环境复测。`}),(0,$.jsx)(`small`,{children:`本报告由视觉模型、物理模型、路径算法与规则引擎联合生成，仅用于竞赛演示；正式行动须由现场指挥员复核。`})]})]}),(0,$.jsxs)(`footer`,{className:`report-actions`,children:[(0,$.jsx)(`button`,{onClick:Qe,children:`↓ 下载完整报告`}),(0,$.jsx)(`button`,{onClick:()=>de(!1),children:`关闭报告`})]})]})]})}),(0,$.jsxs)(`footer`,{children:[(0,$.jsx)(`span`,{children:`数据源：城市感知网络 · 气象局 · 应急资源库`}),(0,$.jsxs)(`strong`,{children:[(0,$.jsx)(`i`,{}),` 模型与算法引擎运行正常 · 处理延迟 128ms`]}),(0,$.jsx)(`span`,{children:`灵境哨兵 v3.1 EVIDENCE · 离线演示环境`})]})]}):(0,$.jsx)(lp,{onAuthenticated:et}):(0,$.jsxs)(`main`,{className:`auth-boot`,children:[(0,$.jsxs)(`div`,{className:`auth-brand-mark`,children:[(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{}),(0,$.jsx)(`i`,{})]}),(0,$.jsx)(`span`,{children:`安全环境初始化中`})]})}export{up as default};